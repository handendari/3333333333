...
Begin VB.Form frm_etc_smtp_server 
   ...
   Begin VB.Frame Frame1 
      ...
      End
   End
   Begin prj_genting.vbButton cmdTest 
      Height          =   405
      Left            =   2340
      TabIndex        =   18
      Top             =   4200
   ...
   Begin VB.Image Image2 
      Height          =   4770
      Left            =   0
      Picture         =   "frmSMTPServer.frx":10D6
      Stretch         =   -1  'True
      Top             =   0
      Width           =   2265
   End
...
On Error GoTo Err:
    For Each objControl In Me.Controls
        If TypeOf objControl Is TextBox Then
            If Trim$(objControl.Text) = vbNullString Then
                MsgBox "All fields are required!", vbExclamation, headerMSG
                objControl.SetFocus
                Exit Sub
            End If
        End If
    ...
    Else
        SQL = "INSERT INTO s_mail(s_number,sender_mail,sender_name,username," & _
                "pwd,smtp_server,no_port,req_ssl) " & _
                "VALUES( " & _
...
On Error GoTo Err
    ...
    MsgBox "Mail (SMTP Server) Configuration Test Successfully!", vbInformation, headerMSG
    Exit Sub
