...
Begin VB.Form frm_trans_spl 
   ...
   Begin VB.Frame fra_entry 
      ...
      Begin TDBTime6Ctl.TDBTime TDBTime1 
         ...
         _ExtentX        =   2566
         _ExtentY        =   529
         Caption         =   "frm_trans_spl.frx":000C
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Keys            =   "frm_trans_spl.frx":0071
         Spin            =   "frm_trans_spl.frx":00C1
         AlignHorizontal =   0
         AlignVertical   =   0
         Appearance      =   1
      ...
      Begin TDBTime6Ctl.TDBTime TDBTime2 
         ...
         _ExtentX        =   2566
         _ExtentY        =   529
         Caption         =   "frm_trans_spl.frx":00E9
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            Name            =   "Tahoma"
            Size            =   8.25
            Charset         =   0
            ...
            Strikethrough   =   0   'False
         EndProperty
         Keys            =   "frm_trans_spl.frx":014E
         Spin            =   "frm_trans_spl.frx":019E
         AlignHorizontal =   0
         AlignVertical   =   0
         Appearance      =   1
         BackColor       =   -2147483643
   ...
   Begin VB.Frame frmTombol 
      ...
      Begin VB.CommandButton cmd_refresh 
         ...
         Height          =   645
         Left            =   7080
         Picture         =   "frm_trans_spl.frx":01C6
         Style           =   1  'Graphical
         TabIndex        =   21
         Top             =   840
         Visible         =   0   'False
      ...
      Begin VB.CommandButton CmdSave 
         ...
         Height          =   645
         Left            =   1800
         Picture         =   "frm_trans_spl.frx":0750
         Style           =   1  'Graphical
         TabIndex        =   8
         Top             =   360
         Width           =   975
      ...
      Begin VB.CommandButton CmdCancel 
         ...
         Height          =   645
         Left            =   5040
         Picture         =   "frm_trans_spl.frx":0CDA
         Style           =   1  'Graphical
         TabIndex        =   11
         Top             =   360
         Width           =   975
      ...
      Begin VB.CommandButton CmdExit 
         ...
         Height          =   645
         Left            =   11400
         Picture         =   "frm_trans_spl.frx":1264
         Style           =   1  'Graphical
         TabIndex        =   12
         Top             =   360
         Width           =   975
      ...
      Begin VB.CommandButton CmdNew 
         ...
         Height          =   645
         Left            =   720
         Picture         =   "frm_trans_spl.frx":17EE
         Style           =   1  'Graphical
         TabIndex        =   7
         Top             =   360
         Width           =   975
      ...
      Begin VB.CommandButton CmdPrint 
         ...
         Height          =   645
         Left            =   0
         Picture         =   "frm_trans_spl.frx":1D78
         Style           =   1  'Graphical
         TabIndex        =   17
         Top             =   600
         Visible         =   0   'False
      ...
      Begin VB.CommandButton cmdDelete 
         ...
         Height          =   645
         Left            =   3960
         Picture         =   "frm_trans_spl.frx":2302
         Style           =   1  'Graphical
         TabIndex        =   10
         Top             =   360
         Width           =   975
      ...
      Begin VB.CommandButton cmdEdit 
         ...
         Height          =   645
         Left            =   2880
         Picture         =   "frm_trans_spl.frx":288C
         Style           =   1  'Graphical
         TabIndex        =   9
         Top             =   360
         Width           =   975
   ...
   Begin TrueOleDBGrid70.TDBGrid TDBGrid1 
      ...
      Columns(2).Caption=   "TITLE CODE"
      Columns(2).DataField=   "title_code"
      Columns(2)._PropDict=   "_MaxComboItems,516,2;_VlistStyle,514,3"
      Columns(3)._VlistStyle=   0
      Columns(3)._MaxComboItems=   5
      Columns(3).Caption=   "TITLE NAME"
      Columns(3).DataField=   "title_name"
      Columns(3)._PropDict=   "_MaxComboItems,516,2;_VlistStyle,514,3"
      Columns(4)._VlistStyle=   0
      Columns(4)._MaxComboItems=   5
      Columns(4).Caption=   "DATE"
      Columns(4).DataField=   "date_"
      Columns(4)._PropDict=   "_MaxComboItems,516,2;_VlistStyle,514,3"
      Columns(5)._VlistStyle=   0
      Columns(5)._MaxComboItems=   5
      Columns(5).Caption=   "START"
      Columns(5).DataField=   "start_time_"
      Columns(5)._PropDict=   "_MaxComboItems,516,2;_VlistStyle,514,3"
      Columns(6)._VlistStyle=   0
      Columns(6)._MaxComboItems=   5
      Columns(6).Caption=   "END"
      Columns(6).DataField=   "end_time_"
      ...
      Splits(0)._ColumnProps(3)=   "Column(0)._WidthInPix=3228"
      ...
      Splits(0)._ColumnProps(14)=   "Column(2).AllowSizing=0"
      ...
      Splits(0)._ColumnProps(27)=   "Column(4).Width=3466"
      Splits(0)._ColumnProps(28)=   "Column(4).DividerColor=0"
      Splits(0)._ColumnProps(29)=   "Column(4)._WidthInPix=3387"
      ...
      Splits(0)._ColumnProps(42)=   "Column(7).Width=5371"
      Splits(0)._ColumnProps(43)=   "Column(7).DividerColor=0"
      Splits(0)._ColumnProps(44)=   "Column(7)._WidthInPix=5292"
      ...
      _StyleDefs(35)  =   "Splits(0).Columns(0).Style:id=32,.parent=99"
      _StyleDefs(36)  =   "Splits(0).Columns(0).HeadingStyle:id=29,.parent=100"
      _StyleDefs(37)  =   "Splits(0).Columns(0).FooterStyle:id=30,.parent=101"
      _StyleDefs(38)  =   "Splits(0).Columns(0).EditorStyle:id=31,.parent=103"
      _StyleDefs(39)  =   "Splits(0).Columns(1).Style:id=28,.parent=99"
      _StyleDefs(40)  =   "Splits(0).Columns(1).HeadingStyle:id=25,.parent=100"
      _StyleDefs(41)  =   "Splits(0).Columns(1).FooterStyle:id=26,.parent=101"
      _StyleDefs(42)  =   "Splits(0).Columns(1).EditorStyle:id=27,.parent=103"
      _StyleDefs(43)  =   "Splits(0).Columns(2).Style:id=154,.parent=99"
      _StyleDefs(44)  =   "Splits(0).Columns(2).HeadingStyle:id=151,.parent=100"
      _StyleDefs(45)  =   "Splits(0).Columns(2).FooterStyle:id=152,.parent=101"
      _StyleDefs(46)  =   "Splits(0).Columns(2).EditorStyle:id=153,.parent=103"
      _StyleDefs(47)  =   "Splits(0).Columns(3).Style:id=158,.parent=99"
      _StyleDefs(48)  =   "Splits(0).Columns(3).HeadingStyle:id=155,.parent=100"
      _StyleDefs(49)  =   "Splits(0).Columns(3).FooterStyle:id=156,.parent=101"
      _StyleDefs(50)  =   "Splits(0).Columns(3).EditorStyle:id=157,.parent=103"
      _StyleDefs(51)  =   "Splits(0).Columns(4).Style:id=46,.parent=99,.alignment=2"
      _StyleDefs(52)  =   "Splits(0).Columns(4).HeadingStyle:id=43,.parent=100"
      _StyleDefs(53)  =   "Splits(0).Columns(4).FooterStyle:id=44,.parent=101"
      _StyleDefs(54)  =   "Splits(0).Columns(4).EditorStyle:id=45,.parent=103"
      _StyleDefs(55)  =   "Splits(0).Columns(5).Style:id=50,.parent=99,.alignment=2"
      _StyleDefs(56)  =   "Splits(0).Columns(5).HeadingStyle:id=47,.parent=100"
      _StyleDefs(57)  =   "Splits(0).Columns(5).FooterStyle:id=48,.parent=101"
      _StyleDefs(58)  =   "Splits(0).Columns(5).EditorStyle:id=49,.parent=103"
      _StyleDefs(59)  =   "Splits(0).Columns(6).Style:id=58,.parent=99,.alignment=2"
      _StyleDefs(60)  =   "Splits(0).Columns(6).HeadingStyle:id=55,.parent=100"
      _StyleDefs(61)  =   "Splits(0).Columns(6).FooterStyle:id=56,.parent=101"
      _StyleDefs(62)  =   "Splits(0).Columns(6).EditorStyle:id=57,.parent=103"
      _StyleDefs(63)  =   "Splits(0).Columns(7).Style:id=62,.parent=99"
      _StyleDefs(64)  =   "Splits(0).Columns(7).HeadingStyle:id=59,.parent=100"
      _StyleDefs(65)  =   "Splits(0).Columns(7).FooterStyle:id=60,.parent=101"
      _StyleDefs(66)  =   "Splits(0).Columns(7).EditorStyle:id=61,.parent=103"
   ...
   Begin TrueOleDBList60.TDBCombo TDBCombo_company 
      Height          =   375
      Left            =   1200
      OleObjectBlob   =   "frm_trans_spl.frx":2E16
      TabIndex        =   1
      Top             =   240
      Width           =   1695
   End
...
'    DTPicker_date_to.Value = DTPicker1.Value
'End If
End Sub
...
& Adodc1.Recordset.Fields("employee_code").Value & "' and left(date,10)='" _
& Format(Adodc1.Recordset.Fields("date").Value, "yyyy-mm-dd") & "'"
CnG.CommitTrans
...
rsBound.Open "select * from t_spl where employee_code = '" _
& Adodc1.Recordset.Fields("employee_code").Value & "' and left(date,10)='" _
& Format(DTPicker1.Value, "yyyy-MM-dd") & "'", CnG, adOpenKeyset, adLockOptimistic
...
If rsBound.State = 1 Then rsBound.Close
rsBound.Open "select * from t_spl where employee_code = '-1'", CnG, adOpenKeyset, adLockOptimistic
...
str1 = "select count(*) as recs from t_spl where year(leave_date_from)=" & Year(dt1) _
...
'rs.Open "select ifnull(max(leave_number),0)+1 as leave_number from t_spl", CnG, adOpenStatic, adLockReadOnly
...
'    .Fields("title_name").Value = Trim(txt_title_name)
    ...
    .Fields("date").Value = DTPicker1.Value
    .Fields("start_time").Value = Format(TDBTime1, "yyyy-mm-dd HH:mm:ss")
    .Fields("end_time").Value = Format(TDBTime2, "yyyy-mm-dd HH:mm:ss")
    .Fields("flag_approval").Value = 0
...
With rsBound
    ...
    '-----------------------------------------------------------------------------
'    .Fields("employee_code").Value = Trim(txt_employee_code)
'    .Fields("leave_date_from").Value = Format(DTPicker1.Value, "yyyy-MM-dd HH:mm:ss")
...
Adodc1.RecordSource = "select a.*, cast(date_format(date,'%d-%m-%Y') as char) as date_, " _
& "cast(date_format(start_time,'%H:%i') as char) as start_time_, " _
& "cast(date_format(end_time,'%H:%i') as char) as end_time_ " _
& "from t_spl a where company_code = '" _
& TDBCombo_company.Columns("company_code").Value & "' order by date asc"
Adodc1.Refresh
