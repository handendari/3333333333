...
Begin VB.Form frm_rpt_summary_leave 
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      TabPicture(1)   =   "frm_rpt_leave_summary.frx":0028
      Tab(1).ControlEnabled=   0   'False
      Tab(1).ControlCount=   0
      TabCaption(2)   =   "RESERVED"
      TabPicture(2)   =   "frm_rpt_leave_summary.frx":0044
      ...
      Begin VB.Frame Frame5 
         ...
         Begin VB.ComboBox cbo_summary_leave_company 
            Height          =   315
            ItemData        =   "frm_rpt_leave_summary.frx":0060
            Left            =   3360
            List            =   "frm_rpt_leave_summary.frx":006A
            TabIndex        =   8
            Text            =   "..."
            Top             =   960
            Width           =   1695
   ...
   Begin VB.Frame Frame3 
      ...
      Begin VB.CommandButton CmdPrint 
         ...
         Height          =   645
         Left            =   6720
         Picture         =   "frm_rpt_leave_summary.frx":007D
         Style           =   1  'Graphical
         TabIndex        =   2
         Top             =   360
         Width           =   975
      ...
      Begin VB.CommandButton CmdExit 
         ...
         Height          =   645
         Left            =   8280
         Picture         =   "frm_rpt_leave_summary.frx":0607
         Style           =   1  'Graphical
         TabIndex        =   1
         Top             =   360
         Width           =   975
   ...
   Begin TrueOleDBList60.TDBCombo TDBCombo_company 
      Height          =   375
      Left            =   1260
      OleObjectBlob   =   "frm_rpt_leave_summary.frx":0B91
      TabIndex        =   5
      Top             =   630
      Width           =   1695
   End
