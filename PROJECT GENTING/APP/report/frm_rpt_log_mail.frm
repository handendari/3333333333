...
Begin VB.Form frm_rpt_log_mail 
   ...
   Begin VB.Frame frmTombol 
      ...
      Begin VB.CommandButton cmd_delete_all 
         ...
         Height          =   645
         Left            =   7800
         Picture         =   "frm_rpt_log_mail.frx":000C
         Style           =   1  'Graphical
         TabIndex        =   7
         Top             =   360
         Width           =   975
      ...
      Begin VB.CommandButton cmd_refresh 
         ...
         Height          =   645
         Left            =   3840
         Picture         =   "frm_rpt_log_mail.frx":0596
         Style           =   1  'Graphical
         TabIndex        =   4
         Top             =   600
         Visible         =   0   'False
      ...
      Begin VB.CommandButton CmdSave 
         ...
         Height          =   645
         Left            =   1680
         Picture         =   "frm_rpt_log_mail.frx":0B20
         Style           =   1  'Graphical
         TabIndex        =   2
         Top             =   600
         Visible         =   0   'False
      ...
      Begin VB.CommandButton CmdCancel 
         ...
         Height          =   645
         Left            =   4920
         Picture         =   "frm_rpt_log_mail.frx":10AA
         Style           =   1  'Graphical
         TabIndex        =   5
         Top             =   600
         Visible         =   0   'False
      ...
      Begin VB.CommandButton CmdExit 
         ...
         Height          =   645
         Left            =   10200
         Picture         =   "frm_rpt_log_mail.frx":1634
         Style           =   1  'Graphical
         TabIndex        =   8
         Top             =   360
         Width           =   975
      ...
      Begin VB.CommandButton CmdNew 
         ...
         Height          =   645
         Left            =   600
         Picture         =   "frm_rpt_log_mail.frx":1BBE
         Style           =   1  'Graphical
         TabIndex        =   1
         Top             =   600
         Visible         =   0   'False
      ...
      Begin VB.CommandButton CmdPrint 
         ...
         Height          =   645
         Left            =   0
         Picture         =   "frm_rpt_log_mail.frx":2148
         Style           =   1  'Graphical
         TabIndex        =   10
         Top             =   600
         Visible         =   0   'False
      ...
      Begin VB.CommandButton cmdDelete 
         ...
         Height          =   645
         Left            =   6720
         Picture         =   "frm_rpt_log_mail.frx":26D2
         Style           =   1  'Graphical
         TabIndex        =   6
         Top             =   360
         Width           =   975
      ...
      Begin VB.CommandButton cmdEdit 
         ...
         Height          =   645
         Left            =   2760
         Picture         =   "frm_rpt_log_mail.frx":2C5C
         Style           =   1  'Graphical
         TabIndex        =   3
         Top             =   600
         Visible         =   0   'False
...
CnG.Execute "delete from h_send_mail where cast(date as char) = '" _
    & Format(Adodc1.Recordset.Fields("date").Value, "yyyy-mm-dd hh:nn:ss") & "' and employee_code = '" _
