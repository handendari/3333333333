...
Begin VB.Form frm_rpt_layout_absen 
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      Begin VB.Frame fra_periode 
         ...
         Begin VB.ComboBox cbo_periode_department 
            Height          =   315
            ItemData        =   "frm_rpt_layout_absen.frx":2005
            Left            =   1410
            List            =   "frm_rpt_layout_absen.frx":200F
            TabIndex        =   27
            Text            =   "..."
            Top             =   540
            Width           =   1695
   ...
   Begin VB.Frame Frame3 
      ...
      Begin VB.CommandButton cmdPrint 
         ...
         Height          =   645
         Left            =   5250
         Picture         =   "frm_rpt_layout_absen.frx":2022
         Style           =   1  'Graphical
         TabIndex        =   26
         Top             =   360
         Width           =   975
      ...
      Begin VB.CommandButton cmd_print_sum_list 
         ...
         Height          =   645
         Left            =   5520
         Picture         =   "frm_rpt_layout_absen.frx":25AC
         Style           =   1  'Graphical
         TabIndex        =   23
         Top             =   840
         Visible         =   0   'False
      ...
      Begin VB.CommandButton cmd_send_mail 
         ...
         Height          =   645
         Left            =   6600
         Picture         =   "frm_rpt_layout_absen.frx":2B36
         Style           =   1  'Graphical
         TabIndex        =   20
         Top             =   840
         Visible         =   0   'False
      ...
      Begin VB.CommandButton CmdExit 
         ...
         Height          =   645
         Left            =   8280
         Picture         =   "frm_rpt_layout_absen.frx":30C0
         Style           =   1  'Graphical
         TabIndex        =   1
         Top             =   360
         Width           =   975
   ...
   Begin TrueOleDBList60.TDBCombo TDBCombo_company 
      Height          =   375
      Left            =   1200
      OleObjectBlob   =   "frm_rpt_layout_absen.frx":364A
      TabIndex        =   4
      Top             =   780
      Width           =   1695
   End
