...
Begin VB.Form frm_rpt_log_activity 
   ...
   Begin VB.Frame frmTombol 
      ...
      Begin VB.CommandButton cmd_refresh 
         ...
         Height          =   645
         Left            =   3840
         Picture         =   "frm_rpt_log_activity.frx":0596
         Style           =   1  'Graphical
         TabIndex        =   4
         Top             =   600
         Visible         =   0   'False
      ...
      Begin VB.CommandButton CmdSave 
         ...
         Height          =   645
         Left            =   1680
         Picture         =   "frm_rpt_log_activity.frx":0B20
         Style           =   1  'Graphical
         TabIndex        =   2
         Top             =   600
         Visible         =   0   'False
      ...
      Begin VB.CommandButton CmdCancel 
         ...
         Height          =   645
         Left            =   4920
         Picture         =   "frm_rpt_log_activity.frx":10AA
         Style           =   1  'Graphical
         TabIndex        =   5
         Top             =   600
         Visible         =   0   'False
      ...
      Begin VB.CommandButton CmdExit 
         ...
         Height          =   645
         Left            =   10200
         Picture         =   "frm_rpt_log_activity.frx":1634
         Style           =   1  'Graphical
         TabIndex        =   8
         Top             =   360
         Width           =   975
      ...
      Begin VB.CommandButton CmdNew 
         ...
         Height          =   645
         Left            =   600
         Picture         =   "frm_rpt_log_activity.frx":1BBE
         Style           =   1  'Graphical
         TabIndex        =   1
         Top             =   600
         Visible         =   0   'False
      ...
      Begin VB.CommandButton CmdPrint 
         ...
         Height          =   645
         Left            =   0
         Picture         =   "frm_rpt_log_activity.frx":2148
         Style           =   1  'Graphical
         TabIndex        =   10
         Top             =   600
         Visible         =   0   'False
      ...
      Begin VB.CommandButton cmdDelete 
         ...
         Height          =   645
         Left            =   6720
         Picture         =   "frm_rpt_log_activity.frx":26D2
         Style           =   1  'Graphical
         TabIndex        =   6
         Top             =   360
         Width           =   975
      ...
      Begin VB.CommandButton cmdEdit 
         ...
         Height          =   645
         Left            =   2760
         Picture         =   "frm_rpt_log_activity.frx":2C5C
         Style           =   1  'Graphical
         TabIndex        =   3
         Top             =   600
         Visible         =   0   'False
...
CnG.BeginTrans
CnG.Execute "delete from log_activitas where user_code = '" & Adodc1.Recordset.Fields("user_code").Value & "' AND " _
        & "login_time = '" & Format(Adodc1.Recordset.Fields("login_time").Value, "yyyy-MM-dd hh:nn:ss") & "' AND " _
        & "click_time = '" & Format(Adodc1.Recordset.Fields("click_time").Value, "yyyy-MM-dd hh:nn:ss") & "'"
CnG.CommitTrans
...
'Adodc1.RecordSource = "select *, cast(date as char) as date_, " _
'& "concat('(',employee_code,') ',employee_name) as employee from h_send_mail order by date(date) asc, employee_name asc"
'Adodc1.Refresh

Adodc1.RecordSource = "select a.*,b.user_name,c.company_name,d.department_name " _
