...
Begin VB.Form frm_rpt_summary_pph21 
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      TabHeight       =   520
      TabCaption(0)   =   "YEARLY"
      TabPicture(0)   =   "frm_rpt_spt_pph21.frx":000C
      Tab(0).ControlEnabled=   -1  'True
      Tab(0).Control(0)=   "Frame2"
      Tab(0).Control(0).Enabled=   0   'False
      Tab(0).ControlCount=   1
      TabCaption(1)   =   "MONTHLY"
      TabPicture(1)   =   "frm_rpt_spt_pph21.frx":0028
      Tab(1).ControlEnabled=   0   'False
      Tab(1).Control(0)=   "Frame1"
      Tab(1).ControlCount=   1
      TabCaption(2)   =   "RESERVED"
      TabPicture(2)   =   "frm_rpt_spt_pph21.frx":0044
      ...
      Begin VB.Frame Frame1 
         ...
         Begin VB.ComboBox cbo_periode_company 
            Height          =   315
            ItemData        =   "frm_rpt_spt_pph21.frx":0060
            Left            =   1800
            List            =   "frm_rpt_spt_pph21.frx":006A
            TabIndex        =   20
            Text            =   "..."
            Top             =   840
            Width           =   1695
         ...
         Begin VB.ComboBox cbo_periode_employee 
            Height          =   315
            ItemData        =   "frm_rpt_spt_pph21.frx":007D
            Left            =   1800
            List            =   "frm_rpt_spt_pph21.frx":0087
            TabIndex        =   18
            Text            =   "..."
            Top             =   1200
            Width           =   1695
      ...
      Begin VB.Frame Frame2 
         ...
         Begin VB.ComboBox cbo_yearly_employee 
            Height          =   315
            ItemData        =   "frm_rpt_spt_pph21.frx":0098
            Left            =   1800
            List            =   "frm_rpt_spt_pph21.frx":00A2
            TabIndex        =   27
            Text            =   "..."
            Top             =   1200
            Width           =   1695
         ...
         Begin VB.ComboBox cbo_monthly_company 
            Height          =   315
            ItemData        =   "frm_rpt_spt_pph21.frx":00B3
            Left            =   1800
            List            =   "frm_rpt_spt_pph21.frx":00BD
            TabIndex        =   8
            Text            =   "..."
            Top             =   840
            Width           =   1695
   ...
   Begin VB.Frame Frame3 
      ...
      Begin VB.CommandButton cmdSummary 
         ...
         Height          =   645
         Left            =   4800
         Picture         =   "frm_rpt_spt_pph21.frx":00D0
         Style           =   1  'Graphical
         TabIndex        =   29
         Top             =   360
         Width           =   975
      ...
      Begin VB.CommandButton CmdPrint 
         ...
         Height          =   645
         Left            =   3720
         Picture         =   "frm_rpt_spt_pph21.frx":065A
         Style           =   1  'Graphical
         TabIndex        =   2
         Top             =   360
         Width           =   975
      ...
      Begin VB.CommandButton CmdExit 
         ...
         Height          =   645
         Left            =   8280
         Picture         =   "frm_rpt_spt_pph21.frx":0BE4
         Style           =   1  'Graphical
         TabIndex        =   1
         Top             =   360
         Width           =   975
   ...
   Begin TrueOleDBList60.TDBCombo TDBCombo_company 
      Height          =   375
      Left            =   1260
      OleObjectBlob   =   "frm_rpt_spt_pph21.frx":116E
      TabIndex        =   5
      Top             =   750
      Width           =   1695
   End
...
d2 = Format(DTPicker_monthly.Value, "yyyy-MM")

str_sql = "CALL spr_pph21_summary('" & txt_periode_employee_code & "','" & d2 & "', " & _
            "'" & TDBCombo_company.Text & "', " & cbo_periode_employee.ListIndex & ",'" & LOGIN_CODE & "');"
...
'MsgBox DTPicker_monthly.DayOfWeek
'ReDim int_libur(5)
Dim a, b As Date
...
str_sql = "CALL spr_pph21('" & str_employee_code & "',  '" & d2 & "', " & _
            "'" & TDBCombo_company.Text & "', " & cbo_yearly_employee.ListIndex & ",'" & LOGIN_CODE & "');"
