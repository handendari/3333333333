...
Begin VB.Form frm_rpt_summary_p24 
   BorderStyle     =   4  'Fixed ToolWindow
   Caption         =   "SUMMARY P24 REPORT"
   ClientHeight    =   6570
   ClientLeft      =   -15
   ClientTop       =   240
   ClientWidth     =   10560
   Icon            =   "frm_rpt_summary_p24.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   MinButton       =   0   'False
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      Style           =   1
      TabHeight       =   520
      TabCaption(0)   =   "SUMMARY P24"
      TabPicture(0)   =   "frm_rpt_summary_p24.frx":000C
      Tab(0).ControlEnabled=   -1  'True
      Tab(0).Control(0)=   "Frame5"
      Tab(0).Control(0).Enabled=   0   'False
      Tab(0).ControlCount=   1
      TabCaption(1)   =   "RESERVED"
      TabPicture(1)   =   "frm_rpt_summary_p24.frx":0028
      Tab(1).ControlEnabled=   0   'False
      Tab(1).ControlCount=   0
      TabCaption(2)   =   "RESERVED"
      TabPicture(2)   =   "frm_rpt_summary_p24.frx":0044
      ...
      Begin VB.Frame Frame5 
         ...
         Begin VB.ComboBox cbo_summary_leave_company 
            Height          =   315
            ItemData        =   "frm_rpt_summary_p24.frx":0060
            Left            =   3360
            List            =   "frm_rpt_summary_p24.frx":006A
            TabIndex        =   8
            Text            =   "..."
            Top             =   960
            Width           =   1695
   ...
   Begin VB.Frame Frame3 
      ...
      Begin VB.CommandButton CmdPrint 
         ...
         Height          =   645
         Left            =   7200
         Picture         =   "frm_rpt_summary_p24.frx":007D
         Style           =   1  'Graphical
         TabIndex        =   2
         Top             =   360
         Width           =   975
      ...
      Begin VB.CommandButton CmdExit 
         ...
         Height          =   645
         Left            =   8280
         Picture         =   "frm_rpt_summary_p24.frx":0607
         Style           =   1  'Graphical
         TabIndex        =   1
         Top             =   360
         Width           =   975
   ...
   Begin TrueOleDBList60.TDBCombo TDBCombo_company 
      Height          =   375
      Left            =   1200
      OleObjectBlob   =   "frm_rpt_summary_p24.frx":0B91
      TabIndex        =   5
      Top             =   240
      Width           =   1695
   End
   ...
   End
End
Attribute VB_Name = "frm_rpt_summary_p24"
...
str_file = "\report\rpt_summary_p24.rpt"
...
str_sql = "call spr_summary_p24('" _
            & Format(DTPicker_summary_leave, "yyyy-MM-dd") & "'," _
            & int_flag_company & ",'" _
            & str_company_code & "')"
...
If LOGIN_LEVEL = 100 Then
    cbo_summary_leave_company.Enabled = True
Else
    cbo_summary_leave_company.Enabled = False
End If
End Sub
