...
Begin VB.Form frm_List_IncomeLain 
   ...
   Begin prj_genting.vbButton vbButton2 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "frm_list_incomeLain.frx":0000
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin TrueOleDBList60.TDBCombo TDBCombo_company 
      Height          =   375
      Left            =   1410
      OleObjectBlob   =   "frm_list_incomeLain.frx":001C
      TabIndex        =   3
      Top             =   1140
      Width           =   1215
   End
   ...
   Begin prj_genting.vbButton vbButton3 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "frm_list_incomeLain.frx":1F82
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin prj_genting.vbButton vbButton4 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "frm_list_incomeLain.frx":1F9E
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin prj_genting.vbButton vbButton1 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "frm_list_incomeLain.frx":1FBA
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
      ...
      VALUE           =   0   'False
   End
   Begin prj_genting.vbButton btnImport 
      Height          =   345
      Left            =   6750
      TabIndex        =   16
      Top             =   1110
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "frm_list_incomeLain.frx":1FD6
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
...
'access = IIf(LOGIN_LEVEL = 100, "", "AND (b.managerial_access = 0 OR b.managerial_access IS NULL)")
    ...
    strsql = "SELECT a.tgltrans,a.notrans," _
                ...
                & "a.jmlPotong,a.remark, a.tglinput, b.employee_code, a.flag_other_income " _
        ...
        & "LEFT JOIN m_title d ON b.title_code = d.title_code and b.company_code = d.company_code " _
    ...
    If rs.RecordCount > 0 Then
        ...
        While Not rs.EOF
            LynxGrid1.AddItem rs!tgltrans & vbTab & rs!noTrans _
                ...
                & vbTab & rs!tglinput & vbTab & rs!employee_code & vbTab & rs!flag_other_income
            rs.MoveNext
        Wend
    End If
...
Private Sub newData()
    With frm_trans_IncomeLain
        ...
        .cmbdep.Text = LynxGrid2.CellText(LynxGrid2.Row, 0)
        .txt_dep_name.Text = LynxGrid2.CellText(LynxGrid2.Row, 1)
'         & " " & LynxGrid2.CellText(LynxGrid2.Row, 1)
        .Show vbModal
    End With
End Sub
...
Private Sub vbButton4_Click()
    ...
    If tanya = vbYes Then
        CnG.Execute "DELETE FROM t_employee_income where employee_code = '" & LynxGrid1.CellText(LynxGrid1.Row, 11) & "' " _
