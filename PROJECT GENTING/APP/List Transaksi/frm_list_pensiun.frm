...
Begin VB.Form frm_List_pensiun 
   ...
   Begin prj_genting.vbButton vbButton7 
      Height          =   345
      Left            =   10080
      TabIndex        =   7
      Top             =   1080
      ...
      VALUE           =   0   'False
   End
   Begin prj_genting.vbButton vbButton6 
      Height          =   345
      Left            =   8310
      TabIndex        =   6
      Top             =   1080
...
str_sql = "CALL spr_pph21('" & str_employee_code & "',  '" & d1 & "', " & _
            "'" & LynxGrid1.CellText(LynxGrid1.Row, 11) & "', 0,'" & LOGIN_CODE & "');"
