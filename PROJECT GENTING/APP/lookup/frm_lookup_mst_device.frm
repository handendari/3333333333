...
Begin VB.Form frm_lookup_mst_device 
   ...
   Begin zkemkeeperCtl.CZKEM CZKEM1 
      Height          =   285
      Left            =   4740
      OleObjectBlob   =   "frm_lookup_mst_device.frx":000C
      TabIndex        =   19
      Top             =   120
      Visible         =   0   'False
      Width           =   495
   ...
   Begin VB.Frame frmTombol 
      ...
      Begin VB.CommandButton cmd_select 
         ...
         Height          =   645
         Left            =   5160
         Picture         =   "frm_lookup_mst_device.frx":0030
         Style           =   1  'Graphical
         TabIndex        =   4
         Top             =   360
         Width           =   975
      ...
      Begin VB.CommandButton cmd_test 
         ...
         Height          =   645
         Left            =   6240
         Picture         =   "frm_lookup_mst_device.frx":05BA
         Style           =   1  'Graphical
         TabIndex        =   5
         Top             =   360
         Width           =   975
      ...
      Begin VB.CommandButton cmd_refresh 
         ...
         Height          =   645
         Left            =   6600
         Picture         =   "frm_lookup_mst_device.frx":0B44
         Style           =   1  'Graphical
         TabIndex        =   13
         Top             =   960
         Visible         =   0   'False
      ...
      Begin VB.CommandButton CmdSave 
         ...
         Height          =   645
         Left            =   1320
         Picture         =   "frm_lookup_mst_device.frx":10CE
         Style           =   1  'Graphical
         TabIndex        =   8
         Top             =   960
         Visible         =   0   'False
      ...
      Begin VB.CommandButton CmdCancel 
         ...
         Height          =   645
         Left            =   4560
         Picture         =   "frm_lookup_mst_device.frx":1658
         Style           =   1  'Graphical
         TabIndex        =   11
         Top             =   960
         Visible         =   0   'False
      ...
      Begin VB.CommandButton CmdExit 
         ...
         Height          =   645
         Left            =   8400
         Picture         =   "frm_lookup_mst_device.frx":1BE2
         Style           =   1  'Graphical
         TabIndex        =   6
         Top             =   360
         Width           =   975
      ...
      Begin VB.CommandButton CmdNew 
         ...
         Height          =   645
         Left            =   240
         Picture         =   "frm_lookup_mst_device.frx":216C
         Style           =   1  'Graphical
         TabIndex        =   7
         Top             =   960
         Visible         =   0   'False
      ...
      Begin VB.CommandButton CmdPrint 
         ...
         Height          =   645
         Left            =   0
         Picture         =   "frm_lookup_mst_device.frx":26F6
         Style           =   1  'Graphical
         TabIndex        =   12
         Top             =   600
         Visible         =   0   'False
      ...
      Begin VB.CommandButton cmdDelete 
         ...
         Height          =   645
         Left            =   3480
         Picture         =   "frm_lookup_mst_device.frx":2C80
         Style           =   1  'Graphical
         TabIndex        =   10
         Top             =   960
         Visible         =   0   'False
      ...
      Begin VB.CommandButton cmdEdit 
         ...
         Height          =   645
         Left            =   2400
         Picture         =   "frm_lookup_mst_device.frx":320A
         Style           =   1  'Graphical
         TabIndex        =   9
         Top             =   960
         Visible         =   0   'False
...
Private Sub cmd_select_Click()
    ...
    ElseIf public_int_mode = 2 Then
        ...
        If Adodc1.Recordset.Fields("device_type_number").Value = 1 Then
            With frm_trans_log_attendance
                Call .delete_log_action_hkai
            End With
        Else
            With frm_trans_log_attendance
