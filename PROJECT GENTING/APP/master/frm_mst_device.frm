...
Begin VB.Form frm_mst_device 
   ...
   Begin zkemkeeperCtl.CZKEM CZKEM1 
      Height          =   285
      Left            =   6210
      OleObjectBlob   =   "frm_mst_device.frx":000C
      TabIndex        =   18
      Top             =   90
      Visible         =   0   'False
      Width           =   285
   ...
   Begin VB.Frame frmTombol 
      ...
      Begin VB.CommandButton cmd_test 
         ...
         Height          =   645
         Left            =   6840
         Picture         =   "frm_mst_device.frx":0030
         Style           =   1  'Graphical
         TabIndex        =   9
         Top             =   360
         Width           =   975
      ...
      Begin VB.CommandButton cmd_refresh 
         ...
         Height          =   645
         Left            =   6600
         Picture         =   "frm_mst_device.frx":05BA
         Style           =   1  'Graphical
         TabIndex        =   12
         Top             =   960
         Visible         =   0   'False
      ...
      Begin VB.CommandButton CmdSave 
         ...
         Height          =   645
         Left            =   1800
         Picture         =   "frm_mst_device.frx":0B44
         Style           =   1  'Graphical
         TabIndex        =   5
         Top             =   360
         Width           =   975
      ...
      Begin VB.CommandButton CmdCancel 
         ...
         Height          =   645
         Left            =   5040
         Picture         =   "frm_mst_device.frx":10CE
         Style           =   1  'Graphical
         TabIndex        =   8
         Top             =   360
         Width           =   975
      ...
      Begin VB.CommandButton CmdExit 
         ...
         Height          =   645
         Left            =   8400
         Picture         =   "frm_mst_device.frx":1658
         Style           =   1  'Graphical
         TabIndex        =   10
         Top             =   360
         Width           =   975
      ...
      Begin VB.CommandButton CmdNew 
         ...
         Height          =   645
         Left            =   720
         Picture         =   "frm_mst_device.frx":1BE2
         Style           =   1  'Graphical
         TabIndex        =   4
         Top             =   360
         Width           =   975
      ...
      Begin VB.CommandButton CmdPrint 
         ...
         Height          =   645
         Left            =   0
         Picture         =   "frm_mst_device.frx":216C
         Style           =   1  'Graphical
         TabIndex        =   11
         Top             =   600
         Visible         =   0   'False
      ...
      Begin VB.CommandButton cmdDelete 
         ...
         Height          =   645
         Left            =   3960
         Picture         =   "frm_mst_device.frx":26F6
         Style           =   1  'Graphical
         TabIndex        =   7
         Top             =   360
         Width           =   975
      ...
      Begin VB.CommandButton cmdEdit 
         ...
         Height          =   645
         Left            =   2880
         Picture         =   "frm_mst_device.frx":2C80
         Style           =   1  'Graphical
         TabIndex        =   6
         Top             =   360
         Width           =   975
