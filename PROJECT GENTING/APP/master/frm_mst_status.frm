...
Begin VB.Form frm_mst_status 
   ...
   Begin VB.Frame frmTombol 
      ...
      Begin VB.CommandButton cmd_refresh 
         ...
         Height          =   645
         Left            =   7440
         Picture         =   "frm_mst_status.frx":000C
         Style           =   1  'Graphical
         TabIndex        =   9
         Top             =   360
         Visible         =   0   'False
      ...
      Begin VB.CommandButton CmdSave 
         ...
         Height          =   645
         Left            =   1800
         Picture         =   "frm_mst_status.frx":0596
         Style           =   1  'Graphical
         TabIndex        =   5
         Top             =   360
         Width           =   975
      ...
      Begin VB.CommandButton CmdCancel 
         ...
         Height          =   645
         Left            =   5040
         Picture         =   "frm_mst_status.frx":0B20
         Style           =   1  'Graphical
         TabIndex        =   8
         Top             =   360
         Width           =   975
      ...
      Begin VB.CommandButton CmdExit 
         ...
         Height          =   645
         Left            =   9600
         Picture         =   "frm_mst_status.frx":10AA
         Style           =   1  'Graphical
         TabIndex        =   10
         Top             =   360
         Width           =   975
      ...
      Begin VB.CommandButton CmdNew 
         ...
         Height          =   645
         Left            =   720
         Picture         =   "frm_mst_status.frx":1634
         Style           =   1  'Graphical
         TabIndex        =   4
         Top             =   360
         Width           =   975
      ...
      Begin VB.CommandButton CmdPrint 
         ...
         Height          =   645
         Left            =   0
         Picture         =   "frm_mst_status.frx":1BBE
         Style           =   1  'Graphical
         TabIndex        =   13
         Top             =   600
         Visible         =   0   'False
      ...
      Begin VB.CommandButton cmdDelete 
         ...
         Height          =   645
         Left            =   3960
         Picture         =   "frm_mst_status.frx":2148
         Style           =   1  'Graphical
         TabIndex        =   7
         Top             =   360
         Width           =   975
      ...
      Begin VB.CommandButton cmdEdit 
         ...
         Height          =   645
         Left            =   2880
         Picture         =   "frm_mst_status.frx":26D2
         Style           =   1  'Graphical
         TabIndex        =   6
         Top             =   360
         Width           =   975
   ...
   Begin VB.Label Label17 
      Alignment       =   2  'Center
      AutoSize        =   -1  'True
      Caption         =   "MASTER STATUS KARYAWAN"
      BeginProperty Font 
...
Dim str_sql As String
    ...
    str_sql = "select count(status_code) as rec_count from m_emp_status where status_code = '" & Trim(txt_p24_number) & "'"
...
Private Function check_validate_exist_edit() As Boolean
    ...
    If Not txt_p24_number.Text = Adodc1.Recordset.Fields("status_code").Value And _
...
Public Sub set_edit_data()
    With Adodc1.Recordset
        txt_p24_number.Text = .Fields("status_code").Value
...
Private Sub cmdEdit_Click()
    ...
    rsBound.Open "select * from m_emp_status " & _
                    "where status_code = '" & Adodc1.Recordset.Fields("status_code").Value & "'", CnG, adOpenKeyset, adLockOptimistic
...
Private Sub CmdNew_Click()
    If rsBound.State = 1 Then rsBound.Close
    rsBound.Open "select * from m_emp_status where status_code = 'άφ'", CnG, adOpenKeyset, adLockOptimistic
...
Private Sub insert_new_data()
    ...
    With rsBound
        ...
        .Fields("status_code").Value = txt_p24_number.Text
        '-----------------------------------------------------------------------------
        .Fields("status_name").Value = txt_name.Text
        .Fields("description").Value = txt_remark.Text
...
'    With rsBound
'
'        .Fields("status_code").Value = Val(txt_p24_number.Text)
'        '-----------------------------------------------------------------------------
...
'        .Update
'    End With
    strsql = "UPDATE m_emp_status SET status_code = '" & txt_p24_number.Text & "'," _
        & "status_name = '" & txt_name.Text & "',description = '" & txt_remark.Text & "' " _
        & "WHERE status_code = '" & txt_p24_number.Text & "'"
    CnG.Execute strsql
...
Private Sub load_data()
    Adodc1.RecordSource = "select * from m_emp_status order by status_code"
    Adodc1.Refresh
