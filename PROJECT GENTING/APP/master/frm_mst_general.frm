...
Begin VB.Form frm_mst_working_time 
   ...
   Begin VB.Frame frmTombol 
      ...
      Begin VB.CommandButton cmdEdit 
         ...
         Height          =   645
         Left            =   3240
         Picture         =   "frm_mst_general.frx":000C
         Style           =   1  'Graphical
         TabIndex        =   10
         Top             =   360
         Width           =   975
      ...
      Begin VB.CommandButton cmdDelete 
         ...
         Height          =   645
         Left            =   4320
         Picture         =   "frm_mst_general.frx":0596
         Style           =   1  'Graphical
         TabIndex        =   11
         Top             =   360
         Width           =   975
      ...
      Begin VB.CommandButton CmdPrint 
         ...
         Height          =   645
         Left            =   0
         Picture         =   "frm_mst_general.frx":0B20
         Style           =   1  'Graphical
         TabIndex        =   22
         Top             =   600
         Visible         =   0   'False
      ...
      Begin VB.CommandButton CmdNew 
         ...
         Height          =   645
         Left            =   1080
         Picture         =   "frm_mst_general.frx":10AA
         Style           =   1  'Graphical
         TabIndex        =   8
         Top             =   360
         Width           =   975
      ...
      Begin VB.CommandButton CmdExit 
         ...
         Height          =   645
         Left            =   10080
         Picture         =   "frm_mst_general.frx":1634
         Style           =   1  'Graphical
         TabIndex        =   14
         Top             =   360
         Width           =   975
      ...
      Begin VB.CommandButton CmdCancel 
         ...
         Height          =   645
         Left            =   5400
         Picture         =   "frm_mst_general.frx":1BBE
         Style           =   1  'Graphical
         TabIndex        =   12
         Top             =   360
         Width           =   975
      ...
      Begin VB.CommandButton CmdSave 
         ...
         Height          =   645
         Left            =   2160
         Picture         =   "frm_mst_general.frx":2148
         Style           =   1  'Graphical
         TabIndex        =   9
         Top             =   360
         Width           =   975
      ...
      Begin VB.CommandButton cmd_refresh 
         ...
         Height          =   645
         Left            =   7200
         Picture         =   "frm_mst_general.frx":26D2
         Style           =   1  'Graphical
         TabIndex        =   13
         Top             =   360
         Visible         =   0   'False
   ...
   Begin VB.Frame fra_entry 
      ...
      Begin VB.ComboBox cbo_day_over 
         Height          =   315
         ItemData        =   "frm_mst_general.frx":2C5C
         Left            =   3300
         List            =   "frm_mst_general.frx":2C66
         TabIndex        =   31
         Text            =   "..."
         Top             =   2040
         Visible         =   0   'False
      ...
      Begin VB.ComboBox cbo_tolerance 
         Height          =   315
         ItemData        =   "frm_mst_general.frx":2C73
         Left            =   7500
         List            =   "frm_mst_general.frx":2C7D
         TabIndex        =   30
         Text            =   "..."
         Top             =   2160
         Visible         =   0   'False
   ...
   Begin TrueOleDBGrid70.TDBGrid TDBGrid1 
      ...
      Splits(0)._ColumnProps(11)=   "Column(2).Width=2223"
      ...
      Splits(0)._ColumnProps(27)=   "Column(5).Width=2408"
      Splits(0)._ColumnProps(28)=   "Column(5).DividerColor=0"
      Splits(0)._ColumnProps(29)=   "Column(5)._WidthInPix=2328"
      Splits(0)._ColumnProps(30)=   "Column(5)._ColStyle=513"
      Splits(0)._ColumnProps(31)=   "Column(5).Order=6"
      Splits(0)._ColumnProps(32)=   "Column(5)._MinWidth=10"
      Splits(0)._ColumnProps(33)=   "Column(6).Width=3122"
      Splits(0)._ColumnProps(34)=   "Column(6).DividerColor=0"
      Splits(0)._ColumnProps(35)=   "Column(6)._WidthInPix=3043"
      Splits(0)._ColumnProps(36)=   "Column(6)._ColStyle=513"
      Splits(0)._ColumnProps(37)=   "Column(6).Order=7"
      Splits(0)._ColumnProps(38)=   "Column(6)._MinWidth=10"
      Splits(0)._ColumnProps(39)=   "Column(7).Width=2566"
      Splits(0)._ColumnProps(40)=   "Column(7).DividerColor=0"
      Splits(0)._ColumnProps(41)=   "Column(7)._WidthInPix=2487"
      ...
      Splits(0)._ColumnProps(47)=   "Column(7)._MinWidth=10"
      Splits(0)._ColumnProps(48)=   "Column(8).Width=1931"
      Splits(0)._ColumnProps(49)=   "Column(8).DividerColor=0"
      Splits(0)._ColumnProps(50)=   "Column(8)._WidthInPix=1852"
      Splits(0)._ColumnProps(51)=   "Column(8).AllowSizing=0"
      Splits(0)._ColumnProps(52)=   "Column(8)._ColStyle=513"
      Splits(0)._ColumnProps(53)=   "Column(8).Visible=0"
      Splits(0)._ColumnProps(54)=   "Column(8).AllowFocus=0"
      Splits(0)._ColumnProps(55)=   "Column(8).Order=9"
      Splits(0)._ColumnProps(56)=   "Column(8)._MinWidth=54215968"
      Splits(0)._ColumnProps(57)=   "Column(9).Width=2434"
      Splits(0)._ColumnProps(58)=   "Column(9).DividerColor=0"
      Splits(0)._ColumnProps(59)=   "Column(9)._WidthInPix=2355"
      Splits(0)._ColumnProps(60)=   "Column(9).AllowSizing=0"
      Splits(0)._ColumnProps(61)=   "Column(9)._ColStyle=513"
      Splits(0)._ColumnProps(62)=   "Column(9).Visible=0"
      Splits(0)._ColumnProps(63)=   "Column(9).AllowFocus=0"
      Splits(0)._ColumnProps(64)=   "Column(9).Order=10"
      Splits(0)._ColumnProps(65)=   "Column(10).Width=2540"
      Splits(0)._ColumnProps(66)=   "Column(10).DividerColor=0"
      Splits(0)._ColumnProps(67)=   "Column(10)._WidthInPix=2461"
      Splits(0)._ColumnProps(68)=   "Column(10).AllowSizing=0"
      Splits(0)._ColumnProps(69)=   "Column(10)._ColStyle=513"
      Splits(0)._ColumnProps(70)=   "Column(10).Visible=0"
      Splits(0)._ColumnProps(71)=   "Column(10).AllowFocus=0"
      Splits(0)._ColumnProps(72)=   "Column(10).Order=11"
      Splits(0)._ColumnProps(73)=   "Column(10)._MinWidth=60129312"
      Splits.Count    =   1
   ...
   Begin TrueOleDBList60.TDBCombo TDBCombo_company 
      Height          =   375
      Left            =   1530
      OleObjectBlob   =   "frm_mst_general.frx":2C8A
      TabIndex        =   27
      Top             =   660
      Width           =   1695
   End
...
& Adodc1.Recordset.Fields("shift_code").Value & "' AND company_code = '" & TDBCombo_company & "'", CnG, adOpenKeyset, adLockOptimistic
...
' additional 4 BPP
DTPicker_min_break_in = Format(Now, "yyyy-mm-dd 12:00:00")
DTPicker_max_break_out = Format(Now, "yyyy-mm-dd 15:00:00")
txt_break_interval_minute = "1"
End Sub
...
Private Sub DTPicker_max_break_out_Change()
txt_break_interval_minute.Text = DateDiff("h", DTPicker_min_break_in, DTPicker_max_break_out)
End Sub
...
Adodc1.RecordSource = "select * from m_shift where flag_shift=0 AND company_code = '" & TDBCombo_company.Text & "' order by shift_code"
Adodc1.Refresh
