...
Begin VB.Form frm_mst_enroll 
   ...
   Begin zkemkeeperCtl.CZKEM CZKEM1 
      Height          =   405
      Left            =   7410
      OleObjectBlob   =   "frm_mst_enroll.frx":000C
      TabIndex        =   13
      Top             =   180
      Visible         =   0   'False
      Width           =   285
   ...
   Begin VB.Frame frmTombol 
      ...
      Begin VB.CommandButton cmd_unset 
         ...
         Height          =   645
         Left            =   8760
         Picture         =   "frm_mst_enroll.frx":0030
         Style           =   1  'Graphical
         TabIndex        =   3
         Top             =   360
         Width           =   975
      ...
      Begin VB.CommandButton cmdDelete 
         ...
         Height          =   645
         Left            =   11040
         Picture         =   "frm_mst_enroll.frx":05BA
         Style           =   1  'Graphical
         TabIndex        =   5
         Top             =   360
         Width           =   975
      ...
      Begin VB.CommandButton cmd_download 
         ...
         Height          =   645
         Left            =   9960
         Picture         =   "frm_mst_enroll.frx":0B44
         Style           =   1  'Graphical
         TabIndex        =   4
         Top             =   360
         Width           =   975
      ...
      Begin VB.CommandButton Command2 
         ...
         Height          =   645
         Left            =   600
         Picture         =   "frm_mst_enroll.frx":10CE
         Style           =   1  'Graphical
         TabIndex        =   8
         Top             =   360
         Visible         =   0   'False
      ...
      Begin VB.CommandButton cmd_set 
         ...
         Height          =   645
         Left            =   7680
         Picture         =   "frm_mst_enroll.frx":1658
         Style           =   1  'Graphical
         TabIndex        =   2
         Top             =   360
         Width           =   975
      ...
      Begin VB.CommandButton cmd_exit 
         ...
         Height          =   645
         Left            =   12720
         Picture         =   "frm_mst_enroll.frx":1BE2
         Style           =   1  'Graphical
         TabIndex        =   6
         Top             =   360
         Width           =   975
   ...
   Begin TrueOleDBList60.TDBCombo TDBCombo_company 
      Height          =   375
      Left            =   1200
      OleObjectBlob   =   "frm_mst_enroll.frx":216C
      TabIndex        =   1
      Top             =   240
      Width           =   1695
   End
