...
Begin VB.Form frm_mst_location 
   ...
   EndProperty
   Icon            =   "frm_mst_location.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   MinButton       =   0   'False
   ...
   Begin VB.Frame frmTombol 
      ...
      Begin VB.CommandButton cmd_refresh 
         ...
         Height          =   645
         Left            =   7440
         Picture         =   "frm_mst_location.frx":000C
         Style           =   1  'Graphical
         TabIndex        =   10
         Top             =   360
         Width           =   975
      ...
      Begin VB.CommandButton CmdSave 
         ...
         Height          =   645
         Left            =   1800
         Picture         =   "frm_mst_location.frx":0596
         Style           =   1  'Graphical
         TabIndex        =   6
         Top             =   360
         Width           =   975
      ...
      Begin VB.CommandButton CmdCancel 
         ...
         Height          =   645
         Left            =   5040
         Picture         =   "frm_mst_location.frx":0B20
         Style           =   1  'Graphical
         TabIndex        =   9
         Top             =   360
         Width           =   975
      ...
      Begin VB.CommandButton CmdExit 
         ...
         Height          =   645
         Left            =   9600
         Picture         =   "frm_mst_location.frx":10AA
         Style           =   1  'Graphical
         TabIndex        =   11
         Top             =   360
         Width           =   975
      ...
      Begin VB.CommandButton CmdNew 
         ...
         Height          =   645
         Left            =   720
         Picture         =   "frm_mst_location.frx":1634
         Style           =   1  'Graphical
         TabIndex        =   5
         Top             =   360
         Width           =   975
      ...
      Begin VB.CommandButton CmdPrint 
         ...
         Height          =   645
         Left            =   0
         Picture         =   "frm_mst_location.frx":1BBE
         Style           =   1  'Graphical
         TabIndex        =   14
         Top             =   600
         Visible         =   0   'False
      ...
      Begin VB.CommandButton cmdDelete 
         ...
         Height          =   645
         Left            =   3960
         Picture         =   "frm_mst_location.frx":2148
         Style           =   1  'Graphical
         TabIndex        =   8
         Top             =   360
         Width           =   975
      ...
      Begin VB.CommandButton cmdEdit 
         ...
         Height          =   645
         Left            =   2880
         Picture         =   "frm_mst_location.frx":26D2
         Style           =   1  'Graphical
         TabIndex        =   7
         Top             =   360
         Width           =   975
   ...
   Begin TrueOleDBGrid70.TDBGrid TDBGrid1 
      ...
      Columns(1).Caption=   "KODE LOKASI"
      Columns(1).DataField=   "location_code"
      Columns(1)._PropDict=   "_MaxComboItems,516,2;_VlistStyle,514,3"
      Columns(2)._VlistStyle=   0
      Columns(2)._MaxComboItems=   5
      Columns(2).Caption=   "NAMA LOKASI"
      Columns(2).DataField=   "location_name"
   ...
   Begin TrueOleDBList60.TDBCombo TDBCombo_company 
      Height          =   375
      Left            =   1200
      OleObjectBlob   =   "frm_mst_location.frx":2C5C
      TabIndex        =   1
      Top             =   690
      Width           =   1695
   End
   ...
   End
End
Attribute VB_Name = "frm_mst_location"
...
If Not txt_department_code = Adodc1.Recordset.Fields("location_code").Value And _
...
i = MsgBox("Are you sure want to delete data '" _
    & TDBGrid1.Columns("location_name").Value & "' ?", vbYesNo + vbQuestion, headerMSG)
If Not i = vbYes Then Exit Sub

CnG.BeginTrans
CnG.Execute "delete from m_location where location_code = '" _
    & TDBGrid1.Columns("location_code").Value & "'"
CnG.CommitTrans
...
With Adodc1.Recordset
    txt_department_code = .Fields("location_code").Value
    txt_department_name = .Fields("location_name").Value
...
rsBound.Open "select * from m_location where location_code = '" _
& Adodc1.Recordset.Fields("location_code").Value & "'", CnG, adOpenKeyset, adLockOptimistic
...
If rsBound.State = 1 Then rsBound.Close
rsBound.Open "select * from m_location where location_code = 'άφ'", CnG, adOpenKeyset, adLockOptimistic
...
With rsBound
    ...
    .Fields("location_code").Value = Trim(txt_department_code)
    '-----------------------------------------------------------------------------
    .Fields("location_name").Value = Trim(txt_department_name)
...
Private Sub load_data_location()
Adodc1.RecordSource = "select * from m_location where company_code = '" _
& TDBCombo_company.Columns("company_code").Value & "' order by location_code"
Adodc1.Refresh
