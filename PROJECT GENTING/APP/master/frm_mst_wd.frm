...
Begin VB.Form frm_mst_working_day 
   ...
   Begin TrueOleDBGrid70.TDBGrid TDBGrid1 
      ...
      Splits(0)._ColumnProps(14)=   "Column(2).Width=4974"
      Splits(0)._ColumnProps(15)=   "Column(2).DividerColor=0"
      Splits(0)._ColumnProps(16)=   "Column(2)._WidthInPix=4895"
      ...
      Splits(0)._ColumnProps(24)=   "Column(4).Width=2117"
      Splits(0)._ColumnProps(25)=   "Column(4).DividerColor=0"
      Splits(0)._ColumnProps(26)=   "Column(4)._WidthInPix=2037"
      Splits(0)._ColumnProps(27)=   "Column(4)._ColStyle=513"
      Splits(0)._ColumnProps(28)=   "Column(4).Order=5"
      Splits(0)._ColumnProps(29)=   "Column(5).Width=1879"
      Splits(0)._ColumnProps(30)=   "Column(5).DividerColor=0"
      Splits(0)._ColumnProps(31)=   "Column(5)._WidthInPix=1799"
      ...
      Splits(0)._ColumnProps(37)=   "Column(5)._MinWidth=10"
      Splits(0)._ColumnProps(38)=   "Column(6).Width=2223"
      Splits(0)._ColumnProps(39)=   "Column(6).DividerColor=0"
      Splits(0)._ColumnProps(40)=   "Column(6)._WidthInPix=2143"
      ...
      Splits(0)._ColumnProps(49)=   "Column(7)._MinWidth=54215968"
      Splits(0)._ColumnProps(50)=   "Column(8).Width=2117"
      Splits(0)._ColumnProps(51)=   "Column(8).DividerColor=0"
      Splits(0)._ColumnProps(52)=   "Column(8)._WidthInPix=2037"
      Splits(0)._ColumnProps(53)=   "Column(8)._ColStyle=513"
      Splits(0)._ColumnProps(54)=   "Column(8).Order=9"
      Splits(0)._ColumnProps(55)=   "Column(8)._MinWidth=54215968"
      Splits(0)._ColumnProps(56)=   "Column(9).Width=1984"
      Splits(0)._ColumnProps(57)=   "Column(9).DividerColor=0"
      Splits(0)._ColumnProps(58)=   "Column(9)._WidthInPix=1905"
      Splits(0)._ColumnProps(59)=   "Column(9)._ColStyle=513"
      Splits(0)._ColumnProps(60)=   "Column(9).Order=10"
      Splits(0)._ColumnProps(61)=   "Column(9)._MinWidth=54215968"
      Splits.Count    =   1
   ...
   Begin TrueOleDBList60.TDBCombo TDBCombo_company 
      Height          =   375
      Left            =   1560
      OleObjectBlob   =   "frm_mst_wd.frx":4C87
      TabIndex        =   31
      Top             =   330
      Width           =   1695
   End
...
With rsBound
    ...
    .Fields("company_code").Value = TDBCombo_company.Text
...
'        If LCase(Ctr.name) = "txt_working_time_name" Then
'            Ctr.Text = ""
'        ElseIf LCase(Ctr.name) = "txtCompany_Name" Then
'            Ctr.Text = ""
'        End If
'    ElseIf TypeOf Ctr Is TDBCombo Then
'        If LCase(Ctr.name) = "tdbcombo_working_time" Then
'            Ctr.Text = ""
'        ElseIf LCase(Ctr.name) = "TDBCombo_company" Then
'            Ctr.Text = ""
'        End If
...
If TDBCombo_company.ApproxCount > 0 Then
    ...
    txtCompany_Name.Text = TDBCombo_company.Columns("company_name").Value
...
Adodc_working_time.RecordSource = "select * from m_shift where flag_shift=0 AND company_code = '" & TDBCombo_company.Text & "' order by shift_code"
...
Adodc1.RecordSource = "select * from m_working_day where shift_code='" _
    & TDBCombo_working_time.Columns("shift_code").Value & "' " _
    & "AND company_code = '" & TDBCombo_company.Text & "' order by day_code"
Adodc1.Refresh
