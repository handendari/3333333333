...
Begin VB.Form frm_mst_other_income 
   ...
   Begin VB.Frame fra_entry 
      ...
      Begin VB.ComboBox cbo_income_type 
         Height          =   315
         ItemData        =   "frm_mst_income.frx":000C
         Left            =   4800
         List            =   "frm_mst_income.frx":0019
         TabIndex        =   3
         Text            =   "OP"
         Top             =   1320
         Width           =   1695
   ...
   Begin VB.Frame frmTombol 
      ...
      Begin VB.CommandButton cmd_select 
         ...
         Height          =   645
         Left            =   7560
         Picture         =   "frm_mst_income.frx":0036
         Style           =   1  'Graphical
         TabIndex        =   10
         Top             =   360
         Visible         =   0   'False
      ...
      Begin VB.CommandButton CmdSave 
         ...
         Height          =   645
         Left            =   1800
         Picture         =   "frm_mst_income.frx":05C0
         Style           =   1  'Graphical
         TabIndex        =   6
         Top             =   360
         Width           =   975
      ...
      Begin VB.CommandButton CmdCancel 
         ...
         Height          =   645
         Left            =   5040
         Picture         =   "frm_mst_income.frx":0B4A
         Style           =   1  'Graphical
         TabIndex        =   9
         Top             =   360
         Width           =   975
      ...
      Begin VB.CommandButton CmdExit 
         ...
         Height          =   645
         Left            =   9600
         Picture         =   "frm_mst_income.frx":10D4
         Style           =   1  'Graphical
         TabIndex        =   11
         Top             =   360
         Width           =   975
      ...
      Begin VB.CommandButton CmdNew 
         ...
         Height          =   645
         Left            =   720
         Picture         =   "frm_mst_income.frx":165E
         Style           =   1  'Graphical
         TabIndex        =   5
         Top             =   360
         Width           =   975
      ...
      Begin VB.CommandButton CmdPrint 
         ...
         Height          =   645
         Left            =   0
         Picture         =   "frm_mst_income.frx":1BE8
         Style           =   1  'Graphical
         TabIndex        =   13
         Top             =   600
         Visible         =   0   'False
      ...
      Begin VB.CommandButton cmdDelete 
         ...
         Height          =   645
         Left            =   3960
         Picture         =   "frm_mst_income.frx":2172
         Style           =   1  'Graphical
         TabIndex        =   8
         Top             =   360
         Width           =   975
      ...
      Begin VB.CommandButton cmdEdit 
         ...
         Height          =   645
         Left            =   2880
         Picture         =   "frm_mst_income.frx":26FC
         Style           =   1  'Graphical
         TabIndex        =   7
         Top             =   360
         Width           =   975
...
If Not txt_income_code = Adodc1.Recordset.Fields("income_code").Value And _
...
With rsBound
    ...
    .Fields("income_type").Value = cbo_income_type.ListIndex
    .Fields("income_type_name").Value = cbo_income_type.Text
...
Adodc1.RecordSource = "select * from m_other_income order by income_code"
Adodc1.Refresh
...
If public_int_mode = 0 Then
    With frm_mst_salary_item
        .txt_item_code = Adodc1.Recordset.Fields("income_code").Value
        .txt_item_name = Adodc1.Recordset.Fields("income_name").Value
        .txt_item_type = Adodc1.Recordset.Fields("income_type").Value
        .txt_item_type_name = Adodc1.Recordset.Fields("income_type_name").Value
    End With
End If
