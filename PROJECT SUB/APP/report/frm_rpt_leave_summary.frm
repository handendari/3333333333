...
Begin VB.Form frm_rpt_leave_summary 
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      TabPicture(1)   =   "frm_rpt_leave_summary.frx":05A6
      Tab(1).ControlEnabled=   0   'False
      Tab(1).ControlCount=   0
      TabCaption(2)   =   "RESERVED"
      TabPicture(2)   =   "frm_rpt_leave_summary.frx":05C2
      ...
      Begin VB.Frame Frame5 
         ...
         Begin VB.ComboBox cbo_summary_leave_company 
            Height          =   315
            ItemData        =   "frm_rpt_leave_summary.frx":05DE
            Left            =   3360
            List            =   "frm_rpt_leave_summary.frx":05E8
            TabIndex        =   6
            Text            =   "..."
            Top             =   960
            Width           =   1695
   ...
   Begin VB.Frame Frame3 
      ...
      Begin prj_absensi.vbButton cmdExit 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frm_rpt_leave_summary.frx":05FB
         PICN            =   "frm_rpt_leave_summary.frx":0617
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   2
         NGREY           =   0   'False
      ...
      Begin prj_absensi.vbButton cmdPrint 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frm_rpt_leave_summary.frx":16A9
         PICN            =   "frm_rpt_leave_summary.frx":16C5
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   2
         NGREY           =   0   'False
   ...
   Begin TrueOleDBList60.TDBCombo TDBCombo_company 
      Height          =   375
      Left            =   1200
      OleObjectBlob   =   "frm_rpt_leave_summary.frx":2757
      TabIndex        =   3
      Top             =   240
      Width           =   1695
   End
   ...
   End
End
Attribute VB_Name = "frm_rpt_leave_summary"
