...
Begin VB.Form frm_rpt_att_summary 
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      Begin VB.Frame Frame2 
         ...
         Begin VB.ComboBox cbo_monthly_employee 
            Height          =   315
            ItemData        =   "frm_rpt_att_summary.frx":05DE
            Left            =   1800
            List            =   "frm_rpt_att_summary.frx":05E8
            TabIndex        =   4
            Text            =   "..."
            Top             =   1200
            Width           =   1695
   ...
   End
End
Attribute VB_Name = "frm_rpt_att_summary"
