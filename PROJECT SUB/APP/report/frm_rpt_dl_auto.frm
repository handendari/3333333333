...
Begin VB.Form frm_rpt_log_dl_auto 
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "REPORT - LOG DOWNLOAD AUTO"
   ClientHeight    =   7320
   ClientLeft      =   -15
   ClientTop       =   300
   ClientWidth     =   12885
   ...
   Begin VB.Frame frmTombol 
      ...
      Begin VB.CommandButton CmdPrint 
         ...
         Height          =   645
         Left            =   300
         Picture         =   "frm_rpt_dl_auto.frx":058A
         Style           =   1  'Graphical
         TabIndex        =   2
         Top             =   360
         Visible         =   0   'False
      ...
      Begin prj_absensi.vbButton cmdExit 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frm_rpt_dl_auto.frx":0B14
         PICN            =   "frm_rpt_dl_auto.frx":0B30
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   2
         NGREY           =   0   'False
      ...
      Begin prj_absensi.vbButton cmdDelete 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frm_rpt_dl_auto.frx":1BC2
         PICN            =   "frm_rpt_dl_auto.frx":1BDE
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   2
         NGREY           =   0   'False
         ...
         VALUE           =   0   'False
      End
      Begin prj_absensi.vbButton cmd_delete_all 
         Height          =   705
         Left            =   7800
         TabIndex        =   6
         Top             =   330
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frm_rpt_dl_auto.frx":2C70
         PICN            =   "frm_rpt_dl_auto.frx":2C8C
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   2
         NGREY           =   0   'False
   ...
   Begin TrueOleDBGrid70.TDBGrid TDBGrid1 
      ...
      Columns(0).Caption=   "DL TIME"
      Columns(0).DataField=   "dl_time"
      Columns(0).NumberFormat=   "yyyy-MM-dd HH:mm:ss"
      Columns(0)._PropDict=   "_MaxComboItems,516,2;_VlistStyle,514,3"
      Columns(1)._VlistStyle=   0
      Columns(1)._MaxComboItems=   5
      Columns(1).Caption=   "DATE TIME"
      Columns(1).DataField=   "tanggal"
      Columns(1).NumberFormat=   "dd-MM-yyyy HH:mm:ss"
      Columns(1)._PropDict=   "_MaxComboItems,516,2;_VlistStyle,514,3"
      Columns(2)._VlistStyle=   0
      Columns(2)._MaxComboItems=   5
      Columns(2).Caption=   "IP ADDRESS"
      Columns(2).DataField=   "ip_address"
      Columns(2)._PropDict=   "_MaxComboItems,516,2;_VlistStyle,514,3"
      Columns(3)._VlistStyle=   0
      Columns(3)._MaxComboItems=   5
      Columns(3).Caption=   "DEVICE"
      Columns(3).DataField=   "device_name"
      Columns(3)._PropDict=   "_MaxComboItems,516,2;_VlistStyle,514,3"
      Columns(4)._VlistStyle=   4
      Columns(4)._MaxComboItems=   5
      Columns(4).Caption=   "CONNECTED"
      Columns(4).DataField=   "flag_connected"
      Columns(4)._PropDict=   "_MaxComboItems,516,2;_VlistStyle,514,3"
      Columns(5)._VlistStyle=   0
      Columns(5)._MaxComboItems=   5
      Columns(5).Caption=   "LOOP"
      Columns(5).DataField=   "tot_loop"
      Columns(5)._PropDict=   "_MaxComboItems,516,2;_VlistStyle,514,3"
      Columns(6)._VlistStyle=   0
      Columns(6)._MaxComboItems=   5
      Columns(6).Caption=   "TOT. LOG"
      Columns(6).DataField=   "tot_log"
      Columns(6)._PropDict=   "_MaxComboItems,516,2;_VlistStyle,514,3"
      Columns(7)._VlistStyle=   4
      Columns(7)._MaxComboItems=   5
      Columns(7).Caption=   "DELETED"
      Columns(7).DataField=   "flag_deleted"
      ...
      Splits(0)._ColumnProps(7)=   "Column(1).Width=4128"
      Splits(0)._ColumnProps(8)=   "Column(1).DividerColor=0"
      Splits(0)._ColumnProps(9)=   "Column(1)._WidthInPix=4048"
      ...
      Splits(0)._ColumnProps(27)=   "Column(5).Width=1217"
      Splits(0)._ColumnProps(28)=   "Column(5).DividerColor=0"
      Splits(0)._ColumnProps(29)=   "Column(5)._WidthInPix=1138"
      ...
      Splits(0)._ColumnProps(34)=   "Column(6)._WidthInPix=2831"
      Splits(0)._ColumnProps(35)=   "Column(6)._ColStyle=514"
      Splits(0)._ColumnProps(36)=   "Column(6).Order=7"
      Splits(0)._ColumnProps(37)=   "Column(7).Width=1852"
      Splits(0)._ColumnProps(38)=   "Column(7).DividerColor=0"
      Splits(0)._ColumnProps(39)=   "Column(7)._WidthInPix=1773"
      ...
      HeadLines       =   1
      FootLines       =   1
      Caption         =   "LIST OF LOG DOWNLOAD AUTO"
      MultipleLines   =   0
      CellTipsWidth   =   0
   ...
   Begin VB.Image Image1 
      Height          =   585
      Left            =   0
      Picture         =   "frm_rpt_dl_auto.frx":3D1E
      Stretch         =   -1  'True
      Top             =   0
      Width           =   14850
   End
End
Attribute VB_Name = "frm_rpt_log_dl_auto"
...
Dim vTotDeleted As Integer
    ...
    i = MsgBox("Are you sure want to delete " _
        & SelBks.Count & " auto download data ?", vbYesNo + vbQuestion, headerMSG)
    If Not i = vbYes Then Exit Sub
                
    CnG.BeginTrans
    vTotDeleted = SelBks.Count
    For Each item In SelBks
        SQL = "DELETE FROM h_auto_download " & _
              "WHERE ip_address = '" & TDBGrid1.Columns("ip_address").CellText(item) & "' " & _
                "AND dl_time = '" & Format(TDBGrid1.Columns("dl_time").CellText(item), "yyyy-MM-dd HH:mm:ss") & "'"
        CnG.Execute SQL
    Next
    CnG.CommitTrans
    Call load_data_log
    
    clsFunc.InsertLog ("Delete " & vTotDeleted & " Log Auto Download")
End Sub
...
Dim i As Integer
    ...
    CnG.BeginTrans
    CnG.Execute "delete from h_auto_download"
    CnG.CommitTrans
    
    Call load_data_log
    
    clsFunc.InsertLog ("Delete All Log Auto Download")
End Sub
...
Private Sub load_data_log()
    ...
    SQL = "SELECT a.*, CAST(dl_time AS CHAR) tanggal, b.name device_name " & _
          "FROM h_auto_download a JOIN m_device b ON a.ip_address = b.ip_address " & _
