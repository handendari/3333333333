...
Begin VB.Form frm_lookup_mst_employee 
   ...
   Begin TrueOleDBGrid70.TDBGrid TDBGrid1 
      ...
      Columns(8).Caption=   "BIRTH DATE"
      Columns(8).DataField=   "date_of_birth"
      Columns(8).NumberFormat=   "FormatText Event"
      Columns(8)._PropDict=   "_MaxComboItems,516,2;_VlistStyle,514,3"
      Columns(9)._VlistStyle=   0
      Columns(9)._MaxComboItems=   5
      Columns(9).Caption=   "PLACE OF BIRTH"
      Columns(9).DataField=   "place_of_birth"
      Columns(9)._PropDict=   "_MaxComboItems,516,2;_VlistStyle,514,3"
      Columns(10)._VlistStyle=   16
      Columns(10)._MaxComboItems=   5
      Columns(10).ValueItems(0)._DefaultItem=   0
      Columns(10).ValueItems(0).Value=   "0"
      Columns(10).ValueItems(0).Value.vt=   8
      Columns(10).ValueItems(0).DisplayValue=   "Female"
      ...
      Columns(10).ValueItems(1).DisplayValue=   "Male"
      ...
      Columns(10).Caption=   "SEX"
      Columns(10).DataField=   "sex"
      ...
      Columns(11).ValueItems(0).DisplayValue=   "Single"
      ...
      Columns(11).ValueItems(1).DisplayValue=   "Married"
      ...
      Columns(11).ValueItems(2).DisplayValue=   "Widow"
      Columns(11).ValueItems(2).DisplayValue.vt=   8
      Columns(11).ValueItems(2)._PropDict=   "_DefaultItem,517,2"
      Columns(11).ValueItems(3)._DefaultItem=   0
      Columns(11).ValueItems(3).Value=   "3"
      Columns(11).ValueItems(3).Value.vt=   8
      Columns(11).ValueItems(3).DisplayValue=   "Widower"
      Columns(11).ValueItems(3).DisplayValue.vt=   8
      Columns(11).ValueItems(3)._PropDict=   "_DefaultItem,517,2"
      Columns(11).ValueItems.Count=   4
      Columns(11).Caption=   "STATUS"
      Columns(11).DataField=   "marital_status"
      Columns(11)._PropDict=   "_MaxComboItems,516,2;_VlistStyle,514,3"
      Columns(12)._VlistStyle=   0
      Columns(12)._MaxComboItems=   5
      Columns(12).Caption=   "ADDRESS"
      Columns(12).DataField=   "address"
      Columns(12)._PropDict=   "_MaxComboItems,516,2;_VlistStyle,514,3"
      Columns(13)._VlistStyle=   0
      Columns(13)._MaxComboItems=   5
      Columns(13).Caption=   "PHONE NUMBER"
      Columns(13).DataField=   "phone_number"
      Columns(13)._PropDict=   "_MaxComboItems,516,2;_VlistStyle,514,3"
      Columns(14)._VlistStyle=   0
      Columns(14)._MaxComboItems=   5
      Columns(14).Caption=   "BANK ACCOUNT"
      Columns(14).DataField=   "bank_account"
      Columns(14)._PropDict=   "_MaxComboItems,516,2;_VlistStyle,514,3"
      Columns(15)._VlistStyle=   0
      Columns(15)._MaxComboItems=   5
      Columns(15).Caption=   "START WORKING"
      Columns(15).DataField=   "start_working"
      Columns(15).NumberFormat=   "FormatText Event"
      Columns(15)._PropDict=   "_MaxComboItems,516,2;_VlistStyle,514,3"
      Columns(16)._VlistStyle=   0
      Columns(16)._MaxComboItems=   5
      Columns(16).Caption=   "TITLE CODE"
      Columns(16).DataField=   "title_code"
      Columns(16)._PropDict=   "_MaxComboItems,516,2;_VlistStyle,514,3"
      Columns(17)._VlistStyle=   0
      Columns(17)._MaxComboItems=   5
      Columns(17).Caption=   "TITLE NAME"
      Columns(17).DataField=   "title_name"
      Columns(17)._PropDict=   "_MaxComboItems,516,2;_VlistStyle,514,3"
      Columns(18)._VlistStyle=   4
      Columns(18)._MaxComboItems=   5
      Columns(18).Caption=   "SHIFTABLE"
      Columns(18).DataField=   "flag_shiftable"
      Columns(18)._PropDict=   "_MaxComboItems,516,2;_VlistStyle,514,3"
      Columns(19)._VlistStyle=   4
      Columns(19)._MaxComboItems=   5
      Columns(19).Caption=   "ACTIVE"
      Columns(19).DataField=   "flag_active"
      Columns(19)._PropDict=   "_MaxComboItems,516,2;_VlistStyle,514,3"
      Columns(20)._VlistStyle=   0
      Columns(20)._MaxComboItems=   5
      Columns(20).Caption=   "END WORKING"
      Columns(20).DataField=   "end_working"
      Columns(20).NumberFormat=   "FormatText Event"
      Columns(20)._PropDict=   "_MaxComboItems,516,2;_VlistStyle,514,3"
      Columns(21)._VlistStyle=   0
      Columns(21)._MaxComboItems=   5
      Columns(21).Caption=   "REASON"
      Columns(21).DataField=   "reason"
      ...
      Splits(0)._ColumnProps(53)=   "Column(8).Width=2064"
      Splits(0)._ColumnProps(54)=   "Column(8).DividerColor=0"
      Splits(0)._ColumnProps(55)=   "Column(8)._WidthInPix=1984"
      ...
      Splits(0)._ColumnProps(61)=   "Column(9).Width=3016"
      Splits(0)._ColumnProps(62)=   "Column(9).DividerColor=0"
      Splits(0)._ColumnProps(63)=   "Column(9)._WidthInPix=2937"
      ...
      Splits(0)._ColumnProps(69)=   "Column(10).Width=2037"
      Splits(0)._ColumnProps(70)=   "Column(10).DividerColor=0"
      Splits(0)._ColumnProps(71)=   "Column(10)._WidthInPix=1958"
      ...
      Splits(0)._ColumnProps(77)=   "Column(11).Width=2725"
      Splits(0)._ColumnProps(78)=   "Column(11).DividerColor=0"
      Splits(0)._ColumnProps(79)=   "Column(11)._WidthInPix=2646"
      ...
      Splits(0)._ColumnProps(93)=   "Column(12)._MinWidth=10"
      Splits(0)._ColumnProps(94)=   "Column(13).Width=2725"
      Splits(0)._ColumnProps(95)=   "Column(13).DividerColor=0"
      Splits(0)._ColumnProps(96)=   "Column(13)._WidthInPix=2646"
      Splits(0)._ColumnProps(97)=   "Column(13).AllowSizing=0"
      Splits(0)._ColumnProps(98)=   "Column(13)._ColStyle=516"
      Splits(0)._ColumnProps(99)=   "Column(13).Visible=0"
      Splits(0)._ColumnProps(100)=   "Column(13).AllowFocus=0"
      Splits(0)._ColumnProps(101)=   "Column(13).Order=14"
      Splits(0)._ColumnProps(102)=   "Column(13)._MinWidth=54215968"
      ...
      Splits(0)._ColumnProps(106)=   "Column(14).AllowSizing=0"
      Splits(0)._ColumnProps(107)=   "Column(14)._ColStyle=516"
      ...
      Splits(0)._ColumnProps(119)=   "Column(15)._MinWidth=60129312"
      ...
      Splits(0)._ColumnProps(136)=   "Column(17)._MinWidth=79702332"
      Splits(0)._ColumnProps(137)=   "Column(18).Width=2725"
      Splits(0)._ColumnProps(138)=   "Column(18).DividerColor=0"
      Splits(0)._ColumnProps(139)=   "Column(18)._WidthInPix=2646"
      Splits(0)._ColumnProps(140)=   "Column(18).AllowSizing=0"
      Splits(0)._ColumnProps(141)=   "Column(18)._ColStyle=516"
      Splits(0)._ColumnProps(142)=   "Column(18).Visible=0"
      Splits(0)._ColumnProps(143)=   "Column(18).AllowFocus=0"
      Splits(0)._ColumnProps(144)=   "Column(18).Order=19"
      Splits(0)._ColumnProps(145)=   "Column(18)._MinWidth=79897920"
      Splits(0)._ColumnProps(146)=   "Column(19).Width=2725"
      Splits(0)._ColumnProps(147)=   "Column(19).DividerColor=0"
      Splits(0)._ColumnProps(148)=   "Column(19)._WidthInPix=2646"
      Splits(0)._ColumnProps(149)=   "Column(19).AllowSizing=0"
      Splits(0)._ColumnProps(150)=   "Column(19)._ColStyle=516"
      Splits(0)._ColumnProps(151)=   "Column(19).Visible=0"
      Splits(0)._ColumnProps(152)=   "Column(19).AllowFocus=0"
      Splits(0)._ColumnProps(153)=   "Column(19).Order=20"
      Splits(0)._ColumnProps(154)=   "Column(19)._MinWidth=79914544"
      Splits(0)._ColumnProps(155)=   "Column(20).Width=2725"
      Splits(0)._ColumnProps(156)=   "Column(20).DividerColor=0"
      Splits(0)._ColumnProps(157)=   "Column(20)._WidthInPix=2646"
      Splits(0)._ColumnProps(158)=   "Column(20).AllowSizing=0"
      Splits(0)._ColumnProps(159)=   "Column(20)._ColStyle=516"
      Splits(0)._ColumnProps(160)=   "Column(20).Visible=0"
      Splits(0)._ColumnProps(161)=   "Column(20).AllowFocus=0"
      Splits(0)._ColumnProps(162)=   "Column(20).Order=21"
      Splits(0)._ColumnProps(163)=   "Column(20)._MinWidth=79914544"
      ...
      Splits(0)._ColumnProps(172)=   "Column(21)._MinWidth=79789632"
      ...
      Splits(1)._ColumnProps(63)=   "Column(8).Width=2064"
      Splits(1)._ColumnProps(64)=   "Column(8).DividerColor=0"
      Splits(1)._ColumnProps(65)=   "Column(8)._WidthInPix=1984"
      Splits(1)._ColumnProps(66)=   "Column(8)._ColStyle=513"
      Splits(1)._ColumnProps(67)=   "Column(8).Order=9"
      Splits(1)._ColumnProps(68)=   "Column(8)._MinWidth=80007280"
      Splits(1)._ColumnProps(69)=   "Column(9).Width=3016"
      Splits(1)._ColumnProps(70)=   "Column(9).DividerColor=0"
      Splits(1)._ColumnProps(71)=   "Column(9)._WidthInPix=2937"
      Splits(1)._ColumnProps(72)=   "Column(9)._ColStyle=516"
      Splits(1)._ColumnProps(73)=   "Column(9).Order=10"
      Splits(1)._ColumnProps(74)=   "Column(9)._MinWidth=80010048"
      Splits(1)._ColumnProps(75)=   "Column(10).Width=2037"
      Splits(1)._ColumnProps(76)=   "Column(10).DividerColor=0"
      Splits(1)._ColumnProps(77)=   "Column(10)._WidthInPix=1958"
      Splits(1)._ColumnProps(78)=   "Column(10)._ColStyle=513"
      Splits(1)._ColumnProps(79)=   "Column(10).Order=11"
      Splits(1)._ColumnProps(80)=   "Column(11).Width=2725"
      Splits(1)._ColumnProps(81)=   "Column(11).DividerColor=0"
      Splits(1)._ColumnProps(82)=   "Column(11)._WidthInPix=2646"
      Splits(1)._ColumnProps(83)=   "Column(11)._ColStyle=513"
      Splits(1)._ColumnProps(84)=   "Column(11).Order=12"
      Splits(1)._ColumnProps(85)=   "Column(12).Width=2725"
      Splits(1)._ColumnProps(86)=   "Column(12).DividerColor=0"
      Splits(1)._ColumnProps(87)=   "Column(12)._WidthInPix=2646"
      Splits(1)._ColumnProps(88)=   "Column(12)._ColStyle=516"
      Splits(1)._ColumnProps(89)=   "Column(12).Order=13"
      Splits(1)._ColumnProps(90)=   "Column(13).Width=2725"
      Splits(1)._ColumnProps(91)=   "Column(13).DividerColor=0"
      Splits(1)._ColumnProps(92)=   "Column(13)._WidthInPix=2646"
      Splits(1)._ColumnProps(93)=   "Column(13)._ColStyle=516"
      Splits(1)._ColumnProps(94)=   "Column(13).Order=14"
      Splits(1)._ColumnProps(95)=   "Column(14).Width=2725"
      Splits(1)._ColumnProps(96)=   "Column(14).DividerColor=0"
      Splits(1)._ColumnProps(97)=   "Column(14)._WidthInPix=2646"
      Splits(1)._ColumnProps(98)=   "Column(14)._ColStyle=516"
      Splits(1)._ColumnProps(99)=   "Column(14).Order=15"
      Splits(1)._ColumnProps(100)=   "Column(15).Width=2725"
      Splits(1)._ColumnProps(101)=   "Column(15).DividerColor=0"
      Splits(1)._ColumnProps(102)=   "Column(15)._WidthInPix=2646"
      Splits(1)._ColumnProps(103)=   "Column(15)._ColStyle=513"
      Splits(1)._ColumnProps(104)=   "Column(15).Order=16"
      Splits(1)._ColumnProps(105)=   "Column(16).Width=2725"
      Splits(1)._ColumnProps(106)=   "Column(16).DividerColor=0"
      Splits(1)._ColumnProps(107)=   "Column(16)._WidthInPix=2646"
      Splits(1)._ColumnProps(108)=   "Column(16)._ColStyle=516"
      Splits(1)._ColumnProps(109)=   "Column(16).Order=17"
      Splits(1)._ColumnProps(110)=   "Column(17).Width=2725"
      Splits(1)._ColumnProps(111)=   "Column(17).DividerColor=0"
      Splits(1)._ColumnProps(112)=   "Column(17)._WidthInPix=2646"
      Splits(1)._ColumnProps(113)=   "Column(17)._ColStyle=516"
      Splits(1)._ColumnProps(114)=   "Column(17).Order=18"
      Splits(1)._ColumnProps(115)=   "Column(18).Width=1720"
      Splits(1)._ColumnProps(116)=   "Column(18).DividerColor=0"
      Splits(1)._ColumnProps(117)=   "Column(18)._WidthInPix=1640"
      Splits(1)._ColumnProps(118)=   "Column(18)._ColStyle=513"
      Splits(1)._ColumnProps(119)=   "Column(18).Order=19"
      Splits(1)._ColumnProps(120)=   "Column(19).Width=1588"
      Splits(1)._ColumnProps(121)=   "Column(19).DividerColor=0"
      Splits(1)._ColumnProps(122)=   "Column(19)._WidthInPix=1508"
      Splits(1)._ColumnProps(123)=   "Column(19)._ColStyle=513"
      Splits(1)._ColumnProps(124)=   "Column(19).Order=20"
      Splits(1)._ColumnProps(125)=   "Column(20).Width=2725"
      Splits(1)._ColumnProps(126)=   "Column(20).DividerColor=0"
      Splits(1)._ColumnProps(127)=   "Column(20)._WidthInPix=2646"
      Splits(1)._ColumnProps(128)=   "Column(20)._ColStyle=513"
      Splits(1)._ColumnProps(129)=   "Column(20).Order=21"
      Splits(1)._ColumnProps(130)=   "Column(21).Width=2725"
      Splits(1)._ColumnProps(131)=   "Column(21).DividerColor=0"
      Splits(1)._ColumnProps(132)=   "Column(21)._WidthInPix=2646"
      Splits(1)._ColumnProps(133)=   "Column(21)._ColStyle=516"
      Splits(1)._ColumnProps(134)=   "Column(21).Order=22"
      Splits(1)._ColumnProps(135)=   "Column(21)._MinWidth=80015760"
      Splits.Count    =   2
      ...
      _StyleDefs(74)  =   "Splits(0).Columns(10).Style:id=62,.parent=13"
      _StyleDefs(75)  =   "Splits(0).Columns(10).HeadingStyle:id=59,.parent=14"
      _StyleDefs(76)  =   "Splits(0).Columns(10).FooterStyle:id=60,.parent=15"
      _StyleDefs(77)  =   "Splits(0).Columns(10).EditorStyle:id=61,.parent=17"
      ...
      _StyleDefs(82)  =   "Splits(0).Columns(12).Style:id=102,.parent=13"
      _StyleDefs(83)  =   "Splits(0).Columns(12).HeadingStyle:id=99,.parent=14"
      _StyleDefs(84)  =   "Splits(0).Columns(12).FooterStyle:id=100,.parent=15"
      _StyleDefs(85)  =   "Splits(0).Columns(12).EditorStyle:id=101,.parent=17"
      ...
      _StyleDefs(98)  =   "Splits(0).Columns(16).Style:id=94,.parent=13"
      _StyleDefs(99)  =   "Splits(0).Columns(16).HeadingStyle:id=91,.parent=14"
      _StyleDefs(100) =   "Splits(0).Columns(16).FooterStyle:id=92,.parent=15"
      _StyleDefs(101) =   "Splits(0).Columns(16).EditorStyle:id=93,.parent=17"
      _StyleDefs(102) =   "Splits(0).Columns(17).Style:id=106,.parent=13"
      _StyleDefs(103) =   "Splits(0).Columns(17).HeadingStyle:id=103,.parent=14"
      _StyleDefs(104) =   "Splits(0).Columns(17).FooterStyle:id=104,.parent=15"
      _StyleDefs(105) =   "Splits(0).Columns(17).EditorStyle:id=105,.parent=17"
      _StyleDefs(106) =   "Splits(0).Columns(18).Style:id=114,.parent=13"
      _StyleDefs(107) =   "Splits(0).Columns(18).HeadingStyle:id=111,.parent=14"
      _StyleDefs(108) =   "Splits(0).Columns(18).FooterStyle:id=112,.parent=15"
      _StyleDefs(109) =   "Splits(0).Columns(18).EditorStyle:id=113,.parent=17"
      _StyleDefs(110) =   "Splits(0).Columns(19).Style:id=222,.parent=13"
      _StyleDefs(111) =   "Splits(0).Columns(19).HeadingStyle:id=219,.parent=14"
      _StyleDefs(112) =   "Splits(0).Columns(19).FooterStyle:id=220,.parent=15"
      _StyleDefs(113) =   "Splits(0).Columns(19).EditorStyle:id=221,.parent=17"
      ...
      _StyleDefs(122) =   "Splits(1).Style:id=123,.parent=1"
      _StyleDefs(123) =   "Splits(1).CaptionStyle:id=132,.parent=4,.bgcolor=&H80000002&"
      _StyleDefs(124) =   ":id=132,.fgcolor=&H80000009&"
      _StyleDefs(125) =   "Splits(1).HeadingStyle:id=124,.parent=2,.alignment=2,.bgcolor=&H8000000F&"
      _StyleDefs(126) =   ":id=124,.fgcolor=&H80000002&"
      _StyleDefs(127) =   "Splits(1).FooterStyle:id=125,.parent=3"
      _StyleDefs(128) =   "Splits(1).InactiveStyle:id=126,.parent=5"
      _StyleDefs(129) =   "Splits(1).SelectedStyle:id=128,.parent=6"
      _StyleDefs(130) =   "Splits(1).EditorStyle:id=127,.parent=7"
      _StyleDefs(131) =   "Splits(1).HighlightRowStyle:id=129,.parent=8"
      _StyleDefs(132) =   "Splits(1).EvenRowStyle:id=130,.parent=9"
      _StyleDefs(133) =   "Splits(1).OddRowStyle:id=131,.parent=10"
      _StyleDefs(134) =   "Splits(1).RecordSelectorStyle:id=133,.parent=11"
      _StyleDefs(135) =   "Splits(1).FilterBarStyle:id=134,.parent=12"
      _StyleDefs(136) =   "Splits(1).Columns(0).Style:id=138,.parent=123"
      _StyleDefs(137) =   "Splits(1).Columns(0).HeadingStyle:id=135,.parent=124"
      _StyleDefs(138) =   "Splits(1).Columns(0).FooterStyle:id=136,.parent=125"
      _StyleDefs(139) =   "Splits(1).Columns(0).EditorStyle:id=137,.parent=127"
      _StyleDefs(140) =   "Splits(1).Columns(1).Style:id=142,.parent=123"
      _StyleDefs(141) =   "Splits(1).Columns(1).HeadingStyle:id=139,.parent=124"
      _StyleDefs(142) =   "Splits(1).Columns(1).FooterStyle:id=140,.parent=125"
      _StyleDefs(143) =   "Splits(1).Columns(1).EditorStyle:id=141,.parent=127"
      _StyleDefs(144) =   "Splits(1).Columns(2).Style:id=146,.parent=123"
      _StyleDefs(145) =   "Splits(1).Columns(2).HeadingStyle:id=143,.parent=124"
      _StyleDefs(146) =   "Splits(1).Columns(2).FooterStyle:id=144,.parent=125"
      _StyleDefs(147) =   "Splits(1).Columns(2).EditorStyle:id=145,.parent=127"
      _StyleDefs(148) =   "Splits(1).Columns(3).Style:id=150,.parent=123"
      _StyleDefs(149) =   "Splits(1).Columns(3).HeadingStyle:id=147,.parent=124"
      _StyleDefs(150) =   "Splits(1).Columns(3).FooterStyle:id=148,.parent=125"
      _StyleDefs(151) =   "Splits(1).Columns(3).EditorStyle:id=149,.parent=127"
      _StyleDefs(152) =   "Splits(1).Columns(4).Style:id=154,.parent=123"
      _StyleDefs(153) =   "Splits(1).Columns(4).HeadingStyle:id=151,.parent=124"
      _StyleDefs(154) =   "Splits(1).Columns(4).FooterStyle:id=152,.parent=125"
      _StyleDefs(155) =   "Splits(1).Columns(4).EditorStyle:id=153,.parent=127"
      _StyleDefs(156) =   "Splits(1).Columns(5).Style:id=158,.parent=123"
      _StyleDefs(157) =   "Splits(1).Columns(5).HeadingStyle:id=155,.parent=124"
      _StyleDefs(158) =   "Splits(1).Columns(5).FooterStyle:id=156,.parent=125"
      _StyleDefs(159) =   "Splits(1).Columns(5).EditorStyle:id=157,.parent=127"
      _StyleDefs(160) =   "Splits(1).Columns(6).Style:id=162,.parent=123"
      _StyleDefs(161) =   "Splits(1).Columns(6).HeadingStyle:id=159,.parent=124"
      _StyleDefs(162) =   "Splits(1).Columns(6).FooterStyle:id=160,.parent=125"
      _StyleDefs(163) =   "Splits(1).Columns(6).EditorStyle:id=161,.parent=127"
      _StyleDefs(164) =   "Splits(1).Columns(7).Style:id=166,.parent=123"
      _StyleDefs(165) =   "Splits(1).Columns(7).HeadingStyle:id=163,.parent=124"
      _StyleDefs(166) =   "Splits(1).Columns(7).FooterStyle:id=164,.parent=125"
      _StyleDefs(167) =   "Splits(1).Columns(7).EditorStyle:id=165,.parent=127"
      _StyleDefs(168) =   "Splits(1).Columns(8).Style:id=170,.parent=123,.alignment=2"
      _StyleDefs(169) =   "Splits(1).Columns(8).HeadingStyle:id=167,.parent=124"
      _StyleDefs(170) =   "Splits(1).Columns(8).FooterStyle:id=168,.parent=125"
      _StyleDefs(171) =   "Splits(1).Columns(8).EditorStyle:id=169,.parent=127"
      _StyleDefs(172) =   "Splits(1).Columns(9).Style:id=174,.parent=123"
      _StyleDefs(173) =   "Splits(1).Columns(9).HeadingStyle:id=171,.parent=124"
      _StyleDefs(174) =   "Splits(1).Columns(9).FooterStyle:id=172,.parent=125"
      _StyleDefs(175) =   "Splits(1).Columns(9).EditorStyle:id=173,.parent=127"
      _StyleDefs(176) =   "Splits(1).Columns(10).Style:id=178,.parent=123,.alignment=2"
      _StyleDefs(177) =   "Splits(1).Columns(10).HeadingStyle:id=175,.parent=124"
      _StyleDefs(178) =   "Splits(1).Columns(10).FooterStyle:id=176,.parent=125"
      _StyleDefs(179) =   "Splits(1).Columns(10).EditorStyle:id=177,.parent=127"
      _StyleDefs(180) =   "Splits(1).Columns(11).Style:id=182,.parent=123,.alignment=2"
      _StyleDefs(181) =   "Splits(1).Columns(11).HeadingStyle:id=179,.parent=124"
      _StyleDefs(182) =   "Splits(1).Columns(11).FooterStyle:id=180,.parent=125"
      _StyleDefs(183) =   "Splits(1).Columns(11).EditorStyle:id=181,.parent=127"
      _StyleDefs(184) =   "Splits(1).Columns(12).Style:id=186,.parent=123"
      _StyleDefs(185) =   "Splits(1).Columns(12).HeadingStyle:id=183,.parent=124"
      _StyleDefs(186) =   "Splits(1).Columns(12).FooterStyle:id=184,.parent=125"
      _StyleDefs(187) =   "Splits(1).Columns(12).EditorStyle:id=185,.parent=127"
      _StyleDefs(188) =   "Splits(1).Columns(13).Style:id=190,.parent=123"
      _StyleDefs(189) =   "Splits(1).Columns(13).HeadingStyle:id=187,.parent=124"
      _StyleDefs(190) =   "Splits(1).Columns(13).FooterStyle:id=188,.parent=125"
      _StyleDefs(191) =   "Splits(1).Columns(13).EditorStyle:id=189,.parent=127"
      _StyleDefs(192) =   "Splits(1).Columns(14).Style:id=194,.parent=123"
      _StyleDefs(193) =   "Splits(1).Columns(14).HeadingStyle:id=191,.parent=124"
      _StyleDefs(194) =   "Splits(1).Columns(14).FooterStyle:id=192,.parent=125"
      _StyleDefs(195) =   "Splits(1).Columns(14).EditorStyle:id=193,.parent=127"
      _StyleDefs(196) =   "Splits(1).Columns(15).Style:id=198,.parent=123,.alignment=2"
      _StyleDefs(197) =   "Splits(1).Columns(15).HeadingStyle:id=195,.parent=124"
      _StyleDefs(198) =   "Splits(1).Columns(15).FooterStyle:id=196,.parent=125"
      _StyleDefs(199) =   "Splits(1).Columns(15).EditorStyle:id=197,.parent=127"
      _StyleDefs(200) =   "Splits(1).Columns(16).Style:id=202,.parent=123"
      _StyleDefs(201) =   "Splits(1).Columns(16).HeadingStyle:id=199,.parent=124"
      _StyleDefs(202) =   "Splits(1).Columns(16).FooterStyle:id=200,.parent=125"
      _StyleDefs(203) =   "Splits(1).Columns(16).EditorStyle:id=201,.parent=127"
      _StyleDefs(204) =   "Splits(1).Columns(17).Style:id=206,.parent=123"
      _StyleDefs(205) =   "Splits(1).Columns(17).HeadingStyle:id=203,.parent=124"
      _StyleDefs(206) =   "Splits(1).Columns(17).FooterStyle:id=204,.parent=125"
      _StyleDefs(207) =   "Splits(1).Columns(17).EditorStyle:id=205,.parent=127"
      _StyleDefs(208) =   "Splits(1).Columns(18).Style:id=210,.parent=123,.alignment=2"
      _StyleDefs(209) =   "Splits(1).Columns(18).HeadingStyle:id=207,.parent=124"
      _StyleDefs(210) =   "Splits(1).Columns(18).FooterStyle:id=208,.parent=125"
      _StyleDefs(211) =   "Splits(1).Columns(18).EditorStyle:id=209,.parent=127"
      _StyleDefs(212) =   "Splits(1).Columns(19).Style:id=226,.parent=123,.alignment=2"
      _StyleDefs(213) =   "Splits(1).Columns(19).HeadingStyle:id=223,.parent=124"
      _StyleDefs(214) =   "Splits(1).Columns(19).FooterStyle:id=224,.parent=125"
      _StyleDefs(215) =   "Splits(1).Columns(19).EditorStyle:id=225,.parent=127"
      _StyleDefs(216) =   "Splits(1).Columns(20).Style:id=214,.parent=123,.alignment=2"
      _StyleDefs(217) =   "Splits(1).Columns(20).HeadingStyle:id=211,.parent=124"
      _StyleDefs(218) =   "Splits(1).Columns(20).FooterStyle:id=212,.parent=125"
      _StyleDefs(219) =   "Splits(1).Columns(20).EditorStyle:id=213,.parent=127"
      _StyleDefs(220) =   "Splits(1).Columns(21).Style:id=218,.parent=123"
      _StyleDefs(221) =   "Splits(1).Columns(21).HeadingStyle:id=215,.parent=124"
      _StyleDefs(222) =   "Splits(1).Columns(21).FooterStyle:id=216,.parent=125"
      _StyleDefs(223) =   "Splits(1).Columns(21).EditorStyle:id=217,.parent=127"
...
If public_int_mode = 0 Then
    ...
    If public_int_mode = 0 Then
        For Each item In SelBks
            ...
            SQL = "SELECT flag_rollable FROM m_shift WHERE shift_code = '" & frm_trans_employees_wt.TDBGrid1.Columns("shift_code").Value & "'"
            rs.Open SQL, CnG, adOpenForwardOnly, adLockReadOnly
            
            If rs.RecordCount > 0 Then
                vRollable = rs!flag_rollable
            End If
            rs.Close
            
            If vRollable = 1 Then
                If rs.State Then rs.Close
                SQL = "SELECT a.shift_number FROM tm_shift a JOIN m_shift b ON a.shift_code = b.shift_code " & _
                      "WHERE IFNULL(b.flag_rollable,0) <> 0 "
                rs.Open SQL, CnG, adOpenForwardOnly, adLockReadOnly
                ...
                If rs.RecordCount > 0 Then
                    ...
                    While Not rs.EOF
                        If check_validate_exist_employee_wt_new(TDBGrid1.Columns("company_code").CellText(item), _
                           rs!shift_number, TDBGrid1.Columns("employee_code").CellText(item)) = False Then
            ...
            Else
                ...
                CnG.Execute "call spi_td_shift('" _
                    & TDBGrid1.Columns("company_code").CellText(item) & "'," _
                    & frm_trans_employees_wt.TDBGrid1.Columns("shift_number").Value & ",'" _
                    & TDBGrid1.Columns("employee_code").CellText(item) & "')"
            End If
        Next
    End If
    CnG.CommitTrans
    Call frm_trans_employees_wt.load_data_detail_working_time
...
ElseIf public_int_mode = 4 Then
    ...
    End If
    For Each item In SelBks
        frm_rpt_att_detail.txt_periode_employee_code = TDBGrid1.Columns("employee_code").CellText(item)
        frm_rpt_att_detail.txt_periode_employee_name = TDBGrid1.Columns("employee_name").CellText(item)
    Next
...
ElseIf public_int_mode = 5 Then
    ...
    End If
    For Each item In SelBks
        frm_rpt_att_detail.txt_monthly_employee_code = TDBGrid1.Columns("employee_code").CellText(item)
        frm_rpt_att_detail.txt_monthly_employee_name = TDBGrid1.Columns("employee_name").CellText(item)
    Next
...
ElseIf public_int_mode = 6 Then
    ...
    End If
    For Each item In SelBks
        frm_rpt_att_detail.txt_daily_employee_code = TDBGrid1.Columns("employee_code").CellText(item)
        frm_rpt_att_detail.txt_daily_employee_name = TDBGrid1.Columns("employee_name").CellText(item)
    Next
...
ElseIf public_int_mode = 7 Then
    ...
    End If
    For Each item In SelBks
        frm_rpt_att_summary.txt_periode_employee_code = TDBGrid1.Columns("employee_code").CellText(item)
        frm_rpt_att_summary.txt_periode_employee_name = TDBGrid1.Columns("employee_name").CellText(item)
    Next
...
ElseIf public_int_mode = 8 Then
    ...
    End If
    For Each item In SelBks
        frm_rpt_att_summary.txt_monthly_employee_code = TDBGrid1.Columns("employee_code").CellText(item)
        frm_rpt_att_summary.txt_monthly_employee_name = TDBGrid1.Columns("employee_name").CellText(item)
    Next
...
ElseIf public_int_mode = 9 Then
    ...
    End If
    For Each item In SelBks
        frm_rpt_att_summary.txt_daily_employee_code = TDBGrid1.Columns("employee_code").CellText(item)
        frm_rpt_att_summary.txt_daily_employee_name = TDBGrid1.Columns("employee_name").CellText(item)
    Next
...
ElseIf public_int_mode = 11 Then
    ...
    End If
    For Each item In SelBks
        frm_trans_performance.txt_employee_code = TDBGrid1.Columns("employee_code").CellText(item)
        frm_trans_performance.txt_employee_name = TDBGrid1.Columns("employee_name").CellText(item)
    Next
...
ElseIf public_int_mode = 77 Then
    ...
    End If
    For Each item In SelBks
        frm_mst_salary.txt_employee_code = TDBGrid1.Columns("employee_code").CellText(item)
        frm_mst_salary.txt_employee_name = TDBGrid1.Columns("employee_name").CellText(item)
    Next
...
ElseIf public_int_mode = 78 Then
    ...
    End If
    For Each item In SelBks
        frm_rpt_salary_summary.txt_monthly_employee_code = TDBGrid1.Columns("employee_code").CellText(item)
        frm_rpt_salary_summary.txt_monthly_employee_name = TDBGrid1.Columns("employee_name").CellText(item)
    Next
...
ElseIf public_int_mode = 79 Then
    ...
    End If
    For Each item In SelBks
        frm_rpt_salary_summary.txt_periode_employee_code = TDBGrid1.Columns("employee_code").CellText(item)
        frm_rpt_salary_summary.txt_periode_employee_name = TDBGrid1.Columns("employee_name").CellText(item)
    Next
