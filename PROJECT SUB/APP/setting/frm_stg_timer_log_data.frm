...
Begin VB.Form frm_stg_all 
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      Tab(0).Control(0)=   "fra_entry_wt"
      Tab(0).Control(1)=   "cmd_update_device_type"
      ...
      Tab(1).Control(2)=   "fraEntry_Device"
      ...
      Begin VB.CommandButton cmd_dt_set 
         ...
         Height          =   645
         Left            =   -68400
         Picture         =   "frm_stg_timer_log_data.frx":16FA
         Style           =   1  'Graphical
         TabIndex        =   22
         Top             =   2820
         Width           =   975
      ...
      Begin VB.CommandButton cmd_dt_refresh 
         ...
         Height          =   645
         Left            =   -69480
         Picture         =   "frm_stg_timer_log_data.frx":1C84
         Style           =   1  'Graphical
         TabIndex        =   21
         Top             =   2820
         Width           =   975
      ...
      Begin VB.Frame frmTombol 
         ...
         Begin VB.Timer timer1 
            ...
            Top             =   360
         End
         Begin prj_absensi.vbButton cmdNew_Device 
            Height          =   705
            Left            =   150
            TabIndex        =   11
            Top             =   330
            ...
            MCOL            =   12632256
            MPTR            =   1
            MICON           =   "frm_stg_timer_log_data.frx":220E
            PICN            =   "frm_stg_timer_log_data.frx":222A
            UMCOL           =   -1  'True
            SOFT            =   0   'False
            PICPOS          =   2
            NGREY           =   0   'False
            ...
            VALUE           =   0   'False
         End
         Begin prj_absensi.vbButton cmdSave_Device 
            Height          =   705
            Left            =   1200
            TabIndex        =   12
            Top             =   330
            ...
            MCOL            =   12632256
            MPTR            =   1
            MICON           =   "frm_stg_timer_log_data.frx":32BC
            PICN            =   "frm_stg_timer_log_data.frx":32D8
            UMCOL           =   -1  'True
            SOFT            =   0   'False
            PICPOS          =   2
            NGREY           =   0   'False
            ...
            VALUE           =   0   'False
         End
         Begin prj_absensi.vbButton cmdEdit_Device 
            Height          =   705
            Left            =   2250
            TabIndex        =   13
            Top             =   330
            ...
            MCOL            =   12632256
            MPTR            =   1
            MICON           =   "frm_stg_timer_log_data.frx":436A
            PICN            =   "frm_stg_timer_log_data.frx":4386
            UMCOL           =   -1  'True
            SOFT            =   0   'False
            PICPOS          =   2
            NGREY           =   0   'False
            ...
            VALUE           =   0   'False
         End
         Begin prj_absensi.vbButton cmdDelete_Device 
            Height          =   705
            Left            =   3300
            TabIndex        =   14
            Top             =   330
            ...
            MCOL            =   12632256
            MPTR            =   1
            MICON           =   "frm_stg_timer_log_data.frx":5418
            PICN            =   "frm_stg_timer_log_data.frx":5434
            UMCOL           =   -1  'True
            SOFT            =   0   'False
            PICPOS          =   2
            NGREY           =   0   'False
            ...
            VALUE           =   0   'False
         End
         Begin prj_absensi.vbButton cmdCancel_Device 
            Height          =   705
            Left            =   4350
            TabIndex        =   15
            Top             =   330
            ...
            MCOL            =   12632256
            MPTR            =   1
            MICON           =   "frm_stg_timer_log_data.frx":64C6
            PICN            =   "frm_stg_timer_log_data.frx":64E2
            UMCOL           =   -1  'True
            SOFT            =   0   'False
            PICPOS          =   2
            NGREY           =   0   'False
         ...
         Begin prj_absensi.vbButton cmd_test 
            ...
            MCOL            =   12632256
            MPTR            =   1
            MICON           =   "frm_stg_timer_log_data.frx":7574
            PICN            =   "frm_stg_timer_log_data.frx":7590
            UMCOL           =   -1  'True
            SOFT            =   0   'False
            PICPOS          =   2
            NGREY           =   0   'False
      ...
      Begin VB.Frame Frame4 
         ...
         Begin prj_absensi.vbButton cmdNew 
            ...
            MCOL            =   12632256
            MPTR            =   1
            MICON           =   "frm_stg_timer_log_data.frx":8622
            PICN            =   "frm_stg_timer_log_data.frx":863E
            UMCOL           =   -1  'True
            SOFT            =   0   'False
            PICPOS          =   2
            NGREY           =   0   'False
         ...
         Begin prj_absensi.vbButton cmdSave 
            ...
            MCOL            =   12632256
            MPTR            =   1
            MICON           =   "frm_stg_timer_log_data.frx":96D0
            PICN            =   "frm_stg_timer_log_data.frx":96EC
            UMCOL           =   -1  'True
            SOFT            =   0   'False
            PICPOS          =   2
            NGREY           =   0   'False
         ...
         Begin prj_absensi.vbButton cmdEdit 
            ...
            MCOL            =   12632256
            MPTR            =   1
            MICON           =   "frm_stg_timer_log_data.frx":A77E
            PICN            =   "frm_stg_timer_log_data.frx":A79A
            UMCOL           =   -1  'True
            SOFT            =   0   'False
            PICPOS          =   2
            NGREY           =   0   'False
         ...
         Begin prj_absensi.vbButton cmdDelete 
            ...
            MCOL            =   12632256
            MPTR            =   1
            MICON           =   "frm_stg_timer_log_data.frx":B82C
            PICN            =   "frm_stg_timer_log_data.frx":B848
            UMCOL           =   -1  'True
            SOFT            =   0   'False
            PICPOS          =   2
            NGREY           =   0   'False
         ...
         Begin prj_absensi.vbButton cmdCancel 
            ...
            MCOL            =   12632256
            MPTR            =   1
            MICON           =   "frm_stg_timer_log_data.frx":C8DA
            PICN            =   "frm_stg_timer_log_data.frx":C8F6
            UMCOL           =   -1  'True
            SOFT            =   0   'False
            PICPOS          =   2
            NGREY           =   0   'False
            ...
            VALUE           =   0   'False
         End
         Begin prj_absensi.vbButton vbButton6 
            Height          =   705
            Left            =   7620
            TabIndex        =   9
            Top             =   330
            ...
            MCOL            =   12632256
            MPTR            =   1
            MICON           =   "frm_stg_timer_log_data.frx":D988
            PICN            =   "frm_stg_timer_log_data.frx":D9A4
            UMCOL           =   -1  'True
            SOFT            =   0   'False
            PICPOS          =   2
            NGREY           =   0   'False
      ...
      Begin TrueOleDBList60.TDBCombo TDBCombo_device 
         Height          =   375
         Left            =   -71160
         OleObjectBlob   =   "frm_stg_timer_log_data.frx":EA36
         TabIndex        =   24
         Top             =   1620
         Width           =   3735
      End
      Begin prj_absensi.vbButton cmd_update_device_type 
         Height          =   450
         Left            =   -68460
         TabIndex        =   25
         Top             =   2970
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frm_stg_timer_log_data.frx":10E2B
         PICN            =   "frm_stg_timer_log_data.frx":10E47
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin TrueOleDBGrid70.TDBGrid TDBGrid2 
         ...
         Columns(3).Caption=   "DEL LOG"
         Columns(3).DataField=   "del_log"
         ...
         Splits(0)._ColumnProps(17)=   "Column(3).Width=2143"
         Splits(0)._ColumnProps(18)=   "Column(3).DividerColor=0"
         Splits(0)._ColumnProps(19)=   "Column(3)._WidthInPix=2064"
         Splits(0)._ColumnProps(20)=   "Column(3)._ColStyle=513"
         Splits(0)._ColumnProps(21)=   "Column(3).Order=4"
         Splits(0)._ColumnProps(22)=   "Column(4).Width=4842"
         Splits(0)._ColumnProps(23)=   "Column(4).DividerColor=0"
         Splits(0)._ColumnProps(24)=   "Column(4)._WidthInPix=4763"
...
On Error GoTo Err
    ...
    SQL = "INSERT INTO m_device(ip_address,port_number,name,auto_del_log) " & _
...
On Error GoTo Err
    ...
    CnG.BeginTrans
    SQL = "UPDATE m_device SET ip_address = '" & txt_ip_address.Text & "'," & _
            "name = '" & Trim(txt_name.Text) & "', " & _
            "port_number = '" & Val(DropAllComma(txt_port.Text)) & "', " & _
