...
Begin VB.Form frm_trans_leave_periode 
   ...
   Begin VB.Frame frmTombol 
      ...
      Begin VB.CommandButton CmdSave 
         ...
         Height          =   645
         Left            =   1800
         Picture         =   "frm_trans_leave_periode.frx":058A
         Style           =   1  'Graphical
         TabIndex        =   6
         Top             =   360
         Width           =   975
      ...
      Begin VB.CommandButton CmdCancel 
         ...
         Height          =   645
         Left            =   5040
         Picture         =   "frm_trans_leave_periode.frx":0B14
         Style           =   1  'Graphical
         TabIndex        =   9
         Top             =   360
         Width           =   975
      ...
      Begin VB.CommandButton CmdNew 
         ...
         Height          =   645
         Left            =   720
         Picture         =   "frm_trans_leave_periode.frx":109E
         Style           =   1  'Graphical
         TabIndex        =   5
         Top             =   360
         Width           =   975
      ...
      Begin VB.CommandButton CmdPrint 
         ...
         Height          =   645
         Left            =   0
         Picture         =   "frm_trans_leave_periode.frx":1628
         Style           =   1  'Graphical
         TabIndex        =   10
         Top             =   600
         Visible         =   0   'False
      ...
      Begin VB.CommandButton cmdDelete 
         ...
         Height          =   645
         Left            =   3960
         Picture         =   "frm_trans_leave_periode.frx":1BB2
         Style           =   1  'Graphical
         TabIndex        =   8
         Top             =   360
         Width           =   975
      ...
      Begin VB.CommandButton cmdEdit 
         ...
         Height          =   645
         Left            =   2880
         Picture         =   "frm_trans_leave_periode.frx":213C
         Style           =   1  'Graphical
         TabIndex        =   7
         Top             =   360
         Width           =   975
      End
      Begin prj_absensi.vbButton cmd_refresh 
         Height          =   705
         Left            =   6990
         TabIndex        =   20
         Top             =   360
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frm_trans_leave_periode.frx":26C6
         PICN            =   "frm_trans_leave_periode.frx":26E2
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   2
         NGREY           =   0   'False
      ...
      Begin prj_absensi.vbButton cmdExit 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frm_trans_leave_periode.frx":3774
         PICN            =   "frm_trans_leave_periode.frx":3790
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   2
         NGREY           =   0   'False
   ...
   Begin TrueOleDBList60.TDBCombo TDBCombo_company 
      Height          =   375
      Left            =   1200
      OleObjectBlob   =   "frm_trans_leave_periode.frx":4822
      TabIndex        =   17
      Top             =   240
      Width           =   1695
   End
   ...
   End
End
Attribute VB_Name = "frm_trans_leave_periode"
...
Adodc1.RecordSource = "select * from v_t_leave_periode where company_code = '" _
& TDBCombo_company.Columns("company_code").Value & "' order by department_code,division_code,employee_code"
Adodc1.Refresh
