...
Begin VB.Form frm_trans_employees_wt 
   ...
   EndProperty
   Icon            =   "frm_trans_employees_wt.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   MinButton       =   0   'False
   ...
   Begin VB.Frame fra_entry 
      ...
      Begin VB.ComboBox cbo_enable 
         Height          =   315
         ItemData        =   "frm_trans_employees_wt.frx":058A
         Left            =   11520
         List            =   "frm_trans_employees_wt.frx":0594
         TabIndex        =   4
         Text            =   "..."
         Top             =   720
         Width           =   1695
      ...
      Begin VB.ComboBox cbo_type 
         ForeColor       =   &H80000002&
         Height          =   315
         ItemData        =   "frm_trans_employees_wt.frx":05A1
         Left            =   11520
         List            =   "frm_trans_employees_wt.frx":05AB
         Locked          =   -1  'True
         TabIndex        =   17
         Text            =   "..."
         Top             =   360
      ...
      Begin TrueOleDBList60.TDBCombo TDBCombo_working_time 
         Height          =   375
         Left            =   1920
         OleObjectBlob   =   "frm_trans_employees_wt.frx":05BF
         TabIndex        =   1
         Top             =   720
         Width           =   1695
      End
   ...
   Begin VB.Frame frmTombol 
      ...
      Begin VB.CommandButton cmd_refresh 
         ...
         Height          =   645
         Left            =   10080
         Picture         =   "frm_trans_employees_wt.frx":29C2
         Style           =   1  'Graphical
         TabIndex        =   12
         Top             =   360
         Visible         =   0   'False
      ...
      Begin VB.CommandButton CmdPrint 
         ...
         Height          =   645
         Left            =   0
         Picture         =   "frm_trans_employees_wt.frx":2F4C
         Style           =   1  'Graphical
         TabIndex        =   9
         Top             =   600
         Visible         =   0   'False
      ...
      Begin prj_absensi.vbButton cmdNew 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frm_trans_employees_wt.frx":34D6
         PICN            =   "frm_trans_employees_wt.frx":34F2
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   2
         NGREY           =   0   'False
      ...
      Begin prj_absensi.vbButton cmdSave 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frm_trans_employees_wt.frx":4584
         PICN            =   "frm_trans_employees_wt.frx":45A0
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   2
         NGREY           =   0   'False
      ...
      Begin prj_absensi.vbButton cmdEdit 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frm_trans_employees_wt.frx":5632
         PICN            =   "frm_trans_employees_wt.frx":564E
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   2
         NGREY           =   0   'False
      ...
      Begin prj_absensi.vbButton cmdDelete 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frm_trans_employees_wt.frx":66E0
         PICN            =   "frm_trans_employees_wt.frx":66FC
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   2
         NGREY           =   0   'False
      ...
      Begin prj_absensi.vbButton cmdCancel 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frm_trans_employees_wt.frx":778E
         PICN            =   "frm_trans_employees_wt.frx":77AA
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   2
         NGREY           =   0   'False
      ...
      Begin prj_absensi.vbButton cmdExit 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frm_trans_employees_wt.frx":883C
         PICN            =   "frm_trans_employees_wt.frx":8858
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   2
         NGREY           =   0   'False
         ...
         VALUE           =   0   'False
      End
      Begin prj_absensi.vbButton cmd_add_dtl 
         Height          =   705
         Left            =   6900
         TabIndex        =   29
         Top             =   390
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frm_trans_employees_wt.frx":98EA
         PICN            =   "frm_trans_employees_wt.frx":9906
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   2
         NGREY           =   0   'False
         ...
         VALUE           =   0   'False
      End
      Begin prj_absensi.vbButton cmd_delete_dtl 
         Height          =   705
         Left            =   7890
         TabIndex        =   30
         Top             =   390
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frm_trans_employees_wt.frx":A998
         PICN            =   "frm_trans_employees_wt.frx":A9B4
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   2
         NGREY           =   0   'False
   ...
   Begin TrueOleDBGrid70.TDBGrid TDBGrid1 
      ...
      Columns(2).Caption=   "ENTRY DATE"
      Columns(2).DataField=   "shift_date"
      Columns(2).NumberFormat=   "FormatText Event"
      Columns(2)._PropDict=   "_MaxComboItems,516,2;_VlistStyle,514,3"
      Columns(3)._VlistStyle=   0
      Columns(3)._MaxComboItems=   5
      Columns(3).Caption=   "WORKING TIME CODE"
      Columns(3).DataField=   "shift_code"
      Columns(3)._PropDict=   "_MaxComboItems,516,2;_VlistStyle,514,3"
      Columns(4)._VlistStyle=   0
      Columns(4)._MaxComboItems=   5
      Columns(4).Caption=   "WORKING TIME NAME"
      Columns(4).DataField=   "shift_name"
      Columns(4)._PropDict=   "_MaxComboItems,516,2;_VlistStyle,514,3"
      Columns(5)._VlistStyle=   0
      Columns(5)._MaxComboItems=   5
      Columns(5).Caption=   "START DATE"
      Columns(5).DataField=   "start_date"
      Columns(5).NumberFormat=   "FormatText Event"
      Columns(5)._PropDict=   "_MaxComboItems,516,2;_VlistStyle,514,3"
      Columns(6)._VlistStyle=   0
      Columns(6)._MaxComboItems=   5
      Columns(6).Caption=   "END DATE"
      Columns(6).DataField=   "end_date"
      ...
      Columns(7).ValueItems(0).DisplayValue=   "General"
      ...
      Columns(7).ValueItems(1).DisplayValue=   "Shift"
      ...
      Columns(7).DataField=   "flag_shift"
      Columns(7)._PropDict=   "_MaxComboItems,516,2;_VlistStyle,514,3"
      Columns(8)._VlistStyle=   4
      Columns(8)._MaxComboItems=   5
      Columns(8).Caption=   "ENABLE"
      Columns(8).DataField=   "flag_enable"
      ...
      Splits(0)._ColumnProps(15)=   "Column(2).Width=3043"
      Splits(0)._ColumnProps(16)=   "Column(2).DividerColor=0"
      Splits(0)._ColumnProps(17)=   "Column(2)._WidthInPix=2963"
      Splits(0)._ColumnProps(18)=   "Column(2)._ColStyle=513"
      Splits(0)._ColumnProps(19)=   "Column(2).Order=3"
      Splits(0)._ColumnProps(20)=   "Column(3).Width=3678"
      Splits(0)._ColumnProps(21)=   "Column(3).DividerColor=0"
      Splits(0)._ColumnProps(22)=   "Column(3)._WidthInPix=3598"
      Splits(0)._ColumnProps(23)=   "Column(3)._ColStyle=516"
      Splits(0)._ColumnProps(24)=   "Column(3).Order=4"
      Splits(0)._ColumnProps(25)=   "Column(4).Width=7038"
      Splits(0)._ColumnProps(26)=   "Column(4).DividerColor=0"
      Splits(0)._ColumnProps(27)=   "Column(4)._WidthInPix=6959"
      Splits(0)._ColumnProps(28)=   "Column(4)._ColStyle=516"
      Splits(0)._ColumnProps(29)=   "Column(4).Order=5"
      Splits(0)._ColumnProps(30)=   "Column(5).Width=2858"
      Splits(0)._ColumnProps(31)=   "Column(5).DividerColor=0"
      Splits(0)._ColumnProps(32)=   "Column(5)._WidthInPix=2778"
      Splits(0)._ColumnProps(33)=   "Column(5)._ColStyle=513"
      Splits(0)._ColumnProps(34)=   "Column(5).Order=6"
      Splits(0)._ColumnProps(35)=   "Column(6).Width=2884"
      Splits(0)._ColumnProps(36)=   "Column(6).DividerColor=0"
      Splits(0)._ColumnProps(37)=   "Column(6)._WidthInPix=2805"
      Splits(0)._ColumnProps(38)=   "Column(6)._ColStyle=513"
      Splits(0)._ColumnProps(39)=   "Column(6).Order=7"
      Splits(0)._ColumnProps(40)=   "Column(7).Width=2805"
      Splits(0)._ColumnProps(41)=   "Column(7).DividerColor=0"
      Splits(0)._ColumnProps(42)=   "Column(7)._WidthInPix=2725"
      Splits(0)._ColumnProps(43)=   "Column(7)._ColStyle=513"
      Splits(0)._ColumnProps(44)=   "Column(7).Order=8"
      Splits(0)._ColumnProps(45)=   "Column(8).Width=1667"
      Splits(0)._ColumnProps(46)=   "Column(8).DividerColor=0"
      Splits(0)._ColumnProps(47)=   "Column(8)._WidthInPix=1588"
      ...
      _StyleDefs(54)  =   "Splits(0).Columns(5).Style:id=58,.parent=13,.alignment=2"
      ...
      _StyleDefs(66)  =   "Splits(0).Columns(8).Style:id=54,.parent=13,.alignment=2"
      _StyleDefs(67)  =   "Splits(0).Columns(8).HeadingStyle:id=51,.parent=14"
      _StyleDefs(68)  =   "Splits(0).Columns(8).FooterStyle:id=52,.parent=15"
      _StyleDefs(69)  =   "Splits(0).Columns(8).EditorStyle:id=53,.parent=17"
   ...
   Begin TrueOleDBGrid70.TDBGrid TDBGrid2 
      ...
      Splits(0)._ColumnProps(17)=   "Column(2).Width=2699"
      Splits(0)._ColumnProps(18)=   "Column(2).DividerColor=0"
      Splits(0)._ColumnProps(19)=   "Column(2)._WidthInPix=2619"
      Splits(0)._ColumnProps(20)=   "Column(2)._ColStyle=516"
      Splits(0)._ColumnProps(21)=   "Column(2).Order=3"
      Splits(0)._ColumnProps(22)=   "Column(3).Width=4868"
      Splits(0)._ColumnProps(23)=   "Column(3).DividerColor=0"
      Splits(0)._ColumnProps(24)=   "Column(3)._WidthInPix=4789"
      Splits(0)._ColumnProps(25)=   "Column(3)._ColStyle=516"
      Splits(0)._ColumnProps(26)=   "Column(3).Order=4"
      Splits(0)._ColumnProps(27)=   "Column(4).Width=2778"
      Splits(0)._ColumnProps(28)=   "Column(4).DividerColor=0"
      Splits(0)._ColumnProps(29)=   "Column(4)._WidthInPix=2699"
      Splits(0)._ColumnProps(30)=   "Column(4)._ColStyle=516"
      Splits(0)._ColumnProps(31)=   "Column(4).Order=5"
      Splits(0)._ColumnProps(32)=   "Column(4)._MinWidth=74338528"
      Splits(0)._ColumnProps(33)=   "Column(5).Width=4895"
      Splits(0)._ColumnProps(34)=   "Column(5).DividerColor=0"
      Splits(0)._ColumnProps(35)=   "Column(5)._WidthInPix=4815"
      Splits(0)._ColumnProps(36)=   "Column(5)._ColStyle=516"
      Splits(0)._ColumnProps(37)=   "Column(5).Order=6"
      Splits(0)._ColumnProps(38)=   "Column(5)._MinWidth=74338544"
      Splits(0)._ColumnProps(39)=   "Column(6).Width=1217"
      Splits(0)._ColumnProps(40)=   "Column(6).DividerColor=0"
      Splits(0)._ColumnProps(41)=   "Column(6)._WidthInPix=1138"
      ...
      Splits(0)._ColumnProps(47)=   "Column(7).Width=2937"
      Splits(0)._ColumnProps(48)=   "Column(7).DividerColor=0"
      Splits(0)._ColumnProps(49)=   "Column(7)._WidthInPix=2858"
      Splits(0)._ColumnProps(50)=   "Column(7)._ColStyle=516"
      Splits(0)._ColumnProps(51)=   "Column(7).Order=8"
      Splits(0)._ColumnProps(52)=   "Column(8).Width=5450"
      Splits(0)._ColumnProps(53)=   "Column(8).DividerColor=0"
      Splits(0)._ColumnProps(54)=   "Column(8)._WidthInPix=5371"
   ...
   Begin TrueOleDBList60.TDBCombo TDBCombo_company 
      Height          =   375
      Left            =   1200
      OleObjectBlob   =   "frm_trans_employees_wt.frx":BA46
      TabIndex        =   21
      Top             =   240
      Width           =   1695
   End
   ...
   End
End
Attribute VB_Name = "frm_trans_employees_wt"
...
'str_sql = "select count(shift_number) as rec_count from tm_shift where shift_number = '" _
...
If cek_validate_tdbcombo(TDBCombo_working_time) = False Then
    MsgBox "Working time is not selected!", vbOKOnly + vbInformation, headerMSG
    TDBCombo_working_time.SetFocus
...
For Each item In SelBks
    ...
    SQL = "SELECT flag_rollable FROM m_shift WHERE shift_code = '" & TDBGrid1.Columns("shift_code").Value & "'"
    ...
    If vFlagRollable = 1 Then
        CnG.Execute "delete from td_shift where company_code = '" _
            & TDBGrid2.Columns("company_code").CellText(item) & "' and employee_code = '" _
            & TDBGrid2.Columns("employee_code").CellText(item) & "'"
    Else
        CnG.Execute "delete from td_shift where company_code = '" _
            & TDBGrid2.Columns("company_code").CellText(item) & "' and shift_number = " _
            & TDBGrid2.Columns("shift_number").Value & " and employee_code = '" _
            & TDBGrid2.Columns("employee_code").CellText(item) & "'"
    End If
Next
CnG.CommitTrans
...
CnG.Execute "delete from tm_shift where company_code = '" _
    ...
    & TDBGrid1.Columns("shift_number").Value
...
Adodc_working_time.Recordset.MoveFirst
Adodc_working_time.Recordset.Find ("shift_code='" & str_code & "'")   ', 0, adSearchForward, 1)
If Not (Adodc_working_time.Recordset.EOF = True Or Adodc_working_time.Recordset.BOF = True) Then
    TDBCombo_working_time.Bookmark = Adodc_working_time.Recordset.AbsolutePosition
    Call TDBCombo_working_time_ItemChange
Else
    TDBCombo_working_time.Text = ""
End If
End Sub

Private Sub cmdEdit_Click()
If rsBound.State = 1 Then rsBound.Close
rsBound.Open "select * from tm_shift where company_code = '" _
& Adodc1.Recordset.Fields("company_code").Value & "' and shift_number=" _
& Adodc1.Recordset.Fields("shift_number").Value, CnG, adOpenKeyset, adLockOptimistic
...
'If get_flag_shift = 0 And Adodc1.Recordset.RecordCount >= 1 Then
'    MsgBox "No need more data for 'working time - general'", vbCritical, headerMSG
'    Exit Sub
'End If

If rsBound.State = 1 Then rsBound.Close
rsBound.Open "select * from tm_shift where shift_number = 'άφ'", CnG, adOpenKeyset, adLockOptimistic
...
Private Function get_next_shift_number() As Long
Dim rs As New ADODB.Recordset

rs.Open "select ifnull(max(shift_number),0)+1 as cur_rec from tm_shift where company_code='" _
& TDBCombo_company.Columns("company_code").Value & "'", CnG, adOpenStatic, adLockReadOnly
get_next_shift_number = rs.Fields("cur_rec").Value
End Function
...
With rsBound
    ...
    .Fields("shift_number").Value = get_next_shift_number
    '-------------------------------------------------------------------------------
    .Fields("shift_date").Value = Format(DTPicker_entry_date.Value, "yyyy-MM-dd HH:mm:ss")
    .Fields("shift_code").Value = TDBCombo_working_time.Columns("shift_code").Value
    .Fields("shift_name").Value = TDBCombo_working_time.Columns("shift_name").Value
    .Fields("start_date").Value = Format(DTPicker_start_date.Value, "yyyy-MM-dd HH:mm:ss")
    .Fields("end_date").Value = Format(DTPicker_end_date.Value, "yyyy-MM-dd HH:mm:ss")
    
    .Fields("flag_shift").Value = TDBCombo_working_time.Columns("flag_shift").Value
    .Fields("flag_enable").Value = cbo_enable.ListIndex
...
cmd_add_dtl.Enabled = c And blnUser_Edit
cmd_delete_dtl.Enabled = c And blnUser_Edit
End Sub
...
If TDBCombo_company.ApproxCount > 0 Then
    ...
    TDBGrid1.Close: TDBGrid2.Close
    Call load_data_header_working_time
    If TDBGrid1.ApproxCount > 0 Then Call TDBGrid1_RowColChange(-1, 0)
...
If TDBCombo_working_time.ApproxCount > 0 Then
    ...
    cbo_type.ListIndex = TDBCombo_working_time.Columns("flag_shift").Value
End If
End Sub
...
Adodc_working_time.RecordSource = "select * from m_shift where flag_shift = " _
& get_flag_shift & " order by shift_code"
...
Adodc1.RecordSource = "select * from tm_shift where company_code='" _
& TDBCombo_company.Columns("company_code").Value & "' order by entry_date desc"
Adodc1.Refresh
...
Adodc2.RecordSource = "select * from v_td_shift where company_code='" _
& TDBGrid1.Columns("company_code").Value & "' and shift_number=" _
& TDBGrid1.Columns("shift_number").Value & " order by shift_number"
Adodc2.Refresh
...
If TDBGrid1.Columns(ColIndex).Caption = "ENTRY DATE" _
Or TDBGrid1.Columns(ColIndex).Caption = "START DATE" _
Or TDBGrid1.Columns(ColIndex).Caption = "END DATE" Then
