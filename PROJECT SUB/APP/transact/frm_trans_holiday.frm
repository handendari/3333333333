...
Begin VB.Form frm_trans_holiday 
   ...
   Begin VB.Frame frmTombol 
      ...
      Begin VB.CommandButton cmd_refresh 
         ...
         Height          =   645
         Left            =   6120
         Picture         =   "frm_trans_holiday.frx":058A
         Style           =   1  'Graphical
         TabIndex        =   7
         Top             =   360
         Visible         =   0   'False
      ...
      Begin VB.CommandButton CmdPrint 
         ...
         Height          =   645
         Left            =   0
         Picture         =   "frm_trans_holiday.frx":0B14
         Style           =   1  'Graphical
         TabIndex        =   5
         Top             =   600
         Visible         =   0   'False
      ...
      Begin prj_absensi.vbButton cmdNew 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frm_trans_holiday.frx":109E
         PICN            =   "frm_trans_holiday.frx":10BA
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   2
         NGREY           =   0   'False
      ...
      Begin prj_absensi.vbButton cmdSave 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frm_trans_holiday.frx":214C
         PICN            =   "frm_trans_holiday.frx":2168
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   2
         NGREY           =   0   'False
      ...
      Begin prj_absensi.vbButton cmdEdit 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frm_trans_holiday.frx":31FA
         PICN            =   "frm_trans_holiday.frx":3216
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   2
         NGREY           =   0   'False
      ...
      Begin prj_absensi.vbButton cmdDelete 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frm_trans_holiday.frx":42A8
         PICN            =   "frm_trans_holiday.frx":42C4
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   2
         NGREY           =   0   'False
      ...
      Begin prj_absensi.vbButton cmdCancel 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frm_trans_holiday.frx":5356
         PICN            =   "frm_trans_holiday.frx":5372
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   2
         NGREY           =   0   'False
      ...
      Begin prj_absensi.vbButton cmdExit 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frm_trans_holiday.frx":6404
         PICN            =   "frm_trans_holiday.frx":6420
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   2
         NGREY           =   0   'False
...
rsBound.Open "select * from t_holiday where holiday_number = " _
& Adodc1.Recordset.Fields("holiday_number").Value, CnG, adOpenKeyset, adLockOptimistic
...
If rsBound.State = 1 Then rsBound.Close
rsBound.Open "select * from t_holiday where holiday_number = -1", CnG, adOpenKeyset, adLockOptimistic
...
With rsBound
    ...
    .Fields("holiday_number").Value = rs.Fields("holiday_number").Value
    '-----------------------------------------------------------------------------
    .Fields("holiday_date").Value = Format(DTPicker_date_holiday.Value, "yyyy-MM-dd HH:mm:ss")
...
Adodc1.RecordSource = "select * from t_holiday order by holiday_number"
Adodc1.Refresh
