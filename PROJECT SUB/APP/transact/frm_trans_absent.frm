...
Begin VB.Form frm_trans_absent 
   ...
   Begin VB.Frame fra_entry 
      ...
      Top             =   4320
      Width           =   14175
      Begin VB.ComboBox cbo_absent_status 
         Height          =   315
         ItemData        =   "frm_trans_absent.frx":058A
         Left            =   8400
         List            =   "frm_trans_absent.frx":0597
         TabIndex        =   1
         Text            =   "..."
         Top             =   480
         Width           =   2895
      ...
      Begin VB.ComboBox cbo_date_to 
         Height          =   315
         ItemData        =   "frm_trans_absent.frx":05B4
         Left            =   10200
         List            =   "frm_trans_absent.frx":05BE
         TabIndex        =   3
         Text            =   "..."
         Top             =   840
         Width           =   1095
   ...
   Begin VB.Frame frmTombol 
      ...
      Begin VB.CommandButton cmd_refresh 
         ...
         Height          =   645
         Left            =   7440
         Picture         =   "frm_trans_absent.frx":05CC
         Style           =   1  'Graphical
         TabIndex        =   15
         Top             =   360
         Visible         =   0   'False
      ...
      Begin VB.CommandButton CmdPrint 
         ...
         Height          =   645
         Left            =   0
         Picture         =   "frm_trans_absent.frx":0B56
         Style           =   1  'Graphical
         TabIndex        =   11
         Top             =   600
         Visible         =   0   'False
      ...
      Begin prj_absensi.vbButton cmdNew 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frm_trans_absent.frx":10E0
         PICN            =   "frm_trans_absent.frx":10FC
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   2
         NGREY           =   0   'False
      ...
      Begin prj_absensi.vbButton cmdSave 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frm_trans_absent.frx":218E
         PICN            =   "frm_trans_absent.frx":21AA
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   2
         NGREY           =   0   'False
      ...
      Begin prj_absensi.vbButton cmdEdit 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frm_trans_absent.frx":323C
         PICN            =   "frm_trans_absent.frx":3258
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   2
         NGREY           =   0   'False
      ...
      Begin prj_absensi.vbButton cmdDelete 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frm_trans_absent.frx":42EA
         PICN            =   "frm_trans_absent.frx":4306
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   2
         NGREY           =   0   'False
      ...
      Begin prj_absensi.vbButton cmdCancel 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frm_trans_absent.frx":5398
         PICN            =   "frm_trans_absent.frx":53B4
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   2
         NGREY           =   0   'False
      ...
      Begin prj_absensi.vbButton cmdExit 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frm_trans_absent.frx":6446
         PICN            =   "frm_trans_absent.frx":6462
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   2
         NGREY           =   0   'False
   ...
   Begin TrueOleDBGrid70.TDBGrid TDBGrid1 
      ...
      _StyleDefs(156) =   "Splits(1).Columns(11).Style:id=54,.parent=99"
   ...
   Begin TrueOleDBList60.TDBCombo TDBCombo_company 
      Height          =   375
      Left            =   1200
      OleObjectBlob   =   "frm_trans_absent.frx":74F4
      TabIndex        =   18
      Top             =   240
      Width           =   1695
   End
...
With Adodc1.Recordset
    ...
    cbo_absent_status.ListIndex = .Fields("absent_status").Value
