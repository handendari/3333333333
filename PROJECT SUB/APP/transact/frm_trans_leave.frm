...
Begin VB.Form frm_trans_leave 
   ...
   Begin VB.Frame fra_entry 
      ...
      Begin VB.ComboBox cbo_date_to 
         Height          =   315
         ItemData        =   "frm_trans_leave.frx":058A
         Left            =   10200
         List            =   "frm_trans_leave.frx":0594
         TabIndex        =   2
         Text            =   "..."
         Top             =   600
         Width           =   1095
   ...
   Begin VB.Frame frmTombol 
      ...
      Begin VB.CommandButton cmd_refresh 
         ...
         Height          =   645
         Left            =   7440
         Picture         =   "frm_trans_leave.frx":05A2
         Style           =   1  'Graphical
         TabIndex        =   14
         Top             =   360
         Visible         =   0   'False
      ...
      Begin VB.CommandButton CmdPrint 
         ...
         Height          =   645
         Left            =   0
         Picture         =   "frm_trans_leave.frx":0B2C
         Style           =   1  'Graphical
         TabIndex        =   10
         Top             =   600
         Visible         =   0   'False
      ...
      Begin prj_absensi.vbButton cmdNew 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frm_trans_leave.frx":10B6
         PICN            =   "frm_trans_leave.frx":10D2
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   2
         NGREY           =   0   'False
      ...
      Begin prj_absensi.vbButton cmdSave 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frm_trans_leave.frx":2164
         PICN            =   "frm_trans_leave.frx":2180
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   2
         NGREY           =   0   'False
      ...
      Begin prj_absensi.vbButton cmdEdit 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frm_trans_leave.frx":3212
         PICN            =   "frm_trans_leave.frx":322E
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   2
         NGREY           =   0   'False
      ...
      Begin prj_absensi.vbButton cmdDelete 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frm_trans_leave.frx":42C0
         PICN            =   "frm_trans_leave.frx":42DC
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   2
         NGREY           =   0   'False
      ...
      Begin prj_absensi.vbButton cmdCancel 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frm_trans_leave.frx":536E
         PICN            =   "frm_trans_leave.frx":538A
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   2
         NGREY           =   0   'False
      ...
      Begin prj_absensi.vbButton cmdExit 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frm_trans_leave.frx":641C
         PICN            =   "frm_trans_leave.frx":6438
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   2
         NGREY           =   0   'False
   ...
   Begin TrueOleDBGrid70.TDBGrid TDBGrid1 
      ...
      Columns(11).DataField=   "leave_date_from"
      ...
      Columns(13).DataField=   "leave_date_to"
   ...
   Begin TrueOleDBList60.TDBCombo TDBCombo_company 
      Height          =   375
      Left            =   1200
      OleObjectBlob   =   "frm_trans_leave.frx":74CA
      TabIndex        =   17
      Top             =   240
      Width           =   1695
   End
...
& TDBCombo_company.Columns("company_code").Value & "' order by leave_number"
Adodc1.Refresh
