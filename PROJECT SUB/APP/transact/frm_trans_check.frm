...
Begin VB.Form frm_trans_manual_check 
   ...
   Begin VB.Frame fra_entry 
      ...
      Begin VB.ComboBox cbo_flag_io 
         Height          =   315
         ItemData        =   "frm_trans_check.frx":058A
         Left            =   8400
         List            =   "frm_trans_check.frx":0594
         TabIndex        =   1
         Text            =   "..."
         Top             =   480
         Width           =   2175
   ...
   Begin VB.Frame frmTombol 
      ...
      Begin VB.CommandButton cmd_refresh 
         ...
         Height          =   645
         Left            =   7440
         Picture         =   "frm_trans_check.frx":05AD
         Style           =   1  'Graphical
         TabIndex        =   13
         Top             =   360
         Visible         =   0   'False
      ...
      Begin VB.CommandButton CmdPrint 
         ...
         Height          =   645
         Left            =   0
         Picture         =   "frm_trans_check.frx":0B37
         Style           =   1  'Graphical
         TabIndex        =   9
         Top             =   600
         Visible         =   0   'False
      ...
      Begin prj_absensi.vbButton cmdNew 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frm_trans_check.frx":10C1
         PICN            =   "frm_trans_check.frx":10DD
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   2
         NGREY           =   0   'False
      ...
      Begin prj_absensi.vbButton cmdSave 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frm_trans_check.frx":216F
         PICN            =   "frm_trans_check.frx":218B
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   2
         NGREY           =   0   'False
      ...
      Begin prj_absensi.vbButton cmdEdit 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frm_trans_check.frx":321D
         PICN            =   "frm_trans_check.frx":3239
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   2
         NGREY           =   0   'False
      ...
      Begin prj_absensi.vbButton cmdDelete 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frm_trans_check.frx":42CB
         PICN            =   "frm_trans_check.frx":42E7
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   2
         NGREY           =   0   'False
      ...
      Begin prj_absensi.vbButton cmdCancel 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frm_trans_check.frx":5379
         PICN            =   "frm_trans_check.frx":5395
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   2
         NGREY           =   0   'False
      ...
      Begin prj_absensi.vbButton cmdExit 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frm_trans_check.frx":6427
         PICN            =   "frm_trans_check.frx":6443
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   2
         NGREY           =   0   'False
   ...
   Begin TrueOleDBGrid70.TDBGrid TDBGrid1 
      ...
      Columns(8).DataField=   "check_number"
      ...
      Columns(13).Caption=   "DESCRIPTION"
      Columns(13).DataField=   "description"
      ...
      Splits(1)._ColumnProps(80)=   "Column(11).Width=3069"
      Splits(1)._ColumnProps(81)=   "Column(11).DividerColor=0"
      Splits(1)._ColumnProps(82)=   "Column(11)._WidthInPix=2990"
      ...
      Splits(1)._ColumnProps(86)=   "Column(12).Width=3307"
      Splits(1)._ColumnProps(87)=   "Column(12).DividerColor=0"
      Splits(1)._ColumnProps(88)=   "Column(12)._WidthInPix=3228"
      Splits(1)._ColumnProps(89)=   "Column(12)._ColStyle=513"
      Splits(1)._ColumnProps(90)=   "Column(12).Order=13"
      Splits(1)._ColumnProps(91)=   "Column(13).Width=5159"
      Splits(1)._ColumnProps(92)=   "Column(13).DividerColor=0"
      Splits(1)._ColumnProps(93)=   "Column(13)._WidthInPix=5080"
      ...
      HeadLines       =   1
      FootLines       =   1
      Caption         =   "LIST OF EMPLOYEE'S MANUAL CHECK"
      MultipleLines   =   0
      CellTipsWidth   =   0
      ...
      _StyleDefs(90)  =   "Splits(1).Style:id=99,.parent=1"
      _StyleDefs(91)  =   "Splits(1).CaptionStyle:id=116,.parent=4,.bgcolor=&H80000002&"
      _StyleDefs(92)  =   ":id=116,.fgcolor=&H80000009&"
      _StyleDefs(93)  =   "Splits(1).HeadingStyle:id=100,.parent=2,.alignment=2,.bgcolor=&H8000000F&"
      _StyleDefs(94)  =   ":id=100,.fgcolor=&H80000002&"
      _StyleDefs(95)  =   "Splits(1).FooterStyle:id=101,.parent=3"
      _StyleDefs(96)  =   "Splits(1).InactiveStyle:id=102,.parent=5"
      _StyleDefs(97)  =   "Splits(1).SelectedStyle:id=104,.parent=6"
      _StyleDefs(98)  =   "Splits(1).EditorStyle:id=103,.parent=7"
      _StyleDefs(99)  =   "Splits(1).HighlightRowStyle:id=105,.parent=8"
      _StyleDefs(100) =   "Splits(1).EvenRowStyle:id=106,.parent=9"
      _StyleDefs(101) =   "Splits(1).OddRowStyle:id=115,.parent=10"
      _StyleDefs(102) =   "Splits(1).RecordSelectorStyle:id=117,.parent=11"
      _StyleDefs(103) =   "Splits(1).FilterBarStyle:id=118,.parent=12"
      _StyleDefs(104) =   "Splits(1).Columns(0).Style:id=122,.parent=99"
      _StyleDefs(105) =   "Splits(1).Columns(0).HeadingStyle:id=119,.parent=100"
      _StyleDefs(106) =   "Splits(1).Columns(0).FooterStyle:id=120,.parent=101"
      _StyleDefs(107) =   "Splits(1).Columns(0).EditorStyle:id=121,.parent=103"
      _StyleDefs(108) =   "Splits(1).Columns(1).Style:id=126,.parent=99"
      _StyleDefs(109) =   "Splits(1).Columns(1).HeadingStyle:id=123,.parent=100"
      _StyleDefs(110) =   "Splits(1).Columns(1).FooterStyle:id=124,.parent=101"
      _StyleDefs(111) =   "Splits(1).Columns(1).EditorStyle:id=125,.parent=103"
      _StyleDefs(112) =   "Splits(1).Columns(2).Style:id=130,.parent=99"
      _StyleDefs(113) =   "Splits(1).Columns(2).HeadingStyle:id=127,.parent=100"
      _StyleDefs(114) =   "Splits(1).Columns(2).FooterStyle:id=128,.parent=101"
      _StyleDefs(115) =   "Splits(1).Columns(2).EditorStyle:id=129,.parent=103"
      _StyleDefs(116) =   "Splits(1).Columns(3).Style:id=134,.parent=99"
      _StyleDefs(117) =   "Splits(1).Columns(3).HeadingStyle:id=131,.parent=100"
      _StyleDefs(118) =   "Splits(1).Columns(3).FooterStyle:id=132,.parent=101"
      _StyleDefs(119) =   "Splits(1).Columns(3).EditorStyle:id=133,.parent=103"
      _StyleDefs(120) =   "Splits(1).Columns(4).Style:id=146,.parent=99"
      _StyleDefs(121) =   "Splits(1).Columns(4).HeadingStyle:id=143,.parent=100"
      _StyleDefs(122) =   "Splits(1).Columns(4).FooterStyle:id=144,.parent=101"
      _StyleDefs(123) =   "Splits(1).Columns(4).EditorStyle:id=145,.parent=103"
      _StyleDefs(124) =   "Splits(1).Columns(5).Style:id=150,.parent=99"
      _StyleDefs(125) =   "Splits(1).Columns(5).HeadingStyle:id=147,.parent=100"
      _StyleDefs(126) =   "Splits(1).Columns(5).FooterStyle:id=148,.parent=101"
      _StyleDefs(127) =   "Splits(1).Columns(5).EditorStyle:id=149,.parent=103"
      _StyleDefs(128) =   "Splits(1).Columns(6).Style:id=154,.parent=99"
      _StyleDefs(129) =   "Splits(1).Columns(6).HeadingStyle:id=151,.parent=100"
      _StyleDefs(130) =   "Splits(1).Columns(6).FooterStyle:id=152,.parent=101"
      _StyleDefs(131) =   "Splits(1).Columns(6).EditorStyle:id=153,.parent=103"
      _StyleDefs(132) =   "Splits(1).Columns(7).Style:id=158,.parent=99"
      _StyleDefs(133) =   "Splits(1).Columns(7).HeadingStyle:id=155,.parent=100"
      _StyleDefs(134) =   "Splits(1).Columns(7).FooterStyle:id=156,.parent=101"
      _StyleDefs(135) =   "Splits(1).Columns(7).EditorStyle:id=157,.parent=103"
      _StyleDefs(136) =   "Splits(1).Columns(8).Style:id=162,.parent=99,.alignment=1"
      _StyleDefs(137) =   "Splits(1).Columns(8).HeadingStyle:id=159,.parent=100"
      _StyleDefs(138) =   "Splits(1).Columns(8).FooterStyle:id=160,.parent=101"
      _StyleDefs(139) =   "Splits(1).Columns(8).EditorStyle:id=161,.parent=103"
      _StyleDefs(140) =   "Splits(1).Columns(9).Style:id=170,.parent=99"
      _StyleDefs(141) =   "Splits(1).Columns(9).HeadingStyle:id=167,.parent=100"
      _StyleDefs(142) =   "Splits(1).Columns(9).FooterStyle:id=168,.parent=101"
      _StyleDefs(143) =   "Splits(1).Columns(9).EditorStyle:id=169,.parent=103"
      _StyleDefs(144) =   "Splits(1).Columns(10).Style:id=174,.parent=99"
      _StyleDefs(145) =   "Splits(1).Columns(10).HeadingStyle:id=171,.parent=100"
      _StyleDefs(146) =   "Splits(1).Columns(10).FooterStyle:id=172,.parent=101"
      _StyleDefs(147) =   "Splits(1).Columns(10).EditorStyle:id=173,.parent=103"
      _StyleDefs(148) =   "Splits(1).Columns(11).Style:id=54,.parent=99,.alignment=2"
      _StyleDefs(149) =   "Splits(1).Columns(11).HeadingStyle:id=51,.parent=100"
      _StyleDefs(150) =   "Splits(1).Columns(11).FooterStyle:id=52,.parent=101"
      _StyleDefs(151) =   "Splits(1).Columns(11).EditorStyle:id=53,.parent=103"
      _StyleDefs(152) =   "Splits(1).Columns(12).Style:id=178,.parent=99,.alignment=2"
      _StyleDefs(153) =   "Splits(1).Columns(12).HeadingStyle:id=175,.parent=100"
      _StyleDefs(154) =   "Splits(1).Columns(12).FooterStyle:id=176,.parent=101"
      _StyleDefs(155) =   "Splits(1).Columns(12).EditorStyle:id=177,.parent=103"
      _StyleDefs(156) =   "Splits(1).Columns(13).Style:id=190,.parent=99"
      _StyleDefs(157) =   "Splits(1).Columns(13).HeadingStyle:id=187,.parent=100"
      _StyleDefs(158) =   "Splits(1).Columns(13).FooterStyle:id=188,.parent=101"
      _StyleDefs(159) =   "Splits(1).Columns(13).EditorStyle:id=189,.parent=103"
      _StyleDefs(160) =   "Named:id=33:Normal"
      _StyleDefs(161) =   ":id=33,.parent=0"
      _StyleDefs(162) =   "Named:id=34:Heading"
      _StyleDefs(163) =   ":id=34,.parent=33,.valignment=2,.bgcolor=&H8000000F&,.fgcolor=&H80000012&"
      _StyleDefs(164) =   ":id=34,.wraptext=-1"
      _StyleDefs(165) =   "Named:id=35:Footing"
      _StyleDefs(166) =   ":id=35,.parent=33,.valignment=2,.bgcolor=&H8000000F&,.fgcolor=&H80000012&"
      _StyleDefs(167) =   "Named:id=36:Selected"
      _StyleDefs(168) =   ":id=36,.parent=33,.bgcolor=&H8000000D&,.fgcolor=&H8000000E&"
      _StyleDefs(169) =   "Named:id=37:Caption"
      _StyleDefs(170) =   ":id=37,.parent=34,.alignment=2"
      _StyleDefs(171) =   "Named:id=38:HighlightRow"
      _StyleDefs(172) =   ":id=38,.parent=33,.bgcolor=&H8000000D&,.fgcolor=&H8000000E&"
      _StyleDefs(173) =   "Named:id=39:EvenRow"
      _StyleDefs(174) =   ":id=39,.parent=33,.bgcolor=&HFFFF00&"
      _StyleDefs(175) =   "Named:id=40:OddRow"
      _StyleDefs(176) =   ":id=40,.parent=33"
      _StyleDefs(177) =   "Named:id=41:RecordSelector"
      _StyleDefs(178) =   ":id=41,.parent=34"
      _StyleDefs(179) =   "Named:id=42:FilterBar"
      _StyleDefs(180) =   ":id=42,.parent=33"
   End
   ...
   Begin TrueOleDBList60.TDBCombo TDBCombo_company 
      Height          =   375
      Left            =   1200
      OleObjectBlob   =   "frm_trans_check.frx":74D5
      TabIndex        =   16
      Top             =   240
      Width           =   1695
   End
...
CnG.BeginTrans
CnG.Execute "delete from t_check where check_number = " _
    & TDBGrid1.Columns("check_number").Value
CnG.CommitTrans
...
rsBound.Open "select * from t_check where check_number = " _
& Adodc1.Recordset.Fields("check_number").Value, CnG, adOpenKeyset, adLockOptimistic
...
If rsBound.State = 1 Then rsBound.Close
rsBound.Open "select * from t_check where check_number = -1", CnG, adOpenKeyset, adLockOptimistic
...
rs.Open "select ifnull(max(check_number),0)+1 as check_number from t_check", CnG, adOpenStatic, adLockReadOnly
...
With rsBound
    ...
    .Fields("check_number").Value = rs.Fields("check_number").Value
    '-----------------------------------------------------------------------------
    .Fields("employee_code").Value = Trim(txt_employee_code)
    .Fields("flag_io").Value = cbo_flag_io.ListIndex
    .Fields("check_date").Value = Format(DTPicker_check.Value, "yyyy-MM-dd HH:mm:ss")
...
Adodc1.RecordSource = "select * from v_t_check where company_code = '" _
& TDBCombo_company.Columns("company_code").Value & "' order by check_number"
Adodc1.Refresh
...
If TDBGrid1.Columns(ColIndex).Caption = "DATE" Then
    Value = Format(Value, "yyyy-mm-dd hh:nn:ss")
End If
End Sub
