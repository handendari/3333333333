...
Begin VB.Form frm_reproccess_download 
   ...
   Begin VB.TextBox txt_company_name 
      ...
      Width           =   3975
   End
   Begin prj_absensi.vbButton cmd_use 
      Height          =   750
      Left            =   5490
      TabIndex        =   14
      Top             =   3120
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "frm_reproccess_download.frx":058A
      PICN            =   "frm_reproccess_download.frx":05A6
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   2
      NGREY           =   0   'False
      ...
      VALUE           =   0   'False
   End
   Begin prj_absensi.vbButton cmd_close 
      Height          =   750
      Left            =   6480
      TabIndex        =   15
      Top             =   3120
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "frm_reproccess_download.frx":1638
      PICN            =   "frm_reproccess_download.frx":1654
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   2
      NGREY           =   0   'False
   ...
   Begin TrueOleDBList60.TDBCombo TDBCombo_company 
      Height          =   375
      Left            =   1110
      OleObjectBlob   =   "frm_reproccess_download.frx":26E6
      TabIndex        =   16
      Top             =   180
      Width           =   1815
   End
   Begin VB.Frame Frame1 
      ...
      Begin VB.Frame fra_employee 
         ...
         Begin prj_absensi.vbButton cmdBrowse 
            ...
            MCOL            =   12632256
            MPTR            =   1
            MICON           =   "frm_reproccess_download.frx":4AF8
            UMCOL           =   -1  'True
            SOFT            =   0   'False
            PICPOS          =   0
            NGREY           =   0   'False
      ...
      Begin VB.ComboBox cbo_employee 
         Height          =   315
         ItemData        =   "frm_reproccess_download.frx":4B14
         Left            =   1200
         List            =   "frm_reproccess_download.frx":4B1E
         TabIndex        =   1
         Text            =   "..."
         Top             =   420
         Width           =   1695
...
Private Sub cbo_employee_Click()
    ...
    txt_employee_name.Text = "": txt_employee_code = ""
End Sub
...
On Error Resume Next
    ...
    If cbo_employee.ListIndex = 0 Then
        ...
        SQL = "INSERT INTO h_log_attendance_recover(att_date, ip_address, enrollnumber, verifymode, " & _
                ...
                "SELECT a.att_date, a.ip_address, a.enrollnumber, a.verifymode, a.flag_io, " & _
                    "a.flag_attendance, a.entry_date " & _
                ...
                "WHERE c.company_code = '" & TDBCombo_company.Columns("company_code").Value & "' " & _
...
Private Sub isiGridKar(pilihan As Integer)
    If pilihan = 1 Then
        ...
        SQL = "select employee_name,employee_code " & _
                "from m_employee a " & _
                "WHERE flag_active <> 0 AND company_code = '" & TDBCombo_company.Columns("company_code").Value & "' " & _
...
'                TDBCombo1.SetFocus
    ...
    Else
        If LynxGrid2.Rows > 0 Then
            txt_employee_code.Text = LynxGrid2.CellText(LynxGrid2.Row, 0)
