...
Begin VB.Form frm_trans_subsidy 
   ...
   Begin VB.Frame fra_entry 
      ...
      Begin VB.Frame Frame1 
         ...
         Begin VB.ComboBox cbo_meal 
            Height          =   315
            ItemData        =   "frm_trans_subsidy.frx":058A
            Left            =   4440
            List            =   "frm_trans_subsidy.frx":0594
            TabIndex        =   26
            Text            =   "opt"
            Top             =   480
            Width           =   1335
         ...
         Begin VB.ComboBox cbo_working_time 
            Height          =   315
            ItemData        =   "frm_trans_subsidy.frx":05A8
            Left            =   4440
            List            =   "frm_trans_subsidy.frx":05AF
            Locked          =   -1  'True
            TabIndex        =   25
            Text            =   "opt"
            Top             =   1920
         ...
         Begin VB.ComboBox cbo_phone_voucher 
            Height          =   315
            ItemData        =   "frm_trans_subsidy.frx":05BB
            Left            =   4440
            List            =   "frm_trans_subsidy.frx":05C5
            TabIndex        =   24
            Text            =   "opt"
            Top             =   1560
            Width           =   1335
         ...
         Begin VB.ComboBox cbo_full_presence 
            Height          =   315
            ItemData        =   "frm_trans_subsidy.frx":05D9
            Left            =   4440
            List            =   "frm_trans_subsidy.frx":05E0
            Locked          =   -1  'True
            TabIndex        =   23
            Text            =   "opt"
            Top             =   1200
         ...
         Begin VB.ComboBox cbo_transport 
            Height          =   315
            ItemData        =   "frm_trans_subsidy.frx":05ED
            Left            =   4440
            List            =   "frm_trans_subsidy.frx":05F7
            TabIndex        =   22
            Text            =   "opt"
            Top             =   840
            Width           =   1335
   ...
   Begin VB.Frame frmTombol 
      ...
      Begin VB.CommandButton cmd_refresh 
         ...
         Height          =   645
         Left            =   7440
         Picture         =   "frm_trans_subsidy.frx":060B
         Style           =   1  'Graphical
         TabIndex        =   14
         Top             =   360
         Width           =   975
      ...
      Begin VB.CommandButton CmdSave 
         ...
         Height          =   645
         Left            =   1800
         Picture         =   "frm_trans_subsidy.frx":0B95
         Style           =   1  'Graphical
         TabIndex        =   5
         Top             =   360
         Width           =   975
      ...
      Begin VB.CommandButton CmdCancel 
         ...
         Height          =   645
         Left            =   5040
         Picture         =   "frm_trans_subsidy.frx":111F
         Style           =   1  'Graphical
         TabIndex        =   8
         Top             =   360
         Width           =   975
      ...
      Begin VB.CommandButton CmdExit 
         ...
         Height          =   645
         Left            =   9600
         Picture         =   "frm_trans_subsidy.frx":16A9
         Style           =   1  'Graphical
         TabIndex        =   10
         Top             =   360
         Width           =   975
      ...
      Begin VB.CommandButton CmdNew 
         ...
         Height          =   645
         Left            =   720
         Picture         =   "frm_trans_subsidy.frx":1C33
         Style           =   1  'Graphical
         TabIndex        =   4
         Top             =   360
         Width           =   975
      ...
      Begin VB.CommandButton CmdPrint 
         ...
         Height          =   645
         Left            =   0
         Picture         =   "frm_trans_subsidy.frx":21BD
         Style           =   1  'Graphical
         TabIndex        =   9
         Top             =   600
         Visible         =   0   'False
      ...
      Begin VB.CommandButton cmdDelete 
         ...
         Height          =   645
         Left            =   3960
         Picture         =   "frm_trans_subsidy.frx":2747
         Style           =   1  'Graphical
         TabIndex        =   7
         Top             =   360
         Width           =   975
      ...
      Begin VB.CommandButton cmdEdit 
         ...
         Height          =   645
         Left            =   2880
         Picture         =   "frm_trans_subsidy.frx":2CD1
         Style           =   1  'Graphical
         TabIndex        =   6
         Top             =   360
         Width           =   975
   ...
   Begin TrueOleDBList60.TDBCombo TDBCombo_company 
      Height          =   375
      Left            =   1200
      OleObjectBlob   =   "frm_trans_subsidy.frx":325B
      TabIndex        =   16
      Top             =   240
      Width           =   1695
   End
   ...
   Begin TrueOleDBGrid70.TDBGrid TDBGrid1 
      ...
      Splits(1)._ColumnProps(60)=   "Column(8)._ColStyle=513"
      ...
      Splits(1)._ColumnProps(70)=   "Column(10)._ColStyle=513"
      ...
      Splits(1)._ColumnProps(80)=   "Column(12)._ColStyle=513"
      ...
      _StyleDefs(115) =   "Splits(1).Columns(4).Style:id=118,.parent=79,.alignment=2"
      ...
      _StyleDefs(123) =   "Splits(1).Columns(6).Style:id=126,.parent=79,.alignment=2"
      ...
      _StyleDefs(131) =   "Splits(1).Columns(8).Style:id=134,.parent=79,.alignment=2"
      ...
      _StyleDefs(139) =   "Splits(1).Columns(10).Style:id=142,.parent=79,.alignment=2"
      ...
      _StyleDefs(147) =   "Splits(1).Columns(12).Style:id=150,.parent=79,.alignment=2"
...
Adodc1.RecordSource = "select * from v_m_subsidy where company_code = '" _
