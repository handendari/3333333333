...
Begin VB.MDIForm mdi_absensi 
   ...
   BackColor       =   &H8000000A&
   Caption         =   "ATTENDANCE & PAYROLL SYSTEM 2.0"
   ClientHeight    =   8535
   ClientLeft      =   165
   ClientTop       =   450
   ClientWidth     =   11280
      ...
      Begin MSComctlLib.ImageList ImageList1 
         ...
         BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
            ...
            BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "mdi_absensi.frx":8A240
               Key             =   ""
            EndProperty
            BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "mdi_absensi.frx":8A7DA
               Key             =   ""
            EndProperty
            BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "mdi_absensi.frx":8AC2C
               Key             =   ""
            EndProperty
         EndProperty
      End
   ...
   Begin VB.PictureBox Picture4 
      ...
      Top             =   0
      Width           =   125
      Begin prj_absensi.vbButton cmd_navigation 
         Height          =   2055
         Left            =   0
         TabIndex        =   7
         Top             =   2640
   ...
   Begin OutlookBar.ctxOutlookBar ctxOutlookBar1 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      FormatControl   =   "mdi_absensi.frx":8CB88
      FormatGroup     =   "mdi_absensi.frx":8CCFC
      FormatGroupHover=   "mdi_absensi.frx":8CE20
      FormatGroupPressed=   "mdi_absensi.frx":8CF30
      FormatGroupSelected=   "mdi_absensi.frx":8D034
      FormatItem      =   "mdi_absensi.frx":8D11C
      FormatItemLargeIcons=   "mdi_absensi.frx":8D22C
      FormatItemHover =   "mdi_absensi.frx":8D328
      FormatItemPressed=   "mdi_absensi.frx":8D410
      FormatItemSelected=   "mdi_absensi.frx":8D4F8
      FormatSmallIcon =   "mdi_absensi.frx":8D5B8
      FormatSmallIconHover=   "mdi_absensi.frx":8D6A0
      FormatSmallIconPressed=   "mdi_absensi.frx":8D79C
      FormatSmallIconSelected=   "mdi_absensi.frx":8D898
      FormatLargeIcon =   "mdi_absensi.frx":8D994
      FormatLargeIconHover=   "mdi_absensi.frx":8DA7C
      FormatLargeIconPressed=   "mdi_absensi.frx":8DB78
      FormatLargeIconSelected=   "mdi_absensi.frx":8DC74
      Groups          =   "mdi_absensi.frx":8DD70
   End
   Begin VB.Menu M01 
      Caption         =   "A1"
   End
...
'    rs2.Open "select * from m_sub_menu where flag_detail=1 order by sub_menu_code asc", CnG, adOpenStatic, adLockReadOnly
    ...
    ctxOutlookBar1.Groups.item("M01").GroupItems.Add "Logout", , , "M01-08"
...
ctlPopMenu.AddItem "Logout", , , , 1, 2, , True
...
Call exec_menu(ctlPopMenu.MenuKey(ItemNumber), ctlPopMenu.Caption(ItemNumber))
End Sub
...
Private Sub exec_menu_backup(ByVal str_key As String, ByVal str_Caption As String)
...
If str_Caption = "Exit" Or str_key = "M01-09" Then
    ...
    Exit Sub
ElseIf str_Caption = "Logout" Or str_key = "M01-08" Then
    vFlagExit = 0
    timer_terminate.Enabled = True
    Exit Sub
End If
...
'---------------------- FILE ----------------
    ...
    If rs1.Fields("form_name").Value = "frm_etc_change_password" Then Call exec_menu_(frm_etc_change_password, rs1.Fields("form_modal").Value)
'--------------------------------------------
...
'------------------- MASTER -----------------
    ...
    If rs1.Fields("form_name").Value = "frm_mst_general" Then Call exec_menu_(frm_mst_general, rs1.Fields("form_modal").Value)
    If rs1.Fields("form_name").Value = "frm_mst_working_day" Then Call exec_menu_(frm_mst_working_day, rs1.Fields("form_modal").Value)
    If rs1.Fields("form_name").Value = "frm_trans_employees_wt" Then Call exec_menu_(frm_trans_employees_wt, rs1.Fields("form_modal").Value)
    If rs1.Fields("form_name").Value = "frm_mst_user" Then Call exec_menu_(frm_mst_user, rs1.Fields("form_modal").Value)
'--------------------------------------------

'------------------ UTILITY -----------------
    If rs1.Fields("form_name").Value = "frm_attendance" Then Call exec_menu_(frm_attendance, rs1.Fields("form_modal").Value)
    ...
    If rs1.Fields("form_name").Value = "frm_trans_leave_periode" Then Call exec_menu_(frm_trans_leave_periode, rs1.Fields("form_modal").Value)
...
'------------------ REPORT ------------------
    ...
    If rs1.Fields("form_name").Value = "frm_rpt_att_detail" Then Call exec_menu_(frm_rpt_att_detail, rs1.Fields("form_modal").Value)
    If rs1.Fields("form_name").Value = "frm_rpt_att_summary" Then Call exec_menu_(frm_rpt_att_summary, rs1.Fields("form_modal").Value)
    If rs1.Fields("form_name").Value = "frm_rpt_leave_summary" Then Call exec_menu_(frm_rpt_leave_summary, rs1.Fields("form_modal").Value)
    If rs1.Fields("form_name").Value = "frm_rpt_log_dl_auto" Then Call exec_menu_(frm_rpt_log_dl_auto, rs1.Fields("form_modal").Value)
'--------------------------------------------
...
Private Sub exec_menu(ByVal str_key As String, ByVal str_Caption As String)
'On Error GoTo err_handle
Dim rs1 As New ADODB.Recordset
Dim str1, str2, stre As String


Call exec_menu_backup(str_key, str_Caption)
'Exit Sub
...
'    If vFlagType = 0 Then
'        If vFlagAuto = 0 Then
'            vLocation = Chr(34) & vLocation & "_Daily_" & Format(Now, "yyyyMMddhhmm") & ".sql" & Chr(34)
'
...
'            vLocation = Chr(34) & vLocation & "_Weekly_" & Format(Now, "yyyyMMddhhmm") & ".sql" & Chr(34)
'
...
'            vLocation = Chr(34) & vLocation & "_Monthly_" & Format(Now, "yyyyMMddhhmm") & ".sql" & Chr(34)
