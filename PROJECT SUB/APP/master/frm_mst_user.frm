...
Begin VB.Form frm_mst_user 
   ...
   Begin VB.Frame fraPasteDtl 
      ...
      Begin VB.ComboBox cboFileName 
         ...
         Width           =   2955
      End
      Begin prj_absensi.vbButton cmd_paste_cancel 
         Height          =   705
         Left            =   3810
         TabIndex        =   51
         Top             =   1260
         ...
         VALUE           =   0   'False
      End
      Begin prj_absensi.vbButton cmd_paste_ok 
         Height          =   705
         Left            =   2760
         TabIndex        =   52
         Top             =   1260
   ...
   Begin VB.Frame fraCopyDtl 
      ...
      Begin VB.TextBox txt_name 
         ...
         Width           =   2895
      End
      Begin prj_absensi.vbButton cmd_copy_cancel 
         Height          =   705
         Left            =   3870
         TabIndex        =   49
         Top             =   1260
         ...
         VALUE           =   0   'False
      End
      Begin prj_absensi.vbButton cmd_copy_ok 
         Height          =   705
         Left            =   2820
         TabIndex        =   47
         Top             =   1260
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      Begin VB.Frame fraAdmin 
         ...
         Begin VB.TextBox txt_company_name 
            ...
            Width           =   4815
         End
         Begin prj_absensi.vbButton cmdNewUser 
            Height          =   705
            Left            =   180
            TabIndex        =   9
            Top             =   6690
            ...
            VALUE           =   0   'False
         End
         Begin prj_absensi.vbButton cmdSimpanUser 
            Height          =   705
            Left            =   1200
            TabIndex        =   10
            Top             =   6690
            ...
            VALUE           =   0   'False
         End
         Begin prj_absensi.vbButton cmdEditUser 
            Height          =   705
            Left            =   2220
            TabIndex        =   11
            Top             =   6690
            ...
            VALUE           =   0   'False
         End
         Begin prj_absensi.vbButton cmdDeleteUser 
            Height          =   705
            Left            =   3240
            TabIndex        =   12
            Top             =   6690
            ...
            VALUE           =   0   'False
         End
         Begin prj_absensi.vbButton cmd_save_dtl 
            Height          =   705
            Left            =   6030
            TabIndex        =   13
            Top             =   6690
         ...
         Begin prj_absensi.vbButton cmd_delete_dtl 
            ...
            VALUE           =   0   'False
         End
         Begin prj_absensi.vbButton cmdGenerate 
            Height          =   705
            Left            =   5010
            TabIndex        =   16
            Top             =   6690
            ...
            VALUE           =   0   'False
         End
         Begin prj_absensi.vbButton cmdCopyDtl 
            Height          =   705
            Left            =   8850
            TabIndex        =   17
            Top             =   6690
            ...
            VALUE           =   0   'False
         End
         Begin prj_absensi.vbButton cmdPasteDtl 
            Height          =   705
            Left            =   9870
            TabIndex        =   18
            Top             =   6690
      ...
      Begin TabDlg.SSTab SSTabUser 
         ...
         TabPicture(0)   =   "frm_mst_user.frx":11378
         ...
         Begin VB.Frame fraTopCmd 
            ...
            Top             =   4950
            Width           =   7935
            Begin prj_absensi.vbButton cmdNewTop 
               Height          =   705
               Left            =   120
               TabIndex        =   41
               Top             =   30
               ...
               MCOL            =   12632256
               MPTR            =   1
               MICON           =   "frm_mst_user.frx":11394
               PICN            =   "frm_mst_user.frx":113B0
               UMCOL           =   -1  'True
               SOFT            =   0   'False
               PICPOS          =   2
               NGREY           =   0   'False
               ...
               VALUE           =   0   'False
            End
            Begin prj_absensi.vbButton cmdSaveTop 
               Height          =   705
               Left            =   1140
               TabIndex        =   42
               Top             =   30
               ...
               MCOL            =   12632256
               MPTR            =   1
               MICON           =   "frm_mst_user.frx":12442
               PICN            =   "frm_mst_user.frx":1245E
               UMCOL           =   -1  'True
               SOFT            =   0   'False
               PICPOS          =   2
               NGREY           =   0   'False
               ...
               VALUE           =   0   'False
            End
            Begin prj_absensi.vbButton cmdEditTop 
               Height          =   705
               Left            =   2160
               TabIndex        =   43
               Top             =   30
               ...
               MCOL            =   12632256
               MPTR            =   1
               MICON           =   "frm_mst_user.frx":134F0
               PICN            =   "frm_mst_user.frx":1350C
               UMCOL           =   -1  'True
               SOFT            =   0   'False
               PICPOS          =   2
               NGREY           =   0   'False
               ...
               VALUE           =   0   'False
            End
            Begin prj_absensi.vbButton cmdDeleteTop 
               Height          =   705
               Left            =   3180
               TabIndex        =   44
               Top             =   30
               ...
               MCOL            =   12632256
               MPTR            =   1
               MICON           =   "frm_mst_user.frx":1459E
               PICN            =   "frm_mst_user.frx":145BA
               UMCOL           =   -1  'True
               SOFT            =   0   'False
               PICPOS          =   2
               NGREY           =   0   'False
   ...
   Begin VB.Image Image2 
      Height          =   585
      Left            =   0
      Picture         =   "frm_mst_user.frx":1564C
      Stretch         =   -1  'True
      Top             =   0
      Width           =   11790
   End
...
Dim v_flag_user As String
    ...
    Else
        ...
        SQL = "select a.*,b.employee_name " & _
...
Private Sub cmd_delete_dtl_Click()
    If Not (TDBGrid_form.ApproxCount > 0 And TDBGrid_form.Bookmark > 0) Then
        Exit Sub
    End If
...
Dim rs1 As New ADODB.Recordset
    SQL = "select count(user_name) as JumlahRec from m_user " & _
            "where company_code = '" & TDBCombo_company.Columns("company_code").Value & "' AND " & _
...
'    CnG.Execute SQL
    ...
    SQL = "Insert into t_user (level_code, sub_menu_code, sub_menu_name, menu_code, menu_name, " & _
            ...
            "Select '" & str_user_code & "', sub_menu_code, sub_menu_name, menu_code, menu_name, form_name, form_title, " & _
                "1,1,1,1,1,1 " & _
            "from m_sub_menu where flag_detail <> 0 AND (sub_menu_code <> 'M03-01' AND sub_menu_code <> 'M03-03') " & _
                "AND ifnull(form_name,'')<>'' and sub_menu_code not in " & _
                "(select sub_menu_code from t_user where level_code = '" & str_user_code & "')"
    CnG.Execute SQL
...
Private Sub SSTab1_Click(PreviousTab As Integer)
    If SSTab1.Tab = 0 Then
        ...
        TDBGrid_User.DataSource = Nothing
        TDBGrid_form.DataSource = Nothing
    Else
        timer1.Enabled = True
    ...
    If pilihan = 1 Then
        ...
        SQL = "select employee_name,employee_code " & _
                ...
                "where a.company_code = '" & TDBCombo_company.Columns("company_code").Value & "' " & _
                    "AND flag_active <> 0 " & _
                    "AND (employee_code LIKE '%" & txtkd_employee.Text & "%' " & _
                    "OR employee_name LIKE '%" & txtkd_employee.Text & "%')"
        rs.Open SQL, CnG, adOpenForwardOnly, adLockReadOnly
        If rs.RecordCount > 0 Then
            LynxGrid2.Redraw = False
            rs.MoveFirst
            While Not rs.EOF
                LynxGrid2.AddItem rs!employee_code & vbTab & rs!EMPLOYEE_NAME
                rs.MoveNext
            Wend
...
'                TDBCombo1.SetFocus
    ...
    Else
        If LynxGrid2.Rows > 0 Then
            txtkd_employee.Text = LynxGrid2.CellText(LynxGrid2.Row, 0)
...
Private Sub txtkd_employee_Change()
    If txtkd_employee.Text = "" Then
        txt_nmemployee.Text = ""
    End If
End Sub

Private Sub txtkd_employee_KeyPress(KeyAscii As Integer)
    If KeyAscii = 13 Then
        isiGridKar (1)
    End If
End Sub
