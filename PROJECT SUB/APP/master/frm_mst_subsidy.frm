...
Begin VB.Form frm_mst_subsidy 
   ...
   Begin VB.Frame fra_entry 
      ...
      Begin VB.Frame Frame1 
         ...
         Begin VB.ComboBox cbo_transport 
            Height          =   315
            ItemData        =   "frm_mst_subsidy.frx":058A
            Left            =   4440
            List            =   "frm_mst_subsidy.frx":0594
            TabIndex        =   33
            Text            =   "opt"
            Top             =   840
            Width           =   1335
         ...
         Begin VB.ComboBox cbo_full_presence 
            Height          =   315
            ItemData        =   "frm_mst_subsidy.frx":05A8
            Left            =   4440
            List            =   "frm_mst_subsidy.frx":05AF
            Locked          =   -1  'True
            TabIndex        =   32
            Text            =   "opt"
            Top             =   1200
         ...
         Begin VB.ComboBox cbo_phone_voucher 
            Height          =   315
            ItemData        =   "frm_mst_subsidy.frx":05BC
            Left            =   4440
            List            =   "frm_mst_subsidy.frx":05C6
            TabIndex        =   31
            Text            =   "opt"
            Top             =   1560
            Width           =   1335
         ...
         Begin VB.ComboBox cbo_working_time 
            Height          =   315
            ItemData        =   "frm_mst_subsidy.frx":05DA
            Left            =   4440
            List            =   "frm_mst_subsidy.frx":05E1
            Locked          =   -1  'True
            TabIndex        =   30
            Text            =   "opt"
            Top             =   1920
         ...
         Begin VB.ComboBox cbo_meal 
            Height          =   315
            ItemData        =   "frm_mst_subsidy.frx":05ED
            Left            =   4440
            List            =   "frm_mst_subsidy.frx":05F7
            TabIndex        =   29
            Text            =   "opt"
            Top             =   480
            Width           =   1335
   ...
   Begin VB.Frame frmTombol 
      ...
      Begin VB.CommandButton cmd_refresh 
         ...
         Height          =   645
         Left            =   7440
         Picture         =   "frm_mst_subsidy.frx":060B
         Style           =   1  'Graphical
         TabIndex        =   15
         Top             =   360
         Width           =   975
      ...
      Begin VB.CommandButton CmdSave 
         ...
         Height          =   645
         Left            =   2160
         Picture         =   "frm_mst_subsidy.frx":0B95
         Style           =   1  'Graphical
         TabIndex        =   6
         Top             =   360
         Width           =   975
      ...
      Begin VB.CommandButton CmdCancel 
         ...
         Height          =   645
         Left            =   5400
         Picture         =   "frm_mst_subsidy.frx":111F
         Style           =   1  'Graphical
         TabIndex        =   9
         Top             =   360
         Width           =   975
      ...
      Begin VB.CommandButton CmdExit 
         ...
         Height          =   645
         Left            =   11520
         Picture         =   "frm_mst_subsidy.frx":16A9
         Style           =   1  'Graphical
         TabIndex        =   11
         Top             =   360
         Width           =   975
      ...
      Begin VB.CommandButton CmdNew 
         ...
         Height          =   645
         Left            =   1080
         Picture         =   "frm_mst_subsidy.frx":1C33
         Style           =   1  'Graphical
         TabIndex        =   5
         Top             =   360
         Width           =   975
      ...
      Begin VB.CommandButton CmdPrint 
         ...
         Height          =   645
         Left            =   8520
         Picture         =   "frm_mst_subsidy.frx":21BD
         Style           =   1  'Graphical
         TabIndex        =   10
         Top             =   360
         Visible         =   0   'False
      ...
      Begin VB.CommandButton cmdDelete 
         ...
         Height          =   645
         Left            =   4320
         Picture         =   "frm_mst_subsidy.frx":2747
         Style           =   1  'Graphical
         TabIndex        =   8
         Top             =   360
         Width           =   975
      ...
      Begin VB.CommandButton cmdEdit 
         ...
         Height          =   645
         Left            =   3240
         Picture         =   "frm_mst_subsidy.frx":2CD1
         Style           =   1  'Graphical
         TabIndex        =   7
         Top             =   360
         Width           =   975
   ...
   Begin TrueOleDBGrid70.TDBGrid TDBGrid1 
      ...
      Columns(1).Caption=   "SUBSIDY NAME"
      ...
      Columns(9).Caption=   "PHONE VOUCHER"
      ...
      Splits(1)._ColumnProps(27)=   "Column(3).Width=2302"
      Splits(1)._ColumnProps(28)=   "Column(3).DividerColor=0"
      Splits(1)._ColumnProps(29)=   "Column(3)._WidthInPix=2223"
      ...
      Splits(1)._ColumnProps(45)=   "Column(6).Width=1746"
      Splits(1)._ColumnProps(46)=   "Column(6).DividerColor=0"
      Splits(1)._ColumnProps(47)=   "Column(6)._WidthInPix=1667"
      ...
      Splits(1)._ColumnProps(57)=   "Column(8).Width=1773"
      Splits(1)._ColumnProps(58)=   "Column(8).DividerColor=0"
      Splits(1)._ColumnProps(59)=   "Column(8)._WidthInPix=1693"
      ...
      Splits(1)._ColumnProps(67)=   "Column(10).Width=1720"
      Splits(1)._ColumnProps(68)=   "Column(10).DividerColor=0"
      Splits(1)._ColumnProps(69)=   "Column(10)._WidthInPix=1640"
      Splits(1)._ColumnProps(70)=   "Column(10)._ColStyle=513"
      Splits(1)._ColumnProps(71)=   "Column(10).Order=11"
      Splits(1)._ColumnProps(72)=   "Column(11).Width=2275"
      Splits(1)._ColumnProps(73)=   "Column(11).DividerColor=0"
      Splits(1)._ColumnProps(74)=   "Column(11)._WidthInPix=2196"
