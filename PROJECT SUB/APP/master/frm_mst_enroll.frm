...
Begin VB.Form frm_mst_enroll 
   ...
   Begin zkemkeeperCtl.CZKEM CZKEM1 
      Height          =   405
      Left            =   7920
      OleObjectBlob   =   "frm_mst_enroll.frx":058A
      TabIndex        =   9
      Top             =   180
      Visible         =   0   'False
      Width           =   345
   ...
   Begin TrueOleDBGrid70.TDBGrid TDBGrid2 
      ...
      Splits(1)._ColumnProps(64)=   "Column(7).Width=3678"
      Splits(1)._ColumnProps(65)=   "Column(7).DividerColor=0"
      Splits(1)._ColumnProps(66)=   "Column(7)._WidthInPix=3598"
   ...
   Begin VB.Frame frmTombol 
      ...
      Begin VB.CommandButton cmdDelete 
         ...
         Height          =   645
         Left            =   11040
         Picture         =   "frm_mst_enroll.frx":05AE
         Style           =   1  'Graphical
         TabIndex        =   4
         Top             =   360
         Visible         =   0   'False
      ...
      Begin VB.CommandButton Command2 
         ...
         Height          =   645
         Left            =   600
         Picture         =   "frm_mst_enroll.frx":0B38
         Style           =   1  'Graphical
         TabIndex        =   2
         Top             =   360
         Visible         =   0   'False
      ...
      Begin VB.Timer Timer1 
         ...
         Top             =   600
      End
      Begin prj_absensi.vbButton cmd_exit 
         Height          =   705
         Left            =   12600
         TabIndex        =   10
         Top             =   360
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frm_mst_enroll.frx":10C2
         PICN            =   "frm_mst_enroll.frx":10DE
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   2
         NGREY           =   0   'False
      ...
      Begin VB.PictureBox Picture1 
         ...
         Width           =   0
      End
      Begin prj_absensi.vbButton cmd_set 
         Height          =   705
         Left            =   7860
         TabIndex        =   12
         Top             =   360
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frm_mst_enroll.frx":2170
         PICN            =   "frm_mst_enroll.frx":218C
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   2
         NGREY           =   0   'False
         ...
         VALUE           =   0   'False
      End
      Begin prj_absensi.vbButton cmd_unset 
         Height          =   705
         Left            =   8910
         TabIndex        =   13
         Top             =   360
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frm_mst_enroll.frx":321E
         PICN            =   "frm_mst_enroll.frx":323A
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   2
         NGREY           =   0   'False
      ...
      Begin prj_absensi.vbButton cmd_download 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frm_mst_enroll.frx":42CC
         PICN            =   "frm_mst_enroll.frx":42E8
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   2
         NGREY           =   0   'False
   ...
   Begin TrueOleDBGrid70.TDBGrid TDBGrid1 
      ...
      Columns(1)._VlistStyle=   0
      Columns(1)._MaxComboItems=   5
      Columns(1).Caption=   "ENROLL NUMBER"
      ...
      Splits(0)._ColumnProps(11)=   "Column(1)._MinWidth=64"
      Splits(0)._ColumnProps(12)=   "Column(2).Width=2672"
      Splits(0)._ColumnProps(13)=   "Column(2).DividerColor=0"
      Splits(0)._ColumnProps(14)=   "Column(2)._WidthInPix=2593"
      ...
      Splits(0)._ColumnProps(22)=   "Column(3)._MinWidth=75697772"
      Splits.Count    =   1
      PrintInfos(0)._StateFlags=   0
      PrintInfos(0).Name=   "piInternal 0"
      PrintInfos(0).PageHeaderFont=   "Size=8.25,Charset=0,Weight=400,Underline=0,Italic=0,Strikethrough=0,Name=Tahoma"
   ...
   Begin TrueOleDBList60.TDBCombo TDBCombo_company 
      Height          =   375
      Left            =   1200
      OleObjectBlob   =   "frm_mst_enroll.frx":537A
      TabIndex        =   7
      Top             =   240
      Width           =   1695
   End
...
Dim vEnrollNumber As Long 'As Integer
Dim vFingerNumber As Long 'As Integer
Dim vEMachineNumber As Long
Dim vPrivilege As Long
Dim vEnrollData As Long
...
vRet = CZKEM1.GetEnrollData(vMachineNumber, vEnrollNumber, vEMachineNumber, _
        vFingerNumber, vPrivilege, vEnrollData, vPassword)
   
If vRet Then
    rs.Open "select * from m_enroll where enrollnumber = " & vEnrollNumber, CnG, adOpenKeyset, adLockOptimistic
    With rs
...
Private Function delete_enroll(ByVal str_e As String) As Boolean
...
'            End If
            ...
            If Ret Then
                CnG.Execute "call spi_m_enroll_link ('" & TDBGrid1.Columns("enrollnumber").CellText(item) & "','" _
                    ...
                    & Replace(.Columns("company_name").Value, "'", "''") & "','" _
                    & Replace(TDBGrid1.Columns("ip_address").Value, "'", "''") & "')"
            End If
        Next
    End With
    CnG.CommitTrans
...
'With TDBGrid2
'    For Each item In SelBks
'        If set_enroll_name(TDBGrid1.Columns("enrollnumber").CellText(item), _
'                .Columns("employee_nick_name").Value, _
'                str(TDBGrid1.Columns("password").Value)) = True Then
'
'            CnG.Execute "call spi_m_enroll_link (" _
'            & TDBGrid1.Columns("enrollnumber").CellText(item) & ",'" _
'            & .Columns("employee_code").Value & "','" _
'            & Replace(.Columns("employee_name").Value, "'", "\'") & "','" _
'            & Replace(.Columns("employee_nick_name").Value, "'", "\'") & "','" _
'            & .Columns("company_code").Value & "','" _
'            & .Columns("company_name").Value & "')"
'
'        End If
'    Next
'End With
...
'Exit Sub
'err_capture:
'MsgBox "Error setting enroll...", vbInformation, headerMSG
'CnG.RollbackTrans
'Call disconnect
'End Sub
...
If CZKEM1.SSR_SetUserInfo(vMachineNumber, dwEnrollNumber, name, passWord, 0, True) Then
...
'Private Function set_enroll_name _
'(ByVal en As Integer, ByVal str As String, ByVal Pwd As String) As Boolean
'Dim iEnrollNumber
'Dim vMachineNumber As Integer
'Dim bEnrollData(1024) As Byte
...
'iEnrollNumber = CLng(en)
'If CZKEM1.SetUserInfo(vMachineNumber, iEnrollNumber, CStr(str), str_pass, 0, True) Then
'    set_enroll_name = True
'Else
'    set_enroll_name = False
'End If
'End Function
...
On Error GoTo Err
    ...
    With TDBGrid2
        For Each item In SelBks
            ...
            If Ret Then _
            CnG.Execute "delete from m_enroll_link where enrollnumber = " & TDBGrid1.Columns("enrollnumber").CellText(item)
        Next
    End With
    CnG.CommitTrans
    Call load_data_enroll
...
'With TDBGrid2
'    For Each item In SelBks
'        If set_enroll_name(TDBGrid1.Columns("enrollnumber").CellText(item), "", "01111") Then _
'        CnG.Execute "delete from m_enroll_link where enrollnumber = " _
'        & TDBGrid1.Columns("enrollnumber").CellText(item)
'    Next
'End With
'CnG.CommitTrans
'Call load_data_enroll
...
'Exit Sub
'err_capture:
'MsgBox "Error unsetting enroll...", vbInformation, headerMSG
'CnG.RollbackTrans
'Call disconnect
'End Sub
...
i = MsgBox("Are you sure want to delete " & SelBks.Count & " enroll data?", vbOKCancel, headerMSG)
...
For Each item In SelBks
    i = i + 1
    If delete_enroll(TDBGrid1.Columns("enrollnumber").CellText(item)) = True Then
...
Next
CnG.CommitTrans
MsgBox i & " enroll's data are successfully deleted", vbInformation, headerMSG
Call load_data_enroll
Call disconnect
...
Adodc2.RecordSource = "select * from m_employee " & _
...
Adodc1.RecordSource = "select * from v_m_enroll order by enrollnumber"
Adodc1.Refresh
...
Public Function get_all_user_info() As Long
            ...
            While CZKEM1.GetAllUserInfo(vMachineNumber, dwEnrollNmber, name, passWord, privilege, Enabled)
                For iBackupNumber = 0 To 9
                    If CZKEM1.GetUserTmpExStr(CLng(vMachineNumber), CStr(dwEnrollNmber), CLng(iBackupNumber), 1, sTmpData, CLng(tmp_len)) Then
                        'Add to DB
                        SQL = "SELECT * FROM m_enroll WHERE EnrollNumber = '" & dwEnrollNmber & "' " & _
                        ...
                        If recFP.RecordCount = 0 Then
                            SQL = "INSERT INTO m_enroll (ip_address, EnrollNumber, EnrollName, EMachineNumber," & _
                                  ...
                                  "VALUES (" & _
                                    "'" & FG_IP_ADDRESS & "','" & dwEnrollNmber & "', '" & name & "'," & _
            ...
            While CZKEM1.SSR_GetAllUserInfo(CLng(vMachineNumber), dwEnrollNmberTFT, name, passWord, privilege, Enabled)
                For iBackupNumber = 0 To 9
                    If CZKEM1.SSR_GetUserTmpStr(CLng(vMachineNumber), dwEnrollNmberTFT, iBackupNumber, sTmpData, CLng(tmp_len)) Then
                        'Add to DB
                        SQL = "SELECT * FROM m_enroll WHERE EnrollNumber = '" & dwEnrollNmberTFT & "' " & _
                                "AND FingerNumber = '" & iBackupNumber & "'"
                        recFP.Open SQL, CnG, adOpenForwardOnly, adLockReadOnly
                        ...
                        If recFP.RecordCount = 0 Then
                            SQL = "INSERT INTO m_enroll (ip_address, EnrollNumber, EnrollName, EMachineNumber," & _
                                    "FingerNumber, Privilige, Password, FPData) " & _
                                  "VALUES (" & _
                                    "'" & FG_IP_ADDRESS & "','" & dwEnrollNmberTFT & "', '" & name & "'," & _
                                    "'" & vMachineNumber & "', '" & iBackupNumber & "', '" & privilege & "'," & _
                                    "'" & passWord & "', '" & sTmpData & "')"
                            CnG.Execute SQL
...
'
'    While CZKEM1.GetAllUserInfo(dwMachineNumber, dwEnrollNmber, name, Pwd, pri, Enabled)
'
''        CnG.Execute "call spi_m_enroll (" & dwEnrollNmber & ",'" _
''        & Replace(name, "'", "\'") & "'," & dwMachineNumber & ", 0, " & privilege & ",'" & passWord & "')"
'
'    CnG.Execute "call spi_m_enroll (" & dwEnrollNmber & ",'" _
'        & Replace(name, "'", "\'") & "'," & dwMachineNumber & ", 0, " & pri & ",'" & Pwd & "')"
'        i = i + 1
'    Wend
'    CnG.CommitTrans
'End If
