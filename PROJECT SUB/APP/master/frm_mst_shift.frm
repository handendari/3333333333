...
Begin VB.Form frm_mst_shift 
   ...
   Begin VB.Frame frmTombol 
      ...
      Begin VB.CommandButton CmdPrint 
         ...
         Height          =   645
         Left            =   0
         Picture         =   "frm_mst_shift.frx":058A
         Style           =   1  'Graphical
         TabIndex        =   13
         Top             =   600
         Visible         =   0   'False
      ...
      Begin VB.CommandButton cmd_refresh 
         ...
         Height          =   645
         Left            =   6480
         Picture         =   "frm_mst_shift.frx":0B14
         Style           =   1  'Graphical
         TabIndex        =   12
         Top             =   360
         Visible         =   0   'False
      ...
      Begin prj_absensi.vbButton cmdNew 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frm_mst_shift.frx":109E
         PICN            =   "frm_mst_shift.frx":10BA
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   2
         NGREY           =   0   'False
      ...
      Begin prj_absensi.vbButton cmdSave 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frm_mst_shift.frx":214C
         PICN            =   "frm_mst_shift.frx":2168
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   2
         NGREY           =   0   'False
      ...
      Begin prj_absensi.vbButton cmdEdit 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frm_mst_shift.frx":31FA
         PICN            =   "frm_mst_shift.frx":3216
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   2
         NGREY           =   0   'False
      ...
      Begin prj_absensi.vbButton cmdDelete 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frm_mst_shift.frx":42A8
         PICN            =   "frm_mst_shift.frx":42C4
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   2
         NGREY           =   0   'False
      ...
      Begin prj_absensi.vbButton cmdCancel 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frm_mst_shift.frx":5356
         PICN            =   "frm_mst_shift.frx":5372
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   2
         NGREY           =   0   'False
      ...
      Begin prj_absensi.vbButton cmdExit 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frm_mst_shift.frx":6404
         PICN            =   "frm_mst_shift.frx":6420
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   2
         NGREY           =   0   'False
   ...
   Begin VB.Frame fra_entry 
      ...
      Begin VB.ComboBox cbo_tolerance 
         Height          =   315
         ItemData        =   "frm_mst_shift.frx":74B2
         Left            =   7440
         List            =   "frm_mst_shift.frx":74BC
         TabIndex        =   20
         Text            =   "..."
         Top             =   2040
         Visible         =   0   'False
      ...
      Begin VB.ComboBox cbo_day_over 
         Height          =   315
         ItemData        =   "frm_mst_shift.frx":74C9
         Left            =   7440
         List            =   "frm_mst_shift.frx":74D3
         TabIndex        =   14
         Text            =   "..."
         Top             =   1440
         Width           =   1575
   ...
   Begin TrueOleDBGrid70.TDBGrid TDBGrid1 
      ...
      Splits(0)._ColumnProps(11)=   "Column(2).Width=3519"
      Splits(0)._ColumnProps(12)=   "Column(2).DividerColor=0"
      Splits(0)._ColumnProps(13)=   "Column(2)._WidthInPix=3440"
      Splits(0)._ColumnProps(14)=   "Column(2)._ColStyle=513"
      Splits(0)._ColumnProps(15)=   "Column(2).Order=3"
      Splits(0)._ColumnProps(16)=   "Column(3).Width=3493"
      Splits(0)._ColumnProps(17)=   "Column(3).DividerColor=0"
      Splits(0)._ColumnProps(18)=   "Column(3)._WidthInPix=3413"
