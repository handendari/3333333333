...
Begin VB.Form frm_mst_general 
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "MASTER WORKING TIME (GENERAL)"
   ClientHeight    =   5655
   ClientLeft      =   -15
   ClientTop       =   270
   ClientWidth     =   12615
   ...
   Begin VB.Frame frmTombol 
      ...
      Begin VB.CommandButton CmdPrint 
         ...
         Height          =   645
         Left            =   0
         Picture         =   "frm_mst_general.frx":058A
         Style           =   1  'Graphical
         TabIndex        =   20
         Top             =   600
         Visible         =   0   'False
      ...
      Begin VB.CommandButton cmd_refresh 
         ...
         Height          =   645
         Left            =   6480
         Picture         =   "frm_mst_general.frx":0B14
         Style           =   1  'Graphical
         TabIndex        =   19
         Top             =   360
         Visible         =   0   'False
      ...
      Begin prj_absensi.vbButton cmdNew 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frm_mst_general.frx":109E
         PICN            =   "frm_mst_general.frx":10BA
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   2
         NGREY           =   0   'False
      ...
      Begin prj_absensi.vbButton cmdSave 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frm_mst_general.frx":214C
         PICN            =   "frm_mst_general.frx":2168
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   2
         NGREY           =   0   'False
      ...
      Begin prj_absensi.vbButton cmdEdit 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frm_mst_general.frx":31FA
         PICN            =   "frm_mst_general.frx":3216
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   2
         NGREY           =   0   'False
      ...
      Begin prj_absensi.vbButton cmdDelete 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frm_mst_general.frx":42A8
         PICN            =   "frm_mst_general.frx":42C4
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   2
         NGREY           =   0   'False
      ...
      Begin prj_absensi.vbButton cmdCancel 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frm_mst_general.frx":5356
         PICN            =   "frm_mst_general.frx":5372
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   2
         NGREY           =   0   'False
      ...
      Begin prj_absensi.vbButton cmdExit 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frm_mst_general.frx":6404
         PICN            =   "frm_mst_general.frx":6420
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   2
         NGREY           =   0   'False
   ...
   Begin VB.Frame fra_entry 
      ...
      Top             =   1560
      Width           =   12135
      Begin VB.ComboBox cbo_rollable 
         Height          =   315
         ItemData        =   "frm_mst_general.frx":74B2
         Left            =   7560
         List            =   "frm_mst_general.frx":74BC
         TabIndex        =   29
         Text            =   "..."
         Top             =   1530
         Width           =   1575
      ...
      Begin VB.ComboBox cbo_tolerance 
         Height          =   315
         ItemData        =   "frm_mst_general.frx":74C9
         Left            =   1800
         List            =   "frm_mst_general.frx":74D3
         TabIndex        =   22
         Text            =   "..."
         Top             =   2160
         Visible         =   0   'False
      ...
      Begin VB.ComboBox cbo_day_over 
         Height          =   315
         ItemData        =   "frm_mst_general.frx":74E0
         Left            =   7560
         List            =   "frm_mst_general.frx":74EA
         TabIndex        =   4
         Text            =   "..."
         Top             =   1170
         Width           =   1575
   ...
   Begin TrueOleDBGrid70.TDBGrid TDBGrid1 
      ...
      Columns(5).Caption=   "ROLLABLE"
      Columns(5).DataField=   "flag_rollable"
      Columns(5)._PropDict=   "_MaxComboItems,516,2;_VlistStyle,514,3"
      Columns(6)._VlistStyle=   4
      Columns(6)._MaxComboItems=   5
      Columns(6).Caption=   "TOLERANCE"
      Columns(6).DataField=   "flag_tolerance"
      Columns(6).NumberFormat=   "FormatText Event"
      Columns(6)._PropDict=   "_MaxComboItems,516,2;_VlistStyle,514,3"
      Columns(7)._VlistStyle=   0
      Columns(7)._MaxComboItems=   5
      Columns(7).Caption=   "IN TOLERANCE"
      Columns(7).DataField=   "start_time_tolerance"
      Columns(7).NumberFormat=   "FormatText Event"
      Columns(7)._PropDict=   "_MaxComboItems,516,2;_VlistStyle,514,3"
      Columns(8)._VlistStyle=   0
      Columns(8)._MaxComboItems=   5
      Columns(8).Caption=   "OUT TOLERANCE"
      Columns(8).DataField=   "end_time_tolerance"
      ...
      Splits(0)._ColumnProps(6)=   "Column(1).Width=6959"
      Splits(0)._ColumnProps(7)=   "Column(1).DividerColor=0"
      Splits(0)._ColumnProps(8)=   "Column(1)._WidthInPix=6879"
      ...
      Splits(0)._ColumnProps(16)=   "Column(3).Width=2434"
      Splits(0)._ColumnProps(17)=   "Column(3).DividerColor=0"
      Splits(0)._ColumnProps(18)=   "Column(3)._WidthInPix=2355"
      ...
      Splits(0)._ColumnProps(26)=   "Column(4).AllowFocus=0"
      Splits(0)._ColumnProps(27)=   "Column(4).Order=5"
      Splits(0)._ColumnProps(28)=   "Column(4)._MinWidth=10"
      Splits(0)._ColumnProps(29)=   "Column(5).Width=1958"
      Splits(0)._ColumnProps(30)=   "Column(5).DividerColor=0"
      Splits(0)._ColumnProps(31)=   "Column(5)._WidthInPix=1879"
      ...
      Splits(0)._ColumnProps(42)=   "Column(6)._MinWidth=54215968"
      ...
      Splits(0)._ColumnProps(46)=   "Column(7).AllowSizing=0"
      Splits(0)._ColumnProps(47)=   "Column(7)._ColStyle=513"
      Splits(0)._ColumnProps(48)=   "Column(7).Visible=0"
      Splits(0)._ColumnProps(49)=   "Column(7).AllowFocus=0"
      Splits(0)._ColumnProps(50)=   "Column(7).Order=8"
      Splits(0)._ColumnProps(51)=   "Column(8).Width=2540"
      Splits(0)._ColumnProps(52)=   "Column(8).DividerColor=0"
      Splits(0)._ColumnProps(53)=   "Column(8)._WidthInPix=2461"
      Splits(0)._ColumnProps(54)=   "Column(8).AllowSizing=0"
      Splits(0)._ColumnProps(55)=   "Column(8)._ColStyle=513"
      Splits(0)._ColumnProps(56)=   "Column(8).Visible=0"
      Splits(0)._ColumnProps(57)=   "Column(8).AllowFocus=0"
      Splits(0)._ColumnProps(58)=   "Column(8).Order=9"
      Splits(0)._ColumnProps(59)=   "Column(8)._MinWidth=60129312"
      Splits.Count    =   1
      ...
      _StyleDefs(58)  =   "Splits(0).Columns(6).Style:id=110,.parent=13,.alignment=2"
   ...
   End
End
Attribute VB_Name = "frm_mst_general"
...
With rsBound
    ...
    .Fields("start_time").Value = Format(DTPicker_start_time.Value, "yyyy-MM-dd HH:mm:ss")
    .Fields("end_time").Value = Format(DTPicker_end_time.Value, "yyyy-MM-dd HH:mm:ss")
    .Fields("flag_day_over").Value = cbo_day_over.ListIndex
    .Fields("flag_rollable").Value = cbo_rollable.ListIndex
    .Fields("flag_tolerance").Value = cbo_tolerance.ListIndex
    If cbo_tolerance.ListIndex Then
        .Fields("start_time_tolerance").Value = Format(DTPicker_in_duration.Value, "yyyy-MM-dd HH:mm:ss")
        .Fields("end_time_tolerance").Value = Format(DTPicker_out_duration.Value, "yyyy-MM-dd HH:mm:ss")
    End If
    .Fields("flag_shift").Value = 0
...
With Adodc1.Recordset
    ...
    cbo_rollable.ListIndex = .Fields("flag_rollable").Value
...
Adodc1.RecordSource = "select * from m_shift where flag_shift=0 order by shift_code"
Adodc1.Refresh
