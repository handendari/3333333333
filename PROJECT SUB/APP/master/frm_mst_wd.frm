...
Begin VB.Form frm_mst_working_day 
   ...
   Caption         =   "MASTER WORKING DAY (GENERAL)"
   ClientHeight    =   5655
   ClientLeft      =   -15
   ClientTop       =   270
   ClientWidth     =   12615
   ...
   Begin VB.Frame frmTombol 
      ...
      Begin prj_absensi.vbButton cmdNew 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frm_mst_wd.frx":109E
         PICN            =   "frm_mst_wd.frx":10BA
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   2
         NGREY           =   0   'False
      ...
      Begin prj_absensi.vbButton cmdSave 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frm_mst_wd.frx":214C
         PICN            =   "frm_mst_wd.frx":2168
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   2
         NGREY           =   0   'False
      ...
      Begin prj_absensi.vbButton cmdEdit 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frm_mst_wd.frx":31FA
         PICN            =   "frm_mst_wd.frx":3216
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   2
         NGREY           =   0   'False
      ...
      Begin prj_absensi.vbButton cmdDelete 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frm_mst_wd.frx":42A8
         PICN            =   "frm_mst_wd.frx":42C4
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   2
         NGREY           =   0   'False
      ...
      Begin prj_absensi.vbButton cmdCancel 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frm_mst_wd.frx":5356
         PICN            =   "frm_mst_wd.frx":5372
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   2
         NGREY           =   0   'False
      ...
      Begin prj_absensi.vbButton cmdExit 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frm_mst_wd.frx":6404
         PICN            =   "frm_mst_wd.frx":6420
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   2
         NGREY           =   0   'False
   ...
   Begin VB.Frame fra_entry 
      ...
      Begin VB.ComboBox cbo_working_day 
         Height          =   315
         ItemData        =   "frm_mst_wd.frx":74B2
         Left            =   2520
         List            =   "frm_mst_wd.frx":74CB
         TabIndex        =   0
         Text            =   "..."
         Top             =   840
         Width           =   2295
      ...
      Begin VB.ComboBox cbo_active 
         Height          =   315
         ItemData        =   "frm_mst_wd.frx":750F
         Left            =   2520
         List            =   "frm_mst_wd.frx":7519
         TabIndex        =   1
         Text            =   "..."
         Top             =   1200
         Width           =   1215
   ...
   Begin TrueOleDBGrid70.TDBGrid TDBGrid1 
      ...
      Splits(0)._ColumnProps(19)=   "Column(3).Width=3704"
      Splits(0)._ColumnProps(20)=   "Column(3).DividerColor=0"
      Splits(0)._ColumnProps(21)=   "Column(3)._WidthInPix=3625"
      Splits(0)._ColumnProps(22)=   "Column(3)._ColStyle=513"
      Splits(0)._ColumnProps(23)=   "Column(3).Order=4"
      Splits(0)._ColumnProps(24)=   "Column(4).Width=3784"
      Splits(0)._ColumnProps(25)=   "Column(4).DividerColor=0"
      Splits(0)._ColumnProps(26)=   "Column(4)._WidthInPix=3704"
      ...
      Splits(0)._ColumnProps(38)=   "Column(6).Width=3598"
      Splits(0)._ColumnProps(39)=   "Column(6).DividerColor=0"
      Splits(0)._ColumnProps(40)=   "Column(6)._WidthInPix=3519"
   ...
   Begin TrueOleDBList60.TDBCombo TDBCombo_working_time 
      Height          =   375
      Left            =   1560
      OleObjectBlob   =   "frm_mst_wd.frx":7526
      TabIndex        =   15
      Top             =   240
      Width           =   1695
   End
...
For i = 0 To 5
    ...
    If i = 0 Then
        ...
        & "', '" & Format(Now, "yyyy-mm-dd ") & Format(rs!end_time, "hh:nn:ss") & "',1"
    Else
...
rs.Close
CnG.Execute "insert into m_working_day(shift_code, day_code, day_name, start_time, end_time, flag_active) " _
...
If rs.State Then rscari.Close
SQL = "SELECT start_time, end_time FROM m_shift " & _
      "WHERE shift_code = '" & TDBCombo_working_time.Columns("shift_code").Value & "'"
rs.Open SQL, CnG, adOpenForwardOnly, adLockReadOnly

If rs.RecordCount > 0 Then
    DTPicker_start_time.Value = rs!start_time
    DTPicker_end_time.Value = rs!end_time
End If
rs.Close
End Sub
