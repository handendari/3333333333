...
Begin VB.Form frm_stg_all 
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      Tab(2).Control(5)=   "cmd_dt_set"
      Tab(2).Control(6)=   "cmd_dt_refresh"
      ...
      Begin VB.CommandButton cmd_update_device_type 
         ...
         Height          =   645
         Left            =   -68160
         Picture         =   "frm_stg_timer_log_data.frx":00A0
         Style           =   1  'Graphical
         TabIndex        =   28
         Top             =   3000
         Width           =   975
      ...
      Begin VB.CommandButton cmd_update_mail 
         ...
         Height          =   645
         Left            =   5760
         Picture         =   "frm_stg_timer_log_data.frx":062A
         Style           =   1  'Graphical
         TabIndex        =   6
         Top             =   4260
         Width           =   975
      ...
      Begin VB.CommandButton cmdSave 
         ...
         Height          =   645
         Left            =   -71400
         Picture         =   "frm_stg_timer_log_data.frx":0BB4
         Style           =   1  'Graphical
         TabIndex        =   2
         Top             =   4080
         Width           =   975
      ...
      Begin VB.CommandButton cmdDelete 
         ...
         Height          =   645
         Left            =   -69240
         Picture         =   "frm_stg_timer_log_data.frx":113E
         Style           =   1  'Graphical
         TabIndex        =   4
         Top             =   4080
         Width           =   975
      ...
      Begin VB.CommandButton CmdNew 
         ...
         Height          =   645
         Left            =   -72480
         Picture         =   "frm_stg_timer_log_data.frx":16C8
         Style           =   1  'Graphical
         TabIndex        =   1
         Top             =   4080
         Width           =   975
      ...
      Begin VB.CommandButton CmdCancel 
         ...
         Height          =   645
         Left            =   -68160
         Picture         =   "frm_stg_timer_log_data.frx":1C52
         Style           =   1  'Graphical
         TabIndex        =   5
         Top             =   4080
         Width           =   975
      ...
      Begin VB.CommandButton cmdEdit 
         ...
         Height          =   645
         Left            =   -70320
         Picture         =   "frm_stg_timer_log_data.frx":21DC
         Style           =   1  'Graphical
         TabIndex        =   3
         Top             =   4080
         Width           =   975
      ...
      Begin VB.CommandButton cmd_dt_refresh 
         ...
         Height          =   645
         Left            =   -69480
         Picture         =   "frm_stg_timer_log_data.frx":2766
         Style           =   1  'Graphical
         TabIndex        =   23
         Top             =   3120
         Width           =   975
      ...
      Begin VB.CommandButton cmd_dt_set 
         ...
         Height          =   645
         Left            =   -68400
         Picture         =   "frm_stg_timer_log_data.frx":2CF0
         Style           =   1  'Graphical
         TabIndex        =   22
         Top             =   3120
         Width           =   975
      ...
      Begin VB.Frame fra_auto_log 
         ...
         Begin VB.Frame fra_entry 
            ...
            Begin VB.ComboBox cbo_auto_log_enable 
               Height          =   315
               ItemData        =   "frm_stg_timer_log_data.frx":327A
               Left            =   1800
               List            =   "frm_stg_timer_log_data.frx":3284
               TabIndex        =   16
               Text            =   "..."
               Top             =   720
               Width           =   1335
      ...
      Begin TrueOleDBList60.TDBCombo TDBCombo_device 
         Height          =   375
         Left            =   -71160
         OleObjectBlob   =   "frm_stg_timer_log_data.frx":3291
         TabIndex        =   27
         Top             =   1920
         Width           =   3735
      End
   ...
   Begin VB.CommandButton cmd_exit 
      ...
      Height          =   645
      Left            =   9600
      Picture         =   "frm_stg_timer_log_data.frx":570E
      Style           =   1  'Graphical
      TabIndex        =   0
      Top             =   4920
      Width           =   975
...
For Each Ctr In Me
    If TypeOf Ctr Is TextBox Or TypeOf Ctr Is TDBText Then
        ...
        And Not LCase(Ctr.name) = "txt_smtp_port" Then
            Ctr.Text = ""
        End If
...
If int_mode = 1 Then        'NEW
    ...
    If DTPicker_download_time.Enabled = True Then
        DTPicker_download_time.SetFocus
    End If
...
strsql = "UPDATE s_mail SET " _
        ...
        & "WHERE s_number = 1"
CnG.Execute (strsql)
'CnG.Execute "delete from s_mail where s_number=1"
'rs1.Open "select * from s_mail where s_number=-77", CnG, adOpenKeyset, adLockOptimistic
'
'rs1.AddNew
'    rs1.Fields("s_number").Value = 1
'    'rs1.Fields("s_smtp").Value = Trim(txt_smtp)
'    rs1.Fields("s_sender_email").Value = Trim(txt_sender_email)
'    rs1.Fields("s_sender_name").Value = Trim(txt_sender_name)
'    'rs1.Fields("s_sender_pwd").Value = Trim(txt_sender_pwd)
'    'rs1.Fields("s_smtp_port").Value = Trim(txt_smtp_port)
'rs1.Update
...
If rs1.RecordCount > 0 Then
    ...
    txt_username.Text = rs1!Username
...
If TDBGrid1.Columns(ColIndex).Caption = "DOWNLOAD TIME" Then
