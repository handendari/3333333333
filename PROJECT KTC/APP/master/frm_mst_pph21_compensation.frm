...
Begin VB.Form frm_mst_pph21_compensation 
   BorderStyle     =   4  'Fixed ToolWindow
   Caption         =   "MASTER PPh PASAL 21 COMPENSATION"
   ClientHeight    =   6690
   ClientLeft      =   -15
   ClientTop       =   240
   ClientWidth     =   11760
   ...
   EndProperty
   Icon            =   "frm_mst_pph21_compensation.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   MinButton       =   0   'False
   ...
   Begin VB.Frame frmTombol 
      ...
      Begin VB.CommandButton cmd_refresh 
         ...
         Height          =   645
         Left            =   7440
         Picture         =   "frm_mst_pph21_compensation.frx":000C
         Style           =   1  'Graphical
         TabIndex        =   12
         Top             =   360
         Width           =   975
      ...
      Begin VB.CommandButton CmdSave 
         ...
         Height          =   645
         Left            =   1800
         Picture         =   "frm_mst_pph21_compensation.frx":0596
         Style           =   1  'Graphical
         TabIndex        =   8
         Top             =   360
         Width           =   975
      ...
      Begin VB.CommandButton CmdCancel 
         ...
         Height          =   645
         Left            =   5040
         Picture         =   "frm_mst_pph21_compensation.frx":0B20
         Style           =   1  'Graphical
         TabIndex        =   11
         Top             =   360
         Width           =   975
      ...
      Begin VB.CommandButton CmdExit 
         ...
         Height          =   645
         Left            =   9600
         Picture         =   "frm_mst_pph21_compensation.frx":10AA
         Style           =   1  'Graphical
         TabIndex        =   13
         Top             =   360
         Width           =   975
      ...
      Begin VB.CommandButton CmdNew 
         ...
         Height          =   645
         Left            =   720
         Picture         =   "frm_mst_pph21_compensation.frx":1634
         Style           =   1  'Graphical
         TabIndex        =   7
         Top             =   360
         Width           =   975
      ...
      Begin VB.CommandButton CmdPrint 
         ...
         Height          =   645
         Left            =   0
         Picture         =   "frm_mst_pph21_compensation.frx":1BBE
         Style           =   1  'Graphical
         TabIndex        =   16
         Top             =   600
         Visible         =   0   'False
      ...
      Begin VB.CommandButton cmdDelete 
         ...
         Height          =   645
         Left            =   3960
         Picture         =   "frm_mst_pph21_compensation.frx":2148
         Style           =   1  'Graphical
         TabIndex        =   10
         Top             =   360
         Width           =   975
      ...
      Begin VB.CommandButton cmdEdit 
         ...
         Height          =   645
         Left            =   2880
         Picture         =   "frm_mst_pph21_compensation.frx":26D2
         Style           =   1  'Graphical
         TabIndex        =   9
         Top             =   360
         Width           =   975
   ...
   Begin TrueOleDBGrid70.TDBGrid TDBGrid1 
      ...
      HeadLines       =   1
      FootLines       =   1
      Caption         =   "LIST OF PPh PASAL 21 COMPENSATION"
      MultipleLines   =   0
      CellTipsWidth   =   0
   ...
   End
End
Attribute VB_Name = "frm_mst_pph21_compensation"
...
str_sql = "select count(pph21_number) as rec_count from m_pph21_comp where pph21_number = " _
& Int(txt_pph21_number)
...
CnG.BeginTrans
CnG.Execute "delete from m_pph21_comp where pph21_number = " _
    & TDBGrid1.Columns("pph21_number").Value
CnG.CommitTrans
...
rsBound.Open "select * from m_pph21_comp where pph21_number = " _
& Adodc1.Recordset.Fields("pph21_number").Value, CnG, adOpenKeyset, adLockOptimistic
...
If rsBound.State = 1 Then rsBound.Close
rsBound.Open "select * from m_pph21_comp where pph21_number = 'άφ'", CnG, adOpenKeyset, adLockOptimistic
...
Adodc1.RecordSource = "select * from m_pph21_comp order by pph21_number"
Adodc1.Refresh
