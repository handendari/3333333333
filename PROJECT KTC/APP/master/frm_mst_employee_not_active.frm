...
Begin VB.Form frm_mst_employee_not_active 
   ...
   ClientTop       =   345
   ClientWidth     =   14685
   Icon            =   "frm_mst_employee_not_active.frx":0000
   LinkTopic       =   "Form2"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   MinButton       =   0   'False
   ...
   Begin VB.Frame fra_entry 
      ...
      Begin VB.ComboBox cbo_shiftable 
         Height          =   315
         ItemData        =   "frm_mst_employee_not_active.frx":000C
         Left            =   10800
         List            =   "frm_mst_employee_not_active.frx":0016
         TabIndex        =   32
         Text            =   "..."
         Top             =   2160
         Width           =   1575
      ...
      Begin VB.Frame fra_last_education 
         ...
         Begin VB.ComboBox cbo_last_education_code 
            Height          =   315
            ItemData        =   "frm_mst_employee_not_active.frx":0023
            Left            =   960
            List            =   "frm_mst_employee_not_active.frx":0048
            TabIndex        =   23
            Text            =   "..."
            Top             =   360
            Width           =   1455
      ...
      Begin VB.ComboBox cbo_religion 
         Height          =   315
         ItemData        =   "frm_mst_employee_not_active.frx":007D
         Left            =   6120
         List            =   "frm_mst_employee_not_active.frx":0093
         TabIndex        =   15
         Text            =   "..."
         Top             =   1560
         Width           =   2775
      ...
      Begin VB.ComboBox cbo_marital_status 
         Height          =   315
         ItemData        =   "frm_mst_employee_not_active.frx":00D7
         Left            =   6120
         List            =   "frm_mst_employee_not_active.frx":00E7
         TabIndex        =   16
         Text            =   "..."
         Top             =   1920
         Width           =   1695
      ...
      Begin VB.ComboBox cbo_sex 
         Height          =   315
         ItemData        =   "frm_mst_employee_not_active.frx":010C
         Left            =   6120
         List            =   "frm_mst_employee_not_active.frx":0116
         TabIndex        =   14
         Text            =   "..."
         Top             =   1200
         Width           =   1695
      ...
      Begin TrueOleDBList60.TDBCombo TDBCombo_title 
         Height          =   375
         Left            =   10800
         OleObjectBlob   =   "frm_mst_employee_not_active.frx":0128
         TabIndex        =   30
         Top             =   1200
         Width           =   1335
      End
      ...
      Begin TrueOleDBList60.TDBCombo TDBCombo_department 
         Height          =   375
         Left            =   1560
         OleObjectBlob   =   "frm_mst_employee_not_active.frx":20D8
         TabIndex        =   5
         Top             =   1620
         Width           =   1695
      End
      Begin TrueOleDBList60.TDBCombo TDBCombo_division 
         Height          =   375
         Left            =   1560
         OleObjectBlob   =   "frm_mst_employee_not_active.frx":4099
         TabIndex        =   6
         Top             =   2640
         Width           =   1695
      End
   ...
   Begin prj_fej_jkt.vbButton btnChange 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "frm_mst_employee_not_active.frx":6058
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin VB.Frame frmTombol 
      ...
      Begin VB.CommandButton cmd_update 
         ...
         Height          =   645
         Left            =   9000
         Picture         =   "frm_mst_employee_not_active.frx":6074
         Style           =   1  'Graphical
         TabIndex        =   45
         Top             =   360
         Width           =   975
      ...
      Begin VB.CommandButton cmdEdit 
         ...
         Height          =   645
         Left            =   3240
         Picture         =   "frm_mst_employee_not_active.frx":65FE
         Style           =   1  'Graphical
         TabIndex        =   41
         Top             =   360
         Width           =   975
      ...
      Begin VB.CommandButton cmdDelete 
         ...
         Height          =   645
         Left            =   4320
         Picture         =   "frm_mst_employee_not_active.frx":6B88
         Style           =   1  'Graphical
         TabIndex        =   42
         Top             =   360
         Width           =   975
      ...
      Begin VB.CommandButton CmdNew 
         ...
         Height          =   645
         Left            =   1080
         Picture         =   "frm_mst_employee_not_active.frx":7112
         Style           =   1  'Graphical
         TabIndex        =   39
         Top             =   360
         Width           =   975
      ...
      Begin VB.CommandButton CmdExit 
         ...
         Height          =   645
         Left            =   11520
         Picture         =   "frm_mst_employee_not_active.frx":769C
         Style           =   1  'Graphical
         TabIndex        =   46
         Top             =   360
         Width           =   975
      ...
      Begin VB.CommandButton CmdCancel 
         ...
         Height          =   645
         Left            =   5400
         Picture         =   "frm_mst_employee_not_active.frx":7C26
         Style           =   1  'Graphical
         TabIndex        =   43
         Top             =   360
         Width           =   975
      ...
      Begin VB.CommandButton CmdSave 
         ...
         Height          =   645
         Left            =   2160
         Picture         =   "frm_mst_employee_not_active.frx":81B0
         Style           =   1  'Graphical
         TabIndex        =   40
         Top             =   360
         Width           =   975
      ...
      Begin VB.CommandButton cmd_import 
         ...
         Height          =   645
         Left            =   7920
         Picture         =   "frm_mst_employee_not_active.frx":873A
         Style           =   1  'Graphical
         TabIndex        =   44
         Top             =   360
         Width           =   975
      ...
      Begin VB.CommandButton CmdPrint 
         ...
         Height          =   645
         Left            =   0
         Picture         =   "frm_mst_employee_not_active.frx":8CC4
         Style           =   1  'Graphical
         TabIndex        =   54
         Top             =   600
         Visible         =   0   'False
   ...
   Begin TrueOleDBList60.TDBCombo TDBCombo_company 
      Height          =   375
      Left            =   1560
      OleObjectBlob   =   "frm_mst_employee_not_active.frx":924E
      TabIndex        =   1
      Top             =   240
      Width           =   1155
   End
   Begin TrueOleDBList60.TDBCombo TDBCombo_company1 
      Height          =   375
      Left            =   7110
      OleObjectBlob   =   "frm_mst_employee_not_active.frx":B20C
      TabIndex        =   101
      Top             =   240
      Width           =   1155
   End
   ...
   End
End
Attribute VB_Name = "frm_mst_employee_not_active"
...
'    strsQL = "UPDATE m_employee set employee_code = '" & Trim(txt_employee_code) & "',employee_name = '" & Trim(txt_employee_name) & "'," _
'        & "employee_nick_name = '" & Trim(txt_employee_nick_name) & "',company_code = '" & TDBCombo_company1.Columns("company_code").Value & "', " _
'        & "company_name = '" & Trim(txt_company_name) & "',department_code = '" & TDBCombo_department.Columns("department_code").Value & "'," _
'        & "department_name = '" & Trim(txt_department_name) & "',division_code = '" & TDBCombo_division.Columns("division_code").Value & "'," _
'        & "division_name = '" & Trim(txt_division_name) & "',date_of_birth = '" & Format(DTPicker_birth.Value, "yyyy-MM-dd HH:mm:ss") & "'," _
...
'        & "title_name = '" & Trim(txt_title_name) & "',flag_shiftable = '" & cbo_shiftable.ListIndex & "',description = '" & Trim(txt_description) & "', " _
'        & "flag_active = '" & IIf(opt_active, 1, 0) & "'," _
'        & "end_working = '" & IIf(opt_not_active, Format(DTPicker_end_working.Value, "yyyy-MM-dd HH:mm:ss"), "00:00:00") & "',reason = '" & IIf(opt_not_active, Trim(txt_end_working_reason), Null) & "', " _
'        & "fathers_name = '" & Trim(txt_fathers_name) & "',mothers_name = '" & Trim(txt_mothers_name) & "',child_number = '" & Val(txt_child_number) & "',child_number_from = '" & Val(txt_child_number_from) & "',managerial_level = '" & Check1.Value & "' " _
'        & "WHERE employee_code = '" & Adodc1.Recordset.Fields("employee_code").Value & "'"
'    CnG.Execute strsQL
        strsql = "UPDATE m_employee set employee_code = '" & Trim(txt_employee_code) & "',employee_name = '" & Trim(txt_employee_name) & "'," _
            & "employee_nick_name = '" & Trim(txt_employee_nick_name) & "',company_code = '" & TDBCombo_company1.Columns("company_code").Value & "', " _
            & "company_name = '" & Trim(txt_company_name1) & "',department_code = '" & TDBCombo_department.Columns("department_code").Value & "'," _
            & "department_name = '" & Trim(txt_department_name) & "',division_code = '" & TDBCombo_division.Columns("division_code").Value & "'," _
            & "division_name = '" & Trim(txt_division_name) & "',date_of_birth = '" & Format(DTPicker_birth.Value, "yyyy-MM-dd HH:mm:ss") & "'," _
            & "place_of_birth = '" & Trim(txt_place_of_birth) & "',sex = '" & cbo_sex.ListIndex & "',religion = '" & cbo_religion.ListIndex & "'," _
            & "marital_status = '" & cbo_marital_status.ListIndex & "',number_of_children = '" & Val(DropAllComma(txt_number_of_children)) & "'," _
            ...
            & "end_working = '" & IIf(opt_not_active.Value, Format(DTPicker_end_working.Value, "yyyy-MM-dd HH:mm:ss"), "0000-00-00") & "', " _
    ...
    Else
        strsql = "UPDATE m_employee set employee_code = '" & Trim(txt_employee_code) & "',employee_name = '" & Trim(txt_employee_name) & "'," _
            ...
            & "company_name = '" & Trim(txt_company_name) & "',department_code = '" & IIf(IsNull(TDBCombo_department.Columns("department_code").Value), "N/A", TDBCombo_department.Columns("department_code").Value) & "'," _
            & "department_name = '" & Trim(txt_department_name) & "',division_code = '" & TDBCombo_division.Columns("division_code").Value & "'," _
            & "division_name = '" & Trim(txt_division_name) & "',date_of_birth = '" & Format(DTPicker_birth.Value, "yyyy-MM-dd HH:mm:ss") & "'," _
            & "place_of_birth = '" & Trim(txt_place_of_birth) & "',sex = '" & cbo_sex.ListIndex & "',religion = '" & cbo_religion.ListIndex & "'," _
            & "marital_status = '" & cbo_marital_status.ListIndex & "',number_of_children = '" & Val(DropAllComma(txt_number_of_children)) & "'," _
...
Adodc1.RecordSource = "SELECT  a.employee_code,a.employee_name,a.employee_nick_name,a.division_code," _
                ...
                & "a.date_of_appointment,a.title_code,a.title_name,a.flag_shiftable," _
                ...
                & "a.child_number_from , a.child_number, a.start_mc, a.end_mc " _
            ...
            & "JOIN m_division d ON a.division_code = d.division_code AND d.department_code = c.department_code AND d.company_code = b.company_code " _
            & "where a.company_code = '" _
            & TDBCombo_company.Columns("company_code").Value & "' " _
            & "AND a.flag_active = 0 order by a.employee_code"
