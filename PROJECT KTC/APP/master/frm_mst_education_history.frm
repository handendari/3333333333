...
Begin VB.Form frm_mst_education_history 
   ...
   Begin VB.Frame fra_entry 
      ...
      Begin VB.ComboBox cbo_status 
         Height          =   315
         ItemData        =   "frm_mst_education_history.frx":000C
         Left            =   6960
         List            =   "frm_mst_education_history.frx":0016
         TabIndex        =   7
         Top             =   2760
         Width           =   1575
      End
   ...
   Begin VB.Frame frmTombol 
      ...
      Begin VB.CommandButton cmdEdit 
         ...
         Height          =   645
         Left            =   4680
         Picture         =   "frm_mst_education_history.frx":002A
         Style           =   1  'Graphical
         TabIndex        =   10
         Top             =   360
         Width           =   975
      ...
      Begin VB.CommandButton cmdDelete 
         ...
         Height          =   645
         Left            =   5760
         Picture         =   "frm_mst_education_history.frx":05B4
         Style           =   1  'Graphical
         TabIndex        =   11
         Top             =   360
         Width           =   975
      ...
      Begin VB.CommandButton CmdNew 
         ...
         Height          =   645
         Left            =   2520
         Picture         =   "frm_mst_education_history.frx":0B3E
         Style           =   1  'Graphical
         TabIndex        =   8
         Top             =   360
         Width           =   975
      ...
      Begin VB.CommandButton CmdCancel 
         ...
         Height          =   645
         Left            =   6840
         Picture         =   "frm_mst_education_history.frx":10C8
         Style           =   1  'Graphical
         TabIndex        =   12
         Top             =   360
         Width           =   975
      ...
      Begin VB.CommandButton CmdSave 
         ...
         Height          =   645
         Left            =   3600
         Picture         =   "frm_mst_education_history.frx":1652
         Style           =   1  'Graphical
         TabIndex        =   9
         Top             =   360
         Width           =   975
      ...
      Begin VB.CommandButton cmd_exit 
         ...
         Height          =   645
         Left            =   11520
         Picture         =   "frm_mst_education_history.frx":1BDC
         Style           =   1  'Graphical
         TabIndex        =   13
         Top             =   360
         Width           =   975
      ...
      Begin zkemkeeperCtl.CZKEM CZKEM1 
         Height          =   375
         Left            =   0
         OleObjectBlob   =   "frm_mst_education_history.frx":2166
         TabIndex        =   16
         Top             =   600
         Visible         =   0   'False
         Width           =   255
