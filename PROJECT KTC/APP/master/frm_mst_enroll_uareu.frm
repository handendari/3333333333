...
Begin VB.Form frm_mst_enroll_uareu 
   ...
   Begin VB.Frame frmTombol 
      ...
      Begin VB.CommandButton cmd_verify 
         ...
         Height          =   645
         Left            =   9720
         Picture         =   "frm_mst_enroll_uareu.frx":000C
         Style           =   1  'Graphical
         TabIndex        =   3
         Top             =   360
         Width           =   975
      ...
      Begin VB.CommandButton cmd_set_finger 
         ...
         Height          =   645
         Left            =   8640
         Picture         =   "frm_mst_enroll_uareu.frx":0596
         Style           =   1  'Graphical
         TabIndex        =   2
         Top             =   360
         Width           =   975
      ...
      Begin VB.CommandButton cmd_unset 
         ...
         Height          =   645
         Left            =   4080
         Picture         =   "frm_mst_enroll_uareu.frx":0B20
         Style           =   1  'Graphical
         TabIndex        =   15
         Top             =   840
         Visible         =   0   'False
      ...
      Begin VB.CommandButton cmdDelete 
         ...
         Height          =   645
         Left            =   10800
         Picture         =   "frm_mst_enroll_uareu.frx":10AA
         Style           =   1  'Graphical
         TabIndex        =   4
         Top             =   360
         Width           =   975
      ...
      Begin VB.CommandButton cmd_download 
         ...
         Height          =   645
         Left            =   5280
         Picture         =   "frm_mst_enroll_uareu.frx":1634
         Style           =   1  'Graphical
         TabIndex        =   10
         Top             =   840
         Visible         =   0   'False
      ...
      Begin VB.CommandButton Command2 
         ...
         Height          =   645
         Left            =   600
         Picture         =   "frm_mst_enroll_uareu.frx":1BBE
         Style           =   1  'Graphical
         TabIndex        =   7
         Top             =   360
         Visible         =   0   'False
      ...
      Begin VB.CommandButton cmd_set 
         ...
         Height          =   645
         Left            =   3000
         Picture         =   "frm_mst_enroll_uareu.frx":2148
         Style           =   1  'Graphical
         TabIndex        =   8
         Top             =   840
         Visible         =   0   'False
      ...
      Begin VB.CommandButton cmd_exit 
         ...
         Height          =   645
         Left            =   12720
         Picture         =   "frm_mst_enroll_uareu.frx":26D2
         Style           =   1  'Graphical
         TabIndex        =   5
         Top             =   360
         Width           =   975
      ...
      Begin zkemkeeperCtl.CZKEM CZKEM1 
         Height          =   375
         Left            =   0
         OleObjectBlob   =   "frm_mst_enroll_uareu.frx":2C5C
         TabIndex        =   9
         Top             =   600
         Visible         =   0   'False
         Width           =   255
