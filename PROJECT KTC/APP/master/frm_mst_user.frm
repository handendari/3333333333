...
Begin VB.Form frm_mst_user 
   ...
   Begin VB.Frame fraAdmin 
      ...
      Begin GridEX20.GridEX GridEXForm 
         ...
         ColumnsCount    =   2
         Column(1)       =   "frm_mst_user.frx":2C5C
         Column(2)       =   "frm_mst_user.frx":2D24
         FormatStylesCount=   6
         FormatStyle(1)  =   "frm_mst_user.frx":2DC8
         FormatStyle(2)  =   "frm_mst_user.frx":2EF0
         FormatStyle(3)  =   "frm_mst_user.frx":2FA0
         FormatStyle(4)  =   "frm_mst_user.frx":3054
         FormatStyle(5)  =   "frm_mst_user.frx":312C
         FormatStyle(6)  =   "frm_mst_user.frx":31E4
         ImageCount      =   0
         PrinterProperties=   "frm_mst_user.frx":32C4
      End
      Begin TrueOleDBList60.TDBCombo TDBCombo_company 
         Height          =   375
         Left            =   2010
         OleObjectBlob   =   "frm_mst_user.frx":349C
         TabIndex        =   0
         Top             =   480
         Width           =   1695
      End
      ...
      Begin VB.Frame fra_EntryUser 
         ...
         Begin VB.ComboBox cbo_user_level 
            ...
            EndProperty
            Height          =   315
            ItemData        =   "frm_mst_user.frx":5402
            Left            =   8280
            List            =   "frm_mst_user.frx":540C
            TabIndex        =   8
            Text            =   "Pilihan"
            Top             =   480
            Width           =   1575
      ...
      Begin GridEX20.GridEX GridEXUser 
         ...
         IntProp1        =   0
         ColumnsCount    =   2
         Column(1)       =   "frm_mst_user.frx":541D
         Column(2)       =   "frm_mst_user.frx":54E5
         FormatStylesCount=   6
         FormatStyle(1)  =   "frm_mst_user.frx":5589
         FormatStyle(2)  =   "frm_mst_user.frx":56B1
         FormatStyle(3)  =   "frm_mst_user.frx":5761
         FormatStyle(4)  =   "frm_mst_user.frx":5815
         FormatStyle(5)  =   "frm_mst_user.frx":58ED
         FormatStyle(6)  =   "frm_mst_user.frx":59A5
         ImageCount      =   0
         PrinterProperties=   "frm_mst_user.frx":5A85
      End
   ...
   Begin VB.Frame fraTop 
      ...
      Begin TabDlg.SSTab SSTabUser 
         ...
         TabPicture(0)   =   "frm_mst_user.frx":5C5D
         Tab(0).ControlEnabled=   -1  'True
         Tab(0).Control(0)=   "GridEXTop"
         Tab(0).Control(0).Enabled=   0   'False
         Tab(0).Control(1)=   "fraEntryTop"
         ...
         Begin VB.Frame fraTopCmd 
            ...
            Top             =   3660
            Width           =   7935
            Begin VB.CommandButton cmdDeleteTop 
               Caption         =   "&Delete"
               Height          =   555
               Left            =   2040
               Picture         =   "frm_mst_user.frx":5C79
               Style           =   1  'Graphical
               TabIndex        =   45
               Top             =   120
               Width           =   855
            End
            Begin VB.CommandButton cmdNewTop 
               Caption         =   "&New"
               Height          =   555
               Left            =   120
               Picture         =   "frm_mst_user.frx":6203
               Style           =   1  'Graphical
               TabIndex        =   44
               Top             =   120
               Width           =   855
            End
            Begin VB.CommandButton cmdEditTop 
               Caption         =   "&Edit"
               Height          =   555
               Left            =   1080
               Picture         =   "frm_mst_user.frx":678D
               Style           =   1  'Graphical
               TabIndex        =   17
               Top             =   120
               Width           =   855
            End
            Begin VB.CommandButton cmdSaveTop 
               Caption         =   "&Save"
               Height          =   555
               Left            =   3000
               Picture         =   "frm_mst_user.frx":6D17
               Style           =   1  'Graphical
               TabIndex        =   18
               Top             =   120
               Width           =   855
         ...
         Begin VB.Frame fraEntryTop 
            ...
            Visible         =   0   'False
            Width           =   7575
            Begin VB.TextBox txt_full_name 
               Appearance      =   0  'Flat
               BackColor       =   &H80000014&
               Height          =   300
               Left            =   2280
            ...
            Begin VB.TextBox txtNamaTop 
               ...
               Width           =   3855
            End
            Begin VB.TextBox txtPasswordTop 
               Appearance      =   0  'Flat
               BackColor       =   &H80000014&
               Height          =   300
               IMEMode         =   3  'DISABLE
            ...
            End
         End
         Begin GridEX20.GridEX GridEXTop 
            Height          =   1455
            Left            =   1680
            TabIndex        =   26
            Top             =   1020
            ...
            IntProp1        =   0
            ColumnsCount    =   2
            Column(1)       =   "frm_mst_user.frx":72A1
            Column(2)       =   "frm_mst_user.frx":7369
            FormatStylesCount=   6
            FormatStyle(1)  =   "frm_mst_user.frx":740D
            FormatStyle(2)  =   "frm_mst_user.frx":7535
            FormatStyle(3)  =   "frm_mst_user.frx":75E5
            FormatStyle(4)  =   "frm_mst_user.frx":7699
            FormatStyle(5)  =   "frm_mst_user.frx":7771
            FormatStyle(6)  =   "frm_mst_user.frx":7829
            ImageCount      =   0
            PrinterProperties=   "frm_mst_user.frx":7909
         End
      End
   End
End
...
Private Sub fill_grid_top_user()
Dim rs1 As New ADODB.Recordset
Dim cmd1 As New ADODB.Command
Set cmd1.ActiveConnection = CnG
cmd1.CommandText = "select * from m_user where user_level = 100"
...
'cmd1.CommandText = "select *, case when user_level=1 then 'User' else 'Admin' end as level " _
'& "from m_user where user_level <> 100 order by user_name"

cmd1.CommandText = "select *, case when user_level=1 then 'User' else 'Admin' end as level " & _
                    "from m_user " & _
                    "where company_code = '" & TDBCombo_company.Columns("company_code").Value & "' " & _
                        "AND user_level <> 100 " & _
                    "order by user_name"
rs1.CursorLocation = adUseClient
rs1.Open cmd1, , adOpenStatic, adLockBatchOptimistic
...
Private Sub ShowWindowEntryForm(ByVal i As Boolean)
'If i = True Then ' Max
'    fraEntryForm.Visible = True
''    GridEXF.Height = 1215
'ElseIf i = False Then ' Min
'    fraEntryForm.Visible = False
''    GridEXF.Height = 2415
'End If
End Sub
...
If GridEXTop.RowCount < 1 Or GridEXTop.Row < 1 Then Exit Sub

Dim i As Integer
i = MsgBox("Are you sure want to delete data '" _
    & GridEXTop.Value(GridEXTop.Columns("user_name").ColPosition) & "' ?", vbOKCancel, headerMSG)

If i = vbOK Then
    
    CnG.Execute "delete from m_user where user_code = '" _
    & GridEXTop.Value(GridEXTop.Columns("user_code").ColPosition) & "'"
    
    Call fill_grid_top_user
End If
End Sub
...
If i = vbOK Then
    CnG.Execute "delete from t_user where user_code = '" _
...
If Not GridEXTop.RowCount > 0 Then Exit Sub

If cmdEditTop.Caption = "&Edit" Then
    cmdEditTop.Caption = "&Cancel"
    Call EnableButtonEntryTop(False, True, False, True)
    Call ShowWindowEntryTop(True)
    
    fraEntryTop.Caption = "Edit"
    txtNamaTop = GridEXTop.Value(GridEXTop.Columns("user_name").ColPosition)
    txtPasswordTop = RC4DeCryptASC(Replace(Trim(GridEXTop.Value(GridEXTop.Columns("user_pass").ColPosition)), Chr(39), Chr(96)), pEncryptionPassword)
    txtNamaTop.SelStart = 0
    txtNamaTop.SelLength = Len(Trim(txtNamaTop))
    txtNamaTop.SetFocus
    Call EnabledOptionTop(False)
Else
    cmdEditTop.Caption = "&Edit"
    Call EnableButtonEntryTop(True, True, True, False)
    Call ShowWindowEntryTop(False)
...
If cmdEditUser.Caption = "&Edit" Then
    ...
    txt_fullname = IIf(IsNull(GridEXUser.Value(GridEXUser.Columns("full_name").ColPosition)), "", GridEXUser.Value(GridEXUser.Columns("full_name").ColPosition))
...
int_level = GridEXUser.Value(GridEXUser.Columns("user_level").ColPosition)
...
'str1 = "Insert into t_user (user_code, sub_menu_code, sub_menu_name, menu_code, menu_name, " _
...
'& "case when user_level<=" & int_level & " then 1 else 0 end, " _
'& "case when user_level<=" & int_level & " then 1 else 0 end " _
'& "from m_sub_menu where ifnull(form_name,'')<>'' and sub_menu_code not in " _
'& "(select sub_menu_code from t_user where user_code = '" & str_user_code & "')"

str1 = "Insert into t_user (user_code, sub_menu_code, sub_menu_name, menu_code, menu_name, " _
& "form_name, form_title, allow_read, allow_add, allow_edit, allow_delete, allow_post, allow_print) " _
& "Select '" & str_user_code & "', sub_menu_code, sub_menu_name, menu_code, menu_name, form_name, form_title, " _
& "1,1,1,1,1,1 " _
& "from m_sub_menu where (sub_menu_code <> 'M02-01' AND sub_menu_code <> 'M02-02' AND " _
& "sub_menu_code <> 'M01-01' AND sub_menu_code <> 'M02-03') AND ifnull(form_name,'')<>'' and sub_menu_code not in " _
& "(select sub_menu_code from t_user where user_code = '" & str_user_code & "')"
...
Private Function CekValidateDataTop() As Boolean
If Not Trim(txtNamaTop) = "" And Not Trim(txtPasswordTop) = "" Then
    CekValidateDataTop = True
Else
    CekValidateDataTop = False
End If
End Function

Private Function CekValidateDataForm() As Boolean
'If Not Trim(txtNamaForm) = "" And Not Trim(txt_form_title) = "" _
'    And cboLevelForm.ListIndex >= 0 _
'    And Not Trim(cboLevelForm.Text) = "" Then
'    CekValidateDataForm = True
'Else
'    CekValidateDataForm = False
'End If
End Function
...
If fraEntryTop.Caption = "Entry" Then
    If CekValidateDataTop = False Then
        MsgBox "Data is not valid", vbCritical, headerMSG
        Exit Sub
    End If
    
    strsql = "select max(user_code) tot from m_user where user_level = 100"
    rstot.Open strsql, CnG, adOpenForwardOnly, adLockReadOnly
        vTot = rstot!tot
    rstot.Close
    
    vTot = vTot + 1
    strsql = "insert into m_user (user_code, user_name, user_pass, user_pass_key, user_level,full_name) " _
        & "values('" & vTot & "', '" & Replace$(Trim$(txtNamaTop), Chr(39), Chr(96)) _
        & "','" & RC4DeCryptASC(Replace(Trim(txtPasswordTop.Text), Chr(39), Chr(96)), pEncryptionPassword) & "', " _
        & "'" & pEncryptionPassword & "',100,'" & Trim(txt_full_name.Text) & "')"
    CnG.Execute strsql
...
ElseIf fraEntryTop.Caption = "Edit" Then
    If CekValidateDataTop = False Then
        MsgBox "Data is not valid", vbCritical, headerMSG
        Exit Sub
    End If
    CnG.Execute _
    "update m_user set user_name = '" & Replace$(Trim$(txtNamaTop), Chr(39), Chr(96)) & _
    "', full_name = '" & Trim(txt_full_name.Text) & _
    "', user_pass = '" & RC4DeCryptASC(Replace(Trim(txtPasswordTop.Text), Chr(39), Chr(96)), pEncryptionPassword) & _
    "', user_pass_key= '" & pEncryptionPassword & _
    "' where user_code = '" & GridEXTop.Value(GridEXTop.Columns("user_code").ColPosition) & "'"
...
If fra_EntryUser.Caption = "Entry" Then
    ...
    If CekDuplicateNameUser = True Then
        MsgBox "UserName Already Exist!", vbCritical, headerMSG
        Exit Sub
    End If
    If CekDuplicateKodeUser = True Then
        MsgBox "UserCode Already Exist!", vbCritical, headerMSG
        Exit Sub
    ...
    With rs
        ...
        .Fields("full_name").Value = Trim(txt_fullname)
...
'    End With
    strsql = "UPDATE m_user Set " _
        ...
        & "full_name = '" & Trim(txt_fullname.Text) & "'," _
...
Private Sub GridEXTop_DblClick()
Call cmdEditTop_Click
End Sub

Private Sub EnabledOptionTop(ByVal i As Boolean)
fraOption.Enabled = i
GridEXTop.Enabled = i
End Sub

Private Sub EnabledOptionForm(ByVal i As Boolean)
fraOption.Enabled = i
'GridEXF.Enabled = i
End Sub
...
Adodc_form.RecordSource = "select * from t_user where user_code = '" _
...
End Sub
Private Sub txt_full_name_KeyPress(KeyAscii As Integer)
KeyAscii = Asc(UCase(Chr(KeyAscii)))
End Sub
