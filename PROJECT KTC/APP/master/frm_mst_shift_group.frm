...
Begin VB.Form frm_mst_shift_group 
   BorderStyle     =   4  'Fixed ToolWindow
   Caption         =   "MASTER GROUP SHIFT"
   ClientHeight    =   6690
   ClientLeft      =   -15
   ClientTop       =   240
   ClientWidth     =   11760
   ...
   EndProperty
   Icon            =   "frm_mst_shift_group.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   MinButton       =   0   'False
   ...
   Begin VB.Frame frmTombol 
      ...
      Begin VB.CommandButton cmd_refresh 
         ...
         Height          =   645
         Left            =   7440
         Picture         =   "frm_mst_shift_group.frx":000C
         Style           =   1  'Graphical
         TabIndex        =   10
         Top             =   360
         Width           =   975
      ...
      Begin VB.CommandButton CmdSave 
         ...
         Height          =   645
         Left            =   1800
         Picture         =   "frm_mst_shift_group.frx":0596
         Style           =   1  'Graphical
         TabIndex        =   6
         Top             =   360
         Width           =   975
      ...
      Begin VB.CommandButton CmdCancel 
         ...
         Height          =   645
         Left            =   5040
         Picture         =   "frm_mst_shift_group.frx":0B20
         Style           =   1  'Graphical
         TabIndex        =   9
         Top             =   360
         Width           =   975
      ...
      Begin VB.CommandButton CmdExit 
         ...
         Height          =   645
         Left            =   9600
         Picture         =   "frm_mst_shift_group.frx":10AA
         Style           =   1  'Graphical
         TabIndex        =   11
         Top             =   360
         Width           =   975
      ...
      Begin VB.CommandButton CmdNew 
         ...
         Height          =   645
         Left            =   720
         Picture         =   "frm_mst_shift_group.frx":1634
         Style           =   1  'Graphical
         TabIndex        =   4
         Top             =   360
         Width           =   975
      ...
      Begin VB.CommandButton CmdPrint 
         ...
         Height          =   645
         Left            =   0
         Picture         =   "frm_mst_shift_group.frx":1BBE
         Style           =   1  'Graphical
         TabIndex        =   14
         Top             =   600
         Visible         =   0   'False
      ...
      Begin VB.CommandButton cmdDelete 
         ...
         Height          =   645
         Left            =   3960
         Picture         =   "frm_mst_shift_group.frx":2148
         Style           =   1  'Graphical
         TabIndex        =   8
         Top             =   360
         Width           =   975
      ...
      Begin VB.CommandButton cmdEdit 
         ...
         Height          =   645
         Left            =   2880
         Picture         =   "frm_mst_shift_group.frx":26D2
         Style           =   1  'Graphical
         TabIndex        =   7
         Top             =   360
         Width           =   975
   ...
   Begin TrueOleDBGrid70.TDBGrid TDBGrid1 
      ...
      Columns(1).Caption=   "GROUP CODE"
      Columns(1).DataField=   "group_code"
      Columns(1)._PropDict=   "_MaxComboItems,516,2;_VlistStyle,514,3"
      Columns(2)._VlistStyle=   0
      Columns(2)._MaxComboItems=   5
      Columns(2).Caption=   "GROUP NAME"
      Columns(2).DataField=   "group_name"
   ...
   Begin TrueOleDBList60.TDBCombo TDBCombo_company 
      Height          =   375
      Left            =   1530
      OleObjectBlob   =   "frm_mst_shift_group.frx":2C5C
      TabIndex        =   1
      Top             =   240
      Width           =   1695
   End
   ...
   End
End
Attribute VB_Name = "frm_mst_shift_group"
...
str_sql = "select count(group_code) as rec_count from m_group_shift where company_code = '" & TDBCombo_company & "' AND group_code = '" _
& Replace$(Trim$(txt_group_code), Chr$(39), Chr$(96)) & "'"
...
If Not txt_group_code = Adodc1.Recordset.Fields("group_code").Value And _
...
CnG.BeginTrans
CnG.Execute "delete from m_group_shift where company_code = '" & TDBCombo_company.Text & "' AND group_code = '" _
...
With Adodc1.Recordset
    txt_group_code = .Fields("group_code").Value
    txt_group_name = .Fields("group_name").Value
...
rsBound.Open "select * from m_group_shift where group_code = '" _
& Adodc1.Recordset.Fields("group_code").Value & "'", CnG, adOpenKeyset, adLockOptimistic
...
If rsBound.State = 1 Then rsBound.Close
rsBound.Open "select * from m_group_shift where group_code = 'άφ'", CnG, adOpenKeyset, adLockOptimistic
...
With rsBound
    ...
    .Fields("group_code").Value = Trim(txt_group_code)
    '-----------------------------------------------------------------------------
    .Fields("group_name").Value = Trim(txt_group_name)
...
CnG.BeginTrans
    strsql = "UPDATE m_group_shift SET " _
        ...
        & "AND group_code = '" & Trim(txt_group_code.Text) & "'"
    CnG.Execute (strsql)
'With rsBound
'
''    .Fields("company_code").Value = TDBCombo_company.Columns("company_code").Value
...
Adodc1.RecordSource = "select * from m_group_shift where company_code = '" _
