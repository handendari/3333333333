...
Begin VB.Form frm_mst_menu 
   ...
   Begin VB.Frame fra_control2 
      ...
      Begin VB.CommandButton cmd_exit2 
         ...
         Height          =   645
         Left            =   10680
         Picture         =   "frm_mst_menu.frx":000C
         Style           =   1  'Graphical
         TabIndex        =   17
         Top             =   240
         Width           =   975
      End
      Begin VB.CommandButton cmd_new2 
         Caption         =   "&New"
         Height          =   645
         Left            =   1560
         Picture         =   "frm_mst_menu.frx":0596
         Style           =   1  'Graphical
         TabIndex        =   12
         Top             =   240
         Width           =   975
      End
      Begin VB.CommandButton cmd_edit2 
         Caption         =   "&Edit"
         Height          =   645
         Left            =   3720
         Picture         =   "frm_mst_menu.frx":0B20
         Style           =   1  'Graphical
         TabIndex        =   14
         Top             =   240
         Width           =   975
      End
      Begin VB.CommandButton cmd_delete2 
         Caption         =   "&Delete"
         Height          =   645
         Left            =   4800
         Picture         =   "frm_mst_menu.frx":10AA
         Style           =   1  'Graphical
         TabIndex        =   15
         Top             =   240
         Width           =   975
      End
      Begin VB.CommandButton cmd_cancel2 
         Caption         =   "&Cancel"
         Height          =   645
         Left            =   5880
         Picture         =   "frm_mst_menu.frx":1634
         Style           =   1  'Graphical
         TabIndex        =   16
         Top             =   240
         Width           =   975
   ...
   Begin VB.Frame fra_sub_menu 
      ...
      Begin VB.Frame fra_entry_sub_menu 
         ...
         Begin VB.ComboBox cbo_user_level 
            ...
            EndProperty
            Height          =   315
            ItemData        =   "frm_mst_menu.frx":2148
            Left            =   9120
            List            =   "frm_mst_menu.frx":2152
            TabIndex        =   11
            Text            =   "Pilihan"
            Top             =   2040
            Width           =   1575
         ...
         Begin TrueOleDBList60.TDBCombo TDBCombo_menu 
            Height          =   375
            Left            =   2160
            OleObjectBlob   =   "frm_mst_menu.frx":2163
            TabIndex        =   4
            Top             =   1320
            Width           =   3615
         End
   ...
   Begin VB.Frame fra_menu 
      ...
      Begin TrueOleDBGrid70.TDBGrid TDBGrid1 
         ...
         Columns(0)._VlistStyle=   0
         Columns(0)._MaxComboItems=   5
         Columns(0).Caption=   "MENU CODE"
         Columns(0).DataField=   "menu_code"
         Columns(0)._PropDict=   "_MaxComboItems,516,2;_VlistStyle,514,3"
         Columns(1)._VlistStyle=   0
         Columns(1)._MaxComboItems=   5
         Columns(1).Caption=   "MENU NAME"
...
'Call mdi_accounting.load_data_menu
End Sub
...
If cmd_cancel.Enabled = True Then
    MsgBox "Entry process haven't been ended!", vbInformation, headerMSG
    Exit Sub
End If
...
If Not txt_menu_code = Adodc1.Recordset.Fields("menu_code").Value And _
...
If Trim(txt_menu_code) = "" Then
    MsgBox "Menu code is empty!", vbOKOnly + vbInformation, headerMSG
...
If Trim(txt_menu_name) = "" Then
    MsgBox "Menu name is empty!", vbOKOnly + vbInformation, headerMSG
...
If check_exist_sub_menu = True Then
    MsgBox "Data found on sub menu!", vbInformation, headerMSG
    Exit Sub
End If
...
rsBound.Open "select * from m_menu where menu_code = '" _
& Adodc1.Recordset.Fields("menu_code").Value & "'", CnG, adOpenKeyset, adLockOptimistic
...
If rsBound.State = 1 Then rsBound.Close
rsBound.Open "select * from m_menu where menu_code = 'uOu'", CnG, adOpenKeyset, adLockOptimistic
...
With Adodc2.Recordset
    ...
    Call set_data_tdbcombo(Adodc_menu, TDBCombo_menu, "menu_code='" & .Fields("menu_code").Value & "'")
    ...
    txt_sub_menu_action = .Fields("sub_menu_action").Value
...
rs1.Open "select * from m_sub_menu where sub_menu_code='" _
        & Adodc2.Recordset.Fields("sub_menu_code").Value & "'", CnG, adOpenKeyset, adLockOptimistic
...
strsql = "UPDATE m_sub_menu SET " _
        ...
        & "WHERE sub_menu_code = '" & Adodc2.Recordset.Fields("sub_menu_code").Value & "'"
CnG.Execute strsql
...
If Not txt_sub_menu_code = Adodc2.Recordset.Fields("sub_menu_code").Value And _
...
If Trim(txt_sub_menu_code) = "" Then
    MsgBox "Sub menu code is empty!", vbOKOnly + vbInformation, headerMSG
    txt_sub_menu_code.SetFocus
...
If Trim(txt_sub_menu_name) = "" Then
    MsgBox "Sub menu name is empty!", vbOKOnly + vbInformation, headerMSG
...
i = MsgBox("Are you sure want to delete data '" _
    & Adodc2.Recordset.Fields("sub_menu_name").Value & "' ?", vbYesNo + vbQuestion, headerMSG)
If Not i = vbYes Then Exit Sub

CnG.BeginTrans
CnG.Execute "delete from m_sub_menu where sub_menu_code = '" & Adodc2.Recordset.Fields("sub_menu_code").Value & "'"
CnG.CommitTrans
