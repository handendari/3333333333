...
Begin VB.Form frm_mst_salary 
   ...
   Begin VB.Frame fra_entry 
      ...
      Begin VB.CheckBox Check1 
         ...
         Width           =   825
      End
      Begin VB.TextBox txtuang_makan 
         Alignment       =   1  'Right Justify
         Appearance      =   0  'Flat
         BeginProperty DataFormat 
            Type            =   1
         ...
         Width           =   2220
      End
      Begin VB.TextBox txtallowance_rate 
         Alignment       =   1  'Right Justify
         Appearance      =   0  'Flat
         BeginProperty DataFormat 
            Type            =   1
   ...
   Begin TrueOleDBGrid70.TDBGrid TDBGrid1 
      ...
      Columns(12).Caption=   "OT RATE"
      Columns(12).DataField=   "rate_hour"
      Columns(12)._PropDict=   "_MaxComboItems,516,2;_VlistStyle,514,3"
      Columns(13)._VlistStyle=   0
      Columns(13)._MaxComboItems=   5
      Columns(13).Caption=   "ALLOWANCE RATE"
      Columns(13).DataField=   "allowance_rate"
      Columns(13)._PropDict=   "_MaxComboItems,516,2;_VlistStyle,514,3"
      Columns(14)._VlistStyle=   0
      Columns(14)._MaxComboItems=   5
      Columns(14).Caption=   "MEAL ALLOWANCE"
      Columns(14).DataField=   "uangmakan"
      Columns(14)._PropDict=   "_MaxComboItems,516,2;_VlistStyle,514,3"
      Columns(15)._VlistStyle=   4
      Columns(15)._MaxComboItems=   5
      Columns(15).Caption=   "INCENTIVE"
      Columns(15).DataField=   "flag_incentive"
      Columns(15)._PropDict=   "_MaxComboItems,516,2;_VlistStyle,514,3"
      Columns(16)._VlistStyle=   0
      Columns(16)._MaxComboItems=   5
      Columns(16).Caption=   "DESCRIPTION"
      Columns(16).DataField=   "desc_salary"
      ...
      Splits(0)._ColumnProps(92)=   "Column(14)._ColStyle=516"
      ...
      Splits(0)._ColumnProps(99)=   "Column(16).Width=2725"
      Splits(0)._ColumnProps(100)=   "Column(16).DividerColor=0"
      Splits(0)._ColumnProps(101)=   "Column(16)._WidthInPix=2646"
      Splits(0)._ColumnProps(102)=   "Column(16).AllowSizing=0"
      Splits(0)._ColumnProps(103)=   "Column(16)._ColStyle=516"
      Splits(0)._ColumnProps(104)=   "Column(16).Visible=0"
      Splits(0)._ColumnProps(105)=   "Column(16).AllowFocus=0"
      ...
      Splits(1)._ColumnProps(88)=   "Column(12)._ColStyle=514"
      ...
      Splits(1)._ColumnProps(93)=   "Column(13)._ColStyle=514"
      ...
      Splits(1)._ColumnProps(98)=   "Column(14)._ColStyle=514"
      ...
      Splits(1)._ColumnProps(105)=   "Column(16).Width=3360"
      Splits(1)._ColumnProps(106)=   "Column(16).DividerColor=0"
      Splits(1)._ColumnProps(107)=   "Column(16)._WidthInPix=3281"
      ...
      _StyleDefs(40)  =   "Splits(0).Columns(0).Style:id=78,.parent=13"
      _StyleDefs(41)  =   "Splits(0).Columns(0).HeadingStyle:id=75,.parent=14"
      _StyleDefs(42)  =   "Splits(0).Columns(0).FooterStyle:id=76,.parent=15"
      _StyleDefs(43)  =   "Splits(0).Columns(0).EditorStyle:id=77,.parent=17"
      ...
      _StyleDefs(60)  =   "Splits(0).Columns(5).Style:id=62,.parent=13"
      _StyleDefs(61)  =   "Splits(0).Columns(5).HeadingStyle:id=59,.parent=14"
      _StyleDefs(62)  =   "Splits(0).Columns(5).FooterStyle:id=60,.parent=15"
      _StyleDefs(63)  =   "Splits(0).Columns(5).EditorStyle:id=61,.parent=17"
      _StyleDefs(64)  =   "Splits(0).Columns(6).Style:id=66,.parent=13"
      _StyleDefs(65)  =   "Splits(0).Columns(6).HeadingStyle:id=63,.parent=14"
      _StyleDefs(66)  =   "Splits(0).Columns(6).FooterStyle:id=64,.parent=15"
      _StyleDefs(67)  =   "Splits(0).Columns(6).EditorStyle:id=65,.parent=17"
      _StyleDefs(68)  =   "Splits(0).Columns(7).Style:id=70,.parent=13"
      _StyleDefs(69)  =   "Splits(0).Columns(7).HeadingStyle:id=67,.parent=14"
      _StyleDefs(70)  =   "Splits(0).Columns(7).FooterStyle:id=68,.parent=15"
      _StyleDefs(71)  =   "Splits(0).Columns(7).EditorStyle:id=69,.parent=17"
      _StyleDefs(72)  =   "Splits(0).Columns(8).Style:id=74,.parent=13"
      _StyleDefs(73)  =   "Splits(0).Columns(8).HeadingStyle:id=71,.parent=14"
      _StyleDefs(74)  =   "Splits(0).Columns(8).FooterStyle:id=72,.parent=15"
      _StyleDefs(75)  =   "Splits(0).Columns(8).EditorStyle:id=73,.parent=17"
      _StyleDefs(76)  =   "Splits(0).Columns(9).Style:id=82,.parent=13"
      _StyleDefs(77)  =   "Splits(0).Columns(9).HeadingStyle:id=79,.parent=14"
      _StyleDefs(78)  =   "Splits(0).Columns(9).FooterStyle:id=80,.parent=15"
      _StyleDefs(79)  =   "Splits(0).Columns(9).EditorStyle:id=81,.parent=17"
      _StyleDefs(80)  =   "Splits(0).Columns(10).Style:id=86,.parent=13"
      _StyleDefs(81)  =   "Splits(0).Columns(10).HeadingStyle:id=83,.parent=14"
      _StyleDefs(82)  =   "Splits(0).Columns(10).FooterStyle:id=84,.parent=15"
      _StyleDefs(83)  =   "Splits(0).Columns(10).EditorStyle:id=85,.parent=17"
      _StyleDefs(84)  =   "Splits(0).Columns(11).Style:id=94,.parent=13"
      _StyleDefs(85)  =   "Splits(0).Columns(11).HeadingStyle:id=91,.parent=14"
      _StyleDefs(86)  =   "Splits(0).Columns(11).FooterStyle:id=92,.parent=15"
      _StyleDefs(87)  =   "Splits(0).Columns(11).EditorStyle:id=93,.parent=17"
      _StyleDefs(88)  =   "Splits(0).Columns(12).Style:id=114,.parent=13"
      _StyleDefs(89)  =   "Splits(0).Columns(12).HeadingStyle:id=111,.parent=14"
      _StyleDefs(90)  =   "Splits(0).Columns(12).FooterStyle:id=112,.parent=15"
      _StyleDefs(91)  =   "Splits(0).Columns(12).EditorStyle:id=113,.parent=17"
      _StyleDefs(92)  =   "Splits(0).Columns(13).Style:id=90,.parent=13"
      _StyleDefs(93)  =   "Splits(0).Columns(13).HeadingStyle:id=87,.parent=14"
      _StyleDefs(94)  =   "Splits(0).Columns(13).FooterStyle:id=88,.parent=15"
      _StyleDefs(95)  =   "Splits(0).Columns(13).EditorStyle:id=89,.parent=17"
      _StyleDefs(96)  =   "Splits(0).Columns(14).Style:id=46,.parent=13"
      _StyleDefs(97)  =   "Splits(0).Columns(14).HeadingStyle:id=43,.parent=14"
      _StyleDefs(98)  =   "Splits(0).Columns(14).FooterStyle:id=44,.parent=15"
      _StyleDefs(99)  =   "Splits(0).Columns(14).EditorStyle:id=45,.parent=17"
      _StyleDefs(100) =   "Splits(0).Columns(15).Style:id=142,.parent=13"
      _StyleDefs(101) =   "Splits(0).Columns(15).HeadingStyle:id=139,.parent=14"
      _StyleDefs(102) =   "Splits(0).Columns(15).FooterStyle:id=140,.parent=15"
      _StyleDefs(103) =   "Splits(0).Columns(15).EditorStyle:id=141,.parent=17"
      _StyleDefs(104) =   "Splits(0).Columns(16).Style:id=98,.parent=13"
      _StyleDefs(105) =   "Splits(0).Columns(16).HeadingStyle:id=95,.parent=14"
      _StyleDefs(106) =   "Splits(0).Columns(16).FooterStyle:id=96,.parent=15"
      _StyleDefs(107) =   "Splits(0).Columns(16).EditorStyle:id=97,.parent=17"
      _StyleDefs(108) =   "Splits(1).Style:id=99,.parent=1"
      _StyleDefs(109) =   "Splits(1).CaptionStyle:id=116,.parent=4,.bgcolor=&H80000002&"
      _StyleDefs(110) =   ":id=116,.fgcolor=&H80000009&"
      _StyleDefs(111) =   "Splits(1).HeadingStyle:id=100,.parent=2,.alignment=2,.bgcolor=&H8000000F&"
      _StyleDefs(112) =   ":id=100,.fgcolor=&H80000002&"
      _StyleDefs(113) =   "Splits(1).FooterStyle:id=101,.parent=3"
      _StyleDefs(114) =   "Splits(1).InactiveStyle:id=102,.parent=5"
      _StyleDefs(115) =   "Splits(1).SelectedStyle:id=104,.parent=6"
      _StyleDefs(116) =   "Splits(1).EditorStyle:id=103,.parent=7"
      _StyleDefs(117) =   "Splits(1).HighlightRowStyle:id=105,.parent=8"
      _StyleDefs(118) =   "Splits(1).EvenRowStyle:id=106,.parent=9"
      _StyleDefs(119) =   "Splits(1).OddRowStyle:id=115,.parent=10"
      _StyleDefs(120) =   "Splits(1).RecordSelectorStyle:id=117,.parent=11"
      _StyleDefs(121) =   "Splits(1).FilterBarStyle:id=118,.parent=12"
      _StyleDefs(122) =   "Splits(1).Columns(0).Style:id=122,.parent=99"
      _StyleDefs(123) =   "Splits(1).Columns(0).HeadingStyle:id=119,.parent=100"
      _StyleDefs(124) =   "Splits(1).Columns(0).FooterStyle:id=120,.parent=101"
      _StyleDefs(125) =   "Splits(1).Columns(0).EditorStyle:id=121,.parent=103"
      _StyleDefs(126) =   "Splits(1).Columns(1).Style:id=126,.parent=99"
      _StyleDefs(127) =   "Splits(1).Columns(1).HeadingStyle:id=123,.parent=100"
      _StyleDefs(128) =   "Splits(1).Columns(1).FooterStyle:id=124,.parent=101"
      _StyleDefs(129) =   "Splits(1).Columns(1).EditorStyle:id=125,.parent=103"
      _StyleDefs(130) =   "Splits(1).Columns(2).Style:id=130,.parent=99"
      _StyleDefs(131) =   "Splits(1).Columns(2).HeadingStyle:id=127,.parent=100"
      _StyleDefs(132) =   "Splits(1).Columns(2).FooterStyle:id=128,.parent=101"
      _StyleDefs(133) =   "Splits(1).Columns(2).EditorStyle:id=129,.parent=103"
      _StyleDefs(134) =   "Splits(1).Columns(3).Style:id=134,.parent=99"
      _StyleDefs(135) =   "Splits(1).Columns(3).HeadingStyle:id=131,.parent=100"
      _StyleDefs(136) =   "Splits(1).Columns(3).FooterStyle:id=132,.parent=101"
      _StyleDefs(137) =   "Splits(1).Columns(3).EditorStyle:id=133,.parent=103"
      _StyleDefs(138) =   "Splits(1).Columns(4).Style:id=146,.parent=99"
      _StyleDefs(139) =   "Splits(1).Columns(4).HeadingStyle:id=143,.parent=100"
      _StyleDefs(140) =   "Splits(1).Columns(4).FooterStyle:id=144,.parent=101"
      _StyleDefs(141) =   "Splits(1).Columns(4).EditorStyle:id=145,.parent=103"
      _StyleDefs(142) =   "Splits(1).Columns(5).Style:id=150,.parent=99"
      _StyleDefs(143) =   "Splits(1).Columns(5).HeadingStyle:id=147,.parent=100"
      _StyleDefs(144) =   "Splits(1).Columns(5).FooterStyle:id=148,.parent=101"
      _StyleDefs(145) =   "Splits(1).Columns(5).EditorStyle:id=149,.parent=103"
      _StyleDefs(146) =   "Splits(1).Columns(6).Style:id=154,.parent=99"
      _StyleDefs(147) =   "Splits(1).Columns(6).HeadingStyle:id=151,.parent=100"
      _StyleDefs(148) =   "Splits(1).Columns(6).FooterStyle:id=152,.parent=101"
      _StyleDefs(149) =   "Splits(1).Columns(6).EditorStyle:id=153,.parent=103"
      _StyleDefs(150) =   "Splits(1).Columns(7).Style:id=158,.parent=99"
      _StyleDefs(151) =   "Splits(1).Columns(7).HeadingStyle:id=155,.parent=100"
      _StyleDefs(152) =   "Splits(1).Columns(7).FooterStyle:id=156,.parent=101"
      _StyleDefs(153) =   "Splits(1).Columns(7).EditorStyle:id=157,.parent=103"
      _StyleDefs(154) =   "Splits(1).Columns(8).Style:id=170,.parent=99"
      _StyleDefs(155) =   "Splits(1).Columns(8).HeadingStyle:id=167,.parent=100"
      _StyleDefs(156) =   "Splits(1).Columns(8).FooterStyle:id=168,.parent=101"
      _StyleDefs(157) =   "Splits(1).Columns(8).EditorStyle:id=169,.parent=103"
      _StyleDefs(158) =   "Splits(1).Columns(9).Style:id=174,.parent=99"
      _StyleDefs(159) =   "Splits(1).Columns(9).HeadingStyle:id=171,.parent=100"
      _StyleDefs(160) =   "Splits(1).Columns(9).FooterStyle:id=172,.parent=101"
      _StyleDefs(161) =   "Splits(1).Columns(9).EditorStyle:id=173,.parent=103"
      _StyleDefs(162) =   "Splits(1).Columns(10).Style:id=178,.parent=99,.alignment=2"
      _StyleDefs(163) =   "Splits(1).Columns(10).HeadingStyle:id=175,.parent=100"
      _StyleDefs(164) =   "Splits(1).Columns(10).FooterStyle:id=176,.parent=101"
      _StyleDefs(165) =   "Splits(1).Columns(10).EditorStyle:id=177,.parent=103"
      _StyleDefs(166) =   "Splits(1).Columns(11).Style:id=186,.parent=99,.alignment=1"
      _StyleDefs(167) =   "Splits(1).Columns(11).HeadingStyle:id=183,.parent=100"
      _StyleDefs(168) =   "Splits(1).Columns(11).FooterStyle:id=184,.parent=101"
      _StyleDefs(169) =   "Splits(1).Columns(11).EditorStyle:id=185,.parent=103"
      _StyleDefs(170) =   "Splits(1).Columns(12).Style:id=138,.parent=99,.alignment=1"
      _StyleDefs(171) =   "Splits(1).Columns(12).HeadingStyle:id=135,.parent=100"
      _StyleDefs(172) =   "Splits(1).Columns(12).FooterStyle:id=136,.parent=101"
      _StyleDefs(173) =   "Splits(1).Columns(12).EditorStyle:id=137,.parent=103"
      _StyleDefs(174) =   "Splits(1).Columns(13).Style:id=110,.parent=99,.alignment=1"
      _StyleDefs(175) =   "Splits(1).Columns(13).HeadingStyle:id=107,.parent=100"
      _StyleDefs(176) =   "Splits(1).Columns(13).FooterStyle:id=108,.parent=101"
      _StyleDefs(177) =   "Splits(1).Columns(13).EditorStyle:id=109,.parent=103"
      _StyleDefs(178) =   "Splits(1).Columns(14).Style:id=54,.parent=99,.alignment=1"
      _StyleDefs(179) =   "Splits(1).Columns(14).HeadingStyle:id=51,.parent=100"
      _StyleDefs(180) =   "Splits(1).Columns(14).FooterStyle:id=52,.parent=101"
      _StyleDefs(181) =   "Splits(1).Columns(14).EditorStyle:id=53,.parent=103"
      _StyleDefs(182) =   "Splits(1).Columns(15).Style:id=162,.parent=99,.alignment=2"
      _StyleDefs(183) =   "Splits(1).Columns(15).HeadingStyle:id=159,.parent=100"
      _StyleDefs(184) =   "Splits(1).Columns(15).FooterStyle:id=160,.parent=101"
      _StyleDefs(185) =   "Splits(1).Columns(15).EditorStyle:id=161,.parent=103"
      _StyleDefs(186) =   "Splits(1).Columns(16).Style:id=190,.parent=99"
      _StyleDefs(187) =   "Splits(1).Columns(16).HeadingStyle:id=187,.parent=100"
      _StyleDefs(188) =   "Splits(1).Columns(16).FooterStyle:id=188,.parent=101"
      _StyleDefs(189) =   "Splits(1).Columns(16).EditorStyle:id=189,.parent=103"
      _StyleDefs(190) =   "Named:id=33:Normal"
      _StyleDefs(191) =   ":id=33,.parent=0"
      _StyleDefs(192) =   "Named:id=34:Heading"
      _StyleDefs(193) =   ":id=34,.parent=33,.valignment=2,.bgcolor=&H8000000F&,.fgcolor=&H80000012&"
      _StyleDefs(194) =   ":id=34,.wraptext=-1"
      _StyleDefs(195) =   "Named:id=35:Footing"
      _StyleDefs(196) =   ":id=35,.parent=33,.valignment=2,.bgcolor=&H8000000F&,.fgcolor=&H80000012&"
      _StyleDefs(197) =   "Named:id=36:Selected"
      _StyleDefs(198) =   ":id=36,.parent=33,.bgcolor=&H8000000D&,.fgcolor=&H8000000E&"
      _StyleDefs(199) =   "Named:id=37:Caption"
      _StyleDefs(200) =   ":id=37,.parent=34,.alignment=2"
      _StyleDefs(201) =   "Named:id=38:HighlightRow"
      _StyleDefs(202) =   ":id=38,.parent=33,.bgcolor=&H8000000D&,.fgcolor=&H8000000E&"
      _StyleDefs(203) =   "Named:id=39:EvenRow"
      _StyleDefs(204) =   ":id=39,.parent=33,.bgcolor=&HFFFF00&"
      _StyleDefs(205) =   "Named:id=40:OddRow"
      _StyleDefs(206) =   ":id=40,.parent=33"
      _StyleDefs(207) =   "Named:id=41:RecordSelector"
      _StyleDefs(208) =   ":id=41,.parent=34"
      _StyleDefs(209) =   "Named:id=42:FilterBar"
      _StyleDefs(210) =   ":id=42,.parent=33"
   End
...
Dim tglLama As Date
Dim v_basic_salary, v_ot, v_allowance, v_meal, v_other, v_incentive As Double
...
'validasi salary
If txt_salary.Text = 0 Then
    MsgBox "Salary is empty!", vbOKOnly + vbInformation, headerMSG
    txt_salary.SetFocus
    check_validate_new = False
    Exit Function
End If
...
Check1.Caption = IIf(Check1.Value = 0, "No", "Yes")
End Sub
...
Dim strsql As String
Dim rsallowance As ADODB.Recordset

    With Adodc1.Recordset
        tglLama = .Fields("salary_date").Value
        ...
        txt_salary.Text = .Fields("salary").Value
        txt_over_time.Text = .Fields("over_time").Value
        
        txt_description = IIf(IsNull(.Fields("desc_salary").Value), "", .Fields("desc_salary").Value)
    End With
    
    strsql = "Select allowance_rate,uangmakan,flag_incentive,tunj_lain from m_salary where employee_code = '" & txt_employee_code.Text & "' " & _
                "AND date(salary_date) = '" & Format(DTPicker_date.Value, "yyyy-MM-dd") & "' order by salary_date desc limit 1"
    Set rsallowance = New ADODB.Recordset
    rsallowance.Open strsql, CnG, adOpenDynamic, adLockReadOnly
    If rsallowance.RecordCount > 0 Then
        txtallowance_rate.Text = IIf(IsNull(rsallowance!allowance_rate), 0, rsallowance!allowance_rate)
        txtuang_makan.Text = IIf(IsNull(rsallowance!uangmakan), 0, rsallowance!uangmakan)
        txttunj_lain.Text = IIf(IsNull(rsallowance!tunj_lain), 0, rsallowance!tunj_lain)
        Check1.Value = IIf(IsNull(rsallowance!flag_incentive), 1, rsallowance!flag_incentive)
        Check1.Caption = IIf(Check1.Value = 0, "No", "Yes")
    End If
    
    v_basic_salary = txt_salary.Text
    v_ot = txt_over_time.Text
    v_allowance = txtallowance_rate.Text
    v_meal = txtuang_makan.Text
    v_other = txttunj_lain.Text
    v_incentive = Check1.Value
End Sub
...
strsql = "INSERT INTO m_salary (employee_code,salary_date,salary,over_time,rate_hour," _
        & "allowance_rate,uangmakan,tunj_lain,description,entry_date,flag_incentive) " _
    & " values ('" & txt_employee_code.Text & "','" & Format(DTPicker_date.Value, "yyyy-MM-dd HH:mm:ss") & "'," _
        & "'" & txt_salary.Text & "','" & txt_over_time.Text & "'," _
        & "'" & txt_over_time.Text & "','" & txtallowance_rate.Text & "','" & txtuang_makan.Text & "','" & txttunj_lain.Text & "'," _
        & "'" & Trim(txt_description.Text) & "',now()," & Check1.Value & ")"
CnG.Execute strsql
...
'    '-----------------------------------------------------------------------------
'    '.Fields("salary_date").Value = Format(DTPicker_date.Value, "yyyy-MM-dd HH:mm:ss")
'    .Fields("salary").Value = txt_salary.Value
'    .Fields("over_time").Value = txt_over_time.Value
'    .Fields("rate_hour").Value = txt_over_time.Value
'    .Fields("allowance_rate").Value = txtallowance_rate.Value
'    .Fields("uangmakan").Value = txtuang_makan.Value
'    .Fields("description").Value = Trim(txt_description)
'    '.Fields("entry_date").Value = Format(Now, "yyyy-MM-dd HH:mm:ss")
'
'    .Update
...
'+++++++++++++++++++++++++++++++++ Update Temp Salary Proses ++++++++++++++
If v_basic_salary <> txt_salary.Text Or v_allowance <> txtallowance_rate.Text _
    Or v_ot <> txt_over_time.Text Or v_meal <> txtuang_makan.Text _
    Or v_incentive <> Check1.Value Or v_other <> txttunj_lain.Text Then
        strsql = "Update temp_sal_proses set salary_proses = 0 where company_code = '" & TDBCombo_company.Text & "'"
        CnG.Execute strsql
End If
'++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
                    
    strsql = "update m_salary SET salary = '" & txt_salary.Text & "'," & _
        "salary_date = '" & Format(DTPicker_date.Value, "yyyy-MM-dd HH:mm:ss") & "',over_time = '" & txt_over_time.Text & "'," & _
        "rate_hour = '" & txt_over_time.Text & "',allowance_rate = '" & txtallowance_rate.Text & "'," & _
        "uangmakan = '" & txtuang_makan.Text & "',tunj_lain = '" & txttunj_lain.Text & "',description = '" & Trim(txt_description.Text) & "'," & _
        "flag_incentive = " & Check1.Value & " " & _
        "WHERE date(salary_date) = '" & Format(tglLama, "yyyy-MM-dd") & "' and employee_code = '" & txt_employee_code.Text & "'"
    CnG.Execute strsql
CnG.CommitTrans
Exit Sub
err_capture:
...
& TDBCombo_company.Columns("company_code").Value & "' " & access & " order by salary_date desc"
Adodc1.Refresh
...
'Private Sub txt_salary_Click()
'    If txt_salary.Enabled Then TextBoxGotFocus txt_salary
'    End If
'End Sub

Private Sub txt_salary_Validate(Cancel As Boolean)
    If txt_salary.Text > "0" Then
        txt_over_time.Text = Round(Val(txt_salary.Text) / 173)
    Else
        txt_over_time.Text = "0"
    End If
End Sub
