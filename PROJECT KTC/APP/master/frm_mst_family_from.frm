...
Begin VB.Form frm_mst_family_from 
   ...
   Begin VB.Frame fra_entry 
      ...
      Begin VB.ComboBox cbo_religion 
         Height          =   315
         ItemData        =   "frm_mst_family_from.frx":000C
         Left            =   6960
         List            =   "frm_mst_family_from.frx":0022
         TabIndex        =   7
         Text            =   "..."
         Top             =   2280
         Width           =   2775
      ...
      Begin VB.ComboBox cbo_marital_status 
         Height          =   315
         ItemData        =   "frm_mst_family_from.frx":0066
         Left            =   6960
         List            =   "frm_mst_family_from.frx":0076
         TabIndex        =   8
         Text            =   "..."
         Top             =   2640
         Width           =   1575
      ...
      Begin VB.ComboBox cbo_sex 
         Height          =   315
         ItemData        =   "frm_mst_family_from.frx":009B
         Left            =   6960
         List            =   "frm_mst_family_from.frx":00A5
         TabIndex        =   6
         Text            =   "..."
         Top             =   1920
         Width           =   1575
   ...
   Begin VB.Frame frmTombol 
      ...
      Begin VB.CommandButton cmdEdit 
         ...
         Height          =   645
         Left            =   4680
         Picture         =   "frm_mst_family_from.frx":00B7
         Style           =   1  'Graphical
         TabIndex        =   13
         Top             =   360
         Width           =   975
      ...
      Begin VB.CommandButton cmdDelete 
         ...
         Height          =   645
         Left            =   5760
         Picture         =   "frm_mst_family_from.frx":0641
         Style           =   1  'Graphical
         TabIndex        =   14
         Top             =   360
         Width           =   975
      ...
      Begin VB.CommandButton CmdNew 
         ...
         Height          =   645
         Left            =   2520
         Picture         =   "frm_mst_family_from.frx":0BCB
         Style           =   1  'Graphical
         TabIndex        =   11
         Top             =   360
         Width           =   975
      ...
      Begin VB.CommandButton CmdCancel 
         ...
         Height          =   645
         Left            =   6840
         Picture         =   "frm_mst_family_from.frx":1155
         Style           =   1  'Graphical
         TabIndex        =   15
         Top             =   360
         Width           =   975
      ...
      Begin VB.CommandButton CmdSave 
         ...
         Height          =   645
         Left            =   3600
         Picture         =   "frm_mst_family_from.frx":16DF
         Style           =   1  'Graphical
         TabIndex        =   12
         Top             =   360
         Width           =   975
      ...
      Begin VB.CommandButton cmd_exit 
         ...
         Height          =   645
         Left            =   11520
         Picture         =   "frm_mst_family_from.frx":1C69
         Style           =   1  'Graphical
         TabIndex        =   16
         Top             =   360
         Width           =   975
      ...
      Begin zkemkeeperCtl.CZKEM CZKEM1 
         Height          =   375
         Left            =   0
         OleObjectBlob   =   "frm_mst_family_from.frx":21F3
         TabIndex        =   20
         Top             =   600
         Visible         =   0   'False
         Width           =   255
