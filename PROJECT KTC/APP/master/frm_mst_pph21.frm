...
Begin VB.Form frm_mst_pph21_spt 
   BorderStyle     =   4  'Fixed ToolWindow
   Caption         =   "MASTER PPh PASAL 21 SPT"
   ClientHeight    =   6690
   ClientLeft      =   -15
   ClientTop       =   240
   ClientWidth     =   11760
   ...
   Begin TrueOleDBGrid70.TDBGrid TDBGrid1 
      ...
      HeadLines       =   1
      FootLines       =   1
      Caption         =   "LIST OF PPh PASAL 21 SPT"
      MultipleLines   =   0
      CellTipsWidth   =   0
   ...
   End
End
Attribute VB_Name = "frm_mst_pph21_spt"
...
str_sql = "select count(pph21_number) as rec_count from m_pph21 where pph21_number = " _
...
CnG.Execute "delete from m_pph21 where pph21_number = " _
...
rsBound.Open "select * from m_pph21 where pph21_number = " _
...
If rsBound.State = 1 Then rsBound.Close
rsBound.Open "select * from m_pph21 where pph21_number = 'άφ'", CnG, adOpenKeyset, adLockOptimistic
...
CnG.BeginTrans
'+++++++++++++++++++++++++++++++++ Update Temp Salary Proses ++++++++++++++
If v_value_under <> txt_pph21_under.Text Or v_value_upper <> txt_pph21_upper Or v_value_percent <> txt_pph21_percentage Then
    strsql = "Update temp_sal_proses set salary_proses = 0"
    CnG.Execute strsql
End If
'++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
Adodc1.RecordSource = "select * from m_pph21 order by pph21_number"
Adodc1.Refresh
