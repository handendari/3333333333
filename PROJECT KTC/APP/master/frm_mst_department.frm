...
Begin VB.Form frm_mst_department 
   ...
   Begin VB.Frame frmTombol 
      ...
      Begin VB.CommandButton cmd_refresh 
         ...
         Height          =   645
         Left            =   7440
         Picture         =   "frm_mst_department.frx":000C
         Style           =   1  'Graphical
         TabIndex        =   10
         Top             =   360
         Width           =   975
      ...
      Begin VB.CommandButton CmdSave 
         ...
         Height          =   645
         Left            =   1800
         Picture         =   "frm_mst_department.frx":0596
         Style           =   1  'Graphical
         TabIndex        =   6
         Top             =   360
         Width           =   975
      ...
      Begin VB.CommandButton CmdCancel 
         ...
         Height          =   645
         Left            =   5040
         Picture         =   "frm_mst_department.frx":0B20
         Style           =   1  'Graphical
         TabIndex        =   9
         Top             =   360
         Width           =   975
      ...
      Begin VB.CommandButton CmdExit 
         ...
         Height          =   645
         Left            =   9600
         Picture         =   "frm_mst_department.frx":10AA
         Style           =   1  'Graphical
         TabIndex        =   11
         Top             =   360
         Width           =   975
      ...
      Begin VB.CommandButton CmdNew 
         ...
         Height          =   645
         Left            =   720
         Picture         =   "frm_mst_department.frx":1634
         Style           =   1  'Graphical
         TabIndex        =   4
         Top             =   360
         Width           =   975
      ...
      Begin VB.CommandButton CmdPrint 
         ...
         Height          =   645
         Left            =   0
         Picture         =   "frm_mst_department.frx":1BBE
         Style           =   1  'Graphical
         TabIndex        =   14
         Top             =   600
         Visible         =   0   'False
      ...
      Begin VB.CommandButton cmdDelete 
         ...
         Height          =   645
         Left            =   3960
         Picture         =   "frm_mst_department.frx":2148
         Style           =   1  'Graphical
         TabIndex        =   8
         Top             =   360
         Width           =   975
      ...
      Begin VB.CommandButton cmdEdit 
         ...
         Height          =   645
         Left            =   2880
         Picture         =   "frm_mst_department.frx":26D2
         Style           =   1  'Graphical
         TabIndex        =   7
         Top             =   360
         Width           =   975
   ...
   Begin TrueOleDBList60.TDBCombo TDBCombo_company 
      Height          =   375
      Left            =   1530
      OleObjectBlob   =   "frm_mst_department.frx":2C5C
      TabIndex        =   1
      Top             =   240
      Width           =   1695
   End
...
str_sql = "select count(department_code) as rec_count from m_department where company_code = '" & TDBCombo_company & "' AND department_code = '" _
...
CnG.BeginTrans
CnG.Execute "delete from m_department where company_code = '" & TDBCombo_company.Text & "' AND department_code = '" _
...
CnG.BeginTrans
    strsql = "UPDATE m_department SET " _
