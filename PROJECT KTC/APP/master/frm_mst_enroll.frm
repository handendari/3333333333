...
Begin VB.Form frm_mst_enroll 
   ...
   Begin VB.Frame frmTombol 
      ...
      Begin VB.CommandButton cmd_unset 
         ...
         Height          =   645
         Left            =   8760
         Picture         =   "frm_mst_enroll.frx":000C
         Style           =   1  'Graphical
         TabIndex        =   3
         Top             =   360
         Width           =   975
      ...
      Begin VB.CommandButton cmdDelete 
         ...
         Height          =   645
         Left            =   11040
         Picture         =   "frm_mst_enroll.frx":0596
         Style           =   1  'Graphical
         TabIndex        =   5
         Top             =   360
         Width           =   975
      ...
      Begin VB.CommandButton cmd_download 
         ...
         Height          =   645
         Left            =   9960
         Picture         =   "frm_mst_enroll.frx":0B20
         Style           =   1  'Graphical
         TabIndex        =   4
         Top             =   360
         Width           =   975
      ...
      Begin VB.CommandButton Command2 
         ...
         Height          =   645
         Left            =   600
         Picture         =   "frm_mst_enroll.frx":10AA
         Style           =   1  'Graphical
         TabIndex        =   8
         Top             =   360
         Visible         =   0   'False
      ...
      Begin VB.CommandButton cmd_set 
         ...
         Height          =   645
         Left            =   7680
         Picture         =   "frm_mst_enroll.frx":1634
         Style           =   1  'Graphical
         TabIndex        =   2
         Top             =   360
         Width           =   975
      ...
      Begin VB.CommandButton cmd_exit 
         ...
         Height          =   645
         Left            =   12720
         Picture         =   "frm_mst_enroll.frx":1BBE
         Style           =   1  'Graphical
         TabIndex        =   6
         Top             =   360
         Width           =   975
      ...
      Begin zkemkeeperCtl.CZKEM CZKEM1 
         Height          =   375
         Left            =   0
         OleObjectBlob   =   "frm_mst_enroll.frx":2148
         TabIndex        =   9
         Top             =   600
         Visible         =   0   'False
         Width           =   255
