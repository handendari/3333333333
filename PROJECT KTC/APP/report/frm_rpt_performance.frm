...
Begin VB.Form frm_rpt_performance 
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      TabsPerRow      =   2
      TabHeight       =   520
      TabCaption(0)   =   "PERFORMANCE"
      TabPicture(0)   =   "frm_rpt_performance.frx":000C
      Tab(0).ControlEnabled=   -1  'True
      Tab(0).Control(0)=   "Frame5"
      Tab(0).Control(0).Enabled=   0   'False
      Tab(0).ControlCount=   1
      TabCaption(1)   =   "RESERVED"
      TabPicture(1)   =   "frm_rpt_performance.frx":0028
   ...
   Begin VB.Frame Frame3 
      ...
      Begin VB.CommandButton CmdPrint 
         ...
         Height          =   645
         Left            =   6360
         Picture         =   "frm_rpt_performance.frx":0044
         Style           =   1  'Graphical
         TabIndex        =   2
         Top             =   360
         Width           =   975
      ...
      Begin VB.CommandButton CmdExit 
         ...
         Height          =   645
         Left            =   8280
         Picture         =   "frm_rpt_performance.frx":05CE
         Style           =   1  'Graphical
         TabIndex        =   3
         Top             =   360
         Width           =   975
   ...
   Begin TrueOleDBList60.TDBCombo TDBCombo_company 
      Height          =   375
      Left            =   1560
      OleObjectBlob   =   "frm_rpt_performance.frx":0B58
      TabIndex        =   1
      Top             =   270
      Width           =   1695
   End
...
frm_lookup_mst_employee.public_int_mode = 160
...
Private Sub rpt_performance()
Dim sql1, sql2, sql3, str_param_periode, str_file As String
Dim int_flag_company As Integer, str_company_code As String
Dim int_flag_employee As Integer, str_employee_code As String
Dim a As New frm_rpt

str_file = "\report\rpt_performance.rpt"
sql1 = "call spr_performance('" & txt_employee_code1 & "')"


Call a.Show
a.Caption = "PERFORMANCE REPORT"
Call a.rpt_view(sql1, str_file, str_param_periode)
End Sub

Private Sub rpt_performance1()
...
If SSTab1.Tab = 0 Then
    If Trim(txt_employee_code1) = "" Then
        MsgBox "No valid data!", vbInformation, headerMSG
        Exit Sub
    End If
    Call rpt_performance
