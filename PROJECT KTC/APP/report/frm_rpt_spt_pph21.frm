...
Begin VB.Form frm_rpt_summary_pph21 
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      Begin VB.Frame Frame1 
         ...
         Begin VB.ComboBox cbo_periode_company 
            Height          =   315
            ItemData        =   "frm_rpt_spt_pph21.frx":0078
            Left            =   1800
            List            =   "frm_rpt_spt_pph21.frx":0082
            TabIndex        =   22
            Text            =   "..."
            Top             =   840
            Width           =   1695
         ...
         Begin VB.ComboBox cbo_periode_employee 
            Height          =   315
            ItemData        =   "frm_rpt_spt_pph21.frx":0095
            Left            =   1800
            List            =   "frm_rpt_spt_pph21.frx":009F
            TabIndex        =   20
            Text            =   "..."
            Top             =   1200
            Width           =   1695
      ...
      Begin VB.Frame Frame2 
         ...
         Begin VB.ComboBox cbo_yearly_employee 
            Height          =   315
            ItemData        =   "frm_rpt_spt_pph21.frx":00B0
            Left            =   1800
            List            =   "frm_rpt_spt_pph21.frx":00BA
            TabIndex        =   3
            Text            =   "..."
            Top             =   1200
            Width           =   1695
         ...
         Begin VB.ComboBox cbo_monthly_company 
            Height          =   315
            ItemData        =   "frm_rpt_spt_pph21.frx":00CB
            Left            =   1800
            List            =   "frm_rpt_spt_pph21.frx":00D5
            TabIndex        =   2
            Text            =   "..."
            Top             =   840
            Width           =   1695
   ...
   Begin VB.Frame Frame3 
      ...
      Begin VB.CommandButton CmdPrint 
         ...
         Height          =   645
         Left            =   6120
         Picture         =   "frm_rpt_spt_pph21.frx":00E8
         Style           =   1  'Graphical
         TabIndex        =   6
         Top             =   360
         Width           =   975
      ...
      Begin VB.CommandButton CmdExit 
         ...
         Height          =   645
         Left            =   8280
         Picture         =   "frm_rpt_spt_pph21.frx":0672
         Style           =   1  'Graphical
         TabIndex        =   7
         Top             =   360
         Width           =   975
   ...
   Begin TrueOleDBList60.TDBCombo TDBCombo_company 
      Height          =   375
      Left            =   1560
      OleObjectBlob   =   "frm_rpt_spt_pph21.frx":0BFC
      TabIndex        =   1
      Top             =   240
      Width           =   1695
   End
...
d1 = Format(DTPicker_yearly.Value, "yyyy")
'd2 = Format(DTPicker_yearly.Value, "yyyy-12-27")

'str_sql = "CALL spg_spt21_ebiz('" & str_employee_code & "', '" & d1 & "', '" & d2 & "', '" & d2 & "');"
'CnG.Execute str_sql
str_sql = "CALL spg_spt21_ebiz1('" & str_employee_code & "','" & d1 & "', " & _
        "'" & TDBCombo_company.Text & "', " & cbo_yearly_employee.ListIndex & ",'" & LOGIN_LEVEL & "');"
str_param_periode = "YEARLY : (" & Format(DTPicker_yearly.Value, "yyyy") & ")"
...
'
'        strSQL = "call sp_summary_payroll('" & kdkaryawan & "','" & tgl1 & "','" & tgl2 & "')"
'
...
'
'    Call a.Show
'    a.Caption = "SUMMARY PPH 21 REPORT"
