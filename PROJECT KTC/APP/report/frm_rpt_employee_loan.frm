...
Begin VB.Form frm_rpt_employee_loan 
   ...
   ClientTop       =   240
   ClientWidth     =   10560
   Icon            =   "frm_rpt_employee_loan.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   MinButton       =   0   'False
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      TabHeight       =   520
      TabCaption(0)   =   "YEARLY"
      TabPicture(0)   =   "frm_rpt_employee_loan.frx":000C
      Tab(0).ControlEnabled=   -1  'True
      Tab(0).Control(0)=   "Frame2"
      Tab(0).Control(0).Enabled=   0   'False
      Tab(0).ControlCount=   1
      TabCaption(1)   =   "PERIODE"
      TabPicture(1)   =   "frm_rpt_employee_loan.frx":0028
      Tab(1).ControlEnabled=   0   'False
      Tab(1).Control(0)=   "Frame1"
      Tab(1).Control(0).Enabled=   0   'False
      Tab(1).ControlCount=   1
      TabCaption(2)   =   "RESERVED"
      TabPicture(2)   =   "frm_rpt_employee_loan.frx":0044
      ...
      Begin VB.Frame Frame1 
         ...
         Begin VB.ComboBox cbo_periode_to 
            Height          =   315
            ItemData        =   "frm_rpt_employee_loan.frx":0060
            Left            =   3600
            List            =   "frm_rpt_employee_loan.frx":006A
            TabIndex        =   21
            Text            =   "..."
            Top             =   1560
            Width           =   1335
         ...
         Begin VB.ComboBox cbo_periode_company 
            Height          =   315
            ItemData        =   "frm_rpt_employee_loan.frx":0078
            Left            =   1800
            List            =   "frm_rpt_employee_loan.frx":0082
            TabIndex        =   20
            Text            =   "..."
            Top             =   840
            Width           =   1695
         ...
         Begin VB.ComboBox cbo_periode_employee 
            Height          =   315
            ItemData        =   "frm_rpt_employee_loan.frx":0095
            Left            =   1800
            List            =   "frm_rpt_employee_loan.frx":009F
            TabIndex        =   18
            Text            =   "..."
            Top             =   1200
            Width           =   1695
      ...
      Begin VB.Frame Frame2 
         ...
         Begin VB.ComboBox cbo_monthly_company 
            Height          =   315
            ItemData        =   "frm_rpt_employee_loan.frx":00B0
            Left            =   1800
            List            =   "frm_rpt_employee_loan.frx":00BA
            TabIndex        =   8
            Text            =   "..."
            Top             =   840
            Width           =   1695
   ...
   Begin VB.Frame Frame3 
      ...
      Begin VB.CommandButton CmdPrint 
         ...
         Height          =   645
         Left            =   6120
         Picture         =   "frm_rpt_employee_loan.frx":00CD
         Style           =   1  'Graphical
         TabIndex        =   2
         Top             =   360
         Width           =   975
      ...
      Begin VB.CommandButton CmdExit 
         ...
         Height          =   645
         Left            =   8280
         Picture         =   "frm_rpt_employee_loan.frx":0657
         Style           =   1  'Graphical
         TabIndex        =   3
         Top             =   360
         Width           =   975
   ...
   Begin TrueOleDBList60.TDBCombo TDBCombo_company 
      Height          =   375
      Left            =   1560
      OleObjectBlob   =   "frm_rpt_employee_loan.frx":0BE1
      TabIndex        =   1
      Top             =   240
      Width           =   1695
   End
   ...
   End
End
Attribute VB_Name = "frm_rpt_employee_loan"
...
'        End If
    ...
    strsql = "call sp_employee_loan('" & tgl1 & "','" & tgl2 & "')"
    str_file = "\report\rpt_employee_loan.rpt"
    
    Call a.Show
    a.Caption = "EMPLOYEE LOAN REPORT"
