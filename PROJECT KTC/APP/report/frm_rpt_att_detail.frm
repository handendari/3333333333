...
str_file = "\report\rpt_01_1_mdn.rpt"
If cbo_daily_company.ListIndex = 0 Then
    int_flag_company = 0
    str_company_code = "-"
ElseIf cbo_daily_company.ListIndex = 1 Then
...
str_sql = "call sp_detail_attendance('" & str_employee_code & "','" & tgl1 & "','" & tgl2 & "','" & TDBCombo_company.Text & "','" & LOGIN_LEVEL & "')"
...
If SSTab1.Tab = 2 Then
    If check_valid_periode Then
        ...
        strsql = "call sp_detail_attendance('" & txt_periode_employee_code.Text & "','" & tgl1 & "','" & tgl2 & "','" & TDBCombo_company.Text & "','" & LOGIN_LEVEL & "')"
        str_file = "\report\rpt_01_mdn.rpt"
...
ElseIf SSTab1.Tab = 1 Then
    If check_valid_monthly Then
        ...
        strsql = "call sp_detail_attendance('" & txt_monthly_employee_code.Text & "','" & tgl1 & "','" & tgl2 & "','" & TDBCombo_company.Text & "','" & LOGIN_LEVEL & "')"
        str_file = "\report\rpt_01_mdn.rpt"
