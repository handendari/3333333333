...
Begin VB.Form frm_rpt_premi_jamsostek 
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      TabPicture(2)   =   "frm_rpt_premi_jamsostek.frx":0044
      ...
      Begin VB.Frame Frame1 
         ...
         Begin VB.ComboBox cbo_periode_to 
            Height          =   315
            ItemData        =   "frm_rpt_premi_jamsostek.frx":0060
            Left            =   3600
            List            =   "frm_rpt_premi_jamsostek.frx":006A
            TabIndex        =   21
            Text            =   "..."
            Top             =   1560
            Width           =   1335
         ...
         Begin VB.ComboBox cbo_periode_company 
            Height          =   315
            ItemData        =   "frm_rpt_premi_jamsostek.frx":0078
            Left            =   1800
            List            =   "frm_rpt_premi_jamsostek.frx":0082
            TabIndex        =   20
            Text            =   "..."
            Top             =   840
            Width           =   1695
         ...
         Begin VB.ComboBox cbo_periode_employee 
            Height          =   315
            ItemData        =   "frm_rpt_premi_jamsostek.frx":0095
            Left            =   1800
            List            =   "frm_rpt_premi_jamsostek.frx":009F
            TabIndex        =   18
            Text            =   "..."
            Top             =   1200
            Width           =   1695
      ...
      Begin VB.Frame Frame2 
         ...
         Begin VB.ComboBox cbo_yearly_employee 
            Height          =   315
            ItemData        =   "frm_rpt_premi_jamsostek.frx":00B0
            Left            =   1800
            List            =   "frm_rpt_premi_jamsostek.frx":00BA
            TabIndex        =   27
            Text            =   "..."
            Top             =   1200
            Width           =   1695
         ...
         Begin VB.ComboBox cbo_monthly_company 
            Height          =   315
            ItemData        =   "frm_rpt_premi_jamsostek.frx":00CB
            Left            =   1800
            List            =   "frm_rpt_premi_jamsostek.frx":00D5
            TabIndex        =   8
            Text            =   "..."
            Top             =   840
            Width           =   1695
   ...
   Begin VB.Frame Frame3 
      ...
      Begin VB.CommandButton CmdPrint 
         ...
         Height          =   645
         Left            =   6120
         Picture         =   "frm_rpt_premi_jamsostek.frx":00E8
         Style           =   1  'Graphical
         TabIndex        =   2
         Top             =   360
         Width           =   975
      ...
      Begin VB.CommandButton CmdExit 
         ...
         Height          =   645
         Left            =   8280
         Picture         =   "frm_rpt_premi_jamsostek.frx":0672
         Style           =   1  'Graphical
         TabIndex        =   3
         Top             =   360
         Width           =   975
   ...
   Begin TrueOleDBList60.TDBCombo TDBCombo_company 
      Height          =   375
      Left            =   1560
      OleObjectBlob   =   "frm_rpt_premi_jamsostek.frx":0BFC
      TabIndex        =   1
      Top             =   240
      Width           =   1695
   End
...
'        End If
    ...
    strsql = "call sp_premi_jamsostek('" & kdkaryawan & "','" & tgl1 & "','" & tgl2 & "','" & TDBCombo_company.Text & "','" & LOGIN_LEVEL & "')"
