...
Begin VB.Form frm_List_Pension 
   Caption         =   "Others Income History"
   ClientHeight    =   8610
   ClientLeft      =   120
   ClientTop       =   450
   ClientWidth     =   14910
   ...
   Begin prj_fej_jkt.vbButton vbButton1 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "frm_list_pension.frx":0000
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin TrueOleDBList60.TDBCombo TDBCombo_company 
      Height          =   375
      Left            =   1410
      OleObjectBlob   =   "frm_list_pension.frx":001C
      TabIndex        =   3
      Top             =   690
      Width           =   1785
   End
   ...
   Begin prj_fej_jkt.vbButton vbButton2 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "frm_list_pension.frx":1FDA
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin prj_fej_jkt.vbButton vbButton3 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "frm_list_pension.frx":1FF6
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin prj_fej_jkt.vbButton vbButton4 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "frm_list_pension.frx":2012
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   End
End
Attribute VB_Name = "frm_List_Pension"
...
'   End With
    ...
    With LynxGrid1
      ...
      .AddColumn "Title Code", , , , , , , , , False
      .AddColumn "Title", 2000, , , , , , , , , True
      .AddColumn "Basic Salary", 1200, lgAlignCenterCenter, lgNumeric, "#,##", , , , , True
      .AddColumn "Kali Gaji", 1200, lgAlignCenterCenter, lgNumeric, "#,##", , , , , True
      .AddColumn "Uang Pensiun", 1200, lgAlignCenterCenter, lgNumeric, "#,##", , , , , True
      .AddColumn "Persen", 500, lgAlignCenterCenter, lgNumeric, "#,##", , , , , True
      .AddColumn "Uang Persen", 1200, lgAlignCenterCenter, lgNumeric, "#,##", , , , , True
      .AddColumn "Total Pensiun", 1200, lgAlignCenterCenter, lgNumeric, "#,##", , , , , True
      .AddColumn "Remark", 2000, , , , , , , , True
      .AddColumn "Entry Date", 1200, lgAlignCenterCenter, lgDate, "dd-MM-yyyy", , , , , True
      .BackColorBkg = &HFCE1CB
      .Redraw = True
...
'        & "FROM t_employee_income a JOIN m_employee b ON a.employee_code = b.employee_code " _
...
'    rs.Close
    strsql = "SELECT a.tgltrans," _
                & "a.employee_code,b.employee_name," _
                & "b.department_code,c.department_name," _
                & "b.title_code,d.title_name," _
                & "a.basic_salary,a.kali_gaji,a.uang_pensiun," _
                & "a.persen_transport,a.uang_transport,a.total_pensiun," _
                & "a.remark,a.tglinput " _
        & "FROM t_pensiun a JOIN m_employee b ON a.employee_code = b.employee_code " _
        & "JOIN m_department c ON b.department_code = c.department_code and b.company_code = c.company_code " _
        & "JOIN m_title d ON b.title_code = d.title_code  " _
        & "WHERE b.company_code = '" & TDBCombo_company.Text & "' " _
        & "AND a.tgltrans BETWEEN '" & Format(DTPicker1.Value, "yyyy-MM-dd") & "' AND '" & Format(DTPicker2.Value, "yyyy-MM-dd") & "' " _
        & "AND b.department_code = '" & LynxGrid2.CellText(LynxGrid2.Row, 0) & "'"
    ...
    If rs.RecordCount > 0 Then
        rs.MoveFirst
        While Not rs.EOF
            LynxGrid1.AddItem rs!tgltrans _
                & vbTab & rs!employee_code & vbTab & rs!employee_name _
                & vbTab & rs!division_code & vbTab & rs!division_name _
                & vbTab & rs!title_code & vbTab & rs!title_name _
                & vbTab & rs!basic_salary & vbTab & rs!kali_gaji _
                & vbTab & rs!uang_pensiun & vbTab & rs!persen_transport _
                & vbTab & rs!uang_transport & vbTab & rs!uang_pensiun _
                & vbTab & rs!remark & vbTab & rs!tglinput
            rs.MoveNext
        Wend
    End If
    rs.Close
...
Private Sub vbButton4_Click()
    ...
    If tanya = vbYes Then
        CnG.Execute "DELETE FROM t_employee_income where employee_code = '" & LynxGrid1.CellText(LynxGrid1.Row, 2) & "' " _
