...
Set ts = TextFileObj.OpenTextFile("D:\tomcat\projects\PPH21\db_backup\db_deploy\db_attp_1_test.sql", ForReading)
Set rs = New ADODB.Recordset

TxtStr = ts.ReadAll

'rs.Open ts.ReadAll, CnG, adOpenForwardOnly, adLockReadOnly

CnG.Execute ts.ReadAll
