...
Begin VB.MDIForm mdi_absensi 
      ...
      Begin MSComctlLib.ImageList ImageList1 
         ...
         BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
            ...
            BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "mdi_absensi.frx":4A2B2
               Key             =   ""
            EndProperty
            BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "mdi_absensi.frx":4A84C
               Key             =   ""
            EndProperty
            BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "mdi_absensi.frx":4AC9E
               Key             =   ""
            EndProperty
         EndProperty
      End
   ...
   Begin VB.PictureBox Picture4 
      ...
      Top             =   0
      Width           =   125
      Begin prj_fej_jkt.vbButton cmd_navigation 
         Height          =   2055
         Left            =   0
         TabIndex        =   7
         Top             =   2640
   ...
   Begin OutlookBar.ctxOutlookBar ctxOutlookBar1 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      FormatControl   =   "mdi_absensi.frx":4CBFA
      FormatGroup     =   "mdi_absensi.frx":4CD6E
      FormatGroupHover=   "mdi_absensi.frx":4CE92
      FormatGroupPressed=   "mdi_absensi.frx":4CFA2
      FormatGroupSelected=   "mdi_absensi.frx":4D0A6
      FormatItem      =   "mdi_absensi.frx":4D18E
      FormatItemLargeIcons=   "mdi_absensi.frx":4D29E
      FormatItemHover =   "mdi_absensi.frx":4D39A
      FormatItemPressed=   "mdi_absensi.frx":4D482
      FormatItemSelected=   "mdi_absensi.frx":4D56A
      FormatSmallIcon =   "mdi_absensi.frx":4D62A
      FormatSmallIconHover=   "mdi_absensi.frx":4D712
      FormatSmallIconPressed=   "mdi_absensi.frx":4D80E
      FormatSmallIconSelected=   "mdi_absensi.frx":4D90A
      FormatLargeIcon =   "mdi_absensi.frx":4DA06
      FormatLargeIconHover=   "mdi_absensi.frx":4DAEE
      FormatLargeIconPressed=   "mdi_absensi.frx":4DBEA
      FormatLargeIconSelected=   "mdi_absensi.frx":4DCE6
      Groups          =   "mdi_absensi.frx":4DDE2
   End
   Begin VB.Menu M01 
      Caption         =   "A1"
   End
...
& "from m_user U join t_user F on U.user_code = F.user_code " _
...
If rs1.Fields("form_name").Value = "frm_mst_shift_group" Then Call exec_menu_(frm_mst_shift_group, rs1.Fields("form_modal").Value)

If rs1.Fields("form_name").Value = "frm_mst_employee" Then Call exec_menu_(frm_mst_employee, rs1.Fields("form_modal").Value)
If rs1.Fields("form_name").Value = "frm_mst_employee_not_active" Then Call exec_menu_(frm_mst_employee_not_active, rs1.Fields("form_modal").Value)
...
If rs1.Fields("form_name").Value = "frm_mst_salary" Then Call exec_menu_(frm_mst_salary, rs1.Fields("form_modal").Value)
...
If rs1.Fields("form_name").Value = "frm_mst_salary_exp_employee" Then Call exec_menu_(frm_List_PotonganLain, rs1.Fields("form_modal").Value)
If rs1.Fields("form_name").Value = "frm_mst_ptkp" Then Call exec_menu_(frm_mst_ptkp, rs1.Fields("form_modal").Value)
If rs1.Fields("form_name").Value = "frm_mst_pph21_spt" Then Call exec_menu_(frm_mst_pph21_spt, rs1.Fields("form_modal").Value)
If rs1.Fields("form_name").Value = "frm_mst_pph21_compensation" Then Call exec_menu_(frm_mst_pph21_compensation, rs1.Fields("form_modal").Value)
...
If rs1.Fields("form_name").Value = "frm_trans_log_attendance_manual" Then Call exec_menu_(frm_log_manual_att, rs1.Fields("form_modal").Value)
If rs1.Fields("form_name").Value = "frm_trans_absent" Then Call exec_menu_(frm_trans_absent, rs1.Fields("form_modal").Value)
If rs1.Fields("form_name").Value = "frm_trans_pensiun" Then Call exec_menu_(frm_List_pensiun, rs1.Fields("form_modal").Value)
...
If rs1.Fields("form_name").Value = "frm_trans_other_expense" Then Call exec_menu_(frm_List_PotonganLain, rs1.Fields("form_modal").Value)
If rs1.Fields("form_name").Value = "frm_trans_other_income" Then Call exec_menu_(frm_List_IncomeLain, rs1.Fields("form_modal").Value)
...
If rs1.Fields("form_name").Value = "frm_import_salary" Then Call exec_menu_(frm_import_salary, rs1.Fields("form_modal").Value)
If rs1.Fields("form_name").Value = "frm_import_salary_pph" Then Call exec_menu_(frm_import_salary_pph, rs1.Fields("form_modal").Value)
If rs1.Fields("form_name").Value = "frm_import_attendance" Then Call exec_menu_(frm_import_attendance, rs1.Fields("form_modal").Value)
...
If rs1.Fields("form_name").Value = "frm_proses_salary" Then Call exec_menu_(frm_proses_salary, rs1.Fields("form_modal").Value)
...
If rs1.Fields("form_name").Value = "frm_rpt_spt_pph21_eks" Then Call exec_menu_(frm_rpt_spt_pph21_eks, rs1.Fields("form_modal").Value)
If rs1.Fields("form_name").Value = "frm_rpt_employee_loan" Then Call exec_menu_(frm_rpt_employee_loan, rs1.Fields("form_modal").Value)
If rs1.Fields("form_name").Value = "frm_rpt_compensation" Then Call exec_menu_(frm_rpt_compensation, rs1.Fields("form_modal").Value)
...
If rs.RecordCount > 0 Then
    If Format(rs!Dt, "yyyy-mm-dd") >= "2011-12-31" Then
