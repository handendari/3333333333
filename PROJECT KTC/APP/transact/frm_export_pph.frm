...
Begin VB.Form frm_export_pph 
   ...
   Begin TrueOleDBList60.TDBCombo TDBCombo_company 
      Height          =   375
      Left            =   1470
      OleObjectBlob   =   "frm_export_pph.frx":0070
      TabIndex        =   10
      Top             =   120
      Width           =   1695
   End
...
If rs.RecordCount > 0 Then
    ...
    strsql = "Select MAX(nourut) nourut from t_pph_export " & _
             "Where tahun_pajak = " & txtYear.Text & " AND company_code = '" & TDBCombo_company.Text & "'"
