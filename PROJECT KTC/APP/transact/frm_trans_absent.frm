...
Begin VB.Form frm_trans_absent 
   BorderStyle     =   4  'Fixed ToolWindow
   Caption         =   "ABSENT UTILITY"
   ClientHeight    =   9090
   ClientLeft      =   -15
   ClientTop       =   240
   ClientWidth     =   14685
   ...
   EndProperty
   Icon            =   "frm_trans_absent.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   MinButton       =   0   'False
   ...
   Begin VB.Frame fra_entry 
      ...
      Begin VB.ComboBox cbo_date_to 
         Height          =   315
         ItemData        =   "frm_trans_absent.frx":000C
         Left            =   10200
         List            =   "frm_trans_absent.frx":0016
         TabIndex        =   5
         Text            =   "..."
         Top             =   840
         Width           =   1095
      ...
      Begin MSComCtl2.DTPicker DTPicker_date_to 
         ...
         CurrentDate     =   39270
      End
      Begin TrueOleDBList60.TDBCombo tdbAbsentStatus 
         Height          =   375
         Left            =   8400
         OleObjectBlob   =   "frm_trans_absent.frx":0024
         TabIndex        =   3
         Top             =   420
         Width           =   1305
      End
   ...
   Begin VB.Frame frmTombol 
      ...
      Begin VB.CommandButton cmd_refresh 
         ...
         Height          =   645
         Left            =   7440
         Picture         =   "frm_trans_absent.frx":1FD1
         Style           =   1  'Graphical
         TabIndex        =   13
         Top             =   360
         Width           =   975
      ...
      Begin VB.CommandButton CmdSave 
         ...
         Height          =   645
         Left            =   1800
         Picture         =   "frm_trans_absent.frx":255B
         Style           =   1  'Graphical
         TabIndex        =   9
         Top             =   360
         Width           =   975
      ...
      Begin VB.CommandButton CmdCancel 
         ...
         Height          =   645
         Left            =   5040
         Picture         =   "frm_trans_absent.frx":2AE5
         Style           =   1  'Graphical
         TabIndex        =   12
         Top             =   360
         Width           =   975
      ...
      Begin VB.CommandButton CmdExit 
         ...
         Height          =   645
         Left            =   9600
         Picture         =   "frm_trans_absent.frx":306F
         Style           =   1  'Graphical
         TabIndex        =   14
         Top             =   360
         Width           =   975
      ...
      Begin VB.CommandButton CmdNew 
         ...
         Height          =   645
         Left            =   720
         Picture         =   "frm_trans_absent.frx":35F9
         Style           =   1  'Graphical
         TabIndex        =   8
         Top             =   360
         Width           =   975
      ...
      Begin VB.CommandButton CmdPrint 
         ...
         Height          =   645
         Left            =   0
         Picture         =   "frm_trans_absent.frx":3B83
         Style           =   1  'Graphical
         TabIndex        =   19
         Top             =   600
         Visible         =   0   'False
      ...
      Begin VB.CommandButton cmdDelete 
         ...
         Height          =   645
         Left            =   3960
         Picture         =   "frm_trans_absent.frx":410D
         Style           =   1  'Graphical
         TabIndex        =   11
         Top             =   360
         Width           =   975
      ...
      Begin VB.CommandButton cmdEdit 
         ...
         Height          =   645
         Left            =   2880
         Picture         =   "frm_trans_absent.frx":4697
         Style           =   1  'Graphical
         TabIndex        =   10
         Top             =   360
         Width           =   975
   ...
   Begin TrueOleDBGrid70.TDBGrid TDBGrid1 
      ...
      Columns(8).DataField=   "absent_number"
      ...
      Columns(11).ValueItems(0).DisplayValue=   "Permission"
      ...
      Columns(11).ValueItems(2).DisplayValue=   "Other"
      ...
      Columns(11).DataField=   "absent_status"
      Columns(11)._PropDict=   "_MaxComboItems,516,2;_VlistStyle,514,3"
      Columns(12)._VlistStyle=   0
      Columns(12)._MaxComboItems=   5
      Columns(12).Caption=   "DATE FROM"
      Columns(12).DataField=   "absent_date_from"
      ...
      Columns(14).DataField=   "absent_date_to"
      ...
      Splits(0)._ColumnProps(74)=   "Column(11)._ColStyle=516"
      Splits(0)._ColumnProps(75)=   "Column(11).Button=1"
      ...
      Splits(1)._ColumnProps(70)=   "Column(9).Width=1852"
      Splits(1)._ColumnProps(71)=   "Column(9).DividerColor=0"
      Splits(1)._ColumnProps(72)=   "Column(9)._WidthInPix=1773"
      Splits(1)._ColumnProps(73)=   "Column(9)._ColStyle=516"
      Splits(1)._ColumnProps(74)=   "Column(9).Order=10"
      Splits(1)._ColumnProps(75)=   "Column(10).Width=4524"
      Splits(1)._ColumnProps(76)=   "Column(10).DividerColor=0"
      Splits(1)._ColumnProps(77)=   "Column(10)._WidthInPix=4445"
      Splits(1)._ColumnProps(78)=   "Column(10)._ColStyle=516"
      Splits(1)._ColumnProps(79)=   "Column(10).Order=11"
      Splits(1)._ColumnProps(80)=   "Column(11).Width=2514"
      Splits(1)._ColumnProps(81)=   "Column(11).DividerColor=0"
      Splits(1)._ColumnProps(82)=   "Column(11)._WidthInPix=2434"
      Splits(1)._ColumnProps(83)=   "Column(11)._ColStyle=516"
      Splits(1)._ColumnProps(84)=   "Column(11).Button=1"
      ...
      Splits(1)._ColumnProps(101)=   "Column(15).Width=3836"
      Splits(1)._ColumnProps(102)=   "Column(15).DividerColor=0"
      Splits(1)._ColumnProps(103)=   "Column(15)._WidthInPix=3757"
      ...
      HeadLines       =   1
      FootLines       =   1
      Caption         =   "LIST OF EMPLOYEE'S ABSENT"
      MultipleLines   =   0
      CellTipsWidth   =   0
      ...
      _StyleDefs(72)  =   "Splits(0).Columns(8).Style:id=110,.parent=13"
      _StyleDefs(73)  =   "Splits(0).Columns(8).HeadingStyle:id=107,.parent=14"
      _StyleDefs(74)  =   "Splits(0).Columns(8).FooterStyle:id=108,.parent=15"
      _StyleDefs(75)  =   "Splits(0).Columns(8).EditorStyle:id=109,.parent=17"
      ...
      _StyleDefs(80)  =   "Splits(0).Columns(10).Style:id=82,.parent=13"
      _StyleDefs(81)  =   "Splits(0).Columns(10).HeadingStyle:id=79,.parent=14"
      _StyleDefs(82)  =   "Splits(0).Columns(10).FooterStyle:id=80,.parent=15"
      _StyleDefs(83)  =   "Splits(0).Columns(10).EditorStyle:id=81,.parent=17"
      _StyleDefs(84)  =   "Splits(0).Columns(11).Style:id=46,.parent=13"
      _StyleDefs(85)  =   "Splits(0).Columns(11).HeadingStyle:id=43,.parent=14"
      _StyleDefs(86)  =   "Splits(0).Columns(11).FooterStyle:id=44,.parent=15"
      _StyleDefs(87)  =   "Splits(0).Columns(11).EditorStyle:id=45,.parent=17"
      _StyleDefs(88)  =   "Splits(0).Columns(12).Style:id=86,.parent=13"
      _StyleDefs(89)  =   "Splits(0).Columns(12).HeadingStyle:id=83,.parent=14"
      _StyleDefs(90)  =   "Splits(0).Columns(12).FooterStyle:id=84,.parent=15"
      _StyleDefs(91)  =   "Splits(0).Columns(12).EditorStyle:id=85,.parent=17"
      ...
      _StyleDefs(96)  =   "Splits(0).Columns(14).Style:id=94,.parent=13"
      _StyleDefs(97)  =   "Splits(0).Columns(14).HeadingStyle:id=91,.parent=14"
      _StyleDefs(98)  =   "Splits(0).Columns(14).FooterStyle:id=92,.parent=15"
      _StyleDefs(99)  =   "Splits(0).Columns(14).EditorStyle:id=93,.parent=17"
      _StyleDefs(100) =   "Splits(0).Columns(15).Style:id=98,.parent=13"
      _StyleDefs(101) =   "Splits(0).Columns(15).HeadingStyle:id=95,.parent=14"
      _StyleDefs(102) =   "Splits(0).Columns(15).FooterStyle:id=96,.parent=15"
      _StyleDefs(103) =   "Splits(0).Columns(15).EditorStyle:id=97,.parent=17"
      _StyleDefs(104) =   "Splits(1).Style:id=99,.parent=1"
      _StyleDefs(105) =   "Splits(1).CaptionStyle:id=116,.parent=4,.bgcolor=&H80000002&"
      _StyleDefs(106) =   ":id=116,.fgcolor=&H80000009&"
      _StyleDefs(107) =   "Splits(1).HeadingStyle:id=100,.parent=2,.alignment=2,.bgcolor=&H8000000F&"
      _StyleDefs(108) =   ":id=100,.fgcolor=&H80000002&"
      _StyleDefs(109) =   "Splits(1).FooterStyle:id=101,.parent=3"
      _StyleDefs(110) =   "Splits(1).InactiveStyle:id=102,.parent=5"
      _StyleDefs(111) =   "Splits(1).SelectedStyle:id=104,.parent=6"
      _StyleDefs(112) =   "Splits(1).EditorStyle:id=103,.parent=7"
      _StyleDefs(113) =   "Splits(1).HighlightRowStyle:id=105,.parent=8"
      _StyleDefs(114) =   "Splits(1).EvenRowStyle:id=106,.parent=9"
      _StyleDefs(115) =   "Splits(1).OddRowStyle:id=115,.parent=10"
      _StyleDefs(116) =   "Splits(1).RecordSelectorStyle:id=117,.parent=11"
      _StyleDefs(117) =   "Splits(1).FilterBarStyle:id=118,.parent=12"
      _StyleDefs(118) =   "Splits(1).Columns(0).Style:id=122,.parent=99"
      _StyleDefs(119) =   "Splits(1).Columns(0).HeadingStyle:id=119,.parent=100"
      _StyleDefs(120) =   "Splits(1).Columns(0).FooterStyle:id=120,.parent=101"
      _StyleDefs(121) =   "Splits(1).Columns(0).EditorStyle:id=121,.parent=103"
      _StyleDefs(122) =   "Splits(1).Columns(1).Style:id=126,.parent=99"
      _StyleDefs(123) =   "Splits(1).Columns(1).HeadingStyle:id=123,.parent=100"
      _StyleDefs(124) =   "Splits(1).Columns(1).FooterStyle:id=124,.parent=101"
      _StyleDefs(125) =   "Splits(1).Columns(1).EditorStyle:id=125,.parent=103"
      _StyleDefs(126) =   "Splits(1).Columns(2).Style:id=130,.parent=99"
      _StyleDefs(127) =   "Splits(1).Columns(2).HeadingStyle:id=127,.parent=100"
      _StyleDefs(128) =   "Splits(1).Columns(2).FooterStyle:id=128,.parent=101"
      _StyleDefs(129) =   "Splits(1).Columns(2).EditorStyle:id=129,.parent=103"
      _StyleDefs(130) =   "Splits(1).Columns(3).Style:id=134,.parent=99"
      _StyleDefs(131) =   "Splits(1).Columns(3).HeadingStyle:id=131,.parent=100"
      _StyleDefs(132) =   "Splits(1).Columns(3).FooterStyle:id=132,.parent=101"
      _StyleDefs(133) =   "Splits(1).Columns(3).EditorStyle:id=133,.parent=103"
      _StyleDefs(134) =   "Splits(1).Columns(4).Style:id=146,.parent=99"
      _StyleDefs(135) =   "Splits(1).Columns(4).HeadingStyle:id=143,.parent=100"
      _StyleDefs(136) =   "Splits(1).Columns(4).FooterStyle:id=144,.parent=101"
      _StyleDefs(137) =   "Splits(1).Columns(4).EditorStyle:id=145,.parent=103"
      _StyleDefs(138) =   "Splits(1).Columns(5).Style:id=150,.parent=99"
      _StyleDefs(139) =   "Splits(1).Columns(5).HeadingStyle:id=147,.parent=100"
      _StyleDefs(140) =   "Splits(1).Columns(5).FooterStyle:id=148,.parent=101"
      _StyleDefs(141) =   "Splits(1).Columns(5).EditorStyle:id=149,.parent=103"
      _StyleDefs(142) =   "Splits(1).Columns(6).Style:id=154,.parent=99"
      _StyleDefs(143) =   "Splits(1).Columns(6).HeadingStyle:id=151,.parent=100"
      _StyleDefs(144) =   "Splits(1).Columns(6).FooterStyle:id=152,.parent=101"
      _StyleDefs(145) =   "Splits(1).Columns(6).EditorStyle:id=153,.parent=103"
      _StyleDefs(146) =   "Splits(1).Columns(7).Style:id=158,.parent=99"
      _StyleDefs(147) =   "Splits(1).Columns(7).HeadingStyle:id=155,.parent=100"
      _StyleDefs(148) =   "Splits(1).Columns(7).FooterStyle:id=156,.parent=101"
      _StyleDefs(149) =   "Splits(1).Columns(7).EditorStyle:id=157,.parent=103"
      _StyleDefs(150) =   "Splits(1).Columns(8).Style:id=162,.parent=99,.alignment=1"
      _StyleDefs(151) =   "Splits(1).Columns(8).HeadingStyle:id=159,.parent=100"
      _StyleDefs(152) =   "Splits(1).Columns(8).FooterStyle:id=160,.parent=101"
      _StyleDefs(153) =   "Splits(1).Columns(8).EditorStyle:id=161,.parent=103"
      _StyleDefs(154) =   "Splits(1).Columns(9).Style:id=170,.parent=99"
      _StyleDefs(155) =   "Splits(1).Columns(9).HeadingStyle:id=167,.parent=100"
      _StyleDefs(156) =   "Splits(1).Columns(9).FooterStyle:id=168,.parent=101"
      _StyleDefs(157) =   "Splits(1).Columns(9).EditorStyle:id=169,.parent=103"
      _StyleDefs(158) =   "Splits(1).Columns(10).Style:id=174,.parent=99"
      _StyleDefs(159) =   "Splits(1).Columns(10).HeadingStyle:id=171,.parent=100"
      _StyleDefs(160) =   "Splits(1).Columns(10).FooterStyle:id=172,.parent=101"
      _StyleDefs(161) =   "Splits(1).Columns(10).EditorStyle:id=173,.parent=103"
      _StyleDefs(162) =   "Splits(1).Columns(11).Style:id=54,.parent=99"
      _StyleDefs(163) =   "Splits(1).Columns(11).HeadingStyle:id=51,.parent=100"
      _StyleDefs(164) =   "Splits(1).Columns(11).FooterStyle:id=52,.parent=101"
      _StyleDefs(165) =   "Splits(1).Columns(11).EditorStyle:id=53,.parent=103"
      _StyleDefs(166) =   "Splits(1).Columns(12).Style:id=178,.parent=99,.alignment=2"
      _StyleDefs(167) =   "Splits(1).Columns(12).HeadingStyle:id=175,.parent=100"
      _StyleDefs(168) =   "Splits(1).Columns(12).FooterStyle:id=176,.parent=101"
      _StyleDefs(169) =   "Splits(1).Columns(12).EditorStyle:id=177,.parent=103"
      _StyleDefs(170) =   "Splits(1).Columns(13).Style:id=182,.parent=99,.alignment=2"
      _StyleDefs(171) =   "Splits(1).Columns(13).HeadingStyle:id=179,.parent=100"
      _StyleDefs(172) =   "Splits(1).Columns(13).FooterStyle:id=180,.parent=101"
      _StyleDefs(173) =   "Splits(1).Columns(13).EditorStyle:id=181,.parent=103"
      _StyleDefs(174) =   "Splits(1).Columns(14).Style:id=186,.parent=99,.alignment=2"
      _StyleDefs(175) =   "Splits(1).Columns(14).HeadingStyle:id=183,.parent=100"
      _StyleDefs(176) =   "Splits(1).Columns(14).FooterStyle:id=184,.parent=101"
      _StyleDefs(177) =   "Splits(1).Columns(14).EditorStyle:id=185,.parent=103"
      _StyleDefs(178) =   "Splits(1).Columns(15).Style:id=190,.parent=99"
      _StyleDefs(179) =   "Splits(1).Columns(15).HeadingStyle:id=187,.parent=100"
      _StyleDefs(180) =   "Splits(1).Columns(15).FooterStyle:id=188,.parent=101"
      _StyleDefs(181) =   "Splits(1).Columns(15).EditorStyle:id=189,.parent=103"
      ...
      _StyleDefs(196) =   ":id=39,.parent=33,.bgcolor=&HFFFF00&"
   ...
   Begin TrueOleDBList60.TDBCombo TDBCombo_company 
      Height          =   375
      Left            =   1500
      OleObjectBlob   =   "frm_trans_absent.frx":4C21
      TabIndex        =   1
      Top             =   180
      Width           =   1695
   End
   ...
   End
End
Attribute VB_Name = "frm_trans_absent"
...
Dim rsAbsenStatus As New ADODB.Recordset
...
frm_lookup_mst_employee.public_int_mode = 2
...
CnG.BeginTrans
CnG.Execute "delete from t_absent where absent_number = " _
    & TDBGrid1.Columns("absent_number").Value
CnG.CommitTrans
...
With Adodc1.Recordset
    ...
    tdbAbsentStatus.Text = .Fields("absent_status").Value
    txtStatusName.Text = .Fields("absent_name").Value
    DTPicker_date_from.Value = .Fields("absent_date_from").Value
    cbo_date_to.ListIndex = .Fields("flag_date_to").Value
    If cbo_date_to.ListIndex = 1 Then _
        DTPicker_date_to.Value = .Fields("absent_date_to").Value
...
rsBound.Open "select * from t_absent where absent_number = " _
& Adodc1.Recordset.Fields("absent_number").Value, CnG, adOpenKeyset, adLockOptimistic
...
If rsBound.State = 1 Then rsBound.Close
rsBound.Open "select * from t_absent where absent_number = -1", CnG, adOpenKeyset, adLockOptimistic
...
rs.Open "select ifnull(max(absent_number),0)+1 as absent_number from t_absent", CnG, adOpenStatic, adLockReadOnly
...
With rsBound
    ...
    .Fields("absent_number").Value = rs.Fields("absent_number").Value
    '-----------------------------------------------------------------------------
    .Fields("employee_code").Value = Trim(txt_employee_code)
    .Fields("absent_status").Value = tdbAbsentStatus.Text
    .Fields("absent_date_from").Value = Format(DTPicker_date_from.Value, "yyyy-MM-dd HH:mm:ss")
    .Fields("flag_date_to").Value = cbo_date_to.ListIndex
    If cbo_date_to.ListIndex = 1 Then _
        .Fields("absent_date_to").Value = Format(DTPicker_date_to.Value, "yyyy-MM-dd HH:mm:ss")
...
With rsBound
    ...
    '-----------------------------------------------------------------------------
'    .Fields("employee_code").Value = Trim(txt_employee_code)
'    .Fields("absent_status").Value = cbo_absent_status.ListIndex
'    .Fields("absent_date_from").Value = Format(DTPicker_date_from.Value, "yyyy-MM-dd HH:mm:ss")
'    .Fields("flag_date_to").Value = cbo_date_to.ListIndex
'    .Fields("absent_date_to").Value = dt_to
'    .Fields("description").Value = Trim(txt_description)
'    .Fields("entry_date").Value = Format(Now, "yyyy-MM-dd HH:mm:ss")
'
'    .Update
...
Private Sub isiAbsentStatus()
    ...
    Dim rsAbsent As New ADODB.Recordset
    
    strSQL = "select absent_code,absent_name from m_absent_status order by absent_code"
    rsAbsent.Open strSQL, CnG, adOpenForwardOnly, adLockReadOnly
    
    Set tdbAbsentStatus.RowSource = rsAbsent
    'rs.Close
...
Private Sub tdbAbsentStatus_ItemChange()
    If tdbAbsentStatus.ApproxCount > 0 Then
        tdbAbsentStatus.Text = tdbAbsentStatus.Columns("absent_code").Value
        txtStatusName.Text = tdbAbsentStatus.Columns("absent_name").Value
...
Private Sub load_data_absent()
Adodc1.RecordSource = "select * from v_t_absent where company_code = '" _
& TDBCombo_company.Columns("company_code").Value & "' order by absent_number"
Adodc1.Refresh
