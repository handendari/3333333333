...
If TDBCombo_company.ApproxCount > 0 Then
    ...
    Call load_data_summary_leave_all
End If
End Sub
...
Adodc1.RecordSource = "select * from v_t_leave_periode " _
    ...
    & "company_code = '" & TDBCombo_company.Columns("company_code").Value & "' order by department_code,division_code,employee_code"
Adodc1.Refresh

TDBGrid1.DataSource = Adodc1
End Sub

Private Sub load_data_summary_leave_all()
Dim access As String

access = IIf(LOGIN_LEVEL = 100, "", "AND (managerial_access = 0 OR managerial_access IS NULL)")

Adodc1.RecordSource = "select * from v_t_leave_periode where " _
    & "company_code = '" & TDBCombo_company.Columns("company_code").Value & "' " & access & " order by department_code,division_code,employee_code"
Adodc1.Refresh
