...
With rs1
    ...
    .Fields("employee_code").Value = IIf(IsNull(Adodc1.Recordset.Fields("employee_code").Value), "", Adodc1.Recordset.Fields("employee_code").Value)
    '--------------------------------
    ...
    .Fields("title_code").Value = kd_jabatan 'IIf(IsNull(Adodc1.Recordset.Fields("title_code").Value), "", Adodc1.Recordset.Fields("title_code").Value)
    ...
    .Fields("flag_pic").Value = IIf(IsNull(Adodc1.Recordset.Fields("flag_pic").Value), 0, Adodc1.Recordset.Fields("flag_pic").Value)
    .Fields("pic").Value = IIf(IsNull(Adodc1.Recordset.Fields("pic").Value), "", Adodc1.Recordset.Fields("pic").Value)
    .Fields("access_code").Value = IIf(IsNull(Adodc1.Recordset.Fields("access_code").Value), 0, Adodc1.Recordset.Fields("access_code").Value)
    .Fields("managerial_level").Value = IIf(IsNull(Adodc1.Recordset.Fields("managerial_level").Value), 0, Adodc1.Recordset.Fields("managerial_level").Value)
    .Fields("fathers_name").Value = IIf(IsNull(Adodc1.Recordset.Fields("fathers_name").Value), "", Adodc1.Recordset.Fields("fathers_name").Value)
    .Fields("mothers_name").Value = IIf(IsNull(Adodc1.Recordset.Fields("mothers_name").Value), "", Adodc1.Recordset.Fields("mothers_name").Value)
    .Fields("child_number_from").Value = IIf(IsNull(Adodc1.Recordset.Fields("child_number_from").Value), 0, Adodc1.Recordset.Fields("child_number_from").Value)
    .Fields("child_number").Value = IIf(IsNull(Adodc1.Recordset.Fields("child_number").Value), 0, Adodc1.Recordset.Fields("child_number").Value)
    .Fields("start_mc").Value = IIf(IsNull(Adodc1.Recordset.Fields("start_mc").Value), vbNull, Adodc1.Recordset.Fields("start_mc").Value)
    .Fields("end_mc").Value = IIf(IsNull(Adodc1.Recordset.Fields("end_mc").Value), vbNull, Adodc1.Recordset.Fields("end_mc").Value)
    .Fields("branches").Value = IIf(IsNull(Adodc1.Recordset.Fields("branches").Value), "", Adodc1.Recordset.Fields("branches").Value)
...
For i = 1 To Adodc1.Recordset.RecordCount
    ...
    If insert_new_data_comp(Adodc1.Recordset.Fields("company_name").Value) Then
        comp = comp + 1
    End If
    If insert_new_data_dept(Adodc1.Recordset.Fields("department_name").Value) Then
        dep = dep + 1
    End If
    If insert_new_data_div(Adodc1.Recordset.Fields("division_name").Value) Then
        div = div + 1
    End If
    If insert_new_data_title(Adodc1.Recordset.Fields("title_name").Value) Then
        ttl = ttl + 1
    End If
...
Private Function insert_new_data_comp(nama As String) As Boolean
'On Error GoTo err_handle

Dim rs1 As New ADODB.Recordset

If rs1.State = 1 Then rs1.Close
rs1.Open "select * from m_company where company_name = '" & nama & "'", CnG, adOpenKeyset, adLockOptimistic
...
Private Function insert_new_data_dept(nama As String) As Boolean
On Error GoTo err_handle

Dim rs1 As New ADODB.Recordset

If rs1.State = 1 Then rs1.Close
rs1.Open "select * from m_department where department_name = 'uOu'", CnG, adOpenKeyset, adLockOptimistic
...
Private Function insert_new_data_div(nama As String) As Boolean
On Error GoTo err_handle

Dim rs1 As New ADODB.Recordset

If rs1.State = 1 Then rs1.Close
rs1.Open "select * from m_division where division_name = 'uOu'", CnG, adOpenKeyset, adLockOptimistic
...
Private Function insert_new_data_title(nama As String) As Boolean
'On Error GoTo err_handle
...
If rs1.State = 1 Then rs1.Close
rs1.Open "select * from m_title where title_name = '" & nama & "'", CnG, adOpenKeyset, adLockOptimistic
If rs1.RecordCount = 0 Then
    rscari.Open "SELECT count(title_code) nourut from m_title", CnG, adOpenForwardOnly, adLockReadOnly
    nourut = IIf(IsNull(rscari!nourut), 0, rscari!nourut) + 1
    ...
    With rs1
        ...
        .Fields("title_code").Value = nourut 'Adodc1.Recordset.Fields("title_code").Value
