...
Begin VB.Form frm_trans_log_attendance_manual 
   ...
   Begin TrueOleDBGrid70.TDBGrid TDBGrid1 
      ...
      _StyleDefs(27)  =   "Splits(0).Style:id=123,.parent=1"
      _StyleDefs(28)  =   "Splits(0).CaptionStyle:id=132,.parent=4,.bgcolor=&H80000002&"
      _StyleDefs(29)  =   ":id=132,.fgcolor=&H80000009&"
      _StyleDefs(30)  =   "Splits(0).HeadingStyle:id=124,.parent=2,.alignment=2,.bgcolor=&H8000000F&"
      _StyleDefs(31)  =   ":id=124,.fgcolor=&H80000002&"
      _StyleDefs(32)  =   "Splits(0).FooterStyle:id=125,.parent=3"
      _StyleDefs(33)  =   "Splits(0).InactiveStyle:id=126,.parent=5"
      _StyleDefs(34)  =   "Splits(0).SelectedStyle:id=128,.parent=6"
      _StyleDefs(35)  =   "Splits(0).EditorStyle:id=127,.parent=7"
      _StyleDefs(36)  =   "Splits(0).HighlightRowStyle:id=129,.parent=8"
      _StyleDefs(37)  =   "Splits(0).EvenRowStyle:id=130,.parent=9"
      _StyleDefs(38)  =   "Splits(0).OddRowStyle:id=131,.parent=10"
      _StyleDefs(39)  =   "Splits(0).RecordSelectorStyle:id=133,.parent=11"
      _StyleDefs(40)  =   "Splits(0).FilterBarStyle:id=134,.parent=12"
      _StyleDefs(41)  =   "Splits(0).Columns(0).Style:id=142,.parent=123,.locked=-1"
      _StyleDefs(42)  =   "Splits(0).Columns(0).HeadingStyle:id=139,.parent=124"
      _StyleDefs(43)  =   "Splits(0).Columns(0).FooterStyle:id=140,.parent=125"
      _StyleDefs(44)  =   "Splits(0).Columns(0).EditorStyle:id=141,.parent=127"
      _StyleDefs(45)  =   "Splits(0).Columns(1).Style:id=162,.parent=123,.locked=-1"
      _StyleDefs(46)  =   "Splits(0).Columns(1).HeadingStyle:id=159,.parent=124"
      _StyleDefs(47)  =   "Splits(0).Columns(1).FooterStyle:id=160,.parent=125"
      _StyleDefs(48)  =   "Splits(0).Columns(1).EditorStyle:id=161,.parent=127"
      _StyleDefs(49)  =   "Splits(0).Columns(2).Style:id=166,.parent=123,.locked=-1"
      _StyleDefs(50)  =   "Splits(0).Columns(2).HeadingStyle:id=163,.parent=124"
      _StyleDefs(51)  =   "Splits(0).Columns(2).FooterStyle:id=164,.parent=125"
      _StyleDefs(52)  =   "Splits(0).Columns(2).EditorStyle:id=165,.parent=127"
      _StyleDefs(53)  =   "Splits(0).Columns(3).Style:id=246,.parent=123,.alignment=2"
      _StyleDefs(54)  =   "Splits(0).Columns(3).HeadingStyle:id=243,.parent=124"
      _StyleDefs(55)  =   "Splits(0).Columns(3).FooterStyle:id=244,.parent=125"
      _StyleDefs(56)  =   "Splits(0).Columns(3).EditorStyle:id=245,.parent=127"
      _StyleDefs(57)  =   "Splits(0).Columns(4).Style:id=16,.parent=123,.alignment=2,.locked=-1"
      _StyleDefs(58)  =   "Splits(0).Columns(4).HeadingStyle:id=13,.parent=124"
      _StyleDefs(59)  =   "Splits(0).Columns(4).FooterStyle:id=14,.parent=125"
      _StyleDefs(60)  =   "Splits(0).Columns(4).EditorStyle:id=15,.parent=127"
