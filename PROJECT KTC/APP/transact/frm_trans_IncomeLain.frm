...
Begin VB.Form frm_trans_IncomeLain 
   ...
   Begin TrueOleDBList60.TDBCombo TDBCombo_company 
      Height          =   375
      Left            =   1410
      OleObjectBlob   =   "frm_trans_IncomeLain.frx":0000
      TabIndex        =   7
      Top             =   570
      Width           =   1785
   End
   Begin prj_fej_jkt.vbButton vbButton5 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "frm_trans_IncomeLain.frx":1FBE
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin prj_fej_jkt.vbButton vbButton1 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "frm_trans_IncomeLain.frx":1FDA
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin prj_fej_jkt.vbButton vbButton2 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "frm_trans_IncomeLain.frx":1FF6
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
...
Dim time_in As String, time_out_break As String, time_in_break As String, time_out As String
    ...
    Else
        ...
        CnG.Execute strsql
        '++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
        strsql = "INSERT INTO t_employee_income (nomer,notrans,tgltrans,employee_code,jmlpotong,userinput,tglinput,remark) VALUES " _
