...
Begin VB.Form frm_trans_manual_check 
   ...
   Begin VB.Frame fra_entry 
      ...
      Begin VB.ComboBox cbo_flag_io 
         Height          =   315
         ItemData        =   "frm_trans_check.frx":000C
         Left            =   8400
         List            =   "frm_trans_check.frx":0016
         TabIndex        =   3
         Text            =   "..."
         Top             =   480
         Width           =   2175
   ...
   Begin VB.Frame frmTombol 
      ...
      Begin VB.CommandButton cmd_refresh 
         ...
         Height          =   645
         Left            =   7440
         Picture         =   "frm_trans_check.frx":002F
         Style           =   1  'Graphical
         TabIndex        =   11
         Top             =   360
         Width           =   975
      ...
      Begin VB.CommandButton CmdSave 
         ...
         Height          =   645
         Left            =   1800
         Picture         =   "frm_trans_check.frx":05B9
         Style           =   1  'Graphical
         TabIndex        =   7
         Top             =   360
         Width           =   975
      ...
      Begin VB.CommandButton CmdCancel 
         ...
         Height          =   645
         Left            =   5040
         Picture         =   "frm_trans_check.frx":0B43
         Style           =   1  'Graphical
         TabIndex        =   10
         Top             =   360
         Width           =   975
      ...
      Begin VB.CommandButton CmdExit 
         ...
         Height          =   645
         Left            =   9600
         Picture         =   "frm_trans_check.frx":10CD
         Style           =   1  'Graphical
         TabIndex        =   12
         Top             =   360
         Width           =   975
      ...
      Begin VB.CommandButton CmdNew 
         ...
         Height          =   645
         Left            =   720
         Picture         =   "frm_trans_check.frx":1657
         Style           =   1  'Graphical
         TabIndex        =   6
         Top             =   360
         Width           =   975
      ...
      Begin VB.CommandButton CmdPrint 
         ...
         Height          =   645
         Left            =   0
         Picture         =   "frm_trans_check.frx":1BE1
         Style           =   1  'Graphical
         TabIndex        =   17
         Top             =   600
         Visible         =   0   'False
      ...
      Begin VB.CommandButton cmdDelete 
         ...
         Height          =   645
         Left            =   3960
         Picture         =   "frm_trans_check.frx":216B
         Style           =   1  'Graphical
         TabIndex        =   9
         Top             =   360
         Width           =   975
      ...
      Begin VB.CommandButton cmdEdit 
         ...
         Height          =   645
         Left            =   2880
         Picture         =   "frm_trans_check.frx":26F5
         Style           =   1  'Graphical
         TabIndex        =   8
         Top             =   360
         Width           =   975
   ...
   Begin TrueOleDBList60.TDBCombo TDBCombo_company 
      Height          =   375
      Left            =   1500
      OleObjectBlob   =   "frm_trans_check.frx":2C7F
      TabIndex        =   1
      Top             =   240
      Width           =   1695
   End
