...
Begin VB.Form frm_trans_other_expense 
   BorderStyle     =   4  'Fixed ToolWindow
   Caption         =   "OTHER EXPENSE HISTORY"
   ClientHeight    =   9090
   ClientLeft      =   -15
   ClientTop       =   240
   ClientWidth     =   14685
   ...
   EndProperty
   Icon            =   "frm_trans_other_expend.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   MinButton       =   0   'False
   ...
   Begin VB.Frame fra_entry 
      ...
      Begin VB.CommandButton cmd_browse_employee 
         ...
         Width           =   375
      End
      Begin VB.TextBox txt_income_type_name 
         Appearance      =   0  'Flat
         Height          =   315
         Left            =   5400
         Locked          =   -1  'True
      ...
      Begin VB.CommandButton CmdBrowse 
         ...
         Width           =   315
      End
      Begin VB.TextBox txt_expend_value 
         ...
         Width           =   1695
      End
      Begin TrueOleDBList60.TDBCombo TDBCombo_expend_type 
         Height          =   375
         Left            =   3600
         OleObjectBlob   =   "frm_trans_other_expend.frx":000C
         TabIndex        =   17
         Top             =   1200
         Width           =   1695
      End
      Begin MSAdodcLib.Adodc Adodc_expend_type 
         Height          =   330
         Left            =   8880
         Top             =   1200
         Visible         =   0   'False
   ...
   Begin VB.Frame frmTombol 
      ...
      Begin VB.CommandButton cmd_refresh 
         ...
         Height          =   645
         Left            =   8280
         Picture         =   "frm_trans_other_expend.frx":296E
         Style           =   1  'Graphical
         TabIndex        =   13
         Top             =   360
         Width           =   975
      ...
      Begin VB.CommandButton CmdSave 
         ...
         Height          =   645
         Left            =   1800
         Picture         =   "frm_trans_other_expend.frx":2EF8
         Style           =   1  'Graphical
         TabIndex        =   5
         Top             =   360
         Width           =   975
      ...
      Begin VB.CommandButton CmdCancel 
         ...
         Height          =   645
         Left            =   5040
         Picture         =   "frm_trans_other_expend.frx":3482
         Style           =   1  'Graphical
         TabIndex        =   8
         Top             =   360
         Width           =   975
      ...
      Begin VB.CommandButton CmdExit 
         ...
         Height          =   645
         Left            =   11640
         Picture         =   "frm_trans_other_expend.frx":3A0C
         Style           =   1  'Graphical
         TabIndex        =   10
         Top             =   360
         Width           =   975
      ...
      Begin VB.CommandButton CmdNew 
         ...
         Height          =   645
         Left            =   720
         Picture         =   "frm_trans_other_expend.frx":3F96
         Style           =   1  'Graphical
         TabIndex        =   4
         Top             =   360
         Width           =   975
      ...
      Begin VB.CommandButton CmdPrint 
         ...
         Height          =   645
         Left            =   0
         Picture         =   "frm_trans_other_expend.frx":4520
         Style           =   1  'Graphical
         TabIndex        =   9
         Top             =   600
         Visible         =   0   'False
      ...
      Begin VB.CommandButton cmdDelete 
         ...
         Height          =   645
         Left            =   3960
         Picture         =   "frm_trans_other_expend.frx":4AAA
         Style           =   1  'Graphical
         TabIndex        =   7
         Top             =   360
         Width           =   975
      ...
      Begin VB.CommandButton cmdEdit 
         ...
         Height          =   645
         Left            =   2880
         Picture         =   "frm_trans_other_expend.frx":5034
         Style           =   1  'Graphical
         TabIndex        =   6
         Top             =   360
         Width           =   975
   ...
   Begin TrueOleDBGrid70.TDBGrid TDBGrid1 
      ...
      Columns(2).Caption=   "EXPEND NAME"
      Columns(2).DataField=   "expend_name"
      Columns(2)._PropDict=   "_MaxComboItems,516,2;_VlistStyle,514,3"
      Columns(3)._VlistStyle=   0
      Columns(3)._MaxComboItems=   5
      Columns(3).Caption=   "VALUE"
      Columns(3).DataField=   "expend_value"
      ...
      Splits(0)._ColumnProps(6)=   "Column(1).Width=6879"
      Splits(0)._ColumnProps(7)=   "Column(1).DividerColor=0"
      Splits(0)._ColumnProps(8)=   "Column(1)._WidthInPix=6800"
      Splits(0)._ColumnProps(9)=   "Column(1)._ColStyle=516"
      Splits(0)._ColumnProps(10)=   "Column(1).Order=2"
      Splits(0)._ColumnProps(11)=   "Column(2).Width=5874"
      Splits(0)._ColumnProps(12)=   "Column(2).DividerColor=0"
      Splits(0)._ColumnProps(13)=   "Column(2)._WidthInPix=5794"
      Splits(0)._ColumnProps(14)=   "Column(2)._ColStyle=516"
      Splits(0)._ColumnProps(15)=   "Column(2).Order=3"
      Splits(0)._ColumnProps(16)=   "Column(3).Width=2699"
      Splits(0)._ColumnProps(17)=   "Column(3).DividerColor=0"
      Splits(0)._ColumnProps(18)=   "Column(3)._WidthInPix=2619"
      Splits(0)._ColumnProps(19)=   "Column(3)._ColStyle=514"
      Splits(0)._ColumnProps(20)=   "Column(3).Order=4"
      Splits(0)._ColumnProps(21)=   "Column(4).Width=5821"
      Splits(0)._ColumnProps(22)=   "Column(4).DividerColor=0"
      Splits(0)._ColumnProps(23)=   "Column(4)._WidthInPix=5741"
      ...
      HeadLines       =   1
      FootLines       =   1
      Caption         =   "LIST OF OTHER EXPEND HISTORY"
      MultipleLines   =   0
      CellTipsWidth   =   0
   ...
   End
End
Attribute VB_Name = "frm_trans_other_expense"
...
str_sql = "select count(date) as rec_count from t_other_expend where date = '" _
& DTPicker_date.Value & "'"
...
If DTPicker_date.Enabled = True Then DTPicker_date.SetFocus
End Sub

Private Function check_validate_exist_edit() As Boolean
check_validate_exist_edit = False

If Not DTPicker_date.Value = Adodc1.Recordset.Fields("date").Value And _
...
If Trim(txt_employee_code) = "" Then
    ...
    cmd_browse_employee.SetFocus
    check_validate_new = False
    Exit Function
End If

If check_validate_tdbcombo(TDBCombo_expend_type) = False Then
    MsgBox "Income type is not selected!", vbOKOnly + vbInformation, headerMSG
    TDBCombo_expend_type.SetFocus
    check_validate_new = False
    Exit Function
End If

If Trim(txt_expend_value) = "" Then
    MsgBox "Value is empty!", vbOKOnly + vbInformation, headerMSG
    txt_expend_value.SetFocus
    check_validate_new = False
    Exit Function
End If
...
frm_lookup_mst_employee.public_int_mode = 91
...
i = MsgBox("Are you sure want to delete data '" _
    & TDBGrid1.Columns("date").Value & "' ?", vbYesNo + vbQuestion, headerMSG)
If Not i = vbYes Then Exit Sub

'CnG.BeginTrans
'CnG.Execute "delete from t_other_expend where date = '" _
'    & Adodc1.Recordset.Fields("date").Value & "'"
...
With Adodc1.Recordset
    ...
    Call set_data_tdbcombo(Adodc_expend_type, TDBCombo_expend_type, "expend_code='" & .Fields("expend_code").Value & "'")
    Call TDBCombo_expend_type_ItemChange
    
    txt_expend_value = FormatNumber(.Fields("expend_value").Value)
...
rsBound.Open "select * from t_other_expend where date = '" _
& Format(Adodc1.Recordset.Fields("date").Value, "yyyy-mm_dd hh:nn:ss") & "'", CnG, adOpenKeyset, adLockOptimistic
...
If rsBound.State = 1 Then rsBound.Close
rsBound.Open "select * from t_other_expend where employee_code = 'άφ'", CnG, adOpenKeyset, adLockOptimistic
...
With rsBound
    ...
    .Fields("date").Value = DTPicker_date.Value
    '-------------------------------------------------------
    .Fields("employee_code").Value = Trim(txt_employee_code)
    .Fields("employee_name").Value = Trim(txt_employee_name)
    .Fields("expend_code").Value = TDBCombo_expend_type.Columns("expend_code").Value
    .Fields("expend_name").Value = TDBCombo_expend_type.Columns("expend_name").Value
    
    .Fields("expend_type").Value = TDBCombo_expend_type.Columns("expend_type").Value
    .Fields("expend_type_name").Value = TDBCombo_expend_type.Columns("expend_type_name").Value
    
    .Fields("expend_value").Value = Val(DropAllComma(txt_expend_value))
...
Adodc_expend_type.ConnectionString = strConn

Call load_data_expend_type
Call load_data
...
Private Sub TDBCombo_expend_type_ItemChange()
If TDBCombo_expend_type.ApproxCount > 0 Then
    TDBCombo_expend_type.Text = TDBCombo_expend_type.Columns("expend_code").Value
    txt_income_type_name = TDBCombo_expend_type.Columns("expend_name").Value
...
Adodc1.RecordSource = "select  *, cast(left(date,10) as char) as date_ " _
& "from t_other_expend order by date asc"
Adodc1.Refresh

TDBGrid1.DataSource = Adodc1
End Sub

Private Sub load_data_expend_type()
Adodc_expend_type.RecordSource = "select * from m_other_expend order by expend_code"
Adodc_expend_type.Refresh

TDBCombo_expend_type.RowSource = Adodc_expend_type
End Sub
