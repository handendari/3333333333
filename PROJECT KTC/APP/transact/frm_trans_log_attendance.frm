...
Begin VB.Form frm_trans_log_attendance 
   ...
   Begin VB.Frame fra_button_control 
      ...
      Begin VB.CommandButton CmdExit 
         ...
         Height          =   645
         Left            =   2280
         Picture         =   "frm_trans_log_attendance.frx":000C
         Style           =   1  'Graphical
         TabIndex        =   3
         Top             =   360
         Width           =   975
      ...
      Begin VB.CommandButton cmd_download 
         ...
         Height          =   645
         Left            =   1200
         Picture         =   "frm_trans_log_attendance.frx":0596
         Style           =   1  'Graphical
         TabIndex        =   2
         Top             =   360
         Width           =   975
   ...
   Begin zkemkeeperCtl.CZKEM CZKEM1 
      Height          =   375
      Left            =   0
      OleObjectBlob   =   "frm_trans_log_attendance.frx":0B20
      TabIndex        =   4
      Top             =   7920
      Visible         =   0   'False
      Width           =   375
   ...
   Begin TrueOleDBList60.TDBCombo TDBCombo_company 
      Height          =   375
      Left            =   1560
      OleObjectBlob   =   "frm_trans_log_attendance.frx":0B44
      TabIndex        =   1
      Top             =   240
      Width           =   1695
   End
