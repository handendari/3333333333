...
Public COMPANY_CODE, LOGIN_NAME, LOGIN_PASS, LOGIN_CODE, LOGIN_FULLNAME As String
...
rs1.Open "SELECT INTERVAL 3 MONTH + register_date as status FROM m_license", CnG, adOpenStatic, adLockBatchOptimistic
