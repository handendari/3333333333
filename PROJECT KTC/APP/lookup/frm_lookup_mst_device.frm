...
Begin VB.Form frm_lookup_mst_device 
   ...
   Begin VB.Frame frmTombol 
      ...
      Begin VB.CommandButton cmd_select 
         ...
         Height          =   645
         Left            =   5160
         Picture         =   "frm_lookup_mst_device.frx":000C
         Style           =   1  'Graphical
         TabIndex        =   4
         Top             =   360
         Width           =   975
      ...
      Begin VB.CommandButton cmd_test 
         ...
         Height          =   645
         Left            =   6240
         Picture         =   "frm_lookup_mst_device.frx":0596
         Style           =   1  'Graphical
         TabIndex        =   5
         Top             =   360
         Width           =   975
      ...
      Begin VB.CommandButton cmd_refresh 
         ...
         Height          =   645
         Left            =   6600
         Picture         =   "frm_lookup_mst_device.frx":0B20
         Style           =   1  'Graphical
         TabIndex        =   13
         Top             =   960
         Visible         =   0   'False
      ...
      Begin VB.CommandButton CmdSave 
         ...
         Height          =   645
         Left            =   1320
         Picture         =   "frm_lookup_mst_device.frx":10AA
         Style           =   1  'Graphical
         TabIndex        =   8
         Top             =   960
         Visible         =   0   'False
      ...
      Begin VB.CommandButton CmdCancel 
         ...
         Height          =   645
         Left            =   4560
         Picture         =   "frm_lookup_mst_device.frx":1634
         Style           =   1  'Graphical
         TabIndex        =   11
         Top             =   960
         Visible         =   0   'False
      ...
      Begin VB.CommandButton CmdExit 
         ...
         Height          =   645
         Left            =   8400
         Picture         =   "frm_lookup_mst_device.frx":1BBE
         Style           =   1  'Graphical
         TabIndex        =   6
         Top             =   360
         Width           =   975
      ...
      Begin VB.CommandButton CmdNew 
         ...
         Height          =   645
         Left            =   240
         Picture         =   "frm_lookup_mst_device.frx":2148
         Style           =   1  'Graphical
         TabIndex        =   7
         Top             =   960
         Visible         =   0   'False
      ...
      Begin VB.CommandButton CmdPrint 
         ...
         Height          =   645
         Left            =   0
         Picture         =   "frm_lookup_mst_device.frx":26D2
         Style           =   1  'Graphical
         TabIndex        =   12
         Top             =   600
         Visible         =   0   'False
      ...
      Begin VB.CommandButton cmdDelete 
         ...
         Height          =   645
         Left            =   3480
         Picture         =   "frm_lookup_mst_device.frx":2C5C
         Style           =   1  'Graphical
         TabIndex        =   10
         Top             =   960
         Visible         =   0   'False
      ...
      Begin VB.CommandButton cmdEdit 
         ...
         Height          =   645
         Left            =   2400
         Picture         =   "frm_lookup_mst_device.frx":31E6
         Style           =   1  'Graphical
         TabIndex        =   9
         Top             =   960
         Visible         =   0   'False
   ...
   Begin zkemkeeperCtl.CZKEM CZKEM1 
      Height          =   495
      Left            =   0
      OleObjectBlob   =   "frm_lookup_mst_device.frx":3770
      TabIndex        =   18
      Top             =   0
      Visible         =   0   'False
      Width           =   495
