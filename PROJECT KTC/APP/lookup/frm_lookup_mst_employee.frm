...
ElseIf public_int_mode = 102 Then
    frm_mst_salary_exp_employee.txt_employee_code.Text = TDBGrid1.Columns("employee_code").Value
    frm_mst_salary_exp_employee.txt_employee_name.Text = TDBGrid1.Columns("employee_name").Value
    
ElseIf public_int_mode = 103 Then
    frm_mst_salary_exp_employee_installment.txt_employee_code.Text = TDBGrid1.Columns("employee_code").Value
    frm_mst_salary_exp_employee_installment.txt_employee_name.Text = TDBGrid1.Columns("employee_name").Value
...
If public_int_mode = 0 Then
    str1 = "select * from m_employee where flag_active <> 0 AND company_code = '" _
    & TDBCombo_company.Columns("company_code").Value & "' " & access & " and employee_code not in " _
    & "(select employee_code from td_shift) order by employee_code"
Else
    str1 = "select * from m_employee where flag_active <> 0 AND company_code = '" _
    & TDBCombo_company.Columns("company_code").Value & "' " & access & " order by employee_code"
End If
