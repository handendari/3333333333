...
Begin VB.MDIForm mdi_absensi 
      ...
      Begin MSComctlLib.ImageList ImageList1 
         ...
         BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
            ...
            BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "mdi_absensi.frx":4C341
               Key             =   ""
            EndProperty
            BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "mdi_absensi.frx":4C8DB
               Key             =   ""
            EndProperty
            BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "mdi_absensi.frx":4CD2D
               Key             =   ""
            EndProperty
         EndProperty
      End
   ...
   Begin VB.PictureBox Picture4 
      ...
      Top             =   0
      Width           =   125
      Begin prj_panji.vbButton cmd_navigation 
         Height          =   2055
         Left            =   0
         TabIndex        =   7
         Top             =   2640
   ...
   Begin OutlookBar.ctxOutlookBar ctxOutlookBar1 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      FormatControl   =   "mdi_absensi.frx":4EC89
      FormatGroup     =   "mdi_absensi.frx":4EDFD
      FormatGroupHover=   "mdi_absensi.frx":4EF21
      FormatGroupPressed=   "mdi_absensi.frx":4F031
      FormatGroupSelected=   "mdi_absensi.frx":4F135
      FormatItem      =   "mdi_absensi.frx":4F21D
      FormatItemLargeIcons=   "mdi_absensi.frx":4F32D
      FormatItemHover =   "mdi_absensi.frx":4F429
      FormatItemPressed=   "mdi_absensi.frx":4F511
      FormatItemSelected=   "mdi_absensi.frx":4F5F9
      FormatSmallIcon =   "mdi_absensi.frx":4F6B9
      FormatSmallIconHover=   "mdi_absensi.frx":4F7A1
      FormatSmallIconPressed=   "mdi_absensi.frx":4F89D
      FormatSmallIconSelected=   "mdi_absensi.frx":4F999
      FormatLargeIcon =   "mdi_absensi.frx":4FA95
      FormatLargeIconHover=   "mdi_absensi.frx":4FB7D
      FormatLargeIconPressed=   "mdi_absensi.frx":4FC79
      FormatLargeIconSelected=   "mdi_absensi.frx":4FD75
      Groups          =   "mdi_absensi.frx":4FE71
   End
   Begin VB.Menu M01 
      Caption         =   "A1"
   End
...
Wend
    ...
    If vFlagUbahPwd = 0 Then
        ctxOutlookBar1.Groups.item("M01").GroupItems.Add "Ganti Password", , , "M01-04"
    End If
...
If rs1.Fields("form_name").Value = "frm_mst_medical" Then Call exec_menu_(frm_mst_medical, rs1.Fields("form_modal").Value)
...
If rs1.Fields("form_name").Value = "frm_trans_pph21" Then Call exec_menu_(frm_trans_pph21, rs1.Fields("form_modal").Value)
If rs1.Fields("form_name").Value = "frm_trans_permission" Then Call exec_menu_(frm_trans_permission, rs1.Fields("form_modal").Value)
...
If rs1.Fields("form_name").Value = "frm_List_medical" Then Call exec_menu_(frm_List_medical, rs1.Fields("form_modal").Value)
