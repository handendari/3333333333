...
Begin VB.Form frm_etc_smtp_server 
   ...
   Begin VB.Frame Frame1 
      Caption         =   "Konfigurasi Server SMTP"
      Height          =   2805
      Left            =   2340
      TabIndex        =   10
      Top             =   90
      ...
      Begin VB.Label Label3 
         BackStyle       =   0  'Transparent
         Caption         =   "Masukkan Konfigurasi Server SMTP Dengan Benar"
         Height          =   405
         Left            =   150
         TabIndex        =   12
         Top             =   2220
   ...
   Begin prj_panji.vbButton cmdCancel 
      ...
      VALUE           =   0   'False
   End
   Begin prj_panji.vbButton cmdTest 
      Height          =   450
      Left            =   2340
      TabIndex        =   7
      Top             =   4170
...
'On Error GoTo Err:
            ...
            If Trim$(objControl.Text) = vbNullString Then
                If chkReqAuth.Value = 0 Then
                    If LCase(objControl.Text) = "txtusername" Or LCase(objControl.Text) = "txtpassword" Then
                        MsgBox "Semua Kolom Wajib Diisi...", vbExclamation, headerMSG
                        Exit Sub
                    End If
                Else
                    MsgBox "Semua Kolom Wajib Diisi...", vbExclamation, headerMSG
    ...
    MsgBox "Konfigurasi Berhasil Disimpan..", vbInformation, headerMSG
    Exit Sub
...
On Error GoTo Err
    ...
    MsgBox "Test Konfigurasi SMTP Server Berhasil...", vbInformation, headerMSG
    Exit Sub
