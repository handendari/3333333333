...
Begin VB.Form frm_etc_backup_restore_device 
   ...
   Begin prj_panji.vbButton cmdOK 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "frm_backup_restore.frx":05AE
      PICN            =   "frm_backup_restore.frx":05CA
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin VB.Frame Frame1 
      ...
      Begin TrueOleDBList60.TDBCombo TDBCombo_device 
         Height          =   375
         Left            =   690
         OleObjectBlob   =   "frm_backup_restore.frx":165C
         TabIndex        =   8
         Top             =   870
         Width           =   1335
      End
   ...
   Begin prj_panji.vbButton cmdCancel 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "frm_backup_restore.frx":3AD1
      PICN            =   "frm_backup_restore.frx":3AED
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin VB.Image Image2 
      Height          =   2850
      Left            =   0
      Picture         =   "frm_backup_restore.frx":4B7F
      Stretch         =   -1  'True
      Top             =   0
      Width           =   2265
   End
