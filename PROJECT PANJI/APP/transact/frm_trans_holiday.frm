...
Begin VB.Form frm_trans_holiday 
   ...
   Begin VB.Frame frmTombol 
      ...
      Begin prj_panji.vbButton cmdNew 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frm_trans_holiday.frx":058A
         PICN            =   "frm_trans_holiday.frx":05A6
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   2
         NGREY           =   0   'False
      ...
      Begin prj_panji.vbButton cmdSave 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frm_trans_holiday.frx":1638
         PICN            =   "frm_trans_holiday.frx":1654
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   2
         NGREY           =   0   'False
      ...
      Begin prj_panji.vbButton cmdEdit 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frm_trans_holiday.frx":26E6
         PICN            =   "frm_trans_holiday.frx":2702
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   2
         NGREY           =   0   'False
      ...
      Begin prj_panji.vbButton cmdDelete 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frm_trans_holiday.frx":3794
         PICN            =   "frm_trans_holiday.frx":37B0
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   2
         NGREY           =   0   'False
      ...
      Begin prj_panji.vbButton cmdCancel 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frm_trans_holiday.frx":4842
         PICN            =   "frm_trans_holiday.frx":485E
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   2
         NGREY           =   0   'False
      ...
      Begin prj_panji.vbButton cmdExit 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frm_trans_holiday.frx":58F0
         PICN            =   "frm_trans_holiday.frx":590C
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   2
         NGREY           =   0   'False
   ...
   Begin VB.Image Image2 
      Height          =   585
      Left            =   0
      Picture         =   "frm_trans_holiday.frx":699E
      Stretch         =   -1  'True
      Top             =   0
      Width           =   11790
   End
...
Dim rs As New ADODB.Recordset
    ...
    SQL = "INSERT INTO t_holiday(holiday_number,holiday_date,description,entry_date) " & _
            "VALUES( " & _
            "'" & rs.Fields("holiday_number").Value & "'," & _
            "'" & Format(DTPicker_date_holiday.Value, "yyyy-MM-dd HH:mm:ss") & "'," & _
            "'" & Trim(txt_description) & "'," & _
...
Private Sub load_data_holiday()
    ...
    SQL = "select * from t_holiday order by holiday_number"
