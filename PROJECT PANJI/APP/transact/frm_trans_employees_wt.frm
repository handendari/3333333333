...
Begin VB.Form frm_mst_employees_working_time 
   BorderStyle     =   4  'Fixed ToolWindow
   Caption         =   "MASTER EMPLOYEES WORKING TIME"
   ClientHeight    =   9090
   ClientLeft      =   -15
   ClientTop       =   240
   ClientWidth     =   14685
   ...
   Begin VB.Frame fra_entry 
      ...
      Begin VB.ComboBox cbo_enable 
         Height          =   315
         ItemData        =   "frm_trans_employees_wt.frx":000C
         Left            =   11520
         List            =   "frm_trans_employees_wt.frx":0016
         TabIndex        =   9
         Text            =   "..."
         Top             =   720
         Width           =   1695
      ...
      Begin VB.ComboBox cbo_type 
         ForeColor       =   &H80000002&
         Height          =   315
         ItemData        =   "frm_trans_employees_wt.frx":0023
         Left            =   11520
         List            =   "frm_trans_employees_wt.frx":002D
         Locked          =   -1  'True
         TabIndex        =   8
         Text            =   "..."
         Top             =   360
      ...
      Begin TrueOleDBList60.TDBCombo TDBCombo_working_time 
         Height          =   375
         Left            =   1920
         OleObjectBlob   =   "frm_trans_employees_wt.frx":0041
         TabIndex        =   4
         Top             =   720
         Width           =   1695
      End
   ...
   Begin VB.Frame frmTombol 
      ...
      Begin VB.CommandButton cmd_delete_dtl 
         ...
         Height          =   645
         Left            =   8280
         Picture         =   "frm_trans_employees_wt.frx":2444
         Style           =   1  'Graphical
         TabIndex        =   21
         Top             =   360
         Width           =   1095
      End
      Begin VB.CommandButton cmd_add_dtl 
         Caption         =   "Add Detail"
         Height          =   645
         Left            =   7200
         Picture         =   "frm_trans_employees_wt.frx":29CE
         Style           =   1  'Graphical
         TabIndex        =   20
         Top             =   360
         Width           =   1095
      ...
      Begin VB.CommandButton cmd_refresh 
         ...
         Height          =   645
         Left            =   10200
         Picture         =   "frm_trans_employees_wt.frx":2F58
         Style           =   1  'Graphical
         TabIndex        =   22
         Top             =   360
         Width           =   975
      ...
      Begin VB.CommandButton CmdSave 
         ...
         Height          =   645
         Left            =   1800
         Picture         =   "frm_trans_employees_wt.frx":34E2
         Style           =   1  'Graphical
         TabIndex        =   13
         Top             =   360
         Width           =   975
      ...
      Begin VB.CommandButton CmdCancel 
         ...
         Height          =   645
         Left            =   5040
         Picture         =   "frm_trans_employees_wt.frx":3A6C
         Style           =   1  'Graphical
         TabIndex        =   16
         Top             =   360
         Width           =   975
      ...
      Begin VB.CommandButton CmdExit 
         ...
         Height          =   645
         Left            =   12120
         Picture         =   "frm_trans_employees_wt.frx":3FF6
         Style           =   1  'Graphical
         TabIndex        =   24
         Top             =   360
         Width           =   975
      ...
      Begin VB.CommandButton CmdNew 
         ...
         Height          =   645
         Left            =   720
         Picture         =   "frm_trans_employees_wt.frx":4580
         Style           =   1  'Graphical
         TabIndex        =   12
         Top             =   360
         Width           =   975
      ...
      Begin VB.CommandButton CmdPrint 
         ...
         Height          =   645
         Left            =   0
         Picture         =   "frm_trans_employees_wt.frx":4B0A
         Style           =   1  'Graphical
         TabIndex        =   17
         Top             =   600
         Visible         =   0   'False
      ...
      Begin VB.CommandButton cmdDelete 
         ...
         Height          =   645
         Left            =   3960
         Picture         =   "frm_trans_employees_wt.frx":5094
         Style           =   1  'Graphical
         TabIndex        =   15
         Top             =   360
         Width           =   975
      ...
      Begin VB.CommandButton cmdEdit 
         ...
         Height          =   645
         Left            =   2880
         Picture         =   "frm_trans_employees_wt.frx":561E
         Style           =   1  'Graphical
         TabIndex        =   14
         Top             =   360
         Width           =   975
   ...
   Begin TrueOleDBGrid70.TDBGrid TDBGrid1 
      ...
      Splits(0)._ColumnProps(19)=   "Column(3).Width=3413"
      Splits(0)._ColumnProps(20)=   "Column(3).DividerColor=0"
      Splits(0)._ColumnProps(21)=   "Column(3)._WidthInPix=3334"
      Splits(0)._ColumnProps(22)=   "Column(3)._ColStyle=516"
      Splits(0)._ColumnProps(23)=   "Column(3).Order=4"
      Splits(0)._ColumnProps(24)=   "Column(4).Width=6932"
      Splits(0)._ColumnProps(25)=   "Column(4).DividerColor=0"
      Splits(0)._ColumnProps(26)=   "Column(4)._WidthInPix=6853"
      ...
      Splits(0)._ColumnProps(39)=   "Column(7).Width=2805"
      Splits(0)._ColumnProps(40)=   "Column(7).DividerColor=0"
      Splits(0)._ColumnProps(41)=   "Column(7)._WidthInPix=2725"
      Splits(0)._ColumnProps(42)=   "Column(7)._ColStyle=513"
      Splits(0)._ColumnProps(43)=   "Column(7).Order=8"
      Splits(0)._ColumnProps(44)=   "Column(8).Width=1561"
      Splits(0)._ColumnProps(45)=   "Column(8).DividerColor=0"
      Splits(0)._ColumnProps(46)=   "Column(8)._WidthInPix=1482"
   ...
   Begin TrueOleDBList60.TDBCombo TDBCombo_company 
      Height          =   375
      Left            =   1200
      OleObjectBlob   =   "frm_trans_employees_wt.frx":5BA8
      TabIndex        =   1
      Top             =   240
      Width           =   1695
   End
   ...
   End
End
Attribute VB_Name = "frm_mst_employees_working_time"
...
If check_validate_tdbcombo(TDBCombo_working_time) = False Then
    MsgBox "Working time Belum Dipilih...", vbOKOnly + vbInformation, headerMSG
...
MsgBox i & " employee's data Berhasil Dihapus...", vbInformation, headerMSG
...
& TDBCombo_company.Columns("company_code").Value & "' order by shift_number"
Adodc1.Refresh
