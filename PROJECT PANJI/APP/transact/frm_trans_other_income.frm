...
Begin VB.Form frm_trans_other_income 
   BorderStyle     =   4  'Fixed ToolWindow
   Caption         =   "OTHER INCOME HISTORY"
   ClientHeight    =   9090
   ClientLeft      =   -15
   ClientTop       =   240
   ClientWidth     =   14685
   ...
   EndProperty
   Icon            =   "frm_trans_other_income.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   MinButton       =   0   'False
   ...
   Begin VB.Frame fra_entry 
      ...
      Begin VB.CommandButton CmdBrowse 
         ...
         Width           =   315
      End
      Begin VB.TextBox txt_income_value 
         ...
         Width           =   1695
      End
      Begin TrueOleDBList60.TDBCombo TDBCombo_income_type 
         Height          =   375
         Left            =   3600
         OleObjectBlob   =   "frm_trans_other_income.frx":000C
         TabIndex        =   17
         Top             =   1200
         Width           =   1695
      End
      Begin MSAdodcLib.Adodc Adodc_income_type 
         Height          =   330
         Left            =   8880
         Top             =   1200
         Visible         =   0   'False
   ...
   Begin VB.Frame frmTombol 
      ...
      Begin VB.CommandButton cmd_refresh 
         ...
         Height          =   645
         Left            =   8280
         Picture         =   "frm_trans_other_income.frx":296A
         Style           =   1  'Graphical
         TabIndex        =   13
         Top             =   360
         Width           =   975
      ...
      Begin VB.CommandButton CmdSave 
         ...
         Height          =   645
         Left            =   1800
         Picture         =   "frm_trans_other_income.frx":2EF4
         Style           =   1  'Graphical
         TabIndex        =   5
         Top             =   360
         Width           =   975
      ...
      Begin VB.CommandButton CmdCancel 
         ...
         Height          =   645
         Left            =   5040
         Picture         =   "frm_trans_other_income.frx":347E
         Style           =   1  'Graphical
         TabIndex        =   8
         Top             =   360
         Width           =   975
      ...
      Begin VB.CommandButton CmdExit 
         ...
         Height          =   645
         Left            =   11640
         Picture         =   "frm_trans_other_income.frx":3A08
         Style           =   1  'Graphical
         TabIndex        =   10
         Top             =   360
         Width           =   975
      ...
      Begin VB.CommandButton CmdNew 
         ...
         Height          =   645
         Left            =   720
         Picture         =   "frm_trans_other_income.frx":3F92
         Style           =   1  'Graphical
         TabIndex        =   4
         Top             =   360
         Width           =   975
      ...
      Begin VB.CommandButton CmdPrint 
         ...
         Height          =   645
         Left            =   0
         Picture         =   "frm_trans_other_income.frx":451C
         Style           =   1  'Graphical
         TabIndex        =   9
         Top             =   600
         Visible         =   0   'False
      ...
      Begin VB.CommandButton cmdDelete 
         ...
         Height          =   645
         Left            =   3960
         Picture         =   "frm_trans_other_income.frx":4AA6
         Style           =   1  'Graphical
         TabIndex        =   7
         Top             =   360
         Width           =   975
      ...
      Begin VB.CommandButton cmdEdit 
         ...
         Height          =   645
         Left            =   2880
         Picture         =   "frm_trans_other_income.frx":5030
         Style           =   1  'Graphical
         TabIndex        =   6
         Top             =   360
         Width           =   975
   ...
   Begin TrueOleDBGrid70.TDBGrid TDBGrid1 
      ...
      Columns(2).Caption=   "INCOME NAME"
      Columns(2).DataField=   "income_name"
      Columns(2)._PropDict=   "_MaxComboItems,516,2;_VlistStyle,514,3"
      Columns(3)._VlistStyle=   0
      Columns(3)._MaxComboItems=   5
      Columns(3).Caption=   "VALUE"
      Columns(3).DataField=   "income_value"
      ...
      HeadLines       =   1
      FootLines       =   1
      Caption         =   "LIST OF OTHER INCOME HISTORY"
      MultipleLines   =   0
      CellTipsWidth   =   0
   ...
   End
End
Attribute VB_Name = "frm_trans_other_income"
...
str_sql = "select count(date) as rec_count from t_other_income where date = '" _
& DTPicker_date.Value & "'"
...
If check_validate_tdbcombo(TDBCombo_income_type) = False Then
    MsgBox "Income type is not selected!", vbOKOnly + vbInformation, headerMSG
    TDBCombo_income_type.SetFocus
    check_validate_new = False
    Exit Function
End If

If Trim(txt_income_value) = "" Then
    MsgBox "Value is empty!", vbOKOnly + vbInformation, headerMSG
    txt_income_value.SetFocus
    check_validate_new = False
    Exit Function
End If
...
frm_lookup_mst_employee.public_int_mode = 90
...
'CnG.BeginTrans
'CnG.Execute "delete from t_other_income where date = '" _
...
With Adodc1.Recordset
    ...
    Call set_data_tdbcombo(Adodc_income_type, TDBCombo_income_type, "income_code='" & .Fields("income_code").Value & "'")
    Call TDBCombo_income_type_ItemChange
    
    txt_income_value = FormatNumber(.Fields("income_value").Value)
...
rsBound.Open "select * from t_other_income where date = '" _
...
If rsBound.State = 1 Then rsBound.Close
rsBound.Open "select * from t_other_income where employee_code = 'άφ'", CnG, adOpenKeyset, adLockOptimistic
...
With rsBound
    ...
    .Fields("income_code").Value = TDBCombo_income_type.Columns("income_code").Value
    .Fields("income_name").Value = TDBCombo_income_type.Columns("income_name").Value
    
    .Fields("income_type").Value = TDBCombo_income_type.Columns("income_type").Value
    .Fields("income_type_name").Value = TDBCombo_income_type.Columns("income_type_name").Value
    
    .Fields("income_value").Value = Val(DropAllComma(txt_income_value))
...
Adodc_income_type.ConnectionString = strConn

Call load_data_income_type
Call load_data
...
Private Sub TDBCombo_income_type_ItemChange()
If TDBCombo_income_type.ApproxCount > 0 Then
    TDBCombo_income_type.Text = TDBCombo_income_type.Columns("income_code").Value
    txt_income_type_name = TDBCombo_income_type.Columns("income_name").Value
...
& "from t_other_income order by date asc"
Adodc1.Refresh

TDBGrid1.DataSource = Adodc1
End Sub

Private Sub load_data_income_type()
Adodc_income_type.RecordSource = "select * from m_other_income order by income_code"
Adodc_income_type.Refresh

TDBCombo_income_type.RowSource = Adodc_income_type
End Sub
