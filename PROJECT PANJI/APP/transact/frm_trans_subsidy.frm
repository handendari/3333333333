...
Begin VB.Form frm_trans_subsidy 
   BorderStyle     =   4  'Fixed ToolWindow
   Caption         =   "EMPLOYEE SUBSIDY"
   ClientHeight    =   9090
   ClientLeft      =   -15
   ClientTop       =   240
   ClientWidth     =   14685
   ...
   EndProperty
   Icon            =   "frm_trans_subsidy.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   MinButton       =   0   'False
   ...
   Begin VB.Frame fra_entry 
      ...
      Begin VB.Frame Frame1 
         ...
         Begin VB.ComboBox cbo_meal 
            Height          =   315
            ItemData        =   "frm_trans_subsidy.frx":000C
            Left            =   4440
            List            =   "frm_trans_subsidy.frx":0016
            TabIndex        =   4
            Text            =   "opt"
            Top             =   480
            Width           =   1335
         ...
         Begin VB.ComboBox cbo_working_time 
            Height          =   315
            ItemData        =   "frm_trans_subsidy.frx":002A
            Left            =   4440
            List            =   "frm_trans_subsidy.frx":0031
            Locked          =   -1  'True
            TabIndex        =   12
            Text            =   "opt"
            Top             =   1920
         ...
         Begin VB.ComboBox cbo_phone_voucher 
            Height          =   315
            ItemData        =   "frm_trans_subsidy.frx":003D
            Left            =   4440
            List            =   "frm_trans_subsidy.frx":0047
            TabIndex        =   10
            Text            =   "opt"
            Top             =   1560
            Width           =   1335
         ...
         Begin VB.ComboBox cbo_full_presence 
            Height          =   315
            ItemData        =   "frm_trans_subsidy.frx":005B
            Left            =   4440
            List            =   "frm_trans_subsidy.frx":0062
            Locked          =   -1  'True
            TabIndex        =   8
            Text            =   "opt"
            Top             =   1200
         ...
         Begin VB.ComboBox cbo_transport 
            Height          =   315
            ItemData        =   "frm_trans_subsidy.frx":006F
            Left            =   4440
            List            =   "frm_trans_subsidy.frx":0079
            TabIndex        =   6
            Text            =   "opt"
            Top             =   840
            Width           =   1335
   ...
   Begin VB.Frame frmTombol 
      ...
      Top             =   7560
      Width           =   14175
      Begin VB.CommandButton cmd_load_new 
         Caption         =   "Load &New"
         Height          =   645
         Left            =   6480
         Picture         =   "frm_trans_subsidy.frx":008D
         Style           =   1  'Graphical
         TabIndex        =   14
         Top             =   360
         Width           =   975
      ...
      Begin VB.CommandButton cmd_update 
         ...
         Height          =   645
         Left            =   9720
         Picture         =   "frm_trans_subsidy.frx":0617
         Style           =   1  'Graphical
         TabIndex        =   17
         Top             =   360
         Width           =   975
      End
      Begin VB.CommandButton cmd_delete_all 
         Caption         =   "&Delete All"
         Height          =   645
         Left            =   8640
         Picture         =   "frm_trans_subsidy.frx":0BA1
         Style           =   1  'Graphical
         TabIndex        =   16
         Top             =   360
         Width           =   975
      End
      Begin VB.CommandButton cmd_delete1 
         Caption         =   "&Delete"
         Height          =   645
         Left            =   7560
         Picture         =   "frm_trans_subsidy.frx":112B
         Style           =   1  'Graphical
         TabIndex        =   15
         Top             =   360
         Width           =   975
      ...
      Begin VB.Timer timer1 
         ...
         Top             =   360
      End
      Begin VB.CommandButton cmd_load_all 
         Caption         =   "&Load All"
         Height          =   645
         Left            =   5400
         Picture         =   "frm_trans_subsidy.frx":16B5
         Style           =   1  'Graphical
         TabIndex        =   13
         Top             =   360
         Width           =   975
      ...
      Begin VB.CommandButton CmdSave 
         ...
         Height          =   645
         Left            =   1800
         Picture         =   "frm_trans_subsidy.frx":1C3F
         Style           =   1  'Graphical
         TabIndex        =   23
         Top             =   720
         Visible         =   0   'False
      ...
      Begin VB.CommandButton CmdCancel 
         ...
         Height          =   645
         Left            =   5040
         Picture         =   "frm_trans_subsidy.frx":21C9
         Style           =   1  'Graphical
         TabIndex        =   26
         Top             =   720
         Visible         =   0   'False
      ...
      Begin VB.CommandButton CmdExit 
         ...
         Height          =   645
         Left            =   12000
         Picture         =   "frm_trans_subsidy.frx":2753
         Style           =   1  'Graphical
         TabIndex        =   18
         Top             =   360
         Width           =   975
      ...
      Begin VB.CommandButton CmdNew 
         ...
         Height          =   645
         Left            =   720
         Picture         =   "frm_trans_subsidy.frx":2CDD
         Style           =   1  'Graphical
         TabIndex        =   22
         Top             =   720
         Visible         =   0   'False
      ...
      Begin VB.CommandButton CmdPrint 
         ...
         Height          =   645
         Left            =   0
         Picture         =   "frm_trans_subsidy.frx":3267
         Style           =   1  'Graphical
         TabIndex        =   27
         Top             =   600
         Visible         =   0   'False
      ...
      Begin VB.CommandButton cmdDelete 
         ...
         Height          =   645
         Left            =   3960
         Picture         =   "frm_trans_subsidy.frx":37F1
         Style           =   1  'Graphical
         TabIndex        =   25
         Top             =   720
         Visible         =   0   'False
      ...
      Begin VB.CommandButton cmdEdit 
         ...
         Height          =   645
         Left            =   2880
         Picture         =   "frm_trans_subsidy.frx":3D7B
         Style           =   1  'Graphical
         TabIndex        =   24
         Top             =   720
         Visible         =   0   'False
   ...
   Begin TrueOleDBList60.TDBCombo TDBCombo_company 
      Height          =   375
      Left            =   1200
      OleObjectBlob   =   "frm_trans_subsidy.frx":4305
      TabIndex        =   1
      Top             =   240
      Width           =   1695
   End
   ...
   Begin TrueOleDBGrid70.TDBGrid TDBGrid1 
      ...
      Columns(3).Caption=   "MEAL"
      Columns(3).DataField=   "meal_subsidy"
      ...
      Columns(4).ValueItems(0).DisplayValue=   "Dayly"
      ...
      Columns(4).ValueItems(1).DisplayValue=   "Monthly"
      Columns(4).ValueItems(1).DisplayValue.vt=   8
      Columns(4).ValueItems(1)._PropDict=   "_DefaultItem,517,2"
      Columns(4).ValueItems.Count=   2
      Columns(4).Caption=   "INTERVAL"
      Columns(4).DataField=   "meal_subsidy_interval"
      Columns(4)._PropDict=   "_MaxComboItems,516,2;_VlistStyle,514,3"
      Columns(5)._VlistStyle=   0
      Columns(5)._MaxComboItems=   5
      Columns(5).Caption=   "TRANSPORT"
      Columns(5).DataField=   "transport_subsidy"
      ...
      Columns(6).ValueItems(0).DisplayValue=   "Dayly"
      ...
      Columns(6).ValueItems(1).DisplayValue=   "Monthly"
      Columns(6).ValueItems(1).DisplayValue.vt=   8
      Columns(6).ValueItems(1)._PropDict=   "_DefaultItem,517,2"
      Columns(6).ValueItems.Count=   2
      Columns(6).Caption=   "INTERVAL"
      Columns(6).DataField=   "transport_subsidy_interval"
      Columns(6)._PropDict=   "_MaxComboItems,516,2;_VlistStyle,514,3"
      Columns(7)._VlistStyle=   0
      Columns(7)._MaxComboItems=   5
      Columns(7).Caption=   "FULL PRESENCE"
      Columns(7).DataField=   "full_presence_subsidy"
      Columns(7).NumberFormat=   "Standard"
      Columns(7)._PropDict=   "_MaxComboItems,516,2;_VlistStyle,514,3"
      Columns(8)._VlistStyle=   16
      Columns(8)._MaxComboItems=   5
      Columns(8).ValueItems(0)._DefaultItem=   0
      Columns(8).ValueItems(0).Value=   "0"
      Columns(8).ValueItems(0).Value.vt=   8
      Columns(8).ValueItems(0).DisplayValue=   "Monthly"
      Columns(8).ValueItems(0).DisplayValue.vt=   8
      Columns(8).ValueItems(0)._PropDict=   "_DefaultItem,517,2"
      Columns(8).ValueItems.Count=   1
      Columns(8).Caption=   "INTERVAL"
      Columns(8).DataField=   "full_presence_subsidy_interval"
      Columns(8)._PropDict=   "_MaxComboItems,516,2;_VlistStyle,514,3"
      Columns(9)._VlistStyle=   0
      Columns(9)._MaxComboItems=   5
      Columns(9).Caption=   "PHONE BALANCE"
      Columns(9).DataField=   "phone_voucher_subsidy"
      ...
      Columns(10).ValueItems(0).DisplayValue=   "Dayly"
      ...
      Columns(10).ValueItems(1).DisplayValue=   "Monthly"
      ...
      Columns(10).Caption=   "INTERVAL"
      Columns(10).DataField=   "phone_voucher_subsidy_interval"
      Columns(10)._PropDict=   "_MaxComboItems,516,2;_VlistStyle,514,3"
      Columns(11)._VlistStyle=   0
      Columns(11)._MaxComboItems=   5
      Columns(11).Caption=   "WORKING TIME"
      Columns(11).DataField=   "working_time_subsidy"
      ...
      Columns(12).ValueItems(0).DisplayValue=   "Yearly"
      Columns(12).ValueItems(0).DisplayValue.vt=   8
      Columns(12).ValueItems(0)._PropDict=   "_DefaultItem,517,2"
      Columns(12).ValueItems.Count=   1
      Columns(12).Caption=   "INTERVAL"
      Columns(12).DataField=   "working_time_subsidy_interval"
      Columns(12)._PropDict=   "_MaxComboItems,516,2;_VlistStyle,514,3"
      Columns.Count   =   13
      Splits(0)._UserFlags=   0
      Splits(0).SizeMode=   1
      Splits(0).Size  =   3704.882
      Splits(0).Size.vt=   4
      ...
      Splits(0)._ColumnProps(26)=   "Column(4)._WidthInPix=1535"
      ...
      Splits(0)._ColumnProps(32)=   "Column(5).Width=2275"
      ...
      Splits(0)._ColumnProps(38)=   "Column(5).AllowFocus=0"
      Splits(0)._ColumnProps(39)=   "Column(5).Order=6"
      Splits(0)._ColumnProps(40)=   "Column(5)._MinWidth=10"
      Splits(0)._ColumnProps(41)=   "Column(6).Width=1640"
      Splits(0)._ColumnProps(42)=   "Column(6).DividerColor=0"
      Splits(0)._ColumnProps(43)=   "Column(6)._WidthInPix=1561"
      ...
      Splits(0)._ColumnProps(49)=   "Column(6)._MinWidth=54215968"
      Splits(0)._ColumnProps(50)=   "Column(7).Width=2275"
      Splits(0)._ColumnProps(51)=   "Column(7).DividerColor=0"
      Splits(0)._ColumnProps(52)=   "Column(7)._WidthInPix=2196"
      ...
      Splits(0)._ColumnProps(58)=   "Column(7)._MinWidth=54215968"
      Splits(0)._ColumnProps(59)=   "Column(8).Width=1482"
      Splits(0)._ColumnProps(60)=   "Column(8).DividerColor=0"
      Splits(0)._ColumnProps(61)=   "Column(8)._WidthInPix=1402"
      ...
      Splits(0)._ColumnProps(67)=   "Column(9).Width=2461"
      Splits(0)._ColumnProps(68)=   "Column(9).DividerColor=0"
      Splits(0)._ColumnProps(69)=   "Column(9)._WidthInPix=2381"
      Splits(0)._ColumnProps(70)=   "Column(9).AllowSizing=0"
      Splits(0)._ColumnProps(71)=   "Column(9)._ColStyle=516"
      ...
      Splits(0)._ColumnProps(75)=   "Column(10).Width=1588"
      Splits(0)._ColumnProps(76)=   "Column(10).DividerColor=0"
      Splits(0)._ColumnProps(77)=   "Column(10)._WidthInPix=1508"
      ...
      Splits(0)._ColumnProps(83)=   "Column(11).Width=2275"
      Splits(0)._ColumnProps(84)=   "Column(11).DividerColor=0"
      Splits(0)._ColumnProps(85)=   "Column(11)._WidthInPix=2196"
      ...
      Splits(0)._ColumnProps(91)=   "Column(12).Width=1588"
      Splits(0)._ColumnProps(92)=   "Column(12).DividerColor=0"
      Splits(0)._ColumnProps(93)=   "Column(12)._WidthInPix=1508"
      ...
      Splits(1)._ColumnProps(27)=   "Column(3).Width=2117"
      Splits(1)._ColumnProps(28)=   "Column(3).DividerColor=0"
      Splits(1)._ColumnProps(29)=   "Column(3)._WidthInPix=2037"
      ...
      Splits(1)._ColumnProps(33)=   "Column(4).Width=1614"
      Splits(1)._ColumnProps(34)=   "Column(4).DividerColor=0"
      Splits(1)._ColumnProps(35)=   "Column(4)._WidthInPix=1535"
      Splits(1)._ColumnProps(36)=   "Column(4)._ColStyle=8705"
      Splits(1)._ColumnProps(37)=   "Column(4).Order=5"
      Splits(1)._ColumnProps(38)=   "Column(4)._MinWidth=71308992"
      Splits(1)._ColumnProps(39)=   "Column(5).Width=2275"
      Splits(1)._ColumnProps(40)=   "Column(5).DividerColor=0"
      Splits(1)._ColumnProps(41)=   "Column(5)._WidthInPix=2196"
      Splits(1)._ColumnProps(42)=   "Column(5)._ColStyle=514"
      Splits(1)._ColumnProps(43)=   "Column(5).Order=6"
      Splits(1)._ColumnProps(44)=   "Column(5)._MinWidth=71305344"
      Splits(1)._ColumnProps(45)=   "Column(6).Width=1614"
      Splits(1)._ColumnProps(46)=   "Column(6).DividerColor=0"
      Splits(1)._ColumnProps(47)=   "Column(6)._WidthInPix=1535"
      Splits(1)._ColumnProps(48)=   "Column(6)._ColStyle=8705"
      Splits(1)._ColumnProps(49)=   "Column(6).Order=7"
      Splits(1)._ColumnProps(50)=   "Column(6)._MinWidth=71306416"
      Splits(1)._ColumnProps(51)=   "Column(7).Width=2275"
      Splits(1)._ColumnProps(52)=   "Column(7).DividerColor=0"
      Splits(1)._ColumnProps(53)=   "Column(7)._WidthInPix=2196"
      Splits(1)._ColumnProps(54)=   "Column(7)._ColStyle=514"
      Splits(1)._ColumnProps(55)=   "Column(7).Order=8"
      Splits(1)._ColumnProps(56)=   "Column(7)._MinWidth=54215968"
      Splits(1)._ColumnProps(57)=   "Column(8).Width=1640"
      Splits(1)._ColumnProps(58)=   "Column(8).DividerColor=0"
      Splits(1)._ColumnProps(59)=   "Column(8)._WidthInPix=1561"
      Splits(1)._ColumnProps(60)=   "Column(8)._ColStyle=8705"
      Splits(1)._ColumnProps(61)=   "Column(8).Order=9"
      Splits(1)._ColumnProps(62)=   "Column(9).Width=2461"
      Splits(1)._ColumnProps(63)=   "Column(9).DividerColor=0"
      Splits(1)._ColumnProps(64)=   "Column(9)._WidthInPix=2381"
      Splits(1)._ColumnProps(65)=   "Column(9)._ColStyle=514"
      Splits(1)._ColumnProps(66)=   "Column(9).Order=10"
      Splits(1)._ColumnProps(67)=   "Column(10).Width=1588"
      Splits(1)._ColumnProps(68)=   "Column(10).DividerColor=0"
      Splits(1)._ColumnProps(69)=   "Column(10)._WidthInPix=1508"
      Splits(1)._ColumnProps(70)=   "Column(10)._ColStyle=8705"
      Splits(1)._ColumnProps(71)=   "Column(10).Order=11"
      Splits(1)._ColumnProps(72)=   "Column(11).Width=2196"
      Splits(1)._ColumnProps(73)=   "Column(11).DividerColor=0"
      Splits(1)._ColumnProps(74)=   "Column(11)._WidthInPix=2117"
      Splits(1)._ColumnProps(75)=   "Column(11)._ColStyle=514"
      Splits(1)._ColumnProps(76)=   "Column(11).Order=12"
      Splits(1)._ColumnProps(77)=   "Column(12).Width=1746"
      Splits(1)._ColumnProps(78)=   "Column(12).DividerColor=0"
      Splits(1)._ColumnProps(79)=   "Column(12)._WidthInPix=1667"
      Splits(1)._ColumnProps(80)=   "Column(12)._ColStyle=8705"
      ...
      _StyleDefs(78)  =   "Splits(0).Columns(11).Style:id=70,.parent=13"
      ...
      _StyleDefs(82)  =   "Splits(0).Columns(12).Style:id=78,.parent=13"
      ...
      _StyleDefs(86)  =   "Splits(1).Style:id=79,.parent=1"
      _StyleDefs(87)  =   "Splits(1).CaptionStyle:id=88,.parent=4,.bgcolor=&H80000002&,.fgcolor=&H80000009&"
      _StyleDefs(88)  =   "Splits(1).HeadingStyle:id=80,.parent=2,.alignment=2,.bgcolor=&H8000000F&"
      _StyleDefs(89)  =   ":id=80,.fgcolor=&H80000002&"
      _StyleDefs(90)  =   "Splits(1).FooterStyle:id=81,.parent=3"
      _StyleDefs(91)  =   "Splits(1).InactiveStyle:id=82,.parent=5"
      _StyleDefs(92)  =   "Splits(1).SelectedStyle:id=84,.parent=6"
      _StyleDefs(93)  =   "Splits(1).EditorStyle:id=83,.parent=7"
      _StyleDefs(94)  =   "Splits(1).HighlightRowStyle:id=85,.parent=8"
      _StyleDefs(95)  =   "Splits(1).EvenRowStyle:id=86,.parent=9"
      _StyleDefs(96)  =   "Splits(1).OddRowStyle:id=87,.parent=10"
      _StyleDefs(97)  =   "Splits(1).RecordSelectorStyle:id=89,.parent=11"
      _StyleDefs(98)  =   "Splits(1).FilterBarStyle:id=90,.parent=12"
      _StyleDefs(99)  =   "Splits(1).Columns(0).Style:id=94,.parent=79"
      _StyleDefs(100) =   "Splits(1).Columns(0).HeadingStyle:id=91,.parent=80"
      _StyleDefs(101) =   "Splits(1).Columns(0).FooterStyle:id=92,.parent=81"
      _StyleDefs(102) =   "Splits(1).Columns(0).EditorStyle:id=93,.parent=83"
      _StyleDefs(103) =   "Splits(1).Columns(1).Style:id=98,.parent=79"
      _StyleDefs(104) =   "Splits(1).Columns(1).HeadingStyle:id=95,.parent=80"
      _StyleDefs(105) =   "Splits(1).Columns(1).FooterStyle:id=96,.parent=81"
      _StyleDefs(106) =   "Splits(1).Columns(1).EditorStyle:id=97,.parent=83"
      _StyleDefs(107) =   "Splits(1).Columns(2).Style:id=106,.parent=79"
      _StyleDefs(108) =   "Splits(1).Columns(2).HeadingStyle:id=103,.parent=80"
      _StyleDefs(109) =   "Splits(1).Columns(2).FooterStyle:id=104,.parent=81"
      _StyleDefs(110) =   "Splits(1).Columns(2).EditorStyle:id=105,.parent=83"
      _StyleDefs(111) =   "Splits(1).Columns(3).Style:id=114,.parent=79,.alignment=1"
      _StyleDefs(112) =   "Splits(1).Columns(3).HeadingStyle:id=111,.parent=80"
      _StyleDefs(113) =   "Splits(1).Columns(3).FooterStyle:id=112,.parent=81"
      _StyleDefs(114) =   "Splits(1).Columns(3).EditorStyle:id=113,.parent=83"
      _StyleDefs(115) =   "Splits(1).Columns(4).Style:id=118,.parent=79,.alignment=2,.locked=-1"
      _StyleDefs(116) =   "Splits(1).Columns(4).HeadingStyle:id=115,.parent=80"
      _StyleDefs(117) =   "Splits(1).Columns(4).FooterStyle:id=116,.parent=81"
      _StyleDefs(118) =   "Splits(1).Columns(4).EditorStyle:id=117,.parent=83"
      _StyleDefs(119) =   "Splits(1).Columns(5).Style:id=122,.parent=79,.alignment=1"
      _StyleDefs(120) =   "Splits(1).Columns(5).HeadingStyle:id=119,.parent=80"
      _StyleDefs(121) =   "Splits(1).Columns(5).FooterStyle:id=120,.parent=81"
      _StyleDefs(122) =   "Splits(1).Columns(5).EditorStyle:id=121,.parent=83"
      _StyleDefs(123) =   "Splits(1).Columns(6).Style:id=126,.parent=79,.alignment=2,.locked=-1"
      _StyleDefs(124) =   "Splits(1).Columns(6).HeadingStyle:id=123,.parent=80"
      _StyleDefs(125) =   "Splits(1).Columns(6).FooterStyle:id=124,.parent=81"
      _StyleDefs(126) =   "Splits(1).Columns(6).EditorStyle:id=125,.parent=83"
      _StyleDefs(127) =   "Splits(1).Columns(7).Style:id=130,.parent=79,.alignment=1"
      _StyleDefs(128) =   "Splits(1).Columns(7).HeadingStyle:id=127,.parent=80"
      _StyleDefs(129) =   "Splits(1).Columns(7).FooterStyle:id=128,.parent=81"
      _StyleDefs(130) =   "Splits(1).Columns(7).EditorStyle:id=129,.parent=83"
      _StyleDefs(131) =   "Splits(1).Columns(8).Style:id=134,.parent=79,.alignment=2,.locked=-1"
      _StyleDefs(132) =   "Splits(1).Columns(8).HeadingStyle:id=131,.parent=80"
      _StyleDefs(133) =   "Splits(1).Columns(8).FooterStyle:id=132,.parent=81"
      _StyleDefs(134) =   "Splits(1).Columns(8).EditorStyle:id=133,.parent=83"
      _StyleDefs(135) =   "Splits(1).Columns(9).Style:id=138,.parent=79,.alignment=1"
      _StyleDefs(136) =   "Splits(1).Columns(9).HeadingStyle:id=135,.parent=80"
      _StyleDefs(137) =   "Splits(1).Columns(9).FooterStyle:id=136,.parent=81"
      _StyleDefs(138) =   "Splits(1).Columns(9).EditorStyle:id=137,.parent=83"
      _StyleDefs(139) =   "Splits(1).Columns(10).Style:id=142,.parent=79,.alignment=2,.locked=-1"
      _StyleDefs(140) =   "Splits(1).Columns(10).HeadingStyle:id=139,.parent=80"
      _StyleDefs(141) =   "Splits(1).Columns(10).FooterStyle:id=140,.parent=81"
      _StyleDefs(142) =   "Splits(1).Columns(10).EditorStyle:id=141,.parent=83"
      _StyleDefs(143) =   "Splits(1).Columns(11).Style:id=146,.parent=79,.alignment=1"
      _StyleDefs(144) =   "Splits(1).Columns(11).HeadingStyle:id=143,.parent=80"
      _StyleDefs(145) =   "Splits(1).Columns(11).FooterStyle:id=144,.parent=81"
      _StyleDefs(146) =   "Splits(1).Columns(11).EditorStyle:id=145,.parent=83"
      _StyleDefs(147) =   "Splits(1).Columns(12).Style:id=150,.parent=79,.alignment=2,.locked=-1"
      _StyleDefs(148) =   "Splits(1).Columns(12).HeadingStyle:id=147,.parent=80"
      _StyleDefs(149) =   "Splits(1).Columns(12).FooterStyle:id=148,.parent=81"
      _StyleDefs(150) =   "Splits(1).Columns(12).EditorStyle:id=149,.parent=83"
      _StyleDefs(151) =   "Named:id=33:Normal"
      _StyleDefs(152) =   ":id=33,.parent=0"
      _StyleDefs(153) =   "Named:id=34:Heading"
      _StyleDefs(154) =   ":id=34,.parent=33,.valignment=2,.bgcolor=&H8000000F&,.fgcolor=&H80000012&"
      _StyleDefs(155) =   ":id=34,.wraptext=-1"
      _StyleDefs(156) =   "Named:id=35:Footing"
      _StyleDefs(157) =   ":id=35,.parent=33,.valignment=2,.bgcolor=&H8000000F&,.fgcolor=&H80000012&"
      _StyleDefs(158) =   "Named:id=36:Selected"
      _StyleDefs(159) =   ":id=36,.parent=33,.bgcolor=&H8000000D&,.fgcolor=&H8000000E&"
      _StyleDefs(160) =   "Named:id=37:Caption"
      _StyleDefs(161) =   ":id=37,.parent=34,.alignment=2"
      _StyleDefs(162) =   "Named:id=38:HighlightRow"
      _StyleDefs(163) =   ":id=38,.parent=33,.bgcolor=&H8000000D&,.fgcolor=&H8000000E&"
      _StyleDefs(164) =   "Named:id=39:EvenRow"
      _StyleDefs(165) =   ":id=39,.parent=33,.bgcolor=&HFFFF00&"
      _StyleDefs(166) =   "Named:id=40:OddRow"
      _StyleDefs(167) =   ":id=40,.parent=33"
      _StyleDefs(168) =   "Named:id=41:RecordSelector"
      _StyleDefs(169) =   ":id=41,.parent=34"
      _StyleDefs(170) =   "Named:id=42:FilterBar"
      _StyleDefs(171) =   ":id=42,.parent=33"
   End
   ...
   End
End
Attribute VB_Name = "frm_trans_subsidy"
...
If Trim(txt_meal) = "" Then
    MsgBox "Meal subsidy Masih Kosong...", vbOKOnly + vbInformation, headerMSG
    txt_meal.SetFocus
    check_validate_new = False
    Exit Function
End If
...
If Trim(txt_transport) = "" Then
    MsgBox "Transport subsidy Masih Kosong...", vbOKOnly + vbInformation, headerMSG
...
If Trim(txt_full_presence) = "" Then
    MsgBox "Full presence subsidy Masih Kosong...", vbOKOnly + vbInformation, headerMSG
...
If Trim(txt_phone_voucher) = "" Then
    MsgBox "Phone voucher subsidy Masih Kosong...", vbOKOnly + vbInformation, headerMSG
...
If Trim(txt_working_time) = "" Then
    MsgBox "Working time subsidy Masih Kosong...", vbOKOnly + vbInformation, headerMSG
...
i = MsgBox("Are you sure want to delete all data '" _
    & TDBCombo_company.Columns("company_name").Value & "' ?", vbYesNo + vbQuestion, headerMSG)
If Not i = vbYes Then Exit Sub

CnG.BeginTrans
CnG.Execute "delete from t_subsidy where company_code = '" _
    & TDBCombo_company.Columns("company_code").Value & "'"
CnG.CommitTrans

Call load_data_subsidy
int_mode = 0
Call load_mode
End Sub

Private Sub cmd_delete1_Click()
Dim i As Integer
...
Private Sub cmd_load_all_Click()
...
CnG.Execute "delete from t_subsidy where company_code='" & TDBCombo_company.Columns("company_code").Value & "'"
rs1.Open "select * from t_subsidy where employee_code = 'uOu'", CnG, adOpenKeyset, adLockOptimistic

str1 = "select b.company_code, b.employee_code, b.employee_name, a.* " _
    & "from m_subsidy a " _
    & "join m_employee b on a.title_code=b.title_code " _
    & "where a.subsidy_date = f_actual_subsidy_date(a.title_code) " _
    & " and b.company_code = '" & TDBCombo_company.Columns("company_code").Value & "'"
    
rs2.Open str1, CnG, adOpenStatic, adLockReadOnly
...
While Not rs2.EOF
    ...
    rs1.Fields("employee_code").Value = rs2.Fields("employee_code").Value
    rs1.Fields("employee_name").Value = rs2.Fields("employee_name").Value
    rs1.Fields("company_code").Value = rs2.Fields("company_code").Value
    
    rs1.Fields("subsidy_date").Value = rs2.Fields("subsidy_date").Value
    rs1.Fields("meal_subsidy").Value = rs2.Fields("meal_subsidy").Value
    rs1.Fields("meal_subsidy_interval").Value = rs2.Fields("meal_subsidy_interval").Value
    rs1.Fields("transport_subsidy").Value = rs2.Fields("transport_subsidy").Value
    rs1.Fields("transport_subsidy_interval").Value = rs2.Fields("transport_subsidy_interval").Value
    rs1.Fields("full_presence_subsidy").Value = rs2.Fields("full_presence_subsidy").Value
    rs1.Fields("full_presence_subsidy_interval").Value = rs2.Fields("full_presence_subsidy_interval").Value
    rs1.Fields("phone_voucher_subsidy").Value = rs2.Fields("phone_voucher_subsidy").Value
    rs1.Fields("phone_voucher_subsidy_interval").Value = rs2.Fields("phone_voucher_subsidy_interval").Value
    rs1.Fields("working_time_subsidy").Value = rs2.Fields("working_time_subsidy").Value
    rs1.Fields("working_time_subsidy_interval").Value = rs2.Fields("working_time_subsidy_interval").Value
...
err_handle:
CnG.RollbackTrans
MsgBox "Error Loading data...!", vbInformation, headerMSG
End Sub

Private Sub cmd_load_new_Click()
'On Error GoTo err_handle
...
str1 = "select b.company_code, b.employee_code, b.employee_name, a.* " _
    ...
    & "join m_employee b on a.title_code=b.title_code " _
    & "where a.subsidy_date = f_actual_subsidy_date(a.title_code) " _
    & " and b.company_code = '" & TDBCombo_company.Columns("company_code").Value & "' " _
    & "and b.employee_code not in (select employee_code from t_subsidy where company_code='" _
    & TDBCombo_company.Columns("company_code").Value & "')"
...
rsBound.Open "select * from t_subsidy where employee_code = '" _
...
With rsBound
    ...
    '.Fields("employee_code").Value = Trim(txt_employee_code)        ' key
    '.Fields("subsidy_date").Value = Format(DTPicker_subsidy.Value, "yyyy-MM-dd HH:mm:ss")
...
Private Sub load_data_subsidy()
Adodc1.RecordSource = "select a.* from t_subsidy a join m_employee b on a.employee_code=b.employee_code " _
& "where b.company_code = '" _
