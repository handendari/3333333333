...
Private Sub createGrid()
   With LynxGrid1
        .AddColumn "NIK", 1500, lgAlignCenterCenter
        .AddColumn "NAMA KARY.", 2500, lgAlignCenterCenter, , , , , , , True
        .AddColumn "NAMA PENDEK", 1500, lgAlignCenterCenter, , , , , , , True
        .AddColumn "KODE PERUSAHAAN", 1000, lgAlignCenterCenter, , , , , , , True
        .AddColumn "KODE DIV.", 1000, lgAlignCenterCenter, , , , , , , True
        .AddColumn "KODE JBTN", 1000, lgAlignCenterCenter, , , , , , , True
        .AddColumn "KODE LEVEL", 1000, lgAlignCenterCenter, , , , , , , True
        .AddColumn "KODE GRADE", 1000, lgAlignCenterCenter, , , , , , , True
        .AddColumn "KODE STATUS", 1000, lgAlignCenterCenter, , , , , , , True
        .AddColumn "TEMPAT LAHIR", 1500, lgAlignCenterCenter, , , , , , , True
        .AddColumn "TGL. LAHIR", 1200, lgAlignCenterCenter, lgDate, "yyyy-MM-dd", , , , , , True
        .AddColumn "JNS KELAMIN", 1000, lgAlignCenterCenter, , , , , , , True
        .AddColumn "AGAMA", 1000, lgAlignCenterCenter, , , , , , , True
        .AddColumn "STATUS NIKAH", 1000, lgAlignCenterCenter, , , , , , , True
        .AddColumn "JML. ANAK", 1500, lgAlignCenterCenter, , , , , , , True
        .AddColumn "ALAMAT KARY.", 2500, lgAlignLeftCenter, , , , , , , True
        .AddColumn "NPWP", 1500, lgAlignCenterCenter, , , , , , , True
        .AddColumn "METODE PAJAK", 1000, lgAlignCenterCenter, , , , , , , True
        .AddColumn "TGL. REG NPWP", 1200, lgAlignCenterCenter, lgDate, "yyyy-MM-dd", , , , , , True
        .AddColumn "ALAMAT NPWP", 2500, lgAlignLeftCenter, , , , , , , True
        .AddColumn "NO JAMSOSTEK", 1500, lgAlignLeftCenter, , , , , , , True
        .AddColumn "TGL. REG JAMSOSTEK", 1200, lgAlignCenterCenter, lgDate, "yyyy-MM-dd", , , , , , True
        .AddColumn "KODE BANK", 1000, lgAlignCenterCenter, , , , , , , True
        .AddColumn "REKENING BANK", 1500, lgAlignLeftCenter, , , , , , , True
        .AddColumn "NAMA DI REKENING", 2500, lgAlignLeftCenter, , , , , , , True
        .AddColumn "TGL. MASUK KERJA", 1200, lgAlignCenterCenter, lgDate, "yyyy-MM-dd", , , , , , True
        .AddColumn "TGL. PENGANGKATAN", 1200, lgAlignCenterCenter, lgDate, "yyyy-MM-dd", , , , , , True
        .AddColumn "NO. TELP", 1500, lgAlignLeftCenter, , , , , , , True
        .AddColumn "EMAIL", 1500, lgAlignLeftCenter, , , , , , , True
        .AddColumn "KEWARGANEGARAAN", 1000, lgAlignCenterCenter, , , , , , , True
        .AddColumn "NO. KTP", 1500, lgAlignLeftCenter, , , , , , , True
        .AddColumn "KETERANGAN", 2500, lgAlignLeftCenter, , , , , , , True
            ...
            While Not .EOF
                'If Adodc1.Recordset!employee_code <> "" Or Adodc1.Recordset!employee_code Is Null Then
                    LynxGrid1.AddItem .Fields(0) & vbTab & .Fields(1) _
                            ...
                            & vbTab & .Fields(30) & vbTab & .Fields(31)
                'End If
                .MoveNext
            Wend
...
'                vMarital = IIf(.CellText(aa, 14) = "S", 0, 1)
                ...
                SQL = "INSERT INTO m_employee (employee_code,seq_no,nik,employee_name,employee_nick_name, " & _
                        "company_code,division_code,title_code,level_code," & _
                        ...
                        "start_working,appointment_date,phone_number,email,nationality," & _
                        "identity_number,description,flag_active,entry_date,entry_user) " & _
                    "VALUES " & _
                        "('" & v_employee_code & "',1,'" & .CellText(aa, 0) & "','" & Replace(.CellText(aa, 1), "'", "''") & "','" & Replace(.CellText(aa, 2), "'", "''") & "'," & _
                        "'" & .CellText(aa, 3) & "','" & .CellText(aa, 4) & "','" & .CellText(aa, 5) & "','" & .CellText(aa, 6) & "','" & .CellText(aa, 7) & "'," & _
                        "'" & .CellText(aa, 8) & "','" & .CellText(aa, 9) & "','" & IIf(.CellText(aa, 10) = "", Format(Now, "yyyy-MM-dd"), Format(.CellText(aa, 10), "yyyy-MM-dd")) & "'," & _
                        "'" & .CellText(aa, 11) & "','" & .CellText(aa, 12) & "','" & .CellText(aa, 13) & "','" & .CellText(aa, 14) & "','" & .CellText(aa, 15) & "','" & .CellText(aa, 16) & "'," & _
                        "'" & .CellText(aa, 17) & "','" & IIf(.CellText(aa, 18) = "", Format(Now, "yyyy-MM-dd"), Format(.CellText(aa, 18), "yyyy-MM-dd")) & "'," & _
                        "'" & .CellText(aa, 19) & "','" & .CellText(aa, 20) & "','" & IIf(.CellText(aa, 21) = "", Format(Now, "yyyy-MM-dd"), Format(.CellText(aa, 21), "yyyy-MM-dd")) & "'," & _
                        ...
                        "'" & .CellText(aa, 27) & "','" & .CellText(aa, 28) & "','" & .CellText(aa, 29) & "','" & .CellText(aa, 30) & "'," & _
                        "'" & .CellText(aa, 31) & "',1,now(),'" & LOGIN_NAME & "')"
                CnG.Execute SQL
                ...
                SQL = "INSERT INTO m_employee_title (employee_code,seq_no,date_title,title_code,entry_date,entry_user) " & _
                      "VALUES (" & _
                        "'" & v_employee_code & "',1," & _
                        "'" & IIf(IsNull(.CellText(aa, 25)), Format(Now, "yyyy-MM-dd"), Format(IIf(.CellText(aa, 25) = "", Now, .CellText(aa, 25)), "yyyy-MM-dd")) & "','" & .CellText(aa, 5) & "'," & _
                        "now(),'" & LOGIN_NAME & "')"
                CnG.Execute SQL
                ...
                SQL = "INSERT INTO m_employee_grade (employee_code,seq_no,date_grade,grade_code,entry_date,entry_user) " & _
                      "VALUES (" & _
                        "'" & v_employee_code & "',1," & _
                        "'" & IIf(IsNull(.CellText(aa, 25)), Format(Now, "yyyy-MM-dd"), Format(IIf(.CellText(aa, 25) = "", Now, .CellText(aa, 25)), "yyyy-MM-dd")) & "','" & .CellText(aa, 7) & "'," & _
                        "now(),'" & LOGIN_NAME & "')"
                CnG.Execute SQL
