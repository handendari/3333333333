...
Begin VB.Form frm_trans_log_attendance 
   ...
   Begin VB.Frame fra_button_control 
      ...
      Begin prj_panji.vbButton cmd_download 
         ...
         PICN            =   "frm_trans_log_attendance.frx":05CA
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   2
         NGREY           =   0   'False
      ...
      Begin prj_panji.vbButton cmdExit 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frm_trans_log_attendance.frx":165C
         PICN            =   "frm_trans_log_attendance.frx":1678
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   2
         NGREY           =   0   'False
         ...
         VALUE           =   0   'False
      End
      Begin prj_panji.vbButton cmd_delete_log 
         Height          =   705
         Left            =   2550
         TabIndex        =   13
         Top             =   360
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frm_trans_log_attendance.frx":270A
         PICN            =   "frm_trans_log_attendance.frx":2726
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   2
         NGREY           =   0   'False
         ...
         VALUE           =   0   'False
      End
      Begin prj_panji.vbButton cmd_reproses 
         Height          =   705
         Left            =   5070
         TabIndex        =   14
         Top             =   360
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frm_trans_log_attendance.frx":37B8
         PICN            =   "frm_trans_log_attendance.frx":37D4
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   2
         NGREY           =   0   'False
         ...
         VALUE           =   0   'False
      End
      Begin prj_panji.vbButton cmd_download_all 
         Height          =   705
         Left            =   6300
         TabIndex        =   15
         Top             =   360
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frm_trans_log_attendance.frx":4866
         PICN            =   "frm_trans_log_attendance.frx":4882
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   2
         NGREY           =   0   'False
   ...
   Begin TrueOleDBList60.TDBCombo TDBCombo_company 
      Height          =   375
      Left            =   1200
      OleObjectBlob   =   "frm_trans_log_attendance.frx":5914
      TabIndex        =   1
      Top             =   930
      Width           =   1695
   End
   ...
   Begin VB.Image Image1 
      Height          =   585
      Left            =   0
      Picture         =   "frm_trans_log_attendance.frx":787A
      Stretch         =   -1  'True
      Top             =   0
      Width           =   14730
   End
...
'End If
    ...
    If CZKEM1.ReadGeneralLogData(vMachineNumber) Then
        ...
        While CZKEM1.GetGeneralLogDataStr(vMachineNumber, dwEnrollNumber, dwVerifyMode, dwInOutMode, timeStr)
            ...
            SQL = "SELECT enrollnumber FROM h_log_attendance " & _
                  "WHERE att_date = '" & str_date & "' " & _
                    "AND ip_address = '" & FG_IP_ADDRESS & "' " & _
                    "AND enrollnumber = '" & dwEnrollNumber & "'"
            ...
            If rs7.RecordCount <= 0 Then
                ...
                SQL = "INSERT INTO h_log_attendance(att_date, ip_address, enrollnumber, employee_code," & _
                      ...
                      "VALUES( " & _
                        "'" & str_date & "', '" & FG_IP_ADDRESS & "', '" & Val(dwEnrollNumber) & "'," & _
...
'End If
    ...
    '    While CZKEM1.SSR_GetGeneralLogData(vMachineNumber, dwEnrollNumber, dwVerifyMode, dwInOutMode, _
    '    lng_year, lng_month, lng_day, lng_hour, lng_minute, lng_second)
...
Private Sub cmd_download_all_Click()
