...
Begin VB.Form frm_trans_absent 
   ...
   Begin VB.Frame fra_entry 
      ...
      Begin VB.ComboBox cbo_absent_status 
         ...
         Left            =   8400
         List            =   "frm_trans_absent.frx":0019
         TabIndex        =   3
         Text            =   "..."
         Top             =   480
         Width           =   2895
      ...
      Begin VB.ComboBox cbo_date_to 
         Height          =   315
         ItemData        =   "frm_trans_absent.frx":0036
         Left            =   10200
         List            =   "frm_trans_absent.frx":0040
         TabIndex        =   5
         Text            =   "..."
         Top             =   840
         Width           =   1095
   ...
   Begin VB.Frame frmTombol 
      ...
      Begin VB.CommandButton cmd_refresh 
         ...
         Height          =   645
         Left            =   7440
         Picture         =   "frm_trans_absent.frx":004E
         Style           =   1  'Graphical
         TabIndex        =   13
         Top             =   360
         Width           =   975
      ...
      Begin VB.CommandButton CmdSave 
         ...
         Height          =   645
         Left            =   1800
         Picture         =   "frm_trans_absent.frx":05D8
         Style           =   1  'Graphical
         TabIndex        =   9
         Top             =   360
         Width           =   975
      ...
      Begin VB.CommandButton CmdCancel 
         ...
         Height          =   645
         Left            =   5040
         Picture         =   "frm_trans_absent.frx":0B62
         Style           =   1  'Graphical
         TabIndex        =   12
         Top             =   360
         Width           =   975
      ...
      Begin VB.CommandButton CmdExit 
         ...
         Height          =   645
         Left            =   9600
         Picture         =   "frm_trans_absent.frx":10EC
         Style           =   1  'Graphical
         TabIndex        =   14
         Top             =   360
         Width           =   975
      ...
      Begin VB.CommandButton CmdNew 
         ...
         Height          =   645
         Left            =   720
         Picture         =   "frm_trans_absent.frx":1676
         Style           =   1  'Graphical
         TabIndex        =   8
         Top             =   360
         Width           =   975
      ...
      Begin VB.CommandButton CmdPrint 
         ...
         Height          =   645
         Left            =   0
         Picture         =   "frm_trans_absent.frx":1C00
         Style           =   1  'Graphical
         TabIndex        =   19
         Top             =   600
         Visible         =   0   'False
      ...
      Begin VB.CommandButton cmdDelete 
         ...
         Height          =   645
         Left            =   3960
         Picture         =   "frm_trans_absent.frx":218A
         Style           =   1  'Graphical
         TabIndex        =   11
         Top             =   360
         Width           =   975
      ...
      Begin VB.CommandButton cmdEdit 
         ...
         Height          =   645
         Left            =   2880
         Picture         =   "frm_trans_absent.frx":2714
         Style           =   1  'Graphical
         TabIndex        =   10
         Top             =   360
         Width           =   975
   ...
   Begin TrueOleDBList60.TDBCombo TDBCombo_company 
      Height          =   375
      Left            =   1200
      OleObjectBlob   =   "frm_trans_absent.frx":2C9E
      TabIndex        =   1
      Top             =   240
      Width           =   1695
   End
