...
Begin VB.Form frm_mst_status 
   ...
   Begin TrueOleDBGrid70.TDBGrid TDBGrid1 
      ...
      Columns(2).Caption=   "STATUS PERIODE"
      ...
      HeadLines       =   1
      FootLines       =   1
      Caption         =   "DAFTAR STATUS KEPEGAWAIAN"
      MultipleLines   =   0
      CellTipsWidth   =   0
   ...
   Begin VB.Label Label5 
      ...
      Caption         =   "MASTER STATUS KEPEGAWAIAN"
      BeginProperty Font 
         Name            =   "Arial"
         Size            =   12
         Charset         =   0
...
Private Function check_validate_new() As Boolean
    ...
    If Trim(txt_code.Text) = "" Then
        MsgBox "Kode Masih Kosong...", vbOKOnly + vbInformation, headerMSG
        txt_code.SetFocus
...
Private Sub load_data()
    ...
    SQL = "select status_code,status_name," & _
          ...
          "from m_emp_status order by status_code"
