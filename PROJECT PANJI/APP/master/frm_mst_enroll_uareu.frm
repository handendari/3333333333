...
Begin VB.Form frm_mst_enroll_uareu 
   BorderStyle     =   4  'Fixed ToolWindow
   Caption         =   "MASTER ENROLL (BASE SENSOR)"
   ClientHeight    =   9120
   ClientLeft      =   45
   ClientTop       =   300
   ClientWidth     =   14715
   Icon            =   "frm_mst_enroll_uareu.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   MinButton       =   0   'False
   ...
   Begin zkemkeeperCtl.CZKEM CZKEM1 
      Height          =   375
      Left            =   7860
      OleObjectBlob   =   "frm_mst_enroll_uareu.frx":000C
      TabIndex        =   15
      Top             =   120
      Visible         =   0   'False
      Width           =   465
   ...
   Begin VB.Frame frmTombol 
      ...
      Begin VB.CommandButton cmd_verify 
         ...
         Height          =   645
         Left            =   9720
         Picture         =   "frm_mst_enroll_uareu.frx":0030
         Style           =   1  'Graphical
         TabIndex        =   3
         Top             =   360
         Width           =   975
      ...
      Begin VB.CommandButton cmd_set_finger 
         ...
         Height          =   645
         Left            =   8640
         Picture         =   "frm_mst_enroll_uareu.frx":05BA
         Style           =   1  'Graphical
         TabIndex        =   2
         Top             =   360
         Width           =   975
      End
      Begin VB.CommandButton cmd_unset 
         Caption         =   "&Unset"
         Height          =   645
         Left            =   4080
         Picture         =   "frm_mst_enroll_uareu.frx":0B44
         Style           =   1  'Graphical
         TabIndex        =   9
         Top             =   840
         Visible         =   0   'False
      ...
      Begin VB.CommandButton cmdDelete 
         ...
         Height          =   645
         Left            =   10800
         Picture         =   "frm_mst_enroll_uareu.frx":10CE
         Style           =   1  'Graphical
         TabIndex        =   4
         Top             =   360
         Width           =   975
      ...
      Begin VB.CommandButton cmd_download 
         ...
         Height          =   645
         Left            =   5280
         Picture         =   "frm_mst_enroll_uareu.frx":1658
         Style           =   1  'Graphical
         TabIndex        =   10
         Top             =   840
         Visible         =   0   'False
      ...
      Begin VB.CommandButton Command2 
         ...
         Height          =   645
         Left            =   600
         Picture         =   "frm_mst_enroll_uareu.frx":1BE2
         Style           =   1  'Graphical
         TabIndex        =   7
         Top             =   360
         Visible         =   0   'False
      ...
      Begin VB.CommandButton cmd_set 
         ...
         Height          =   645
         Left            =   3000
         Picture         =   "frm_mst_enroll_uareu.frx":216C
         Style           =   1  'Graphical
         TabIndex        =   8
         Top             =   840
         Visible         =   0   'False
      ...
      Begin VB.CommandButton cmd_exit 
         ...
         Height          =   645
         Left            =   12720
         Picture         =   "frm_mst_enroll_uareu.frx":26F6
         Style           =   1  'Graphical
         TabIndex        =   5
         Top             =   360
         Width           =   975
   ...
   Begin TrueOleDBGrid70.TDBGrid TDBGrid1 
      ...
      Columns(1)._VlistStyle=   0
      Columns(1)._MaxComboItems=   5
      Columns(1).Caption=   "FINGER ID"
      Columns(1).DataField=   "finger"
      Columns(1)._PropDict=   "_MaxComboItems,516,2;_VlistStyle,514,3"
      Columns(2)._VlistStyle=   0
      Columns(2)._MaxComboItems=   5
      ...
      Splits(0)._ColumnProps(16)=   "Column(2).Width=5133"
      Splits(0)._ColumnProps(17)=   "Column(2).DividerColor=0"
      Splits(0)._ColumnProps(18)=   "Column(2)._WidthInPix=5054"
      ...
      _StyleDefs(38)  =   "Splits(0).Columns(1).Style:id=28,.parent=13,.alignment=2,.locked=-1"
   ...
   Begin TrueOleDBList60.TDBCombo TDBCombo_company 
      Height          =   375
      Left            =   1200
      OleObjectBlob   =   "frm_mst_enroll_uareu.frx":2C80
      TabIndex        =   1
      Top             =   240
      Width           =   1695
   End
   ...
   End
End
Attribute VB_Name = "frm_mst_enroll_uareu"
...
'
'str_ip = InputBox("Input IP Address")
'
'If Trim(str_ip) = "" Then Exit Sub
''MsgBox str_ip
'
'Timer2.Enabled = True
End Sub
...
If check_multi_ip = True Then
    MsgBox "Ada Lebih Dari Satu Alat Terdeteksi...", vbInformation, headerMSG
    Exit Sub
End If
...
'frm_etc_finger_reg.register
frm_etc_finger_reg.Show 1
End Sub
...
With TDBGrid2
    For Each item In SelBks
        ...
        CnG.Execute "delete from m_enroll_link where ip_address = '" & Adodc1.Recordset.Fields("ip_address").Value _
...
i = MsgBox("Apakah Yakin Akan Menghapus " & SelBks.Count & " enroll data?", vbOKCancel, headerMSG)
...
For Each item In SelBks
    i = i + 1
        CnG.Execute "delete from fingerprint_t where id = '" _
        & TDBGrid1.Columns("id").CellText(item) & "' and finger = " _
        & TDBGrid1.Columns("finger").CellText(item)
Next
CnG.CommitTrans

Call load_data_enroll
MsgBox i & " enroll's data Berhasil Dihapus...", vbInformation, headerMSG
...
Adodc1.RecordSource = "select a.id, a.finger, b.finger_name as description from fingerprint_t a " _
& " inner join m_finger_name b on a.finger = b.finger_number " _
& "where a.id='" & Adodc2.Recordset.Fields("employee_code").Value & "' order by a.finger asc"
Adodc1.Refresh
