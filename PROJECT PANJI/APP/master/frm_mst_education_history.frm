...
Begin VB.Form frm_mst_education_history 
   BorderStyle     =   4  'Fixed ToolWindow
   Caption         =   "MASTER EDUCATION HISTORY"
   ClientHeight    =   9120
   ClientLeft      =   45
   ClientTop       =   300
   ClientWidth     =   14715
   Icon            =   "frm_mst_education_history.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   MinButton       =   0   'False
   ...
   Begin zkemkeeperCtl.CZKEM CZKEM1 
      Height          =   495
      Left            =   7650
      OleObjectBlob   =   "frm_mst_education_history.frx":000C
      TabIndex        =   29
      Top             =   120
      Visible         =   0   'False
      Width           =   615
   ...
   Begin VB.Frame fra_entry 
      ...
      Begin VB.ComboBox cbo_status 
         Height          =   315
         ItemData        =   "frm_mst_education_history.frx":0030
         Left            =   6960
         List            =   "frm_mst_education_history.frx":003A
         TabIndex        =   7
         Top             =   2760
         Width           =   1575
      End
   ...
   Begin VB.Frame frmTombol 
      ...
      Begin VB.CommandButton cmdEdit 
         ...
         Height          =   645
         Left            =   4680
         Picture         =   "frm_mst_education_history.frx":004E
         Style           =   1  'Graphical
         TabIndex        =   10
         Top             =   360
         Width           =   975
      ...
      Begin VB.CommandButton cmdDelete 
         ...
         Height          =   645
         Left            =   5760
         Picture         =   "frm_mst_education_history.frx":05D8
         Style           =   1  'Graphical
         TabIndex        =   11
         Top             =   360
         Width           =   975
      ...
      Begin VB.CommandButton CmdNew 
         ...
         Height          =   645
         Left            =   2520
         Picture         =   "frm_mst_education_history.frx":0B62
         Style           =   1  'Graphical
         TabIndex        =   8
         Top             =   360
         Width           =   975
      ...
      Begin VB.CommandButton CmdCancel 
         ...
         Height          =   645
         Left            =   6840
         Picture         =   "frm_mst_education_history.frx":10EC
         Style           =   1  'Graphical
         TabIndex        =   12
         Top             =   360
         Width           =   975
      ...
      Begin VB.CommandButton CmdSave 
         ...
         Height          =   645
         Left            =   3600
         Picture         =   "frm_mst_education_history.frx":1676
         Style           =   1  'Graphical
         TabIndex        =   9
         Top             =   360
         Width           =   975
      ...
      Begin VB.CommandButton cmd_exit 
         ...
         Height          =   645
         Left            =   11520
         Picture         =   "frm_mst_education_history.frx":1C00
         Style           =   1  'Graphical
         TabIndex        =   13
         Top             =   360
         Width           =   975
   ...
   Begin TrueOleDBList60.TDBCombo TDBCombo_company 
      Height          =   375
      Left            =   1200
      OleObjectBlob   =   "frm_mst_education_history.frx":218A
      TabIndex        =   1
      Top             =   240
      Width           =   1695
   End
   ...
   End
End
Attribute VB_Name = "frm_mst_education_history"
...
& "else 'NOT PASS' end as status_ from t_education where employee_code='" _
...
str_sql = "select count(sequence_number) as rec_count from t_education where employee_code = '" _
...
CnG.BeginTrans
CnG.Execute "delete from t_education where employee_code = '" _
...
rs.Open "select * from t_education where sequence_number = -77", CnG, adOpenKeyset, adLockOptimistic
...
If rs.State = 1 Then rs.Close
rs.Open "select * from t_education where sequence_number = " _
