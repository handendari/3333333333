...
Begin VB.Form frm_mst_salary_slip_formula 
   BorderStyle     =   4  'Fixed ToolWindow
   Caption         =   "MASTER SALARY SLIP FORMULA"
   ClientHeight    =   6690
   ClientLeft      =   -15
   ClientTop       =   240
   ClientWidth     =   11760
   ...
   EndProperty
   Icon            =   "frm_mst_salary_slip_formula.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   6690
   ...
   Begin VB.Frame fra_entry 
      ...
      Begin VB.ComboBox cbo_operation 
         Height          =   315
         ItemData        =   "frm_mst_salary_slip_formula.frx":000C
         Left            =   4800
         List            =   "frm_mst_salary_slip_formula.frx":001C
         TabIndex        =   4
         Text            =   "OP"
         Top             =   1800
         Width           =   1695
   ...
   Begin VB.Frame frmTombol 
      ...
      Begin VB.CommandButton cmd_select 
         ...
         Height          =   645
         Left            =   7560
         Picture         =   "frm_mst_salary_slip_formula.frx":002C
         Style           =   1  'Graphical
         TabIndex        =   13
         Top             =   360
         Visible         =   0   'False
      ...
      Begin VB.CommandButton CmdSave 
         ...
         Height          =   645
         Left            =   1800
         Picture         =   "frm_mst_salary_slip_formula.frx":05B6
         Style           =   1  'Graphical
         TabIndex        =   9
         Top             =   360
         Width           =   975
      ...
      Begin VB.CommandButton CmdCancel 
         ...
         Height          =   645
         Left            =   5040
         Picture         =   "frm_mst_salary_slip_formula.frx":0B40
         Style           =   1  'Graphical
         TabIndex        =   12
         Top             =   360
         Width           =   975
      ...
      Begin VB.CommandButton CmdExit 
         ...
         Height          =   645
         Left            =   9600
         Picture         =   "frm_mst_salary_slip_formula.frx":10CA
         Style           =   1  'Graphical
         TabIndex        =   14
         Top             =   360
         Width           =   975
      ...
      Begin VB.CommandButton CmdNew 
         ...
         Height          =   645
         Left            =   720
         Picture         =   "frm_mst_salary_slip_formula.frx":1654
         Style           =   1  'Graphical
         TabIndex        =   8
         Top             =   360
         Width           =   975
      ...
      Begin VB.CommandButton CmdPrint 
         ...
         Height          =   645
         Left            =   0
         Picture         =   "frm_mst_salary_slip_formula.frx":1BDE
         Style           =   1  'Graphical
         TabIndex        =   19
         Top             =   600
         Visible         =   0   'False
      ...
      Begin VB.CommandButton cmdDelete 
         ...
         Height          =   645
         Left            =   3960
         Picture         =   "frm_mst_salary_slip_formula.frx":2168
         Style           =   1  'Graphical
         TabIndex        =   11
         Top             =   360
         Width           =   975
      ...
      Begin VB.CommandButton cmdEdit 
         ...
         Height          =   645
         Left            =   2880
         Picture         =   "frm_mst_salary_slip_formula.frx":26F2
         Style           =   1  'Graphical
         TabIndex        =   10
         Top             =   360
         Width           =   975
   ...
   Begin TrueOleDBGrid70.TDBGrid TDBGrid1 
      ...
      HeadLines       =   1
      FootLines       =   1
      Caption         =   "LIST OF SALARY SLIP FORMULA"
      MultipleLines   =   0
      CellTipsWidth   =   0
   ...
   End
End
Attribute VB_Name = "frm_mst_salary_slip_formula"
...
str_sql = "select count(formula_salary_code) as rec_count from m_salary_slip_formula " _
    & "where formula_salary_code = '" & Trim(txt_formula_salary_code) & "' and salary_code='" _
    & frm_mst_salary_slip.Adodc1.Recordset.Fields("salary_code").Value & "'"
...
If Trim(txt_formula_salary_code) = "" Then
    MsgBox "Salary Code Masih Kosong...", vbOKOnly + vbInformation, headerMSG
...
'frm_mst_salary_slip.public_int_mode = 0
'frm_mst_salary_slip.Show 1
End Sub
...
CnG.BeginTrans
CnG.Execute "delete from m_salary_slip_formula where salary_code = '" _
    & Adodc1.Recordset.Fields("salary_code").Value & "' and formula_salary_code = '" _
    & Adodc1.Recordset.Fields("formula_salary_code").Value & "'"
CnG.CommitTrans
...
rsBound.Open "select * from m_salary_slip_formula where formula_salary_code = 'άφ'", CnG, adOpenKeyset, adLockOptimistic
...
With rsBound
    ...
    .Fields("salary_code").Value = frm_mst_salary_slip.Adodc1.Recordset.Fields("salary_code").Value
    .Fields("formula_salary_code").Value = Trim(txt_formula_salary_code)
    '---------------------------------------------------------------------------
    .Fields("salary_name").Value = frm_mst_salary_slip.Adodc1.Recordset.Fields("salary_name").Value
...
rs1.Open "select * from m_salary_slip where salary_code = '" & str1 & "'", CnG, adOpenStatic, adLockReadOnly
...
If rsBound.State = 1 Then rsBound.Close
rsBound.Open "select * from m_salary_slip_formula where salary_code = '" _
& Adodc1.Recordset.Fields("salary_code").Value & "' and formula_salary_code = '" _
...
Adodc1.RecordSource = "select * from m_salary_slip_formula " _
& "where salary_code='" & frm_mst_salary_slip.Adodc1.Recordset.Fields("salary_code").Value _
