...
Begin VB.Form frm_mst_employee_ktp 
   BorderStyle     =   4  'Fixed ToolWindow
   Caption         =   "MASTER KARYAWAN KETAPANG"
   ClientHeight    =   9090
   ClientLeft      =   -15
   ClientTop       =   345
   ClientWidth     =   14685
   Icon            =   "frm_mst_employee_ktp.frx":0000
   LinkTopic       =   "Form2"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   MinButton       =   0   'False
   ...
   Begin VB.Frame frmTombol 
      ...
      Begin VB.ComboBox cbo_shiftable 
         Height          =   315
         ItemData        =   "frm_mst_employee_ktp.frx":000C
         Left            =   9570
         List            =   "frm_mst_employee_ktp.frx":0016
         TabIndex        =   116
         Text            =   "..."
         Top             =   990
         Visible         =   0   'False
      ...
      Begin VB.CommandButton cmd_update 
         ...
         Height          =   645
         Left            =   9000
         Picture         =   "frm_mst_employee_ktp.frx":0023
         Style           =   1  'Graphical
         TabIndex        =   41
         Top             =   360
         Width           =   975
      ...
      Begin VB.CommandButton cmdEdit 
         ...
         Height          =   645
         Left            =   3240
         Picture         =   "frm_mst_employee_ktp.frx":05AD
         Style           =   1  'Graphical
         TabIndex        =   37
         Top             =   360
         Width           =   975
      ...
      Begin VB.CommandButton cmdDelete 
         ...
         Height          =   645
         Left            =   4320
         Picture         =   "frm_mst_employee_ktp.frx":0B37
         Style           =   1  'Graphical
         TabIndex        =   38
         Top             =   360
         Width           =   975
      ...
      Begin VB.CommandButton CmdNew 
         ...
         Height          =   645
         Left            =   1080
         Picture         =   "frm_mst_employee_ktp.frx":10C1
         Style           =   1  'Graphical
         TabIndex        =   35
         Top             =   360
         Width           =   975
      ...
      Begin VB.CommandButton CmdExit 
         ...
         Height          =   645
         Left            =   11520
         Picture         =   "frm_mst_employee_ktp.frx":164B
         Style           =   1  'Graphical
         TabIndex        =   42
         Top             =   360
         Width           =   975
      ...
      Begin VB.CommandButton CmdCancel 
         ...
         Height          =   645
         Left            =   5400
         Picture         =   "frm_mst_employee_ktp.frx":1BD5
         Style           =   1  'Graphical
         TabIndex        =   39
         Top             =   360
         Width           =   975
      ...
      Begin VB.CommandButton CmdSave 
         ...
         Height          =   645
         Left            =   2160
         Picture         =   "frm_mst_employee_ktp.frx":215F
         Style           =   1  'Graphical
         TabIndex        =   36
         Top             =   360
         Width           =   975
      ...
      Begin VB.CommandButton cmd_import 
         ...
         Height          =   645
         Left            =   7920
         Picture         =   "frm_mst_employee_ktp.frx":26E9
         Style           =   1  'Graphical
         TabIndex        =   40
         Top             =   360
         Width           =   975
      ...
      Begin VB.CommandButton CmdPrint 
         ...
         Height          =   645
         Left            =   0
         Picture         =   "frm_mst_employee_ktp.frx":2C73
         Style           =   1  'Graphical
         TabIndex        =   51
         Top             =   360
         Visible         =   0   'False
   ...
   Begin TrueOleDBList60.TDBCombo TDBCombo_company 
      Height          =   375
      Left            =   1560
      OleObjectBlob   =   "frm_mst_employee_ktp.frx":31FD
      TabIndex        =   1
      Top             =   90
      Width           =   1695
   End
   Begin VB.Frame fra_entry 
      ...
      Begin VB.CheckBox chk_all 
         ...
         Width           =   915
      End
      Begin VB.ComboBox cbo_curr_location 
         Appearance      =   0  'Flat
         Height          =   315
         Left            =   1380
         TabIndex        =   111
         ...
         Width           =   2295
      End
      Begin VB.ComboBox cbo_prev_location 
         Appearance      =   0  'Flat
         Height          =   315
         Left            =   1380
         TabIndex        =   110
      ...
      Begin TrueOleDBList60.TDBCombo TDBCombo_department 
         Height          =   375
         Left            =   1560
         OleObjectBlob   =   "frm_mst_employee_ktp.frx":51BB
         TabIndex        =   105
         Top             =   1560
         Width           =   1695
      End
      ...
      Begin VB.ComboBox cbo_status_emp 
         Height          =   315
         ItemData        =   "frm_mst_employee_ktp.frx":7174
         Left            =   10770
         List            =   "frm_mst_employee_ktp.frx":7181
         TabIndex        =   98
         Text            =   "..."
         Top             =   2760
         Width           =   2475
      ...
      Begin VB.ComboBox cbo_bank_name 
         Height          =   315
         ItemData        =   "frm_mst_employee_ktp.frx":71A2
         Left            =   6120
         List            =   "frm_mst_employee_ktp.frx":71A4
         TabIndex        =   20
         Text            =   "..."
         Top             =   4200
         Width           =   2775
      ...
      Begin VB.Frame fra_last_education 
         ...
         Begin VB.ComboBox cbo_last_education_code 
            Height          =   315
            ItemData        =   "frm_mst_employee_ktp.frx":71A6
            Left            =   960
            List            =   "frm_mst_employee_ktp.frx":71CB
            TabIndex        =   8
            Text            =   "..."
            Top             =   360
            Width           =   1455
      ...
      Begin VB.ComboBox cbo_religion 
         Height          =   315
         ItemData        =   "frm_mst_employee_ktp.frx":7200
         Left            =   6120
         List            =   "frm_mst_employee_ktp.frx":7216
         TabIndex        =   14
         Text            =   "..."
         Top             =   1560
         Width           =   2775
      ...
      Begin VB.ComboBox cbo_marital_status 
         Height          =   315
         ItemData        =   "frm_mst_employee_ktp.frx":725A
         Left            =   6120
         List            =   "frm_mst_employee_ktp.frx":726A
         TabIndex        =   15
         Text            =   "..."
         Top             =   1920
         Width           =   1695
      ...
      Begin VB.ComboBox cbo_sex 
         Height          =   315
         ItemData        =   "frm_mst_employee_ktp.frx":728F
         Left            =   6120
         List            =   "frm_mst_employee_ktp.frx":7299
         TabIndex        =   13
         Text            =   "..."
         Top             =   1200
         Width           =   1695
      ...
      Begin TrueOleDBList60.TDBCombo TDBCombo_title 
         Height          =   375
         Left            =   10800
         OleObjectBlob   =   "frm_mst_employee_ktp.frx":72AB
         TabIndex        =   26
         Top             =   1200
         Width           =   1335
      End
      ...
      Begin TrueOleDBList60.TDBCombo TDBCombo_level 
         Height          =   375
         Left            =   10770
         OleObjectBlob   =   "frm_mst_employee_ktp.frx":925B
         TabIndex        =   94
         Top             =   2040
         Width           =   1335
      End
   ...
   Begin TrueOleDBGrid70.TDBGrid TDBGrid1 
      ...
      Columns(2).Caption=   "AREA. CODE"
      Columns(2).DataField=   "area_code"
      Columns(2)._PropDict=   "_MaxComboItems,516,2;_VlistStyle,514,3"
      Columns(3)._VlistStyle=   0
      Columns(3)._MaxComboItems=   5
      Columns(3).Caption=   "AREA. NAME"
      Columns(3).DataField=   "area_name"
      Columns(3)._PropDict=   "_MaxComboItems,516,2;_VlistStyle,514,3"
      Columns(4)._VlistStyle=   0
      Columns(4)._MaxComboItems=   5
      Columns(4).Caption=   "PREV LOCATION"
      Columns(4).DataField=   "prev_location"
      Columns(4)._PropDict=   "_MaxComboItems,516,2;_VlistStyle,514,3"
      Columns(5)._VlistStyle=   0
      Columns(5)._MaxComboItems=   5
      Columns(5).Caption=   "CURR. LOCATION"
      Columns(5).DataField=   "curr_location"
      ...
      Splits(0)._ColumnProps(37)=   "Column(5).Width=2646"
      Splits(0)._ColumnProps(38)=   "Column(5).DividerColor=0"
      Splits(0)._ColumnProps(39)=   "Column(5)._WidthInPix=2566"
      Splits(0)._ColumnProps(40)=   "Column(5)._ColStyle=8708"
      ...
      Splits(0)._ColumnProps(50)=   "Column(7).Width=1588"
      Splits(0)._ColumnProps(51)=   "Column(7).DividerColor=0"
      Splits(0)._ColumnProps(52)=   "Column(7)._WidthInPix=1508"
      ...
      Splits(0)._ColumnProps(62)=   "Column(8)._ColStyle=516"
      Splits(0)._ColumnProps(63)=   "Column(8).Visible=0"
      ...
      Splits(0)._ColumnProps(70)=   "Column(9)._ColStyle=513"
      ...
      Splits(0)._ColumnProps(78)=   "Column(10)._ColStyle=516"
      ...
      Splits(0)._ColumnProps(82)=   "Column(11).Width=2064"
      Splits(0)._ColumnProps(83)=   "Column(11).DividerColor=0"
      Splits(0)._ColumnProps(84)=   "Column(11)._WidthInPix=1984"
      Splits(0)._ColumnProps(85)=   "Column(11).AllowSizing=0"
      Splits(0)._ColumnProps(86)=   "Column(11)._ColStyle=516"
      Splits(0)._ColumnProps(87)=   "Column(11).Visible=0"
      Splits(0)._ColumnProps(88)=   "Column(11).AllowFocus=0"
      Splits(0)._ColumnProps(89)=   "Column(11).Order=12"
      Splits(0)._ColumnProps(90)=   "Column(12).Width=3016"
      Splits(0)._ColumnProps(91)=   "Column(12).DividerColor=0"
      Splits(0)._ColumnProps(92)=   "Column(12)._WidthInPix=2937"
      Splits(0)._ColumnProps(93)=   "Column(12).AllowSizing=0"
      Splits(0)._ColumnProps(94)=   "Column(12)._ColStyle=516"
      Splits(0)._ColumnProps(95)=   "Column(12).Visible=0"
      Splits(0)._ColumnProps(96)=   "Column(12).AllowFocus=0"
      Splits(0)._ColumnProps(97)=   "Column(12).Order=13"
      Splits(0)._ColumnProps(98)=   "Column(13).Width=2037"
      Splits(0)._ColumnProps(99)=   "Column(13).DividerColor=0"
      Splits(0)._ColumnProps(100)=   "Column(13)._WidthInPix=1958"
      Splits(0)._ColumnProps(101)=   "Column(13).AllowSizing=0"
      Splits(0)._ColumnProps(102)=   "Column(13)._ColStyle=516"
      Splits(0)._ColumnProps(103)=   "Column(13).Visible=0"
      Splits(0)._ColumnProps(104)=   "Column(13).AllowFocus=0"
      Splits(0)._ColumnProps(105)=   "Column(13).Order=14"
      Splits(0)._ColumnProps(106)=   "Column(14).Width=2725"
      Splits(0)._ColumnProps(107)=   "Column(14).DividerColor=0"
      Splits(0)._ColumnProps(108)=   "Column(14)._WidthInPix=2646"
      Splits(0)._ColumnProps(109)=   "Column(14).AllowSizing=0"
      Splits(0)._ColumnProps(110)=   "Column(14)._ColStyle=516"
      Splits(0)._ColumnProps(111)=   "Column(14).Visible=0"
      Splits(0)._ColumnProps(112)=   "Column(14).AllowFocus=0"
      ...
      Splits(0)._ColumnProps(122)=   "Column(15)._MinWidth=10"
      Splits(0)._ColumnProps(123)=   "Column(16).Width=2725"
      Splits(0)._ColumnProps(124)=   "Column(16).DividerColor=0"
      Splits(0)._ColumnProps(125)=   "Column(16)._WidthInPix=2646"
      Splits(0)._ColumnProps(126)=   "Column(16).AllowSizing=0"
      Splits(0)._ColumnProps(127)=   "Column(16)._ColStyle=516"
      Splits(0)._ColumnProps(128)=   "Column(16).Visible=0"
      Splits(0)._ColumnProps(129)=   "Column(16).AllowFocus=0"
      Splits(0)._ColumnProps(130)=   "Column(16).Order=17"
      Splits(0)._ColumnProps(131)=   "Column(16)._MinWidth=54215968"
      Splits(0)._ColumnProps(132)=   "Column(17).Width=2725"
      Splits(0)._ColumnProps(133)=   "Column(17).DividerColor=0"
      Splits(0)._ColumnProps(134)=   "Column(17)._WidthInPix=2646"
      Splits(0)._ColumnProps(135)=   "Column(17).AllowSizing=0"
      Splits(0)._ColumnProps(136)=   "Column(17)._ColStyle=516"
      Splits(0)._ColumnProps(137)=   "Column(17).Visible=0"
      Splits(0)._ColumnProps(138)=   "Column(17).AllowFocus=0"
      Splits(0)._ColumnProps(139)=   "Column(17).Order=18"
      Splits(0)._ColumnProps(140)=   "Column(18).Width=2725"
      Splits(0)._ColumnProps(141)=   "Column(18).DividerColor=0"
      Splits(0)._ColumnProps(142)=   "Column(18)._WidthInPix=2646"
      Splits(0)._ColumnProps(143)=   "Column(18).AllowSizing=0"
      Splits(0)._ColumnProps(144)=   "Column(18)._ColStyle=516"
      Splits(0)._ColumnProps(145)=   "Column(18).Visible=0"
      Splits(0)._ColumnProps(146)=   "Column(18).AllowFocus=0"
      Splits(0)._ColumnProps(147)=   "Column(18).Order=19"
      Splits(0)._ColumnProps(148)=   "Column(18)._MinWidth=60129312"
      Splits(0)._ColumnProps(149)=   "Column(19).Width=2725"
      Splits(0)._ColumnProps(150)=   "Column(19).DividerColor=0"
      Splits(0)._ColumnProps(151)=   "Column(19)._WidthInPix=2646"
      Splits(0)._ColumnProps(152)=   "Column(19).AllowSizing=0"
      Splits(0)._ColumnProps(153)=   "Column(19)._ColStyle=516"
      Splits(0)._ColumnProps(154)=   "Column(19).Visible=0"
      Splits(0)._ColumnProps(155)=   "Column(19).AllowFocus=0"
      Splits(0)._ColumnProps(156)=   "Column(19).Order=20"
      ...
      Splits(0)._ColumnProps(165)=   "Column(20)._MinWidth=79702332"
      ...
      Splits(0)._ColumnProps(174)=   "Column(21)._MinWidth=79897920"
      ...
      Splits(0)._ColumnProps(183)=   "Column(22)._MinWidth=79914544"
      Splits(0)._ColumnProps(184)=   "Column(23).Width=2725"
      Splits(0)._ColumnProps(185)=   "Column(23).DividerColor=0"
      Splits(0)._ColumnProps(186)=   "Column(23)._WidthInPix=2646"
      Splits(0)._ColumnProps(187)=   "Column(23).AllowSizing=0"
      Splits(0)._ColumnProps(188)=   "Column(23)._ColStyle=516"
      Splits(0)._ColumnProps(189)=   "Column(23).Visible=0"
      Splits(0)._ColumnProps(190)=   "Column(23).AllowFocus=0"
      Splits(0)._ColumnProps(191)=   "Column(23).Order=24"
      Splits(0)._ColumnProps(192)=   "Column(23)._MinWidth=79789632"
      ...
      Splits(1)._ColumnProps(0)=   "Columns.Count=24"
      ...
      HeadLines       =   1
      FootLines       =   1
      Caption         =   "LIST KARYAWAN KETAPANG"
      MultipleLines   =   0
      CellTipsWidth   =   0
      ...
      _StyleDefs(130) =   "Splits(1).Style:id=123,.parent=1"
      _StyleDefs(131) =   "Splits(1).CaptionStyle:id=132,.parent=4,.bgcolor=&H80000002&"
      _StyleDefs(132) =   ":id=132,.fgcolor=&H80000009&"
      _StyleDefs(133) =   "Splits(1).HeadingStyle:id=124,.parent=2,.alignment=2,.bgcolor=&H8000000F&"
      _StyleDefs(134) =   ":id=124,.fgcolor=&H80000002&"
      _StyleDefs(135) =   "Splits(1).FooterStyle:id=125,.parent=3"
      _StyleDefs(136) =   "Splits(1).InactiveStyle:id=126,.parent=5"
      _StyleDefs(137) =   "Splits(1).SelectedStyle:id=128,.parent=6"
      _StyleDefs(138) =   "Splits(1).EditorStyle:id=127,.parent=7"
      _StyleDefs(139) =   "Splits(1).HighlightRowStyle:id=129,.parent=8"
      _StyleDefs(140) =   "Splits(1).EvenRowStyle:id=130,.parent=9"
      _StyleDefs(141) =   "Splits(1).OddRowStyle:id=131,.parent=10"
      _StyleDefs(142) =   "Splits(1).RecordSelectorStyle:id=133,.parent=11"
      _StyleDefs(143) =   "Splits(1).FilterBarStyle:id=134,.parent=12"
      _StyleDefs(144) =   "Splits(1).Columns(0).Style:id=138,.parent=123"
      _StyleDefs(145) =   "Splits(1).Columns(0).HeadingStyle:id=135,.parent=124"
      _StyleDefs(146) =   "Splits(1).Columns(0).FooterStyle:id=136,.parent=125"
      _StyleDefs(147) =   "Splits(1).Columns(0).EditorStyle:id=137,.parent=127"
      _StyleDefs(148) =   "Splits(1).Columns(1).Style:id=142,.parent=123"
      _StyleDefs(149) =   "Splits(1).Columns(1).HeadingStyle:id=139,.parent=124"
      _StyleDefs(150) =   "Splits(1).Columns(1).FooterStyle:id=140,.parent=125"
      _StyleDefs(151) =   "Splits(1).Columns(1).EditorStyle:id=141,.parent=127"
      _StyleDefs(152) =   "Splits(1).Columns(2).Style:id=146,.parent=123"
      _StyleDefs(153) =   "Splits(1).Columns(2).HeadingStyle:id=143,.parent=124"
      _StyleDefs(154) =   "Splits(1).Columns(2).FooterStyle:id=144,.parent=125"
      _StyleDefs(155) =   "Splits(1).Columns(2).EditorStyle:id=145,.parent=127"
      _StyleDefs(156) =   "Splits(1).Columns(3).Style:id=150,.parent=123"
      _StyleDefs(157) =   "Splits(1).Columns(3).HeadingStyle:id=147,.parent=124"
      _StyleDefs(158) =   "Splits(1).Columns(3).FooterStyle:id=148,.parent=125"
      _StyleDefs(159) =   "Splits(1).Columns(3).EditorStyle:id=149,.parent=127"
      _StyleDefs(160) =   "Splits(1).Columns(4).Style:id=154,.parent=123"
      _StyleDefs(161) =   "Splits(1).Columns(4).HeadingStyle:id=151,.parent=124"
      _StyleDefs(162) =   "Splits(1).Columns(4).FooterStyle:id=152,.parent=125"
      _StyleDefs(163) =   "Splits(1).Columns(4).EditorStyle:id=153,.parent=127"
      _StyleDefs(164) =   "Splits(1).Columns(5).Style:id=158,.parent=123"
      _StyleDefs(165) =   "Splits(1).Columns(5).HeadingStyle:id=155,.parent=124"
      _StyleDefs(166) =   "Splits(1).Columns(5).FooterStyle:id=156,.parent=125"
      _StyleDefs(167) =   "Splits(1).Columns(5).EditorStyle:id=157,.parent=127"
      _StyleDefs(168) =   "Splits(1).Columns(6).Style:id=162,.parent=123,.locked=-1"
      _StyleDefs(169) =   "Splits(1).Columns(6).HeadingStyle:id=159,.parent=124"
      _StyleDefs(170) =   "Splits(1).Columns(6).FooterStyle:id=160,.parent=125"
      _StyleDefs(171) =   "Splits(1).Columns(6).EditorStyle:id=161,.parent=127"
      _StyleDefs(172) =   "Splits(1).Columns(7).Style:id=166,.parent=123,.locked=-1"
      _StyleDefs(173) =   "Splits(1).Columns(7).HeadingStyle:id=163,.parent=124"
      _StyleDefs(174) =   "Splits(1).Columns(7).FooterStyle:id=164,.parent=125"
      _StyleDefs(175) =   "Splits(1).Columns(7).EditorStyle:id=165,.parent=127"
      _StyleDefs(176) =   "Splits(1).Columns(8).Style:id=230,.parent=123,.locked=-1"
      _StyleDefs(177) =   "Splits(1).Columns(8).HeadingStyle:id=227,.parent=124"
      _StyleDefs(178) =   "Splits(1).Columns(8).FooterStyle:id=228,.parent=125"
      _StyleDefs(179) =   "Splits(1).Columns(8).EditorStyle:id=229,.parent=127"
      _StyleDefs(180) =   "Splits(1).Columns(9).Style:id=238,.parent=123,.alignment=2"
      _StyleDefs(181) =   "Splits(1).Columns(9).HeadingStyle:id=235,.parent=124"
      _StyleDefs(182) =   "Splits(1).Columns(9).FooterStyle:id=236,.parent=125"
      _StyleDefs(183) =   "Splits(1).Columns(9).EditorStyle:id=237,.parent=127"
      _StyleDefs(184) =   "Splits(1).Columns(10).Style:id=246,.parent=123"
      _StyleDefs(185) =   "Splits(1).Columns(10).HeadingStyle:id=243,.parent=124"
      _StyleDefs(186) =   "Splits(1).Columns(10).FooterStyle:id=244,.parent=125"
      _StyleDefs(187) =   "Splits(1).Columns(10).EditorStyle:id=245,.parent=127"
      _StyleDefs(188) =   "Splits(1).Columns(11).Style:id=170,.parent=123,.alignment=2,.locked=-1"
      _StyleDefs(189) =   "Splits(1).Columns(11).HeadingStyle:id=167,.parent=124"
      _StyleDefs(190) =   "Splits(1).Columns(11).FooterStyle:id=168,.parent=125"
      _StyleDefs(191) =   "Splits(1).Columns(11).EditorStyle:id=169,.parent=127"
      _StyleDefs(192) =   "Splits(1).Columns(12).Style:id=174,.parent=123,.locked=-1"
      _StyleDefs(193) =   "Splits(1).Columns(12).HeadingStyle:id=171,.parent=124"
      _StyleDefs(194) =   "Splits(1).Columns(12).FooterStyle:id=172,.parent=125"
      _StyleDefs(195) =   "Splits(1).Columns(12).EditorStyle:id=173,.parent=127"
      _StyleDefs(196) =   "Splits(1).Columns(13).Style:id=178,.parent=123,.alignment=2,.locked=-1"
      _StyleDefs(197) =   "Splits(1).Columns(13).HeadingStyle:id=175,.parent=124"
      _StyleDefs(198) =   "Splits(1).Columns(13).FooterStyle:id=176,.parent=125"
      _StyleDefs(199) =   "Splits(1).Columns(13).EditorStyle:id=177,.parent=127"
      _StyleDefs(200) =   "Splits(1).Columns(14).Style:id=182,.parent=123,.alignment=2,.locked=-1"
      _StyleDefs(201) =   "Splits(1).Columns(14).HeadingStyle:id=179,.parent=124"
      _StyleDefs(202) =   "Splits(1).Columns(14).FooterStyle:id=180,.parent=125"
      _StyleDefs(203) =   "Splits(1).Columns(14).EditorStyle:id=181,.parent=127"
      _StyleDefs(204) =   "Splits(1).Columns(15).Style:id=186,.parent=123,.locked=-1"
      _StyleDefs(205) =   "Splits(1).Columns(15).HeadingStyle:id=183,.parent=124"
      _StyleDefs(206) =   "Splits(1).Columns(15).FooterStyle:id=184,.parent=125"
      _StyleDefs(207) =   "Splits(1).Columns(15).EditorStyle:id=185,.parent=127"
      _StyleDefs(208) =   "Splits(1).Columns(16).Style:id=190,.parent=123,.locked=-1"
      _StyleDefs(209) =   "Splits(1).Columns(16).HeadingStyle:id=187,.parent=124"
      _StyleDefs(210) =   "Splits(1).Columns(16).FooterStyle:id=188,.parent=125"
      _StyleDefs(211) =   "Splits(1).Columns(16).EditorStyle:id=189,.parent=127"
      _StyleDefs(212) =   "Splits(1).Columns(17).Style:id=194,.parent=123,.locked=-1"
      _StyleDefs(213) =   "Splits(1).Columns(17).HeadingStyle:id=191,.parent=124"
      _StyleDefs(214) =   "Splits(1).Columns(17).FooterStyle:id=192,.parent=125"
      _StyleDefs(215) =   "Splits(1).Columns(17).EditorStyle:id=193,.parent=127"
      _StyleDefs(216) =   "Splits(1).Columns(18).Style:id=198,.parent=123,.alignment=2,.locked=-1"
      _StyleDefs(217) =   "Splits(1).Columns(18).HeadingStyle:id=195,.parent=124"
      _StyleDefs(218) =   "Splits(1).Columns(18).FooterStyle:id=196,.parent=125"
      _StyleDefs(219) =   "Splits(1).Columns(18).EditorStyle:id=197,.parent=127"
      _StyleDefs(220) =   "Splits(1).Columns(19).Style:id=202,.parent=123,.locked=-1"
      _StyleDefs(221) =   "Splits(1).Columns(19).HeadingStyle:id=199,.parent=124"
      _StyleDefs(222) =   "Splits(1).Columns(19).FooterStyle:id=200,.parent=125"
      _StyleDefs(223) =   "Splits(1).Columns(19).EditorStyle:id=201,.parent=127"
      _StyleDefs(224) =   "Splits(1).Columns(20).Style:id=206,.parent=123,.locked=-1"
      _StyleDefs(225) =   "Splits(1).Columns(20).HeadingStyle:id=203,.parent=124"
      _StyleDefs(226) =   "Splits(1).Columns(20).FooterStyle:id=204,.parent=125"
      _StyleDefs(227) =   "Splits(1).Columns(20).EditorStyle:id=205,.parent=127"
      _StyleDefs(228) =   "Splits(1).Columns(21).Style:id=210,.parent=123,.alignment=2,.locked=-1"
      _StyleDefs(229) =   "Splits(1).Columns(21).HeadingStyle:id=207,.parent=124"
      _StyleDefs(230) =   "Splits(1).Columns(21).FooterStyle:id=208,.parent=125"
      _StyleDefs(231) =   "Splits(1).Columns(21).EditorStyle:id=209,.parent=127"
      _StyleDefs(232) =   "Splits(1).Columns(22).Style:id=214,.parent=123,.alignment=2,.locked=-1"
      _StyleDefs(233) =   "Splits(1).Columns(22).HeadingStyle:id=211,.parent=124"
      _StyleDefs(234) =   "Splits(1).Columns(22).FooterStyle:id=212,.parent=125"
      _StyleDefs(235) =   "Splits(1).Columns(22).EditorStyle:id=213,.parent=127"
      _StyleDefs(236) =   "Splits(1).Columns(23).Style:id=218,.parent=123,.locked=-1"
      _StyleDefs(237) =   "Splits(1).Columns(23).HeadingStyle:id=215,.parent=124"
      _StyleDefs(238) =   "Splits(1).Columns(23).FooterStyle:id=216,.parent=125"
      _StyleDefs(239) =   "Splits(1).Columns(23).EditorStyle:id=217,.parent=127"
      _StyleDefs(240) =   "Named:id=33:Normal"
      _StyleDefs(241) =   ":id=33,.parent=0"
      _StyleDefs(242) =   "Named:id=34:Heading"
      _StyleDefs(243) =   ":id=34,.parent=33,.valignment=2,.bgcolor=&H8000000F&,.fgcolor=&H80000012&"
      _StyleDefs(244) =   ":id=34,.wraptext=-1"
      _StyleDefs(245) =   "Named:id=35:Footing"
      _StyleDefs(246) =   ":id=35,.parent=33,.valignment=2,.bgcolor=&H8000000F&,.fgcolor=&H80000012&"
      _StyleDefs(247) =   "Named:id=36:Selected"
      _StyleDefs(248) =   ":id=36,.parent=33,.bgcolor=&H8000000D&,.fgcolor=&H8000000E&"
      _StyleDefs(249) =   "Named:id=37:Caption"
      _StyleDefs(250) =   ":id=37,.parent=34,.alignment=2"
      _StyleDefs(251) =   "Named:id=38:HighlightRow"
      _StyleDefs(252) =   ":id=38,.parent=33,.bgcolor=&H8000000D&,.fgcolor=&H8000000E&"
      _StyleDefs(253) =   "Named:id=39:EvenRow"
      _StyleDefs(254) =   ":id=39,.parent=33,.bgcolor=&HFFFF00&"
      _StyleDefs(255) =   "Named:id=40:OddRow"
      _StyleDefs(256) =   ":id=40,.parent=33"
      _StyleDefs(257) =   "Named:id=41:RecordSelector"
      _StyleDefs(258) =   ":id=41,.parent=34"
      _StyleDefs(259) =   "Named:id=42:FilterBar"
      _StyleDefs(260) =   ":id=42,.parent=33"
   End
   ...
   End
End
Attribute VB_Name = "frm_mst_employee_ktp"
...
Private Sub chk_jstk_Click()
chk_jstk.Caption = IIf(chk_jstk.Value = 0, "Tidak", "Ya")
End Sub

Private Sub chk_tanggung_pajak_Click()
chk_tanggung_pajak.Caption = IIf(chk_tanggung_pajak.Value = 0, "NO", "YES")
End Sub
...
Private Sub set_data_area(ByVal str_code As String)
On Error Resume Next

Adodc_department.Recordset.MoveFirst
Adodc_department.Recordset.Find ("area_code='" & str_code & "'")   ', 0, adSearchForward, 1)
...
'    kdDivision = .Fields("division_code").Value
    ...
    Call set_data_area(IIf(IsNull(.Fields("area_code").Value), "", .Fields("area_code").Value))
    cbo_prev_location = IIf(IsNull(.Fields("prev_location").Value), "", .Fields("prev_location").Value)
    cbo_curr_location = IIf(IsNull(.Fields("curr_location").Value), "", .Fields("curr_location").Value)
...
'    cbo_bank_name.ListIndex = IIf(.Fields("bank_name").Value = "MANDIRI", 1, 0)
    ...
    Call set_data_title(IIf(IsNull(.Fields("title_code").Value), "", .Fields("title_code").Value))
    ...
    chk_jstk = IIf(IsNull(.Fields("flag_jstk").Value), 0, .Fields("flag_jstk").Value)
...
With rsBound
    ...
    .Fields("company_name").Value = Trim(txt_company_name)
    .Fields("area_code").Value = TDBCombo_department.Columns("area_code").Value
    .Fields("prev_location").Value = cbo_prev_location.Text
    .Fields("curr_location").Value = cbo_curr_location.Text
...
'    .Fields("
    ...
    .Fields("status_employee").Value = cbo_status_emp.ListIndex
    .Fields("flag_jstk") = chk_jstk
...
strsql = "UPDATE m_employee set employee_code = '" & Replace(Trim(txt_employee_code), "'", "''") & "',employee_name = '" & Trim(txt_employee_name) & "'," _
            & "employee_nick_name = '" & Trim(txt_employee_nick_name) & "',company_code = '" & TDBCombo_company.Columns("company_code").Value & "', " _
            & "company_name = '" & Trim(txt_company_name) & "',area_code = '" & TDBCombo_department.Columns("area_code").Value & "'," _
            & "date_of_birth = '" & Format(DTPicker_birth.Value, "yyyy-MM-dd HH:mm:ss") & "'," _
            ...
            & "flag_active = '" & IIf(opt_active, 1, 0) & "'," _
            & "end_working = '" & Format(DTPicker_end_working.Value, "yyyy-MM-dd HH:mm:ss") & "', " _
            & "reason = '" & Trim(txt_end_working_reason) & "', " _
            & "fathers_name = '" & Trim(txt_fathers_name) & "',mothers_name = '" & Trim(txt_mothers_name) & "',child_number = '" & Val(txt_child_number) & "', " _
            & "child_number_from = '" & Val(txt_child_number_from) & "', " _
            & "all_in = '" & IIf(chk_all.Value = 1, 1, 0) & "',no_jamsostek = '" & Trim(txt_jamsostek.Text) & "'," _
            & "status_employee = '" & cbo_status_emp.ListIndex & "',prev_location = '" & cbo_prev_location.Text & "', " _
            & "curr_location = '" & cbo_curr_location.Text & "',flag_jstk = '" & chk_jstk & "' " _
...
If int_mode = 1 Then
    ...
    clsFunc.InsertLog ("Insert Master Employee : " & txt_employee_code.Text)
ElseIf int_mode = 2 Then
    ...
    End If
    Call edit_old_data
    clsFunc.InsertLog ("Edit Master Employee : " & txt_employee_code.Text)
End If
...
cbo_prev_location.Text = ""
cbo_curr_location.Text = ""
...
strsql = "SELECT location_name from m_location"
rsloc.Open strsql, CnG, adOpenForwardOnly, adLockReadOnly

If Not rsloc.EOF Then
rsloc.MoveFirst
    While Not rsloc.EOF
        cbo_prev_location.AddItem rsloc!location_name
        cbo_curr_location.AddItem rsloc!location_name
    rsloc.MoveNext
    Wend
End If
...
If TDBCombo_department.ApproxCount > 0 Then
    TDBCombo_department.Text = TDBCombo_department.Columns("area_code").Value
    txt_department_name = TDBCombo_department.Columns("area_name").Value
...
Private Sub TDBCombo_level_ItemChange()
    If TDBCombo_level.ApproxCount > 0 Then
        TDBCombo_level.Text = TDBCombo_level.Columns("code").Value
        txtnm_level.Text = TDBCombo_level.Columns("name").Value
    End If
End Sub
...
If optActive.Value = True Then
    Adodc1.RecordSource = "select a.*,b.area_name from m_employee a left join m_area b on a.area_code = b.area_code " & _
            "where a.company_code = '" & TDBCombo_company.Columns("company_code").Value & "' " & _
            "AND a.level_code >= '" & DATA_LEVEL & "' AND a.flag_active <> 0 order by a.employee_code"
Else
    Adodc1.RecordSource = "select a.*,b.area_name from m_employee a left join m_area b on a.area_code = b.area_code " & _
            "where a.company_code = '" & TDBCombo_company.Columns("company_code").Value & "' " & _
            "AND a.level_code >= '" & DATA_LEVEL & "' AND a.flag_active = 0 order by a.employee_code"
...
Private Sub load_data_area()
TDBCombo_department.Text = "": txt_department_name = ""

Adodc_department.RecordSource = "select * from m_area where company_code='" _
& TDBCombo_company.Columns("company_code").Value & "' order by area_code"
...
Adodc_title.RecordSource = "select * from m_title WHERE company_code = '" & TDBCombo_company.Text & "' order by title_code"
Adodc_title.Refresh
...
Adodc_level.RecordSource = "select * from m_akses_level_group order by code"
Adodc_level.Refresh
...
strsql = "Select Count(employee_code) jml_emp From m_employee " _
        & "WHERE company_code = '" & TDBCombo_company.Text & "' AND flag_active " & active & ""
