...
Begin VB.Form frm_mst_jamsostek 
   ...
   Begin VB.Frame frmTombol 
      ...
      Begin prj_panji.vbButton cmdNew 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frm_mst_jamsostek.frx":058A
         PICN            =   "frm_mst_jamsostek.frx":05A6
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   2
         NGREY           =   0   'False
      ...
      Begin prj_panji.vbButton cmdSave 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frm_mst_jamsostek.frx":1638
         PICN            =   "frm_mst_jamsostek.frx":1654
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   2
         NGREY           =   0   'False
      ...
      Begin prj_panji.vbButton cmdEdit 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frm_mst_jamsostek.frx":26E6
         PICN            =   "frm_mst_jamsostek.frx":2702
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   2
         NGREY           =   0   'False
      ...
      Begin prj_panji.vbButton cmdDelete 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frm_mst_jamsostek.frx":3794
         PICN            =   "frm_mst_jamsostek.frx":37B0
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   2
         NGREY           =   0   'False
      ...
      Begin prj_panji.vbButton cmdCancel 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frm_mst_jamsostek.frx":4842
         PICN            =   "frm_mst_jamsostek.frx":485E
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   2
         NGREY           =   0   'False
      ...
      Begin prj_panji.vbButton CmdNew_Master 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frm_mst_jamsostek.frx":58F0
         PICN            =   "frm_mst_jamsostek.frx":590C
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   2
         NGREY           =   0   'False
      ...
      Begin prj_panji.vbButton cmdDelete_All 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frm_mst_jamsostek.frx":699E
         PICN            =   "frm_mst_jamsostek.frx":69BA
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   2
         NGREY           =   0   'False
      ...
      Begin prj_panji.vbButton cmdExit 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frm_mst_jamsostek.frx":7A4C
         PICN            =   "frm_mst_jamsostek.frx":7A68
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   2
         NGREY           =   0   'False
   ...
   Begin TrueOleDBList60.TDBCombo TDBCombo_jamsostek 
      Height          =   375
      Left            =   1590
      OleObjectBlob   =   "frm_mst_jamsostek.frx":8AFA
      TabIndex        =   17
      Top             =   870
      Width           =   1695
   End
   ...
   Begin VB.Frame fra_entry 
      ...
      Begin TrueOleDBList60.TDBCombo TDBCombo_company 
         Height          =   375
         Left            =   4020
         OleObjectBlob   =   "frm_mst_jamsostek.frx":AA6A
         TabIndex        =   1
         Top             =   690
         Width           =   1695
      End
      ...
      Begin VB.ComboBox cbo_shiftable 
         Height          =   315
         ItemData        =   "frm_mst_jamsostek.frx":C9D0
         Left            =   120
         List            =   "frm_mst_jamsostek.frx":C9DA
         TabIndex        =   13
         Text            =   "..."
         Top             =   2400
         Visible         =   0   'False
   ...
   Begin TrueOleDBGrid70.TDBGrid TDBGrid1 
      ...
      Splits(0)._ColumnProps(27)=   "Column(5).Width=2831"
      Splits(0)._ColumnProps(28)=   "Column(5).DividerColor=0"
      Splits(0)._ColumnProps(29)=   "Column(5)._WidthInPix=2752"
   ...
   Begin VB.Image Image1 
      Height          =   585
      Left            =   0
      Picture         =   "frm_mst_jamsostek.frx":C9E7
      Stretch         =   -1  'True
      Top             =   0
      Width           =   11970
   End
...
Private Function check_validate_new() As Boolean
    ...
    If Trim(txt_jkk) = "" Then
        MsgBox "JKK Masih Kosong...", vbOKOnly + vbInformation, headerMSG
        txt_jkk.SetFocus
    ...
    If Trim(txt_jkm) = "" Then
        MsgBox "JKM Masih Kosong...", vbOKOnly + vbInformation, headerMSG
        txt_jkm.SetFocus
        check_validate_new = False
        Exit Function
    End If
    ...
    'validasi TK
    If Trim(txt_tk) = "" Then
        MsgBox "JHT Kary. Masih Kosong...", vbOKOnly + vbInformation, headerMSG
        txt_tk.SetFocus
        check_validate_new = False
        Exit Function
    End If
    ...
    If Trim(txt_prs) = "" Then
        MsgBox "JHT Pers. Masih Kosong...", vbOKOnly + vbInformation, headerMSG
        txt_prs.SetFocus
        check_validate_new = False
        Exit Function
    End If
...
Dim SQL As String
    ...
    Else
        ...
        TDBCombo_jamsostek.Text = txt_jamsostek_code
        txt_jamsostek_name_type.Text = txt_name_jamsostek
...
Private Sub set_data_mode()
    If int_mode = 1 Then        'NEW
        ...
        If Trim(TDBCombo_jamsostek) = "" Then
            MsgBox "Tipe Jamsostek Belum Dipilih...", vbOKOnly + vbInformation, headerMSG
