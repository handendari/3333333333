...
Begin VB.Form frm_mst_area 
   ...
   Begin TrueOleDBGrid70.TDBGrid TDBGrid1 
      ...
      Columns(1).Caption=   "AREA. CODE"
      Columns(1).DataField=   "area_code"
      Columns(1)._PropDict=   "_MaxComboItems,516,2;_VlistStyle,514,3"
      Columns(2)._VlistStyle=   0
      Columns(2)._MaxComboItems=   5
      Columns(2).Caption=   "AREA. NAME"
      Columns(2).DataField=   "area_name"
   ...
   Begin TrueOleDBList60.TDBCombo TDBCombo_company 
      Height          =   375
      Left            =   1200
      OleObjectBlob   =   "frm_mst_area.frx":2C5C
      TabIndex        =   1
      Top             =   240
      Width           =   1695
   End
   ...
   End
End
Attribute VB_Name = "frm_mst_area"
...
If Trim(txt_department_code) = "" Then
    MsgBox "Area Code is empty!", vbOKOnly + vbInformation, headerMSG
...
If Trim(txt_department_name) = "" Then
    MsgBox "Area Name is empty!", vbOKOnly + vbInformation, headerMSG
...
CnG.BeginTrans
CnG.Execute "delete from m_area where area_code = '" _
    & TDBGrid1.Columns("area_code").Value & "'"
CnG.CommitTrans
...
With Adodc1.Recordset
    txt_department_code = .Fields("area_code").Value
    txt_department_name = .Fields("area_name").Value
...
rsBound.Open "select * from m_area where area_code = '" _
& Adodc1.Recordset.Fields("area_code").Value & "'", CnG, adOpenKeyset, adLockOptimistic
...
If rsBound.State = 1 Then rsBound.Close
rsBound.Open "select * from m_area where area_code = 'άφ'", CnG, adOpenKeyset, adLockOptimistic
...
With rsBound
    ...
    .Fields("area_code").Value = Trim(txt_department_code)
    '-----------------------------------------------------------------------------
    .Fields("area_name").Value = Trim(txt_department_name)
...
Adodc1.RecordSource = "select * from m_area where company_code = '" _
