...
Begin VB.Form frm_mst_other_income 
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "MASTER OTHER INCOME"
   ClientHeight    =   7275
   ClientLeft      =   -15
   ClientTop       =   300
   ClientWidth     =   11760
   ...
   Begin VB.Frame fra_entry 
      ...
      Top             =   3090
      Width           =   11295
      Begin VB.ComboBox cbo_income_type 
         Height          =   315
         ItemData        =   "frm_mst_income.frx":058A
         Left            =   4800
         List            =   "frm_mst_income.frx":0597
         TabIndex        =   3
         Text            =   "OP"
         Top             =   1320
         Width           =   1695
      ...
      Begin VB.TextBox txt_description 
         ...
         Width           =   3495
      End
      Begin VB.TextBox txt_income_name 
         Appearance      =   0  'Flat
         Height          =   315
         Left            =   4800
         MaxLength       =   50
      ...
      Begin VB.CommandButton CmdBrowse 
         ...
         Width           =   315
      End
      Begin VB.TextBox txt_income_code 
         Appearance      =   0  'Flat
         Height          =   315
         Left            =   4800
         MaxLength       =   10
   ...
   Begin VB.Frame frmTombol 
      ...
      Begin prj_panji.vbButton cmdNew 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frm_mst_income.frx":05B4
         PICN            =   "frm_mst_income.frx":05D0
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   2
         NGREY           =   0   'False
      ...
      Begin prj_panji.vbButton cmdSave 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frm_mst_income.frx":1662
         PICN            =   "frm_mst_income.frx":167E
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   2
         NGREY           =   0   'False
      ...
      Begin prj_panji.vbButton cmdEdit 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frm_mst_income.frx":2710
         PICN            =   "frm_mst_income.frx":272C
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   2
         NGREY           =   0   'False
      ...
      Begin prj_panji.vbButton cmdDelete 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frm_mst_income.frx":37BE
         PICN            =   "frm_mst_income.frx":37DA
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   2
         NGREY           =   0   'False
      ...
      Begin prj_panji.vbButton cmdCancel 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frm_mst_income.frx":486C
         PICN            =   "frm_mst_income.frx":4888
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   2
         NGREY           =   0   'False
      ...
      Begin prj_panji.vbButton cmdExit 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frm_mst_income.frx":591A
         PICN            =   "frm_mst_income.frx":5936
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   2
         NGREY           =   0   'False
      ...
      Begin prj_panji.vbButton cmd_Select 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frm_mst_income.frx":69C8
         PICN            =   "frm_mst_income.frx":69E4
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   2
         NGREY           =   0   'False
   ...
   Begin TrueOleDBGrid70.TDBGrid TDBGrid1 
      ...
      Columns(0).Caption=   "INCOME CODE"
      Columns(0).DataField=   "income_code"
      Columns(0)._PropDict=   "_MaxComboItems,516,2;_VlistStyle,514,3"
      Columns(1)._VlistStyle=   0
      Columns(1)._MaxComboItems=   5
      Columns(1).Caption=   "INCOME NAME"
      Columns(1).DataField=   "income_name"
      Columns(1)._PropDict=   "_MaxComboItems,516,2;_VlistStyle,514,3"
      Columns(2)._VlistStyle=   0
      Columns(2)._MaxComboItems=   5
      Columns(2).Caption=   "TYPE"
      Columns(2).DataField=   "income_type_name"
   ...
   Begin VB.Image Image2 
      Height          =   585
      Left            =   0
      Picture         =   "frm_mst_income.frx":7A76
      Stretch         =   -1  'True
      Top             =   0
      Width           =   11790
   End
End
Attribute VB_Name = "frm_mst_other_income"
...
Dim rs As New ADODB.Recordset
    ...
    SQL = "select count(income_code) as rec_count from m_other_income where income_code = '" _
...
Private Sub check_invalid()
    ...
    txt_income_code = ""
    If txt_income_code.Enabled = True Then txt_income_code.SetFocus
End Sub

Private Function check_validate_exist_edit() As Boolean
    check_validate_exist_edit = False
    
    If Not txt_income_code = rsIncome.Fields("income_code").Value And _
...
Private Function check_validate_new() As Boolean
    ...
    If Trim(txt_income_code) = "" Then
        MsgBox "Income Code Masih Kosong...", vbOKOnly + vbInformation, headerMSG
    ...
    If Trim(txt_income_name) = "" Then
        MsgBox "Income Name Masih Kosong...", vbOKOnly + vbInformation, headerMSG
        txt_income_name.SetFocus
        check_validate_new = False
        Exit Function
    End If
    
    If Trim(cbo_income_type.Text) = "" Then
        MsgBox "Income Type Masih Kosong...", vbOKOnly + vbInformation, headerMSG
        cbo_income_type.SetFocus
        check_validate_new = False
        Exit Function
    End If
...
On Error GoTo Err
    ...
    i = MsgBox("Apakah Yakin Akan Menghapus Data '" _
        & TDBGrid1.Columns("income_name").Value & "' ?", vbYesNo + vbQuestion, headerMSG)
    If Not i = vbYes Then Exit Sub
    
    CnG.BeginTrans
    CnG.Execute "delete from m_other_income where income_code = '" _
        & TDBGrid1.Columns("income_code").Value & "'"
    CnG.CommitTrans
...
Public Sub set_edit_data()
    With rsIncome
        ...
        cbo_income_type.ListIndex = .Fields("income_type").Value
...
On Error GoTo Err
    ...
    SQL = "INSERT INTO m_other_income(income_code,income_name,income_type," & _
            "income_type_name,description) " & _
          "VALUES( " & _
            "'" & Trim(txt_income_code.Text) & "','" & Trim(txt_income_name.Text) & "'," & _
            "'" & cbo_income_type.ListIndex & "','" & cbo_income_type.Text & "'," & _
...
On Error GoTo Err
    ...
    SQL = "UPDATE m_other_income SET income_code = '" & Trim(txt_income_code.Text) & "'," & _
            "income_name = '" & Trim(txt_income_name.Text) & "'," & _
            "income_type = '" & cbo_income_type.ListIndex & "'," & _
            "income_type_name = '" & cbo_income_type.Text & "'," & _
            "description = '" & Trim(txt_description) & "' " & _
          "WHERE income_code = '" & Trim(txt_income_code.Text) & "'"
    CnG.Execute SQL
...
Private Sub Form_Unload(Cancel As Integer)
    Set frm_mst_other_income = Nothing
End Sub
...
Private Sub load_data()
    If rsIncome.State Then rsIncome.Close
    SQL = "select * from m_other_income order by income_code"
    rsIncome.Open SQL, CnG, adOpenForwardOnly, adLockReadOnly
    
    TDBGrid1.DataSource = rsIncome
End Sub
...
On Error GoTo Err
    ...
    If public_int_mode = 0 Then
        With frm_mst_salary_item
            .txt_item_code = rsIncome.Fields("income_code").Value
            .txt_item_name = rsIncome.Fields("income_name").Value
            .txt_item_type = rsIncome.Fields("income_type").Value
            .txt_item_type_name = rsIncome.Fields("income_type_name").Value
        End With
    End If
...
Private Sub txt_income_code_KeyPress(KeyAscii As Integer)
    KeyAscii = Asc(UCase(Chr(KeyAscii)))
End Sub

Private Sub txt_income_name_KeyPress(KeyAscii As Integer)
    KeyAscii = Asc(UCase(Chr(KeyAscii)))
End Sub
