...
Begin VB.Form frm_mst_job_history 
   BorderStyle     =   4  'Fixed ToolWindow
   Caption         =   "MASTER JOB HISTORY"
   ClientHeight    =   9120
   ClientLeft      =   45
   ClientTop       =   300
   ClientWidth     =   14715
   Icon            =   "frm_mst_job_history.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   MinButton       =   0   'False
   ...
   Begin zkemkeeperCtl.CZKEM CZKEM1 
      Height          =   315
      Left            =   7860
      OleObjectBlob   =   "frm_mst_job_history.frx":000C
      TabIndex        =   30
      Top             =   180
      Visible         =   0   'False
      Width           =   435
   ...
   Begin VB.Frame fra_entry 
      ...
      Begin VB.TextBox txt_title_code 
         ...
         Width           =   1095
      End
      Begin VB.CommandButton cmd_browse_title 
         Caption         =   "..."
         Height          =   320
         Left            =   8040
         TabIndex        =   3
   ...
   Begin VB.Frame frmTombol 
      ...
      Begin VB.CommandButton cmdEdit 
         ...
         Height          =   645
         Left            =   4680
         Picture         =   "frm_mst_job_history.frx":0030
         Style           =   1  'Graphical
         TabIndex        =   11
         Top             =   360
         Width           =   975
      ...
      Begin VB.CommandButton cmdDelete 
         ...
         Height          =   645
         Left            =   5760
         Picture         =   "frm_mst_job_history.frx":05BA
         Style           =   1  'Graphical
         TabIndex        =   12
         Top             =   360
         Width           =   975
      ...
      Begin VB.CommandButton CmdNew 
         ...
         Height          =   645
         Left            =   2520
         Picture         =   "frm_mst_job_history.frx":0B44
         Style           =   1  'Graphical
         TabIndex        =   9
         Top             =   360
         Width           =   975
      ...
      Begin VB.CommandButton CmdCancel 
         ...
         Height          =   645
         Left            =   6840
         Picture         =   "frm_mst_job_history.frx":10CE
         Style           =   1  'Graphical
         TabIndex        =   13
         Top             =   360
         Width           =   975
      ...
      Begin VB.CommandButton CmdSave 
         ...
         Height          =   645
         Left            =   3600
         Picture         =   "frm_mst_job_history.frx":1658
         Style           =   1  'Graphical
         TabIndex        =   10
         Top             =   360
         Width           =   975
      ...
      Begin VB.CommandButton cmd_exit 
         ...
         Height          =   645
         Left            =   11520
         Picture         =   "frm_mst_job_history.frx":1BE2
         Style           =   1  'Graphical
         TabIndex        =   14
         Top             =   360
         Width           =   975
   ...
   Begin TrueOleDBGrid70.TDBGrid TDBGrid1 
      ...
      Columns(3).DataField=   "company_address"
      Columns(3)._PropDict=   "_MaxComboItems,516,2;_VlistStyle,514,3"
      Columns(4)._VlistStyle=   0
      Columns(4)._MaxComboItems=   5
      Columns(4).Caption=   "FROM"
      Columns(4).DataField=   "job_from_"
      Columns(4)._PropDict=   "_MaxComboItems,516,2;_VlistStyle,514,3"
      Columns(5)._VlistStyle=   0
      Columns(5)._MaxComboItems=   5
      Columns(5).Caption=   "TO"
      Columns(5).DataField=   "job_to_"
      Columns(5)._PropDict=   "_MaxComboItems,516,2;_VlistStyle,514,3"
      Columns.Count   =   6
      Splits(0)._UserFlags=   0
      Splits(0).Size  =   2
      ...
      Splits(0)._ColumnProps(28)=   "Column(5).Width=1826"
      Splits(0)._ColumnProps(29)=   "Column(5).DividerColor=0"
      Splits(0)._ColumnProps(30)=   "Column(5)._WidthInPix=1746"
   ...
   Begin TrueOleDBList60.TDBCombo TDBCombo_company 
      Height          =   375
      Left            =   1200
      OleObjectBlob   =   "frm_mst_job_history.frx":216C
      TabIndex        =   1
      Top             =   240
      Width           =   1695
   End
   ...
   End
End
Attribute VB_Name = "frm_mst_job_history"
...
Private Sub cmd_browse_title_Click()
frm_mst_title.public_int_mode = 1
frm_mst_title.cmd_Select.Visible = True
frm_mst_title.Show 1
End Sub
...
Adodc1.RecordSource = "select *, CAST(DATE_FORMAT(job_from,'%d-%m-%Y') AS CHAR) AS job_from_, " _
& "CAST(DATE_FORMAT(job_to,'%d-%m-%Y') AS CHAR) AS job_to_ from t_job_history where employee_code='" _
...
str_sql = "select count(sequence_number) as rec_count from t_job_history where employee_code = '" _
...
If Trim(txt_company) = "" Then
    MsgBox "Perusahaan Belum Dipilih...", vbOKOnly + vbInformation, headerMSG
...
If Trim(txt_address) = "" Then
    MsgBox "Address Masih Kosong...", vbOKOnly + vbInformation, headerMSG
...
i = MsgBox("Apakah Yakin Akan Menghapus Data '" _
    & Adodc1.Recordset.Fields("title_name").Value & "' ?", vbYesNo + vbQuestion, headerMSG)
If Not i = vbYes Then Exit Sub

CnG.BeginTrans
CnG.Execute "delete from t_job_history where employee_code = '" _
...
With Adodc1.Recordset
    ...
    txt_company = .Fields("company_name").Value
    txt_address = .Fields("company_address").Value
    DTPicker_From = .Fields("job_from").Value
    DTPicker_To = .Fields("job_to").Value
    txt_reason = .Fields("reason").Value
End With
End Sub
...
rs.Open "select * from t_job_history where sequence_number = -77", CnG, adOpenKeyset, adLockOptimistic
...
With rs
    ...
    .Fields("company_name").Value = Trim(txt_company)
    .Fields("company_address").Value = Trim(txt_address)
    
    .Fields("job_from").Value = DTPicker_From
    .Fields("job_to").Value = DTPicker_To
    .Fields("reason").Value = Trim(txt_reason)
...
If rs.State = 1 Then rs.Close
rs.Open "select * from t_job_history where sequence_number = " _
