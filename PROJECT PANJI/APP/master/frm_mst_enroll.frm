...
Begin VB.Form frm_mst_enroll 
   ...
   Caption         =   "PENDAFTARAN SIDIK JARI (BASIS IP)"
   ClientHeight    =   9795
   ClientLeft      =   45
   ClientTop       =   360
   ClientWidth     =   14715
   ...
   Begin VB.Frame frmTombol 
      ...
      Begin VB.Timer Timer1 
         ...
         Top             =   600
      End
      Begin prj_panji.vbButton cmd_set 
         Height          =   705
         Left            =   7050
         TabIndex        =   7
         Top             =   360
         ...
         VALUE           =   0   'False
      End
      Begin prj_panji.vbButton cmd_unset 
         Height          =   705
         Left            =   8070
         TabIndex        =   8
         Top             =   360
         ...
         VALUE           =   0   'False
      End
      Begin prj_panji.vbButton cmd_download 
         Height          =   705
         Left            =   9120
         TabIndex        =   9
         Top             =   360
   ...
   Begin VB.Label Label17 
      ...
      Caption         =   "PENDAFTARAN SIDIK JARI"
      BeginProperty Font 
         Name            =   "Arial"
         Size            =   12
         Charset         =   0
...
Err:
MsgBox "Gagal Set Enroll...", vbInformation, headerMSG
CnG.RollbackTrans
Call disconnect
End Sub
...
Err:
MsgBox "Gagal Unset Enroll...", vbInformation, headerMSG
CnG.RollbackTrans
Call disconnect
End Sub
...
On Error GoTo Err
    ...
    i = MsgBox("Apakah Yakin Akan Menghapus " & SelBks.Count & " Data Enroll?", vbOKCancel, headerMSG)
...
Private Sub load_data_employee()
    ...
    SQL = "select a.*, b.division_name,c.title_name from m_employee a join m_division b on a.company_code = b.company_code and a.division_code = b.division_code " & _
...
Err:
    CnG.RollbackTrans
    MsgBox Err.Description, vbCritical, headerMSG
    Call disconnect
