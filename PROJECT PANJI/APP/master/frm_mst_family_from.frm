...
Begin VB.Form frm_mst_family_from 
   BorderStyle     =   4  'Fixed ToolWindow
   Caption         =   "MASTER FAMILY FROM"
   ClientHeight    =   9120
   ClientLeft      =   45
   ClientTop       =   300
   ClientWidth     =   14715
   Icon            =   "frm_mst_family_from.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   MinButton       =   0   'False
   ...
   Begin zkemkeeperCtl.CZKEM CZKEM1 
      Height          =   405
      Left            =   8040
      OleObjectBlob   =   "frm_mst_family_from.frx":000C
      TabIndex        =   36
      Top             =   120
      Visible         =   0   'False
      Width           =   525
   ...
   Begin VB.Frame fra_entry 
      ...
      Begin VB.ComboBox cbo_religion 
         Height          =   315
         ItemData        =   "frm_mst_family_from.frx":0030
         Left            =   6960
         List            =   "frm_mst_family_from.frx":0046
         TabIndex        =   7
         Text            =   "..."
         Top             =   2280
         Width           =   2775
      ...
      Begin VB.ComboBox cbo_marital_status 
         Height          =   315
         ItemData        =   "frm_mst_family_from.frx":008A
         Left            =   6960
         List            =   "frm_mst_family_from.frx":009A
         TabIndex        =   8
         Text            =   "..."
         Top             =   2640
         Width           =   1575
      ...
      Begin VB.ComboBox cbo_sex 
         Height          =   315
         ItemData        =   "frm_mst_family_from.frx":00BF
         Left            =   6960
         List            =   "frm_mst_family_from.frx":00C9
         TabIndex        =   6
         Text            =   "..."
         Top             =   1920
         Width           =   1575
      End
      Begin VB.CheckBox chk_flag_employee 
         Caption         =   "AS EMPLOYEE"
         Height          =   255
         Left            =   9120
         TabIndex        =   3
      ...
      Begin VB.TextBox txt_education_name 
         ...
         Width           =   3495
      End
      Begin VB.TextBox txt_education_code 
         Appearance      =   0  'Flat
         BackColor       =   &H8000000B&
         Height          =   315
         Left            =   6960
         ...
         Width           =   1095
      End
      Begin VB.CommandButton cmd_browse_education 
         Caption         =   "..."
         Height          =   320
         Left            =   8040
         TabIndex        =   9
         ...
         Width           =   495
      End
      Begin VB.TextBox txt_relation_name 
         Appearance      =   0  'Flat
         BackColor       =   &H8000000B&
         Height          =   315
         Left            =   8520
         ...
         Width           =   3495
      End
      Begin VB.TextBox txt_relation_code 
         Appearance      =   0  'Flat
         BackColor       =   &H8000000B&
         Height          =   315
         Left            =   6960
         ...
         Width           =   1095
      End
      Begin VB.CommandButton cmd_browse_relation 
         Caption         =   "..."
         Height          =   320
         Left            =   8040
         TabIndex        =   5
   ...
   Begin VB.Frame frmTombol 
      ...
      Begin VB.CommandButton cmdEdit 
         ...
         Height          =   645
         Left            =   4680
         Picture         =   "frm_mst_family_from.frx":00DB
         Style           =   1  'Graphical
         TabIndex        =   13
         Top             =   360
         Width           =   975
      ...
      Begin VB.CommandButton cmdDelete 
         ...
         Height          =   645
         Left            =   5760
         Picture         =   "frm_mst_family_from.frx":0665
         Style           =   1  'Graphical
         TabIndex        =   14
         Top             =   360
         Width           =   975
      ...
      Begin VB.CommandButton CmdNew 
         ...
         Height          =   645
         Left            =   2520
         Picture         =   "frm_mst_family_from.frx":0BEF
         Style           =   1  'Graphical
         TabIndex        =   11
         Top             =   360
         Width           =   975
      ...
      Begin VB.CommandButton CmdCancel 
         ...
         Height          =   645
         Left            =   6840
         Picture         =   "frm_mst_family_from.frx":1179
         Style           =   1  'Graphical
         TabIndex        =   15
         Top             =   360
         Width           =   975
      ...
      Begin VB.CommandButton CmdSave 
         ...
         Height          =   645
         Left            =   3600
         Picture         =   "frm_mst_family_from.frx":1703
         Style           =   1  'Graphical
         TabIndex        =   12
         Top             =   360
         Width           =   975
      ...
      Begin VB.CommandButton cmd_exit 
         ...
         Height          =   645
         Left            =   11520
         Picture         =   "frm_mst_family_from.frx":1C8D
         Style           =   1  'Graphical
         TabIndex        =   16
         Top             =   360
         Width           =   975
   ...
   Begin TrueOleDBGrid70.TDBGrid TDBGrid1 
      ...
      Columns(1).DataField=   "family_name"
      Columns(1)._PropDict=   "_MaxComboItems,516,2;_VlistStyle,514,3"
      Columns(2)._VlistStyle=   0
      Columns(2)._MaxComboItems=   5
      Columns(2).Caption=   "RELATION"
      Columns(2).DataField=   "level_name"
      Columns(2)._PropDict=   "_MaxComboItems,516,2;_VlistStyle,514,3"
      Columns(3)._VlistStyle=   0
      Columns(3)._MaxComboItems=   5
      Columns(3).Caption=   "EDUCATION"
      Columns(3).DataField=   "education_name"
      Columns(3)._PropDict=   "_MaxComboItems,516,2;_VlistStyle,514,3"
      Columns(4)._VlistStyle=   0
      Columns(4)._MaxComboItems=   5
      Columns(4).Caption=   "BIRTH"
      Columns(4).DataField=   "date_of_birth_"
      Columns(4)._PropDict=   "_MaxComboItems,516,2;_VlistStyle,514,3"
      Columns.Count   =   5
      Splits(0)._UserFlags=   0
      Splits(0).Size  =   2
      ...
      Splits(0)._ColumnProps(10)=   "Column(1)._ColStyle=8704"
      ...
      _StyleDefs(38)  =   "Splits(0).Columns(1).Style:id=28,.parent=13,.alignment=0,.locked=-1"
      ...
      _StyleDefs(42)  =   "Splits(0).Columns(2).Style:id=32,.parent=13,.alignment=0,.locked=-1"
   ...
   Begin TrueOleDBList60.TDBCombo TDBCombo_company 
      Height          =   375
      Left            =   1200
      OleObjectBlob   =   "frm_mst_family_from.frx":2217
      TabIndex        =   1
      Top             =   240
      Width           =   1695
   End
   ...
   End
End
Attribute VB_Name = "frm_mst_family_from"
...
Private Sub chk_flag_employee_Click()
If chk_flag_employee.Value = vbChecked Then
    txt_family_name = Adodc2.Recordset.Fields("employee_name").Value
    cbo_marital_status.ListIndex = 1
Else
...
frm_mst_education.public_int_mode = 1
...
'cmdEdit.Enabled = IIf(Adodc2.Recordset.RecordCount = 0, False, True)
'cmdDelete.Enabled = IIf(Adodc2.Recordset.RecordCount = 0, False, True)
'CmdNew.Enabled = IIf(TDBCombo_company.Columns("company_code").Text = "", False, True)

TDBGrid2.DataSource = Adodc2
If Adodc2.Recordset.RecordCount > 0 Then Call load_data_family_from
End Sub
...
If TDBGrid2.ApproxCount > 0 Then Call load_data_family_from
End Sub
...
Public Sub load_data_family_from()
Adodc1.RecordSource = "select *, CAST(DATE_FORMAT(date_of_birth,'%d-%m-%Y') AS CHAR) AS date_of_birth_ " _
& "from t_family_from where employee_code='" _
...
err_capture:
CnG.RollbackTrans
MsgBox "Gagal Membaca Fingerprint...", vbCritical, headerMSG
Call disconnect
get_all_user_info = 0
End Function
...
str_sql = "select count(sequence_number) as rec_count from t_family_from where employee_code = '" _
...
If Trim(txt_family_name) = "" Then
    MsgBox "Family name Masih Kosong...", vbOKOnly + vbInformation, headerMSG
    txt_family_name.SetFocus
    check_validate_new = False
    Exit Function
End If

If Trim(txt_relation_code) = "" Then
    MsgBox "Relation Belum Dipilih...", vbOKOnly + vbInformation, headerMSG
...
If Trim(txt_education_name) = "" Then
    MsgBox "Education Belum Dipilih...", vbOKOnly + vbInformation, headerMSG
...
i = MsgBox("Apakah Yakin Akan Menghapus Data '" _
    & Adodc1.Recordset.Fields("family_name").Value & "' ?", vbYesNo + vbQuestion, headerMSG)
If Not i = vbYes Then Exit Sub

CnG.BeginTrans
CnG.Execute "delete from t_family_from where employee_code = '" _
...
With Adodc1.Recordset
    ...
    txt_family_name = .Fields("family_name").Value
    txt_relation_code = .Fields("level_code").Value
    txt_relation_name = .Fields("level_name").Value
    
    txt_education_code = .Fields("education_code").Value
    txt_education_name = .Fields("education_name").Value
    
    chk_flag_employee.Value = .Fields("flag_employee").Value
    
    cbo_religion.ListIndex = .Fields("religion").Value
    cbo_sex.ListIndex = .Fields("sex").Value
    cbo_marital_status.ListIndex = .Fields("marital_status").Value
...
If Not Adodc2.Recordset.Fields("marital_status").Value >= 1 Then
    MsgBox "The Employee haven't been married!", vbInformation, headerMSG
    Exit Sub
End If
...
Private Function check_married_status() As Boolean
End Function
...
rs.Open "select * from t_family_from where sequence_number = -77", CnG, adOpenKeyset, adLockOptimistic
...
With rs
    ...
    .Fields("family_name").Value = Trim(txt_family_name)
    .Fields("date_of_birth").Value = DTPicker_birth
    .Fields("level_code").Value = Trim(txt_relation_code)
    .Fields("level_name").Value = Trim(txt_relation_name)
    ...
    .Fields("marital_status_name").Value = Trim(cbo_marital_status.Text)
    .Fields("religion").Value = cbo_religion.ListIndex
    .Fields("religion_name").Value = Trim(cbo_religion.Text)
    
    .Fields("flag_employee").Value = IIf(chk_flag_employee.Value = vbChecked, 1, 0)
...
If rs.State = 1 Then rs.Close
rs.Open "select * from t_family_from where sequence_number = " _
...
chk_flag_employee.Value = vbUnchecked
...
If int_mode = 1 Then        'NEW
    ...
    txt_relation_code.Enabled = True
...
ElseIf int_mode = 2 Then    'EDIT
    Call set_edit_data
    txt_relation_code.Enabled = False
    fra_entry.Visible = True
    TDBGrid1.Enabled = False
End If
End Sub
