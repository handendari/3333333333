...
Begin VB.Form frm_mst_signature 
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "MASTER SIGNATURE"
   ClientHeight    =   7035
   ClientLeft      =   -15
   ClientTop       =   300
   ClientWidth     =   11760
   ...
   EndProperty
   Icon            =   "frm_mst_signature.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   MinButton       =   0   'False
   ...
   Begin VB.Frame fra_entry 
      ...
      Begin VB.TextBox txt_description 
         ...
         Width           =   5655
      End
      Begin VB.TextBox txt_sign_name 
         Appearance      =   0  'Flat
         Height          =   315
         Left            =   3600
         MaxLength       =   50
      ...
      Begin VB.CommandButton CmdBrowse 
         ...
         Width           =   315
      End
      Begin VB.TextBox txt_sign_code 
         Appearance      =   0  'Flat
         Height          =   315
         Left            =   3600
         MaxLength       =   10
      ...
      Begin TrueOleDBList60.TDBCombo TDBCombo_title 
         Height          =   375
         Left            =   3600
         OleObjectBlob   =   "frm_mst_signature.frx":058A
         TabIndex        =   2
         Top             =   1290
         Width           =   1695
      End
   ...
   Begin VB.Frame frmTombol 
      ...
      Begin prj_panji.vbButton cmdNew 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frm_mst_signature.frx":253E
         PICN            =   "frm_mst_signature.frx":255A
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   2
         NGREY           =   0   'False
      ...
      Begin prj_panji.vbButton cmdSave 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frm_mst_signature.frx":35EC
         PICN            =   "frm_mst_signature.frx":3608
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   2
         NGREY           =   0   'False
      ...
      Begin prj_panji.vbButton cmdEdit 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frm_mst_signature.frx":469A
         PICN            =   "frm_mst_signature.frx":46B6
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   2
         NGREY           =   0   'False
      ...
      Begin prj_panji.vbButton cmdDelete 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frm_mst_signature.frx":5748
         PICN            =   "frm_mst_signature.frx":5764
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   2
         NGREY           =   0   'False
      ...
      Begin prj_panji.vbButton cmdCancel 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frm_mst_signature.frx":67F6
         PICN            =   "frm_mst_signature.frx":6812
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   2
         NGREY           =   0   'False
      ...
      Begin prj_panji.vbButton cmdExit 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frm_mst_signature.frx":78A4
         PICN            =   "frm_mst_signature.frx":78C0
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   2
         NGREY           =   0   'False
   ...
   Begin TrueOleDBGrid70.TDBGrid TDBGrid1 
      ...
      Columns(0).Caption=   "SIGN CODE"
      Columns(0).DataField=   "sign_code"
      Columns(0)._PropDict=   "_MaxComboItems,516,2;_VlistStyle,514,3"
      Columns(1)._VlistStyle=   0
      Columns(1)._MaxComboItems=   5
      Columns(1).Caption=   "SIGN NAME"
      Columns(1).DataField=   "sign_name"
      ...
      Splits(0)._ColumnProps(17)=   "Column(3).Width=4604"
      Splits(0)._ColumnProps(18)=   "Column(3).DividerColor=0"
      Splits(0)._ColumnProps(19)=   "Column(3)._WidthInPix=4524"
      Splits(0)._ColumnProps(20)=   "Column(3)._ColStyle=516"
      Splits(0)._ColumnProps(21)=   "Column(3).Order=4"
      Splits(0)._ColumnProps(22)=   "Column(4).Width=7064"
      Splits(0)._ColumnProps(23)=   "Column(4).DividerColor=0"
      Splits(0)._ColumnProps(24)=   "Column(4)._WidthInPix=6985"
   ...
   Begin VB.Image Image1 
      Height          =   585
      Left            =   0
      Picture         =   "frm_mst_signature.frx":8952
      Stretch         =   -1  'True
      Top             =   0
      Width           =   11850
   End
End
Attribute VB_Name = "frm_mst_signature"
...
Dim v_title_code As String

Private Function check_validate_exist_new() As Boolean
Dim rs As New ADODB.Recordset
    check_validate_exist_new = False
    
    SQL = "select count(sign_code) as rec_count from m_signature where sign_code = '" _
            & Replace(Trim(txt_sign_code), "'", "''") & "' and title_code = '" & Replace(TDBCombo_title.Text, "'", "''") & "'"
...
Private Sub check_invalid()
    ...
    txt_sign_code = ""
    If txt_sign_code.Enabled = True Then txt_sign_code.SetFocus
End Sub

Private Function check_validate_exist_edit() As Boolean
    check_validate_exist_edit = False
    
    If Not txt_sign_code = rsSign.Fields("sign_code").Value And _
...
Private Function check_validate_new() As Boolean
    ...
    'validasi sign code
    If Trim(txt_sign_code) = "" Then
        MsgBox "Kode Tanda Tangan Masih Kosong...", vbOKOnly + vbInformation, headerMSG
        txt_sign_code.SetFocus
        check_validate_new = False
        Exit Function
    End If
    
    'validasi division name
    If Trim(txt_sign_name) = "" Then
        MsgBox "Nama Masih Kosong...", vbOKOnly + vbInformation, headerMSG
        txt_sign_name.SetFocus
        check_validate_new = False
        Exit Function
    End If
End Function
...
Dim i As Integer
    ...
    i = MsgBox("Apakah Yakin Akan Menghapus Data '" _
            & TDBGrid1.Columns("sign_name").Value & "' ?", vbYesNo + vbQuestion, headerMSG)
    If Not i = vbYes Then Exit Sub
    
    CnG.BeginTrans
    CnG.Execute "delete from m_signature where sign_code = '" _
            & Replace(TDBGrid1.Columns("sign_code").Value, "'", "''") & "' " _
            & "AND title_code = '" & TDBCombo_title.Text & "'"
    CnG.CommitTrans
...
Private Sub set_data_Title(ByVal str_code As String)
    ...
    Else
        TDBCombo_title.Text = "": txt_title_name.Text = ""
    End If
End Sub
...
On Error GoTo Err
    With rsSign
        txt_sign_code = .Fields("sign_code").Value
        Call set_data_Title(.Fields("title_code").Value)
        txt_sign_name = .Fields("sign_name").Value
        txt_description = .Fields("description").Value
    End With
    
    v_title_code = TDBCombo_title.Text
...
On Error GoTo Err
    ...
    SQL = "INSERT INTO m_signature(sign_code,sign_name,title_code,description,entry_date,entry_user) " & _
            "VALUES " & _
            "('" & Trim(txt_sign_code.Text) & "'," & _
            "'" & Trim(txt_sign_name.Text) & "'," & _
            "'" & TDBCombo_title.Text & "'," & _
            "'" & Trim(txt_description.Text) & "'," & _
            "now(),'" & LOGIN_NAME & "')"
    CnG.Execute SQL
...
On Error GoTo Err
    ...
    SQL = "UPDATE m_signature SET sign_code = '" & Trim(txt_sign_code.Text) & "'," & _
            "sign_name = '" & Trim(txt_sign_name.Text) & "'," & _
            "title_code = '" & TDBCombo_title.Text & "'," & _
            "description = '" & Trim(txt_description.Text) & "'," & _
            "edit_date = now(),edit_user = '" & LOGIN_NAME & "' " & _
          "WHERE sign_code = '" & Trim(txt_sign_code.Text) & "' " & _
            "AND title_code = '" & v_title_code & "'"
    CnG.Execute SQL
...
Dim Ctr As CONTROL
    For Each Ctr In Me
        If TypeOf Ctr Is TextBox Or TypeOf Ctr Is TDBText Then
            If Not LCase(Ctr.name) = "txt_title_name" Then Ctr.Text = ""
        ElseIf TypeOf Ctr Is TDBCombo Then
            If Not LCase(Ctr.name) = "tdbcombo_title" Then Ctr.Text = ""
...
Private Sub set_data_mode()
    If int_mode = 1 Then        'NEW
        ...
        txt_sign_code.Enabled = True
        TDBGrid1.Enabled = False
        Call set_new_data
        
        If txt_sign_code.Enabled = True Then
            txt_sign_code.SetFocus
        End If
...
Private Sub load_data_sign()
    If rsSign.State Then rsSign.Close
    SQL = "select a.*,b.title_name from m_signature a join m_title b on a.title_code = b.title_code order by sign_code,title_code"
    rsSign.Open SQL, CnG, adOpenForwardOnly, adLockReadOnly
    
    TDBGrid1.DataSource = rsSign
End Sub
