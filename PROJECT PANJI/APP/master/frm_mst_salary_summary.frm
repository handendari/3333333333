...
Begin VB.Form frm_mst_salary_summary 
   BorderStyle     =   4  'Fixed ToolWindow
   Caption         =   "MASTER SALARY SUMMARY"
   ClientHeight    =   9090
   ClientLeft      =   -15
   ClientTop       =   240
   ClientWidth     =   14640
   ...
   EndProperty
   Icon            =   "frm_mst_salary_summary.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   MinButton       =   0   'False
   ...
   Begin VB.Frame fra_entry 
      ...
      Top             =   360
      Width           =   14175
      Begin VB.CheckBox chk_flag_pph_in_year 
         Height          =   255
         Left            =   4320
         TabIndex        =   41
         Top             =   4320
         ...
         Width           =   495
      End
      Begin VB.CheckBox chk_flag_pkp 
         Height          =   255
         Left            =   9720
         TabIndex        =   10
         Top             =   2400
   ...
   Begin VB.Frame frmTombol 
      ...
      Begin VB.CommandButton cmd_select 
         ...
         Height          =   645
         Left            =   11040
         Picture         =   "frm_mst_salary_summary.frx":000C
         Style           =   1  'Graphical
         TabIndex        =   23
         Top             =   360
         Visible         =   0   'False
      ...
      Begin VB.CommandButton cmd_update 
         ...
         Height          =   645
         Left            =   9240
         Picture         =   "frm_mst_salary_summary.frx":0596
         Style           =   1  'Graphical
         TabIndex        =   22
         Top             =   360
         Width           =   975
      ...
      Begin VB.CommandButton cmd_delete_detail 
         ...
         Height          =   645
         Left            =   8160
         Picture         =   "frm_mst_salary_summary.frx":0B20
         Style           =   1  'Graphical
         TabIndex        =   21
         Top             =   360
         Width           =   975
      ...
      Begin VB.CommandButton cmd_add_detail 
         ...
         Height          =   645
         Left            =   7080
         Picture         =   "frm_mst_salary_summary.frx":10AA
         Style           =   1  'Graphical
         TabIndex        =   20
         Top             =   360
         Width           =   975
      ...
      Begin VB.CommandButton CmdSave 
         ...
         Height          =   645
         Left            =   1560
         Picture         =   "frm_mst_salary_summary.frx":1634
         Style           =   1  'Graphical
         TabIndex        =   16
         Top             =   360
         Width           =   975
      ...
      Begin VB.CommandButton CmdCancel 
         ...
         Height          =   645
         Left            =   4800
         Picture         =   "frm_mst_salary_summary.frx":1BBE
         Style           =   1  'Graphical
         TabIndex        =   19
         Top             =   360
         Width           =   975
      ...
      Begin VB.CommandButton CmdExit 
         ...
         Height          =   645
         Left            =   12600
         Picture         =   "frm_mst_salary_summary.frx":2148
         Style           =   1  'Graphical
         TabIndex        =   24
         Top             =   360
         Width           =   975
      ...
      Begin VB.CommandButton CmdNew 
         ...
         Height          =   645
         Left            =   480
         Picture         =   "frm_mst_salary_summary.frx":26D2
         Style           =   1  'Graphical
         TabIndex        =   15
         Top             =   360
         Width           =   975
      ...
      Begin VB.CommandButton cmdDelete 
         ...
         Height          =   645
         Left            =   3720
         Picture         =   "frm_mst_salary_summary.frx":2C5C
         Style           =   1  'Graphical
         TabIndex        =   18
         Top             =   360
         Width           =   975
      ...
      Begin VB.CommandButton cmdEdit 
         ...
         Height          =   645
         Left            =   2640
         Picture         =   "frm_mst_salary_summary.frx":31E6
         Style           =   1  'Graphical
         TabIndex        =   17
         Top             =   360
         Width           =   975
   ...
   Begin TrueOleDBGrid70.TDBGrid TDBGrid1 
      ...
      Columns(9).Caption=   "PKP"
      Columns(9).DataField=   "flag_pkp"
      Columns(9)._PropDict=   "_MaxComboItems,516,2;_VlistStyle,514,3"
      Columns(10)._VlistStyle=   4
      Columns(10)._MaxComboItems=   5
      Columns(10).Caption=   "PPH21"
      Columns(10).DataField=   "flag_pph21"
      Columns(10)._PropDict=   "_MaxComboItems,516,2;_VlistStyle,514,3"
      Columns(11)._VlistStyle=   0
      Columns(11)._MaxComboItems=   5
      Columns(11).Caption=   "PPH21 NO."
      Columns(11).DataField=   "pph21_number"
      Columns(11)._PropDict=   "_MaxComboItems,516,2;_VlistStyle,514,3"
      Columns(12)._VlistStyle=   4
      Columns(12)._MaxComboItems=   5
      Columns(12).Caption=   "VISIBLE"
      Columns(12).DataField=   "flag_visible"
      ...
      Splits(0)._ColumnProps(52)=   "Column(9).Width=714"
      Splits(0)._ColumnProps(53)=   "Column(9).DividerColor=0"
      Splits(0)._ColumnProps(54)=   "Column(9)._WidthInPix=635"
      Splits(0)._ColumnProps(55)=   "Column(9)._ColStyle=513"
      Splits(0)._ColumnProps(56)=   "Column(9).Order=10"
      Splits(0)._ColumnProps(57)=   "Column(9)._MinWidth=131052256"
      Splits(0)._ColumnProps(58)=   "Column(10).Width=1058"
      Splits(0)._ColumnProps(59)=   "Column(10).DividerColor=0"
      Splits(0)._ColumnProps(60)=   "Column(10)._WidthInPix=979"
      Splits(0)._ColumnProps(61)=   "Column(10)._ColStyle=8705"
      Splits(0)._ColumnProps(62)=   "Column(10).Order=11"
      Splits(0)._ColumnProps(63)=   "Column(10)._MinWidth=131052256"
      Splits(0)._ColumnProps(64)=   "Column(11).Width=1640"
      Splits(0)._ColumnProps(65)=   "Column(11).DividerColor=0"
      Splits(0)._ColumnProps(66)=   "Column(11)._WidthInPix=1561"
      Splits(0)._ColumnProps(67)=   "Column(11)._ColStyle=8705"
      Splits(0)._ColumnProps(68)=   "Column(11).Order=12"
      Splits(0)._ColumnProps(69)=   "Column(11)._MinWidth=131061680"
      Splits(0)._ColumnProps(70)=   "Column(12).Width=1244"
      Splits(0)._ColumnProps(71)=   "Column(12).DividerColor=0"
      Splits(0)._ColumnProps(72)=   "Column(12)._WidthInPix=1164"
      Splits(0)._ColumnProps(73)=   "Column(12)._ColStyle=8705"
      Splits(0)._ColumnProps(74)=   "Column(12).Order=13"
      Splits(0)._ColumnProps(75)=   "Column(12)._MinWidth=131062720"
      Splits.Count    =   1
      ...
      HeadLines       =   1
      FootLines       =   1
      Caption         =   "LIST OF SALARY SUMMARY"
      MultipleLines   =   0
      CellTipsWidth   =   0
      ...
      _StyleDefs(74)  =   "Splits(0).Columns(10).Style:id=82,.parent=13,.alignment=2,.locked=-1"
      ...
      _StyleDefs(78)  =   "Splits(0).Columns(11).Style:id=86,.parent=13,.alignment=2,.locked=-1"
      ...
      _StyleDefs(82)  =   "Splits(0).Columns(12).Style:id=90,.parent=13,.alignment=2,.locked=-1"
   ...
   Begin TrueOleDBGrid70.TDBGrid TDBGrid2 
      ...
      Splits(0)._ColumnProps(5)=   "Column(0).Order=1"
      Splits(0)._ColumnProps(6)=   "Column(1).Width=6641"
      Splits(0)._ColumnProps(7)=   "Column(1).DividerColor=0"
      Splits(0)._ColumnProps(8)=   "Column(1)._WidthInPix=6562"
   ...
   End
End
Attribute VB_Name = "frm_mst_salary_summary"
...
str_sql = "select count(salary_code) as rec_count from m_salary_summary where salary_code = '" _
...
If Trim(txt_salary_code) = "" Then
    MsgBox "Upah Masih Kosong...", vbInformation, headerMSG
...
Adodc1.RecordSource = "select * from m_salary_summary order by salary_code"
Adodc1.Refresh
...
Adodc2.RecordSource = "select * from d_salary_summary " _
...
frm_mst_salary_item.public_int_mode = 1
...
CnG.BeginTrans
CnG.Execute "delete from d_salary_summary where salary_code = '" _
    & Adodc1.Recordset.Fields("salary_code").Value & "'"
CnG.Execute "delete from m_salary_summary where salary_code = '" _
    & Adodc1.Recordset.Fields("salary_code").Value & "'"
CnG.CommitTrans
...
'    txt_formula_salary_code = .Fields("formula_salary_code").Value
    ...
    chk_flag_pkp = Val("" & .Fields("flag_pkp").Value)
    
    chk_flag_pph21 = .Fields("flag_pph21").Value
    txt_pph21_number = .Fields("pph21_number").Value
    chk_flag_pph_in_year = Val("" & .Fields("flag_pph_in_year").Value)
...
rsBound.Open "select * from m_salary_summary where salary_code = 'άφ'", CnG, adOpenKeyset, adLockOptimistic
...
'    .Fields("formula_salary_code").Value = Trim(txt_formula_salary_code)
    ...
    .Fields("flag_pkp").Value = IIf(chk_flag_pkp.Value = vbChecked, 1, 0)
    
    .Fields("flag_pph21").Value = IIf(chk_flag_pph21.Value = vbChecked, 1, 0)
    .Fields("pph21_number").Value = Val(txt_pph21_number)
    .Fields("flag_pph_in_year").Value = IIf(chk_flag_pph_in_year.Value = vbChecked, 1, 0)
...
If rsBound.State = 1 Then rsBound.Close
rsBound.Open "select * from m_salary_summary where salary_code = '" _
...
CnG.Execute "update m_salary_summary_formula set salary_code = '" & Trim(txt_salary_code) & "' " _
    & "where salary_code = '" & Adodc1.Recordset.Fields("salary_code").Value & "'"

CnG.Execute "update d_salary_summary set salary_code = '" & Trim(txt_salary_code) & "' " _
    & "where salary_code = '" & Adodc1.Recordset.Fields("salary_code").Value & "'"
...
If TDBGrid1.Columns(ColIndex).Caption = "FN" And TDBGrid1.Columns("flag_use_formula").Value = 1 Then
    frm_mst_salary_summary_formula.Show 1
End If
End Sub
