...
Begin VB.Form frm_mst_salary_item 
   BorderStyle     =   4  'Fixed ToolWindow
   Caption         =   "MASTER SALARY ITEM"
   ClientHeight    =   7395
   ClientLeft      =   -15
   ClientTop       =   240
   ClientWidth     =   12405
   ...
   EndProperty
   Icon            =   "frm_mst_salary_item.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   7395
   ...
   Begin VB.Frame fra_entry 
      ...
      Top             =   1200
      Width           =   11895
      Begin VB.CommandButton cmd_browse_item_type 
         Caption         =   "..."
         Height          =   300
         Left            =   6120
         TabIndex        =   9
      ...
      Begin VB.TextBox txt_item_name 
         ...
         Width           =   3375
      End
      Begin VB.TextBox txt_item_type_name 
         Appearance      =   0  'Flat
         BackColor       =   &H8000000B&
         Height          =   315
         Left            =   6600
         ...
         Width           =   3375
      End
      Begin VB.TextBox txt_item_type 
         Appearance      =   0  'Flat
         BackColor       =   &H8000000B&
         Height          =   315
         Left            =   4800
         ...
         Width           =   1335
      End
      Begin VB.TextBox txt_default_value 
         Appearance      =   0  'Flat
         Height          =   315
         Left            =   4800
         MaxLength       =   10
         ...
         Width           =   1695
      End
      Begin VB.CheckBox chk_flag_per_presence 
         Height          =   255
         Left            =   4800
         TabIndex        =   7
         Top             =   2280
      ...
      Begin VB.TextBox txt_description 
         ...
         Width           =   3495
      End
      Begin VB.TextBox txt_salary_item_name 
         Appearance      =   0  'Flat
         Height          =   315
         Left            =   4800
         MaxLength       =   50
      ...
      Begin VB.CommandButton CmdBrowse 
         ...
         Width           =   315
      End
      Begin VB.TextBox txt_salary_item_code 
         Appearance      =   0  'Flat
         Height          =   315
         Left            =   4800
         MaxLength       =   10
   ...
   Begin VB.Frame frmTombol 
      ...
      Begin VB.CommandButton cmd_select 
         ...
         Height          =   645
         Left            =   7920
         Picture         =   "frm_mst_salary_item.frx":000C
         Style           =   1  'Graphical
         TabIndex        =   17
         Top             =   360
         Visible         =   0   'False
      ...
      Begin VB.CommandButton CmdSave 
         ...
         Height          =   645
         Left            =   1800
         Picture         =   "frm_mst_salary_item.frx":0596
         Style           =   1  'Graphical
         TabIndex        =   13
         Top             =   360
         Width           =   975
      ...
      Begin VB.CommandButton CmdCancel 
         ...
         Height          =   645
         Left            =   5040
         Picture         =   "frm_mst_salary_item.frx":0B20
         Style           =   1  'Graphical
         TabIndex        =   16
         Top             =   360
         Width           =   975
      ...
      Begin VB.CommandButton CmdExit 
         ...
         Height          =   645
         Left            =   10200
         Picture         =   "frm_mst_salary_item.frx":10AA
         Style           =   1  'Graphical
         TabIndex        =   18
         Top             =   360
         Width           =   975
      ...
      Begin VB.CommandButton CmdNew 
         ...
         Height          =   645
         Left            =   720
         Picture         =   "frm_mst_salary_item.frx":1634
         Style           =   1  'Graphical
         TabIndex        =   12
         Top             =   360
         Width           =   975
      ...
      Begin VB.CommandButton CmdPrint 
         ...
         Height          =   645
         Left            =   0
         Picture         =   "frm_mst_salary_item.frx":1BBE
         Style           =   1  'Graphical
         TabIndex        =   21
         Top             =   600
         Visible         =   0   'False
      ...
      Begin VB.CommandButton cmdDelete 
         ...
         Height          =   645
         Left            =   3960
         Picture         =   "frm_mst_salary_item.frx":2148
         Style           =   1  'Graphical
         TabIndex        =   15
         Top             =   360
         Width           =   975
      ...
      Begin VB.CommandButton cmdEdit 
         ...
         Height          =   645
         Left            =   2880
         Picture         =   "frm_mst_salary_item.frx":26D2
         Style           =   1  'Graphical
         TabIndex        =   14
         Top             =   360
         Width           =   975
   ...
   Begin TrueOleDBGrid70.TDBGrid TDBGrid1 
      ...
      Splits(0)._ColumnProps(36)=   "Column(7).Width=979"
      Splits(0)._ColumnProps(37)=   "Column(7).DividerColor=0"
      Splits(0)._ColumnProps(38)=   "Column(7)._WidthInPix=900"
      Splits(0)._ColumnProps(39)=   "Column(7)._ColStyle=513"
      Splits(0)._ColumnProps(40)=   "Column(7).Order=8"
      Splits(0)._ColumnProps(41)=   "Column(8).Width=2434"
      Splits(0)._ColumnProps(42)=   "Column(8).DividerColor=0"
      Splits(0)._ColumnProps(43)=   "Column(8)._WidthInPix=2355"
   ...
   End
End
Attribute VB_Name = "frm_mst_salary_item"
...
str_sql = "select count(salary_item_code) as rec_count from m_salary_item where salary_item_code = '" _
& Trim(txt_salary_item_code) & "'"
...
txt_salary_item_code = ""
If txt_salary_item_code.Enabled = True Then txt_salary_item_code.SetFocus
End Sub

Private Function check_validate_exist_edit() As Boolean
check_validate_exist_edit = False

If Not txt_salary_item_code = Adodc1.Recordset.Fields("salary_item_code").Value And _
...
If Trim(txt_salary_item_code) = "" Then
    MsgBox "Item Code Masih Kosong...", vbOKOnly + vbInformation, headerMSG
    txt_salary_item_code.SetFocus
    check_validate_new = False
    Exit Function
End If

If Trim(txt_salary_item_name) = "" Then
    MsgBox "Item Name Masih Kosong...", vbOKOnly + vbInformation, headerMSG
    txt_salary_item_name.SetFocus
    check_validate_new = False
    Exit Function
End If
End Function
...
Private Sub cmd_browse_item_type_Click()
If opt_plus Then
    frm_mst_other_income.public_int_mode = 0
    frm_mst_other_income.cmd_Select.Visible = True
    frm_mst_other_income.Show 1
Else
    frm_mst_other_expense.public_int_mode = 0
    frm_mst_other_expense.cmd_Select.Visible = True
    frm_mst_other_expense.Show 1
End If
End Sub
...
If public_int_mode = 0 Then
    With frm_mst_salary_slip.Adodc2.Recordset
        .AddNew
        .Fields("salary_code").Value = frm_mst_salary_slip.Adodc1.Recordset("salary_code").Value
        .Fields("sequence_number").Value = get_inc_number("d_salary_slip", "sequence_number", "where salary_code='" _
                            & frm_mst_salary_slip.Adodc1.Recordset("salary_code").Value & "'")
        '---------------------------------
        .Fields("salary_name").Value = frm_mst_salary_slip.Adodc1.Recordset("salary_name").Value
        
        .Fields("flag_main_salary").Value = TDBGrid1.Columns("flag_main_salary").Value
        .Fields("salary_item_code").Value = TDBGrid1.Columns("salary_item_code").Value
        ...
        .Fields("item_code").Value = Adodc1.Recordset.Fields("item_code").Value
        .Fields("item_name").Value = Adodc1.Recordset.Fields("item_name").Value
        .Fields("item_type").Value = Adodc1.Recordset.Fields("item_type").Value
        .Fields("item_type_name").Value = Adodc1.Recordset.Fields("item_type_name").Value
...
ElseIf public_int_mode = 1 Then
    With frm_mst_salary_summary.Adodc2.Recordset
        ...
        .Fields("sequence_number").Value = get_inc_number("d_salary_summary", "sequence_number", "where salary_code='" _
...
ElseIf public_int_mode = 11 Then
    With frm_mst_salary_inc_employee
        
        .txt_item_code = TDBGrid1.Columns("salary_item_code").Value
        .txt_item_name = TDBGrid1.Columns("salary_item_name").Value
    End With
    
ElseIf public_int_mode = 12 Then
    With frm_mst_salary_exp_employee
...
ElseIf public_int_mode = 13 Then
    With frm_mst_salary_exp_employee_installment
...
i = MsgBox("Apakah Yakin Akan Menghapus Data '" _
    & TDBGrid1.Columns("salary_item_name").Value & "' ?", vbYesNo + vbQuestion, headerMSG)
If Not i = vbYes Then Exit Sub

CnG.BeginTrans
CnG.Execute "delete from m_salary_item where salary_item_code = '" _
    & TDBGrid1.Columns("salary_item_code").Value & "'"
CnG.CommitTrans
...
With Adodc1.Recordset
    txt_salary_item_code = .Fields("salary_item_code").Value
    txt_salary_item_name = .Fields("salary_item_name").Value
    ...
    chk_flag_per_presence = .Fields("flag_per_presence").Value
    txt_default_value = .Fields("default_value").Value
    
    txt_item_code = .Fields("item_code").Value
    txt_item_name = .Fields("item_name").Value
    txt_item_type = Val("" & .Fields("item_type").Value)
    txt_item_type_name = Trim("" & .Fields("item_type_name").Value)
...
rsBound.Open "select * from m_salary_item where salary_item_code = '" _
...
If rsBound.State = 1 Then rsBound.Close
rsBound.Open "select * from m_salary_item where salary_item_code = 'άφ'", CnG, adOpenKeyset, adLockOptimistic
...
With rsBound
    ...
    .Fields("salary_item_code").Value = Trim(txt_salary_item_code)
    '------------------------------------------------------------------
    .Fields("salary_item_name").Value = Trim(txt_salary_item_name)
    ...
    .Fields("flag_per_presence").Value = IIf(chk_flag_per_presence.Value = vbChecked, 1, 0)
    .Fields("default_value").Value = Val(DropAllComma(txt_default_value))
    
    .Fields("item_code").Value = Trim(txt_item_code)
    .Fields("item_name").Value = Trim(txt_item_name)
    .Fields("item_type").Value = IIf(Trim(txt_item_type_name) <> "", Val(txt_item_type), -1)
    .Fields("item_type_name").Value = Trim(txt_item_type_name)
...
If int_mode = 1 Then        'NEW
    ...
    txt_salary_item_code.Enabled = True
    TDBGrid1.Enabled = False
    Call set_new_data
    
    If txt_salary_item_code.Enabled = True Then
        txt_salary_item_code.SetFocus
    End If
...
ElseIf int_mode = 2 Then    'EDIT
    Call set_edit_data
    txt_salary_item_code.Enabled = False
    fra_entry.Visible = True
    TDBGrid1.Enabled = False
End If
End Sub
...
Adodc1.RecordSource = "select * from m_salary_item order by salary_item_code"
Adodc1.Refresh
