...
Begin VB.Form frm_rpt_verify_att 
   BorderStyle     =   4  'Fixed ToolWindow
   Caption         =   "REPORT VERIFY ATTENDANCE"
   ClientHeight    =   6990
   ClientLeft      =   -15
   ClientTop       =   240
   ClientWidth     =   10560
   Icon            =   "frm_rpt_verify_att.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   MinButton       =   0   'False
   ...
   Begin VB.TextBox Text1 
      ...
      TabIndex        =   33
      Text            =   "frm_rpt_verify_att.frx":000C
      Top             =   420
      Visible         =   0   'False
      Width           =   1575
   End
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      TabPicture(2)   =   "frm_rpt_verify_att.frx":004A
      ...
      Begin VB.Frame fra_monthly 
         ...
         Begin VB.ComboBox cbo_monthly_company 
            Height          =   315
            ItemData        =   "frm_rpt_verify_att.frx":0066
            Left            =   1800
            List            =   "frm_rpt_verify_att.frx":0070
            TabIndex        =   13
            Text            =   "..."
            Top             =   840
            Width           =   1695
         ...
         Begin VB.ComboBox cbo_monthly_employee 
            Height          =   315
            ItemData        =   "frm_rpt_verify_att.frx":0083
            Left            =   1800
            List            =   "frm_rpt_verify_att.frx":008D
            TabIndex        =   8
            Text            =   "..."
            Top             =   1200
            Width           =   1695
      ...
      Begin VB.Frame fra_periode 
         ...
         Begin VB.ComboBox cbo_periode_department 
            Height          =   315
            ItemData        =   "frm_rpt_verify_att.frx":009E
            Left            =   1800
            List            =   "frm_rpt_verify_att.frx":00A8
            TabIndex        =   51
            Text            =   "..."
            Top             =   840
            Width           =   1695
         ...
         Begin VB.Frame fra_periode_department 
            ...
            Begin TrueOleDBList60.TDBCombo TDBCombo_department 
               Height          =   375
               Left            =   0
               OleObjectBlob   =   "frm_rpt_verify_att.frx":00BB
               TabIndex        =   50
               Top             =   90
               Width           =   1845
            End
         ...
         Begin VB.ComboBox cbo_periode_to 
            Height          =   315
            ItemData        =   "frm_rpt_verify_att.frx":207C
            Left            =   3600
            List            =   "frm_rpt_verify_att.frx":2086
            Locked          =   -1  'True
            TabIndex        =   26
            Text            =   "..."
            Top             =   1590
         ...
         Begin VB.ComboBox cbo_periode_employee 
            Height          =   315
            ItemData        =   "frm_rpt_verify_att.frx":2094
            Left            =   1800
            List            =   "frm_rpt_verify_att.frx":209E
            TabIndex        =   23
            Text            =   "..."
            Top             =   1200
            Width           =   1695
         ...
         Begin VB.ComboBox cbo_periode_company 
            Height          =   315
            ItemData        =   "frm_rpt_verify_att.frx":20AF
            Left            =   6360
            List            =   "frm_rpt_verify_att.frx":20B9
            TabIndex        =   25
            Text            =   "..."
            Top             =   1260
            Visible         =   0   'False
   ...
   Begin VB.Frame Frame3 
      ...
      Begin VB.CommandButton cmdCekPrint 
         ...
         Height          =   645
         Left            =   5250
         Picture         =   "frm_rpt_verify_att.frx":20CC
         Style           =   1  'Graphical
         TabIndex        =   43
         Top             =   360
         Width           =   975
      ...
      Begin VB.CommandButton cmd_print_slip 
         ...
         Height          =   645
         Left            =   1440
         Picture         =   "frm_rpt_verify_att.frx":2656
         Style           =   1  'Graphical
         TabIndex        =   32
         Top             =   360
         Visible         =   0   'False
      ...
      Begin VB.CommandButton CmdPrint 
         ...
         Height          =   645
         Left            =   2520
         Picture         =   "frm_rpt_verify_att.frx":2BE0
         Style           =   1  'Graphical
         TabIndex        =   2
         Top             =   360
         Visible         =   0   'False
      ...
      Begin VB.CommandButton cmd_print_sum_list 
         ...
         Height          =   645
         Left            =   5520
         Picture         =   "frm_rpt_verify_att.frx":316A
         Style           =   1  'Graphical
         TabIndex        =   39
         Top             =   840
         Visible         =   0   'False
      ...
      Begin VB.CommandButton cmd_send_mail 
         ...
         Height          =   645
         Left            =   6600
         Picture         =   "frm_rpt_verify_att.frx":36F4
         Style           =   1  'Graphical
         TabIndex        =   34
         Top             =   840
         Visible         =   0   'False
      ...
      Begin VB.CommandButton CmdExit 
         ...
         Height          =   645
         Left            =   8280
         Picture         =   "frm_rpt_verify_att.frx":3C7E
         Style           =   1  'Graphical
         TabIndex        =   1
         Top             =   360
         Width           =   975
   ...
   Begin TrueOleDBList60.TDBCombo TDBCombo_company 
      Height          =   375
      Left            =   1200
      OleObjectBlob   =   "frm_rpt_verify_att.frx":4208
      TabIndex        =   5
      Top             =   540
      Width           =   1695
   End
   ...
   End
End
Attribute VB_Name = "frm_rpt_verify_att"
...
TDBCombo_department = "": txt_department_name = ""
End Sub
...
frm_lookup_mst_employee.public_int_mode = 170
frm_lookup_mst_employee.public_str_company_code = TDBCombo_company.Columns("company_code").Value
frm_lookup_mst_employee.Show 1
End Sub
...
If cbo_periode_department.ListIndex = 1 And TDBCombo_department.Text = "" Then
    MsgBox "Department Belum Diisi!", vbExclamation, "Warning!"
    Exit Sub
End If
    
int_process = vbNo

str_file = "\report\rpt_verify_att.rpt"

d1 = Format(DTPicker_periode_from.Value, "yyyy-MM-dd")
d2 = Format(DTPicker_periode_to.Value, "yyyy-MM-dd")

If cbo_periode_department.ListIndex = 1 Then
    str_sql = "SELECT b.company_code, c.company_name, a.shift_code,a.employee_code, b.nik, b.employee_name," _
                & "TIME_FORMAT(a.time_in,'%H:%i') time_in, TIME_FORMAT(a.time_out,'%H:%i') time_out," _
                & "a.total_ot,CASE WHEN a.holiday = 1 THEN 'Hari Libur' ELSE 'Hari Kerja' END holiday," _
                & "DATE_FORMAT(a.att_date,'%Y-%m-%d') att_date,a.description,a.shift_number," _
                & "(HOUR(TIMEDIFF(time_out_break,time_in_break))+(MINUTE(TIMEDIFF(time_out_break,time_in_break))/60)) break " _
            ...
            & "JOIN m_shift d ON b.company_code = d.company_code AND a.shift_number = d.shift_code " _
            & "WHERE b.company_code = '" & TDBCombo_company.Text & "' AND b.department_code = '" & TDBCombo_department.Text & "' " _
            & "AND (b.level_code = ANY (SELECT access_level_code FROM t_user_access_level WHERE level_code = '" & LOGIN_CODE & "' AND allow_access <> 0)) AND " _
            ...
            & "ELSE (DATE(att_date) BETWEEN '" & d1 & "' AND '" & d2 & "') END"
Else
    str_sql = "SELECT b.company_code, c.company_name, a.shift_code,a.employee_code, b.nik, b.employee_name," _
                & "TIME_FORMAT(a.time_in,'%H:%i') time_in, TIME_FORMAT(a.time_out,'%H:%i') time_out," _
                & "a.total_ot,CASE WHEN a.holiday = 1 THEN 'Hari Libur' ELSE 'Hari Kerja' END holiday," _
...
a.Caption = "REPORT CHECK KEHADIRAN"
