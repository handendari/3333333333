...
Begin VB.Form frm_rpt_summary_salary 
   ...
   Begin VB.Frame Frame3 
      ...
      Begin prj_panji.vbButton cmdExit 
         ...
         VALUE           =   0   'False
      End
      Begin prj_panji.vbButton cmd_print_slip 
         Height          =   705
         Left            =   3270
         TabIndex        =   34
         Top             =   270
      ...
      Begin prj_panji.vbButton cmdPrint 
         ...
         VALUE           =   0   'False
      End
      Begin prj_panji.vbButton cmd_send_mail 
         Height          =   705
         Left            =   7950
         TabIndex        =   36
         Top             =   300
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      Begin VB.Frame fra_periode 
         ...
         Begin VB.Frame fra_periode_employee 
            ...
            Begin prj_panji.vbButton cmd_periode_browse_employee 
               ...
               MCOL            =   12632256
               MPTR            =   1
               MICON           =   "frm_rpt_salary_summary.frx":6837
               UMCOL           =   -1  'True
               SOFT            =   0   'False
               PICPOS          =   0
               NGREY           =   0   'False
      ...
      Begin VB.Frame fra_monthly 
         ...
         Begin VB.ComboBox cbo_monthly_company 
            Height          =   315
            ItemData        =   "frm_rpt_salary_summary.frx":6853
            Left            =   1800
            List            =   "frm_rpt_salary_summary.frx":685D
            TabIndex        =   10
            Text            =   "..."
            Top             =   840
            Width           =   1695
         ...
         Begin VB.ComboBox cbo_monthly_employee 
            Height          =   315
            ItemData        =   "frm_rpt_salary_summary.frx":6870
            Left            =   1800
            List            =   "frm_rpt_salary_summary.frx":687A
            TabIndex        =   5
            Text            =   "..."
            Top             =   1200
            Width           =   1695
   ...
   Begin TrueOleDBList60.TDBCombo TDBCombo_company 
      Height          =   375
      Left            =   1560
      OleObjectBlob   =   "frm_rpt_salary_summary.frx":688B
      TabIndex        =   2
      Top             =   990
      Width           =   1695
   End
   ...
   Begin VB.Image Image1 
      Height          =   585
      Left            =   0
      Picture         =   "frm_rpt_salary_summary.frx":87F1
      Stretch         =   -1  'True
      Top             =   0
      Width           =   14850
   End
...
Dim rsEmployee As New ADODB.Recordset
    ...
    If j = 0 Then
        str_file = "\report\rpt_salary_summary.rpt"
    ElseIf j = 2 Then
...
'            End If
            ...
            strsql = "SELECT 1 FROM h_salary a join m_employee b on a.employee_code = b.employee_code WHERE `month` = '" & Format(DTPicker1.Value, "yyyy-MM") & "' " _
                & "AND a.period_start = '" & Format(DTPicker_periode_from.Value, "yyyy-MM-dd") & "' " _
                & "AND a.period_end = '" & Format(DTPicker_periode_to.Value, "yyyy-MM-dd") & "' " _
            ...
            If rsEmployee.RecordCount = 0 Then
                MsgBox "Data Salary Belum Diproses...", vbExclamation, headerMSG
                rsEmployee.Close
                Exit Sub
            End If
            rsEmployee.Close
        ...
        '--
            If cbo_periode_to.ListIndex = 0 Then
                str_sql = "call spr_salary_hardys_sum('" & d1 & "','" & d2 & "'," _
                    ...
                    & int_flag_employee & ",'" & str_employee_code & "','" & LOGIN_LEVEL & "','" & LOGIN_CODE & "')"
...
Private Sub load_data_division()
    ...
    Adodc_division.RecordSource = "select * from m_division where company_code='" _
