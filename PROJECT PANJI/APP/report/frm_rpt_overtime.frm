...
Begin VB.Form frm_rpt_overtime 
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      TabHeight       =   520
      TabCaption(0)   =   "DETAIL"
      TabPicture(0)   =   "frm_rpt_overtime.frx":058A
      Tab(0).ControlEnabled=   -1  'True
      Tab(0).Control(0)=   "Frame5"
      Tab(0).Control(0).Enabled=   0   'False
      Tab(0).ControlCount=   1
      TabCaption(1)   =   "SUMMARY"
      TabPicture(1)   =   "frm_rpt_overtime.frx":05A6
      ...
      Begin VB.Frame Frame1 
         ...
         Begin VB.ComboBox cbo_sum_employee 
            Height          =   315
            ItemData        =   "frm_rpt_overtime.frx":05C2
            Left            =   1800
            List            =   "frm_rpt_overtime.frx":05CC
            TabIndex        =   29
            Text            =   "..."
            Top             =   780
            Width           =   1695
         ...
         Begin VB.Frame fra_sum_employee 
            ...
            Begin prj_panji.vbButton cmd_sum_browse_employee 
               ...
               MCOL            =   12632256
               MPTR            =   1
               MICON           =   "frm_rpt_overtime.frx":05DD
               UMCOL           =   -1  'True
               SOFT            =   0   'False
               PICPOS          =   0
               NGREY           =   0   'False
      ...
      Begin VB.Frame Frame5 
         ...
         Begin VB.Frame fra_dtl_employee 
            ...
            Begin prj_panji.vbButton cmd_dtl_browse_employee 
               ...
               MCOL            =   12632256
               MPTR            =   1
               MICON           =   "frm_rpt_overtime.frx":05F9
               UMCOL           =   -1  'True
               SOFT            =   0   'False
               PICPOS          =   0
               NGREY           =   0   'False
         ...
         Begin VB.ComboBox cbo_dtl_employee 
            Height          =   315
            ItemData        =   "frm_rpt_overtime.frx":0615
            Left            =   1800
            List            =   "frm_rpt_overtime.frx":061F
            TabIndex        =   2
            Text            =   "..."
            Top             =   810
            Width           =   1695
   ...
   Begin VB.Frame Frame3 
      ...
      Begin prj_panji.vbButton cmdExit 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frm_rpt_overtime.frx":0630
         PICN            =   "frm_rpt_overtime.frx":064C
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   2
         NGREY           =   0   'False
      ...
      Begin prj_panji.vbButton cmdPrint 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frm_rpt_overtime.frx":16DE
         PICN            =   "frm_rpt_overtime.frx":16FA
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   2
         NGREY           =   0   'False
   ...
   Begin TrueOleDBList60.TDBCombo TDBCombo_company 
      Height          =   375
      Left            =   1500
      OleObjectBlob   =   "frm_rpt_overtime.frx":278C
      TabIndex        =   1
      Top             =   840
      Width           =   1695
   End
   Begin TrueOleDBList60.TDBCombo TDBCombo_division 
      Height          =   375
      Left            =   1500
      OleObjectBlob   =   "frm_rpt_overtime.frx":46F2
      TabIndex        =   41
      Top             =   1200
      Width           =   1695
   End
   ...
   Begin VB.Image Image1 
      Height          =   585
      Left            =   0
      Picture         =   "frm_rpt_overtime.frx":6659
      Stretch         =   -1  'True
      Top             =   0
      Width           =   14850
   End
...
'        Call days_func(tgl1, tgl2)
        ...
        SQL = "call sp_detail_overtime('" & txt_dtl_employee_code.Text & "','" & tgl1 & "','" & tgl2 & "'," & _
                "'" & TDBCombo_company.Text & "','" & LOGIN_LEVEL & "','" & TDBCombo_division.Text & "'," & _
                "'" & IIf(LOGIN_LEVEL = 100, LOGIN_FULLNAME, EMPLOYEE_NAME) & "','" & LOGIN_CODE & "')"
        str_file = "\report\rpt_ot_detail.rpt"
        
        Call a.Show
        a.Caption = "DETAIL OVERTIME"
...
'    v_dept = IIf(tdbcombo_division.Text = "", "company_code = '" & TDBCombo_company.Text & "'", "company_code = '" & TDBCombo_company.Text & "' AND department_code = '" & tdbcombo_division.Text & "'")
    ...
    If check_valid_periode Then
        ...
        SQL = "call sp_summary_overtime('" & txt_sum_employee_code.Text & "','" & tgl1 & "','" & tgl2 & "'," & _
                "'" & TDBCombo_company.Text & "','" & LOGIN_LEVEL & "','" & TDBCombo_division.Text & "'," & _
                "'" & IIf(LOGIN_LEVEL = 100, LOGIN_FULLNAME, EMPLOYEE_NAME) & "','" & LOGIN_CODE & "')"
        str_file = "\report\rpt_ot_summary.rpt"
        
        Call a.Show
        a.Caption = "SUMMARY OVERTIME"
