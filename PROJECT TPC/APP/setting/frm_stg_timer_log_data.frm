   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      Begin VB.Frame fraEntry_Device 
         ...
         Begin VB.ComboBox cboType 
            Height          =   315
            ItemData        =   "frm_stg_timer_log_data.frx":16E3
            Left            =   3660
            List            =   "frm_stg_timer_log_data.frx":16ED
            TabIndex        =   41
            Text            =   "TIPE A"
            Top             =   1020
            Width           =   1605
      ...
      Begin VB.Frame fra_auto_log 
         ...
         Begin VB.Frame fra_entry 
            ...
            Begin VB.ComboBox cbo_auto_log_enable 
               Height          =   315
               ItemData        =   "frm_stg_timer_log_data.frx":1701
               Left            =   1800
               List            =   "frm_stg_timer_log_data.frx":170B
               TabIndex        =   28
               Text            =   "..."
               Top             =   720
               Width           =   1335
      ...
      Begin VB.CommandButton cmd_dt_set 
         ...
         Height          =   645
         Left            =   -68400
         Picture         =   "frm_stg_timer_log_data.frx":1718
         Style           =   1  'Graphical
         TabIndex        =   22
         Top             =   2820
         Width           =   975
      ...
      Begin VB.CommandButton cmd_dt_refresh 
         ...
         Height          =   645
         Left            =   -69480
         Picture         =   "frm_stg_timer_log_data.frx":1CA2
         Style           =   1  'Graphical
         TabIndex        =   21
         Top             =   2820
         Width           =   975
      ...
      Begin VB.Frame frmTombol 
         ...
         Begin VB.Timer timer1 
            ...
            Top             =   360
         End
         Begin prj_tpc.vbButton cmdNew_Device 
            Height          =   705
            Left            =   150
            TabIndex        =   11
            Top             =   330
            ...
            MCOL            =   12632256
            MPTR            =   1
            MICON           =   "frm_stg_timer_log_data.frx":222C
            PICN            =   "frm_stg_timer_log_data.frx":2248
            UMCOL           =   -1  'True
            SOFT            =   0   'False
            PICPOS          =   2
            NGREY           =   0   'False
            ...
            VALUE           =   0   'False
         End
         Begin prj_tpc.vbButton cmdSave_Device 
            Height          =   705
            Left            =   1200
            TabIndex        =   12
            Top             =   330
            ...
            MCOL            =   12632256
            MPTR            =   1
            MICON           =   "frm_stg_timer_log_data.frx":32DA
            PICN            =   "frm_stg_timer_log_data.frx":32F6
            UMCOL           =   -1  'True
            SOFT            =   0   'False
            PICPOS          =   2
            NGREY           =   0   'False
            ...
            VALUE           =   0   'False
         End
         Begin prj_tpc.vbButton cmdEdit_Device 
            Height          =   705
            Left            =   2250
            TabIndex        =   13
            Top             =   330
            ...
            MCOL            =   12632256
            MPTR            =   1
            MICON           =   "frm_stg_timer_log_data.frx":4388
            PICN            =   "frm_stg_timer_log_data.frx":43A4
            UMCOL           =   -1  'True
            SOFT            =   0   'False
            PICPOS          =   2
            NGREY           =   0   'False
            ...
            VALUE           =   0   'False
         End
         Begin prj_tpc.vbButton cmdDelete_Device 
            Height          =   705
            Left            =   3300
            TabIndex        =   14
            Top             =   330
            ...
            MCOL            =   12632256
            MPTR            =   1
            MICON           =   "frm_stg_timer_log_data.frx":5436
            PICN            =   "frm_stg_timer_log_data.frx":5452
            UMCOL           =   -1  'True
            SOFT            =   0   'False
            PICPOS          =   2
            NGREY           =   0   'False
            ...
            VALUE           =   0   'False
         End
         Begin prj_tpc.vbButton cmdCancel_Device 
            Height          =   705
            Left            =   4350
            TabIndex        =   15
            Top             =   330
            ...
            MCOL            =   12632256
            MPTR            =   1
            MICON           =   "frm_stg_timer_log_data.frx":64E4
            PICN            =   "frm_stg_timer_log_data.frx":6500
            UMCOL           =   -1  'True
            SOFT            =   0   'False
            PICPOS          =   2
            NGREY           =   0   'False
            ...
            VALUE           =   0   'False
         End
         Begin prj_tpc.vbButton cmd_test 
            Height          =   705
            Left            =   7620
            TabIndex        =   16
            Top             =   330
            ...
            MCOL            =   12632256
            MPTR            =   1
            MICON           =   "frm_stg_timer_log_data.frx":7592
            PICN            =   "frm_stg_timer_log_data.frx":75AE
            UMCOL           =   -1  'True
            SOFT            =   0   'False
            PICPOS          =   2
            NGREY           =   0   'False
      ...
      Begin VB.Frame Frame4 
         ...
         Begin prj_tpc.vbButton cmdNew 
            ...
            MCOL            =   12632256
            MPTR            =   1
            MICON           =   "frm_stg_timer_log_data.frx":8640
            PICN            =   "frm_stg_timer_log_data.frx":865C
            UMCOL           =   -1  'True
            SOFT            =   0   'False
            PICPOS          =   2
            NGREY           =   0   'False
         ...
         Begin prj_tpc.vbButton cmdSave 
            ...
            MCOL            =   12632256
            MPTR            =   1
            MICON           =   "frm_stg_timer_log_data.frx":96EE
            PICN            =   "frm_stg_timer_log_data.frx":970A
            UMCOL           =   -1  'True
            SOFT            =   0   'False
            PICPOS          =   2
            NGREY           =   0   'False
         ...
         Begin prj_tpc.vbButton cmdEdit 
            ...
            MCOL            =   12632256
            MPTR            =   1
            MICON           =   "frm_stg_timer_log_data.frx":A79C
            PICN            =   "frm_stg_timer_log_data.frx":A7B8
            UMCOL           =   -1  'True
            SOFT            =   0   'False
            PICPOS          =   2
            NGREY           =   0   'False
         ...
         Begin prj_tpc.vbButton cmdDelete 
            ...
            MCOL            =   12632256
            MPTR            =   1
            MICON           =   "frm_stg_timer_log_data.frx":B84A
            PICN            =   "frm_stg_timer_log_data.frx":B866
            UMCOL           =   -1  'True
            SOFT            =   0   'False
            PICPOS          =   2
            NGREY           =   0   'False
         ...
         Begin prj_tpc.vbButton cmdCancel 
            ...
            MCOL            =   12632256
            MPTR            =   1
            MICON           =   "frm_stg_timer_log_data.frx":C8F8
            PICN            =   "frm_stg_timer_log_data.frx":C914
            UMCOL           =   -1  'True
            SOFT            =   0   'False
            PICPOS          =   2
            NGREY           =   0   'False
            ...
            VALUE           =   0   'False
         End
         Begin prj_tpc.vbButton vbButton6 
            Height          =   705
            Left            =   7620
            TabIndex        =   9
            Top             =   330
            ...
            MCOL            =   12632256
            MPTR            =   1
            MICON           =   "frm_stg_timer_log_data.frx":D9A6
            PICN            =   "frm_stg_timer_log_data.frx":D9C2
            UMCOL           =   -1  'True
            SOFT            =   0   'False
            PICPOS          =   2
            NGREY           =   0   'False
      ...
      Begin TrueOleDBList60.TDBCombo TDBCombo_device 
         Height          =   375
         Left            =   -71160
         OleObjectBlob   =   "frm_stg_timer_log_data.frx":EA54
         TabIndex        =   24
         Top             =   1620
         Width           =   3735
      End
      Begin prj_tpc.vbButton cmd_update_device_type 
         Height          =   450
         Left            =   -68460
         TabIndex        =   25
         Top             =   2970
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frm_stg_timer_log_data.frx":10E49
         PICN            =   "frm_stg_timer_log_data.frx":10E65
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin TrueOleDBGrid70.TDBGrid TDBGrid2 
         ...
         Columns(4).Caption=   "DEL LOG"
         Columns(4).DataField=   "del_log"
         Columns(4)._PropDict=   "_MaxComboItems,516,2;_VlistStyle,514,3"
         Columns(5)._VlistStyle=   0
         Columns(5)._MaxComboItems=   5
         Columns(5).Caption=   "DESCRIPTION"
         Columns(5).DataField=   "name"
         ...
         Splits(0)._ColumnProps(22)=   "Column(4).Width=2143"
         Splits(0)._ColumnProps(23)=   "Column(4).DividerColor=0"
         Splits(0)._ColumnProps(24)=   "Column(4)._WidthInPix=2064"
         Splits(0)._ColumnProps(25)=   "Column(4)._ColStyle=513"
         Splits(0)._ColumnProps(26)=   "Column(4).Order=5"
         Splits(0)._ColumnProps(27)=   "Column(5).Width=4842"
         Splits(0)._ColumnProps(28)=   "Column(5).DividerColor=0"
         Splits(0)._ColumnProps(29)=   "Column(5)._WidthInPix=4763"
...
Private Sub cmd_dt_set_Click()
    If check_validate_tdbcombo(TDBCombo_device) = False Then
        MsgBox "Invalid Data...", vbInformation, headerMSG
        Exit Sub
    End If
    ...
    If Not connect Then
        MsgBox "Failed to Connecting Device...", vbCritical, headerMSG
        Exit Sub
    End If
...
Private Function connect() As Boolean
    ...
    FG_DEVICE_TYPE = rsDevice.Fields("flag_type").Value
...
Dim Ctr As CONTROL
    For Each Ctr In Me
        If TypeOf Ctr Is TextBox Or TypeOf Ctr Is TDBText Then
            ...
            And Not LCase(Ctr.name) = "txt_smtp_port" And Not LCase(Ctr.name) = "txt_mail_username" _
            And Not LCase(Ctr.name) = "txt_port" Then
                Ctr.Text = ""
            End If
...
Public Sub set_edit_data_device()
    With rsDevice
        ...
        cboAuto.ListIndex = IIf(IsNull(.Fields("auto_del_log").Value), 0, .Fields("auto_del_log").Value)
...
On Error GoTo Err
    ...
    SQL = "INSERT INTO m_device(ip_address,port_number,name,flag_type,auto_del_log) " & _
...
On Error GoTo Err
    ...
    CnG.BeginTrans
    SQL = "UPDATE m_device SET name = '" & Trim(txt_name) & "', " & _
            "port_number = '" & Val(DropAllComma(txt_port)) & "', " & _
            "flag_type = '" & cboType.ListIndex & "', " & _
            "auto_del_log = '" & cboAuto.ListIndex & "' " & _
...
Private Sub load_data_device()
    ...
    SQL = "select *,case when flag_type = 0 then 'TIPE A' else 'TIPE B' end type," & _
