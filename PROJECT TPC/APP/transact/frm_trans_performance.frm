...
Begin VB.Form frm_trans_performance 
   ...
   Begin TrueOleDBGrid70.TDBGrid TDBGrid_Perf 
      ...
      HeadLines       =   1
      FootLines       =   1
      Caption         =   "LIST OF EMPLOYEE PERFORMANCE"
      MultipleLines   =   0
      CellTipsWidth   =   0
   ...
   Begin TrueOleDBGrid70.TDBGrid TDBGrid_Perf_Result 
      ...
      HeadLines       =   1
      FootLines       =   1
      Caption         =   "LIST OF EMPLOYEE PERFORMANCE RESULT"
      MultipleLines   =   0
      CellTipsWidth   =   0
      DeadAreaBackColor=   13160660
      RowDividerColor =   13160660
   ...
   Begin TrueOleDBList60.TDBCombo TDBCombo_department 
      Height          =   375
      Left            =   1500
      OleObjectBlob   =   "frm_trans_performance.frx":99CE
      TabIndex        =   27
      Top             =   1530
      Width           =   1545
   End
   ...
   Begin VB.Image Image2 
      ...
      Height          =   585
      Left            =   0
      Picture         =   "frm_trans_performance.frx":B937
      Stretch         =   -1  'True
      Top             =   0
      Width           =   14850
   End
...
Private Function check_validate_new() As Boolean
    ...
    If txt_perf_value.Text = "" Then
        MsgBox "Performance Value is empty!", vbOKOnly + vbInformation, headerMSG
    ...
    If Not IsNumeric(txt_perf_value.Text) Or Val(txt_perf_value.Text) < 0 Then
        MsgBox "Invalid Performance Value!", vbOKOnly + vbInformation, headerMSG
...
On Error GoTo Err
    ...
    SQL = "INSERT INTO t_employee_perf (employee_code,seq_no,perf_date," & _
            "perf_value,description,entry_date,entry_user) " & _
          "VALUES (" & _
            "'" & txt_employee_code.Text & "','" & v_seq & "'," & _
...
Private Sub set_data_mode()
    If int_mode = 1 Then        'NEW
        ...
        If txt_nik.Text = "" Then
            MsgBox "Employee Code Is Empty!", vbExclamation, headerMSG
            txt_nik.SetFocus
...
Private Sub load_data_employee_perf()
    ...
    SQL = "select * from t_employee_perf " & _
          "where employee_code = '" & txt_employee_code.Text & "' " & _
            "AND (year(perf_date) between '" & year(DTPicker_perf_from.Value) & "' and '" & year(DTPicker_perf_to.Value) & "') " & oClause
