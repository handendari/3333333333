...
Begin VB.Form frm_trans_att_man 
   ...
   Begin VB.ComboBox Combo1 
      Appearance      =   0  'Flat
      Height          =   315
      ItemData        =   "frm_trans_att_man.frx":0000
      Left            =   3150
      List            =   "frm_trans_att_man.frx":0002
   ...
   Begin TrueOleDBList60.TDBCombo TDBCombo_company 
      Height          =   375
      Left            =   1290
      OleObjectBlob   =   "frm_trans_att_man.frx":0004
      TabIndex        =   10
      Top             =   570
      Width           =   1785
   End
   Begin prj_fej_jkt.vbButton vbButton5 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "frm_trans_att_man.frx":1FC2
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin prj_fej_jkt.vbButton vbButton1 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "frm_trans_att_man.frx":1FDE
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin TDBTime6Ctl.TDBTime ttin 
      ...
      _ExtentX        =   1455
      _ExtentY        =   503
      Caption         =   "frm_trans_att_man.frx":1FFA
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         Name            =   "MS Sans Serif"
         Size            =   8.25
         Charset         =   0
         ...
         Strikethrough   =   0   'False
      EndProperty
      Keys            =   "frm_trans_att_man.frx":2066
      Spin            =   "frm_trans_att_man.frx":20B6
      AlignHorizontal =   2
      AlignVertical   =   0
      Appearance      =   0
   ...
   Begin prj_fej_jkt.vbButton vbButton2 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "frm_trans_att_man.frx":20DE
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin TDBTime6Ctl.TDBTime ttout 
      ...
      _ExtentX        =   1455
      _ExtentY        =   503
      Caption         =   "frm_trans_att_man.frx":20FA
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         Name            =   "MS Sans Serif"
         Size            =   8.25
         Charset         =   0
         ...
         Strikethrough   =   0   'False
      EndProperty
      Keys            =   "frm_trans_att_man.frx":2166
      Spin            =   "frm_trans_att_man.frx":21B6
      AlignHorizontal =   2
      AlignVertical   =   0
      Appearance      =   0
      BackColor       =   -2147483643
