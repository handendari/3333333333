...
Begin VB.Form frm_mst_employees_working_time 
   ...
   Begin VB.Frame frmTombol 
      ...
      Begin VB.CommandButton cmd_delete_dtl 
         ...
         Height          =   645
         Left            =   8280
         Picture         =   "frm_trans_employees_wt.frx":24C8
         Style           =   1  'Graphical
         TabIndex        =   21
         Top             =   360
         Width           =   1095
      ...
      Begin VB.CommandButton cmd_add_dtl 
         ...
         Height          =   645
         Left            =   7200
         Picture         =   "frm_trans_employees_wt.frx":2A52
         Style           =   1  'Graphical
         TabIndex        =   20
         Top             =   360
         Width           =   1095
      ...
      Begin VB.CommandButton cmd_refresh 
         ...
         Height          =   645
         Left            =   10200
         Picture         =   "frm_trans_employees_wt.frx":2FDC
         Style           =   1  'Graphical
         TabIndex        =   22
         Top             =   360
         Width           =   975
      ...
      Begin VB.CommandButton CmdSave 
         ...
         Height          =   645
         Left            =   1800
         Picture         =   "frm_trans_employees_wt.frx":3566
         Style           =   1  'Graphical
         TabIndex        =   13
         Top             =   360
         Width           =   975
      ...
      Begin VB.CommandButton CmdCancel 
         ...
         Height          =   645
         Left            =   5040
         Picture         =   "frm_trans_employees_wt.frx":3AF0
         Style           =   1  'Graphical
         TabIndex        =   16
         Top             =   360
         Width           =   975
      ...
      Begin VB.CommandButton CmdExit 
         ...
         Height          =   645
         Left            =   12120
         Picture         =   "frm_trans_employees_wt.frx":407A
         Style           =   1  'Graphical
         TabIndex        =   24
         Top             =   360
         Width           =   975
      ...
      Begin VB.CommandButton CmdNew 
         ...
         Height          =   645
         Left            =   720
         Picture         =   "frm_trans_employees_wt.frx":4604
         Style           =   1  'Graphical
         TabIndex        =   12
         Top             =   360
         Width           =   975
      ...
      Begin VB.CommandButton CmdPrint 
         ...
         Height          =   645
         Left            =   0
         Picture         =   "frm_trans_employees_wt.frx":4B8E
         Style           =   1  'Graphical
         TabIndex        =   17
         Top             =   600
         Visible         =   0   'False
      ...
      Begin VB.CommandButton cmdDelete 
         ...
         Height          =   645
         Left            =   3960
         Picture         =   "frm_trans_employees_wt.frx":5118
         Style           =   1  'Graphical
         TabIndex        =   15
         Top             =   360
         Width           =   975
      ...
      Begin VB.CommandButton cmdEdit 
         ...
         Height          =   645
         Left            =   2880
         Picture         =   "frm_trans_employees_wt.frx":56A2
         Style           =   1  'Graphical
         TabIndex        =   14
         Top             =   360
         Width           =   975
   ...
   Begin TrueOleDBList60.TDBCombo TDBCombo_company 
      Height          =   375
      Left            =   1200
      OleObjectBlob   =   "frm_trans_employees_wt.frx":5C2C
      TabIndex        =   1
      Top             =   240
      Width           =   1695
   End
