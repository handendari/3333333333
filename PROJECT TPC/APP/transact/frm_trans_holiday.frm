...
Begin VB.Form frm_trans_holiday 
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "MASTER HOLIDAY"
   ClientHeight    =   9090
   ClientLeft      =   -15
   ClientTop       =   300
   ClientWidth     =   10095
   ...
   EndProperty
   Icon            =   "frm_trans_holiday.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   9090
   ...
   Begin VB.Frame fra_entry 
      ...
      Begin VB.CommandButton CmdBrowse 
         ...
         Width           =   315
      End
      Begin MSComCtl2.DTPicker DTPicker_date_holiday 
         Height          =   315
         Left            =   2640
         TabIndex        =   1
         Top             =   720
      ...
      Begin TrueOleDBList60.TDBCombo TDBCombo_ot 
         Height          =   375
         Left            =   2625
         OleObjectBlob   =   "frm_trans_holiday.frx":058A
         TabIndex        =   2
         Top             =   1110
         Width           =   1725
      End
   ...
   Begin VB.Frame frmTombol 
      ...
      Begin prj_tpc.vbButton cmdNew 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frm_trans_holiday.frx":24D3
         PICN            =   "frm_trans_holiday.frx":24EF
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   2
         NGREY           =   0   'False
      ...
      Begin prj_tpc.vbButton cmdSave 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frm_trans_holiday.frx":3581
         PICN            =   "frm_trans_holiday.frx":359D
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   2
         NGREY           =   0   'False
      ...
      Begin prj_tpc.vbButton cmdEdit 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frm_trans_holiday.frx":462F
         PICN            =   "frm_trans_holiday.frx":464B
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   2
         NGREY           =   0   'False
      ...
      Begin prj_tpc.vbButton cmdDelete 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frm_trans_holiday.frx":56DD
         PICN            =   "frm_trans_holiday.frx":56F9
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   2
         NGREY           =   0   'False
      ...
      Begin prj_tpc.vbButton cmdCancel 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frm_trans_holiday.frx":678B
         PICN            =   "frm_trans_holiday.frx":67A7
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   2
         NGREY           =   0   'False
      ...
      Begin prj_tpc.vbButton cmdExit 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frm_trans_holiday.frx":7839
         PICN            =   "frm_trans_holiday.frx":7855
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   2
         NGREY           =   0   'False
   ...
   Begin TrueOleDBGrid70.TDBGrid TDBGrid1 
      ...
      Columns(0).DataField=   "holiday_number"
      Columns(0)._PropDict=   "_MaxComboItems,516,2;_VlistStyle,514,3"
      Columns(1)._VlistStyle=   0
      Columns(1)._MaxComboItems=   5
      Columns(1).Caption=   "DATE"
      Columns(1).DataField=   "holiday_date"
      Columns(1).NumberFormat=   "dd-MM-yyyy"
      Columns(1)._PropDict=   "_MaxComboItems,516,2;_VlistStyle,514,3"
      Columns(2)._VlistStyle=   0
      Columns(2)._MaxComboItems=   5
      Columns(2).Caption=   "OT TYPE"
      Columns(2).DataField=   "ot_code"
      ...
      Splits(0)._ColumnProps(16)=   "Column(3).Width=7250"
      Splits(0)._ColumnProps(17)=   "Column(3).DividerColor=0"
      Splits(0)._ColumnProps(18)=   "Column(3)._WidthInPix=7170"
      ...
      _StyleDefs(43)  =   "Splits(0).Columns(2).Style:id=16,.parent=99,.alignment=2"
      _StyleDefs(44)  =   "Splits(0).Columns(2).HeadingStyle:id=13,.parent=100"
      _StyleDefs(45)  =   "Splits(0).Columns(2).FooterStyle:id=14,.parent=101"
      _StyleDefs(46)  =   "Splits(0).Columns(2).EditorStyle:id=15,.parent=103"
      _StyleDefs(47)  =   "Splits(0).Columns(3).Style:id=190,.parent=99"
      _StyleDefs(48)  =   "Splits(0).Columns(3).HeadingStyle:id=187,.parent=100"
      _StyleDefs(49)  =   "Splits(0).Columns(3).FooterStyle:id=188,.parent=101"
      _StyleDefs(50)  =   "Splits(0).Columns(3).EditorStyle:id=189,.parent=103"
   ...
   Begin VB.Image Image2 
      Height          =   585
      Left            =   0
      Picture         =   "frm_trans_holiday.frx":88E7
      Stretch         =   -1  'True
      Top             =   0
      Width           =   11790
   End
End
Attribute VB_Name = "frm_trans_holiday"
...
Dim i As Integer
    ...
    CnG.BeginTrans
    CnG.Execute "delete from t_holiday where holiday_number = " _
        & TDBGrid1.Columns("holiday_number").Value
    CnG.CommitTrans
    
    Call load_data_holiday
    int_mode = 0
    Call load_mode
    Exit Sub
...
Public Sub set_edit_data()
    With rsHoliday
        DTPicker_date_holiday.Value = .Fields("holiday_date").Value
...
Dim rs As New ADODB.Recordset
    rs.Open "select ifnull(max(holiday_number),0)+1 as holiday_number from t_holiday", CnG, adOpenStatic, adLockReadOnly
    
    CnG.BeginTrans

    SQL = "INSERT INTO t_holiday(holiday_number,holiday_date,ot_code,description,entry_date) " & _
            "VALUES( " & _
            "'" & rs.Fields("holiday_number").Value & "'," & _
            "'" & Format(DTPicker_date_holiday.Value, "yyyy-MM-dd HH:mm:ss") & "'," & _
            "'" & TDBCombo_ot.Text & "','" & Trim(txt_description) & "'," & _
...
On Error GoTo Err
    ...
    CnG.BeginTrans
    SQL = "UPDATE t_holiday SET holiday_date = '" & Format(DTPicker_date_holiday.Value, "yyyy-MM-dd HH:mm:ss") & "'," & _
            "ot_code = '" & TDBCombo_ot.Text & "',description = '" & Trim(txt_description) & "' " & _
            "WHERE holiday_number = '" & TDBGrid1.Columns("holiday_number").Value & "'"
    CnG.Execute SQL
    CnG.CommitTrans
    Exit Sub
...
Private Sub set_new_data()
    DTPicker_date_holiday.Value = Now
    txt_description = ""
End Sub
...
Private Sub set_data_mode()
    If int_mode = 1 Then        'NEW
        ...
        DTPicker_date_holiday.Enabled = True
        TDBGrid1.Enabled = False
        Call set_new_data
        
        If DTPicker_date_holiday.Enabled = True Then
            DTPicker_date_holiday.SetFocus
        End If
    ...
    ElseIf int_mode = 2 Then    'EDIT
        Call set_edit_data
        DTPicker_date_holiday.Enabled = False
        fra_entry.Visible = True
        TDBGrid1.Enabled = False
    End If
End Sub
...
Private Sub load_data_holiday()
    If rsHoliday.State Then rsHoliday.Close
    SQL = "select a.* from t_holiday a join m_ot b on a.ot_code = b.ot_code " & oClause
    rsHoliday.Open SQL, CnG, adOpenForwardOnly, adLockReadOnly
    
    TDBGrid1.DataSource = rsHoliday
End Sub

Public Sub load_data_ot()
    TDBCombo_ot.Text = "": txt_ot_name.Text = ""
...
Private Sub TDBCombo_ot_ItemChange()
    If TDBCombo_ot.ApproxCount > 0 Then
        ...
        txt_ot_name.Text = TDBCombo_ot.Columns("ot_name").Value
    End If
End Sub
