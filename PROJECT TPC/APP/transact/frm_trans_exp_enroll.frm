...
Begin VB.Form frm_trans_exp_enroll 
   Caption         =   "EXPORT DATA ENROLL"
   ClientHeight    =   8040
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   10950
   Icon            =   "frm_trans_exp_enroll.frx":0000
   LinkTopic       =   "Form1"
   MDIChild        =   -1  'True
   ScaleHeight     =   8040
   ScaleWidth      =   10950
   Begin zkemkeeperCtl.CZKEM CZKEM1 
      Height          =   615
      Left            =   480
      OleObjectBlob   =   "frm_trans_exp_enroll.frx":000C
      TabIndex        =   6
      Top             =   6720
      Visible         =   0   'False
      Width           =   735
   ...
   Begin VB.CommandButton cmd_export 
      ...
      Height          =   765
      Left            =   4080
      Picture         =   "frm_trans_exp_enroll.frx":0030
      Style           =   1  'Graphical
      TabIndex        =   4
      Top             =   6840
      Width           =   1095
   ...
   Begin VB.CommandButton cmdDelete 
      ...
      Height          =   765
      Left            =   2880
      Picture         =   "frm_trans_exp_enroll.frx":05BA
      Style           =   1  'Graphical
      TabIndex        =   3
      Top             =   6840
      Width           =   1095
   ...
   Begin VB.CommandButton cmd_exit 
      ...
      Height          =   765
      Left            =   9360
      Picture         =   "frm_trans_exp_enroll.frx":0B44
      Style           =   1  'Graphical
      TabIndex        =   2
      Top             =   6840
      Width           =   1095
   ...
   End
End
Attribute VB_Name = "frm_trans_exp_enroll"
