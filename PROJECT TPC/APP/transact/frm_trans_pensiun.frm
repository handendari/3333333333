...
Begin VB.Form frm_trans_pensiun 
   ...
   End
   Begin prj_tpc.EnterNum txtgaji_bersih 
      Height          =   285
      Left            =   1320
      TabIndex        =   36
      Top             =   2220
   ...
   Begin VB.PictureBox Picture1 
      ...
      Width           =   0
   End
   Begin prj_tpc.EnterNum txt_kali 
      Height          =   285
      Left            =   4530
      TabIndex        =   38
      Top             =   2220
      ...
      EndProperty
   End
   Begin prj_tpc.EnterNum txt_jml_pesangon 
      Height          =   285
      Left            =   5550
      TabIndex        =   39
      Top             =   2220
...
Dim access As String
    ...
    Else
        If LynxGrid2.Rows > 0 Then
            ...
            txtkdkar.Text = LynxGrid2.CellValue(LynxGrid2.Row, 12)
            txtgaji_bersih.SetFocus
        End If
...
'    rs.Close
    ...
    Call clsinsert.CalcSuFormula(bulan, rs!employee_code, rs!no_jamsostek, rs!npwp, rs!COMPANY_CODE, rs!pph21_type, rs!jstk_type)
