...
Begin VB.Form frm_mst_salary_standard1 
   ...
   Begin TrueOleDBGrid70.TDBGrid TDBGrid1 
      ...
      _StyleDefs(107) =   "Named:id=33:Normal"
      _StyleDefs(108) =   ":id=33,.parent=0"
      _StyleDefs(109) =   "Named:id=34:Heading"
      _StyleDefs(110) =   ":id=34,.parent=33,.valignment=2,.bgcolor=&H8000000F&,.fgcolor=&H80000012&"
      _StyleDefs(111) =   ":id=34,.wraptext=-1"
      _StyleDefs(112) =   "Named:id=35:Footing"
      _StyleDefs(113) =   ":id=35,.parent=33,.valignment=2,.bgcolor=&H8000000F&,.fgcolor=&H80000012&"
      _StyleDefs(114) =   "Named:id=36:Selected"
      _StyleDefs(115) =   ":id=36,.parent=33,.bgcolor=&H8000000D&,.fgcolor=&H8000000E&"
      _StyleDefs(116) =   "Named:id=37:Caption"
      _StyleDefs(117) =   ":id=37,.parent=34,.alignment=2"
      _StyleDefs(118) =   "Named:id=38:HighlightRow"
      _StyleDefs(119) =   ":id=38,.parent=33,.bgcolor=&H8000000D&,.fgcolor=&H8000000E&"
      _StyleDefs(120) =   "Named:id=39:EvenRow"
      _StyleDefs(121) =   ":id=39,.parent=33,.bgcolor=&HFFFF00&"
      _StyleDefs(122) =   "Named:id=40:OddRow"
      _StyleDefs(123) =   ":id=40,.parent=33"
      _StyleDefs(124) =   "Named:id=41:RecordSelector"
      _StyleDefs(125) =   ":id=41,.parent=34"
      _StyleDefs(126) =   "Named:id=42:FilterBar"
      _StyleDefs(127) =   ":id=42,.parent=33"
   End
   ...
   End
End
Attribute VB_Name = "frm_mst_salary_standard1"
