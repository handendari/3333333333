...
Begin VB.Form frm_mst_menu 
   ...
   Begin VB.Frame fra_control2 
      ...
      Top             =   7560
      Width           =   13335
      Begin prj_tpc.vbButton cmd_new2 
         Height          =   705
         Left            =   1020
         TabIndex        =   41
         Top             =   240
         ...
         VALUE           =   0   'False
      End
      Begin prj_tpc.vbButton cmd_save2 
         Height          =   705
         Left            =   2040
         TabIndex        =   42
         Top             =   240
         ...
         VALUE           =   0   'False
      End
      Begin prj_tpc.vbButton cmd_edit2 
         Height          =   705
         Left            =   3060
         TabIndex        =   43
         Top             =   240
         ...
         VALUE           =   0   'False
      End
      Begin prj_tpc.vbButton cmd_delete2 
         Height          =   705
         Left            =   4080
         TabIndex        =   44
         Top             =   240
         ...
         VALUE           =   0   'False
      End
      Begin prj_tpc.vbButton cmd_cancel2 
         Height          =   705
         Left            =   5100
         TabIndex        =   45
         Top             =   240
         ...
         VALUE           =   0   'False
      End
      Begin prj_tpc.vbButton cmd_exit2 
         Height          =   705
         Left            =   10140
         TabIndex        =   46
         Top             =   270
   ...
   Begin VB.Frame fra_control1 
      ...
      Begin prj_tpc.vbButton cmd_new 
         ...
         VALUE           =   0   'False
      End
      Begin prj_tpc.vbButton cmd_save 
         Height          =   705
         Left            =   2340
         TabIndex        =   48
         Top             =   240
         ...
         VALUE           =   0   'False
      End
      Begin prj_tpc.vbButton cmd_edit 
         Height          =   705
         Left            =   3360
         TabIndex        =   49
         Top             =   240
         ...
         VALUE           =   0   'False
      End
      Begin prj_tpc.vbButton cmd_delete 
         Height          =   705
         Left            =   4380
         TabIndex        =   50
         Top             =   240
         ...
         VALUE           =   0   'False
      End
      Begin prj_tpc.vbButton cmd_cancel 
         Height          =   705
         Left            =   5400
         TabIndex        =   51
         Top             =   240
