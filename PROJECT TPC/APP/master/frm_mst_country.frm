...
Begin VB.Form frm_mst_country 
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "MASTER COUNTRY"
   ClientHeight    =   7005
   ClientLeft      =   -15
   ClientTop       =   300
   ClientWidth     =   11760
   ...
   Begin VB.Frame frmTombol 
      ...
      Begin prj_tpc.vbButton cmdNew 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frm_mst_country.frx":058A
         PICN            =   "frm_mst_country.frx":05A6
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   2
         NGREY           =   0   'False
      ...
      Begin prj_tpc.vbButton cmdSave 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frm_mst_country.frx":1638
         PICN            =   "frm_mst_country.frx":1654
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   2
         NGREY           =   0   'False
      ...
      Begin prj_tpc.vbButton cmdEdit 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frm_mst_country.frx":26E6
         PICN            =   "frm_mst_country.frx":2702
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   2
         NGREY           =   0   'False
      ...
      Begin prj_tpc.vbButton cmdDelete 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frm_mst_country.frx":3794
         PICN            =   "frm_mst_country.frx":37B0
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   2
         NGREY           =   0   'False
      ...
      Begin prj_tpc.vbButton cmdCancel 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frm_mst_country.frx":4842
         PICN            =   "frm_mst_country.frx":485E
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   2
         NGREY           =   0   'False
      ...
      Begin prj_tpc.vbButton cmdExit 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frm_mst_country.frx":58F0
         PICN            =   "frm_mst_country.frx":590C
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   2
         NGREY           =   0   'False
   ...
   Begin TrueOleDBGrid70.TDBGrid TDBGrid1 
      ...
      Columns(0).Caption=   "COUNTRY CODE"
      Columns(0).DataField=   "country_code"
      Columns(0)._PropDict=   "_MaxComboItems,516,2;_VlistStyle,514,3"
      Columns(1)._VlistStyle=   0
      Columns(1)._MaxComboItems=   5
      Columns(1).Caption=   "COUNTRY NAME"
      Columns(1).DataField=   "country_name"
   ...
   Begin VB.Image Image1 
      Height          =   585
      Left            =   0
      Picture         =   "frm_mst_country.frx":699E
      Stretch         =   -1  'True
      Top             =   0
      Width           =   11850
   End
End
Attribute VB_Name = "frm_mst_country"
...
Dim rs As New ADODB.Recordset
    ...
    SQL = "select count(country_code) as rec_count from m_country where country_code = '" _
                & Replace$(Trim$(txt_country_code), Chr$(39), Chr$(96)) & "'"
...
Private Sub check_invalid()
    ...
    txt_country_code = ""
    If txt_country_code.Enabled = True Then txt_country_code.SetFocus
End Sub

Private Function check_validate_exist_edit() As Boolean
    check_validate_exist_edit = False
    
    If Not txt_country_code = rsCountry.Fields("country_code").Value And _
...
check_validate_new = True
    ...
    'validasi title code
    If Trim(txt_country_code) = "" Then
        MsgBox "Country Code is empty!", vbOKOnly + vbInformation, headerMSG
        txt_country_code.SetFocus
        check_validate_new = False
        Exit Function
    End If
    
    'validasi title name
    If Trim(txt_country_name) = "" Then
        MsgBox "Country Name is empty!", vbOKOnly + vbInformation, headerMSG
        txt_country_name.SetFocus
        check_validate_new = False
        Exit Function
    End If
End Function
...
On Error GoTo Err
    ...
    i = MsgBox("Are you sure want to delete data '" _
        & TDBGrid1.Columns("country_name").Value & "' ?", vbYesNo + vbQuestion, headerMSG)
    If Not i = vbYes Then Exit Sub
    
    CnG.BeginTrans
    CnG.Execute "delete from m_country where country_code = '" _
        & TDBGrid1.Columns("country_code").Value & "'"
    CnG.CommitTrans
...
On Error GoTo Err
    ...
    With rsCountry
        txt_country_code = .Fields("country_code").Value
        txt_country_name = .Fields("country_name").Value
...
On Error GoTo Err
    ...
    SQL = "INSERT INTO m_country(country_code,country_name,description) " _
            & "VALUES " _
            & "('" & Trim(txt_country_code.Text) & "'," _
            & "'" & Trim(txt_country_name.Text) & "','" & Trim(txt_description.Text) & "')"
    CnG.Execute SQL
...
On Error GoTo Err
    ...
    SQL = "UPDATE m_country SET country_code = '" & Trim(txt_country_code.Text) & "'," _
            & "country_name = '" & Trim(txt_country_name.Text) & "'," _
            & "description = '" & Trim(txt_description.Text) & "' " _
            & "WHERE country_code = '" & Trim(txt_country_code.Text) & "'"
    CnG.Execute SQL
...
Private Sub set_data_mode()
    If int_mode = 1 Then        'NEW
        ...
        txt_country_code.Enabled = True
        TDBGrid1.Enabled = False
        Call set_new_data
        
        If txt_country_code.Enabled = True Then
            txt_country_code.SetFocus
        End If
    ...
    ElseIf int_mode = 2 Then    'EDIT
        ...
        txt_country_code.Enabled = False
        fra_entry.Visible = True
        TDBGrid1.Enabled = False
    End If
End Sub
...
Private Sub load_data_country()
    ...
    SQL = "select * from m_country " & oClause
    rsCountry.Open SQL, CnG, adOpenForwardOnly, adLockReadOnly
    
    TDBGrid1.DataSource = rsCountry
End Sub
...
Private Sub txt_country_code_KeyPress(KeyAscii As Integer)
    KeyAscii = Asc(UCase(Chr(KeyAscii)))
End Sub

Private Sub txt_country_name_KeyPress(KeyAscii As Integer)
    KeyAscii = Asc(UCase(Chr(KeyAscii)))
End Sub
