...
Begin VB.Form frm_mst_working_day_shift 
   ...
   Begin VB.Frame frmTombol 
      ...
      Begin VB.CommandButton cmdEdit 
         ...
         Height          =   645
         Left            =   3240
         Picture         =   "frm_mst_wd_shift.frx":000C
         Style           =   1  'Graphical
         TabIndex        =   16
         Top             =   360
         Width           =   975
      ...
      Begin VB.CommandButton cmdDelete 
         ...
         Height          =   645
         Left            =   4320
         Picture         =   "frm_mst_wd_shift.frx":0596
         Style           =   1  'Graphical
         TabIndex        =   15
         Top             =   360
         Width           =   975
      ...
      Begin VB.CommandButton CmdPrint 
         ...
         Height          =   645
         Left            =   0
         Picture         =   "frm_mst_wd_shift.frx":0B20
         Style           =   1  'Graphical
         TabIndex        =   14
         Top             =   600
         Visible         =   0   'False
      ...
      Begin VB.CommandButton CmdNew 
         ...
         Height          =   645
         Left            =   1080
         Picture         =   "frm_mst_wd_shift.frx":10AA
         Style           =   1  'Graphical
         TabIndex        =   13
         Top             =   360
         Width           =   975
      ...
      Begin VB.CommandButton CmdExit 
         ...
         Height          =   645
         Left            =   10080
         Picture         =   "frm_mst_wd_shift.frx":1634
         Style           =   1  'Graphical
         TabIndex        =   12
         Top             =   360
         Width           =   975
      ...
      Begin VB.CommandButton CmdCancel 
         ...
         Height          =   645
         Left            =   5400
         Picture         =   "frm_mst_wd_shift.frx":1BBE
         Style           =   1  'Graphical
         TabIndex        =   11
         Top             =   360
         Width           =   975
      ...
      Begin VB.CommandButton CmdSave 
         ...
         Height          =   645
         Left            =   2160
         Picture         =   "frm_mst_wd_shift.frx":2148
         Style           =   1  'Graphical
         TabIndex        =   10
         Top             =   360
         Width           =   975
      ...
      Begin VB.CommandButton cmd_refresh 
         ...
         Height          =   645
         Left            =   6480
         Picture         =   "frm_mst_wd_shift.frx":26D2
         Style           =   1  'Graphical
         TabIndex        =   9
         Top             =   360
         Width           =   975
   ...
   Begin VB.Frame fra_entry 
      ...
      Begin VB.ComboBox cbo_day_over 
         Height          =   315
         ItemData        =   "frm_mst_wd_shift.frx":2C5C
         Left            =   7680
         List            =   "frm_mst_wd_shift.frx":2C66
         TabIndex        =   23
         Text            =   "..."
         Top             =   1440
         Width           =   1575
      ...
      Begin VB.ComboBox cbo_working_day 
         Height          =   315
         ItemData        =   "frm_mst_wd_shift.frx":2C73
         Left            =   2520
         List            =   "frm_mst_wd_shift.frx":2C8C
         TabIndex        =   22
         Text            =   "..."
         Top             =   720
         Width           =   2295
      ...
      Begin VB.ComboBox cbo_active 
         Height          =   315
         ItemData        =   "frm_mst_wd_shift.frx":2CD0
         Left            =   2520
         List            =   "frm_mst_wd_shift.frx":2CDA
         TabIndex        =   17
         Text            =   "..."
         Top             =   1080
         Width           =   1215
   ...
   Begin TrueOleDBList60.TDBCombo TDBCombo_working_time 
      Height          =   375
      Left            =   1560
      OleObjectBlob   =   "frm_mst_wd_shift.frx":2CE7
      TabIndex        =   20
      Top             =   240
      Width           =   1695
   End
