...
Private Function check_validate_new() As Boolean
    ...
    If Trim(txt_income_code) = "" Then
        MsgBox "Income Code is empty!", vbOKOnly + vbInformation, headerMSG
    ...
    If Trim(txt_income_name) = "" Then
        MsgBox "Income Name is empty!", vbOKOnly + vbInformation, headerMSG
    ...
    If Trim(cbo_income_type.Text) = "" Then
        MsgBox "Income Type is empty!", vbOKOnly + vbInformation, headerMSG
