...
Private Function check_validate_new() As Boolean
    ...
    If Trim(txt_sign_code) = "" Then
        MsgBox "Signature Code is empty!", vbOKOnly + vbInformation, headerMSG
    ...
    If Trim(txt_sign_name) = "" Then
        MsgBox "Signature Name is empty!", vbOKOnly + vbInformation, headerMSG
...
Private Sub load_data_sign()
    ...
    SQL = "select a.*,b.title_name from m_signature a join m_title b on a.title_code = b.title_code " & oClause
