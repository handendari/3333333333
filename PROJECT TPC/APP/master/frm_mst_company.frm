...
Begin VB.Form frm_mst_company 
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      TabPicture(0)   =   "frm_mst_company.frx":24F0
      ...
      TabPicture(1)   =   "frm_mst_company.frx":250C
      ...
      TabPicture(2)   =   "frm_mst_company.frx":2528
      Tab(2).ControlEnabled=   -1  'True
      Tab(2).Control(0)=   "TDBGrid_Division"
      ...
      TabCaption(3)   =   "GRADE"
      TabPicture(3)   =   "frm_mst_company.frx":2544
      Tab(3).ControlEnabled=   0   'False
      Tab(3).Control(0)=   "TDBGrid_Grade"
      ...
      TabCaption(4)   =   "LEVEL"
      TabPicture(4)   =   "frm_mst_company.frx":2560
      ...
      TabPicture(5)   =   "frm_mst_company.frx":257C
      ...
      TabCaption(6)   =   "JOB TITLE"
      TabPicture(6)   =   "frm_mst_company.frx":2598
      Tab(6).ControlEnabled=   0   'False
      Tab(6).Control(0)=   "TDBGrid_Title"
      Tab(6).Control(0).Enabled=   0   'False
      Tab(6).Control(1)=   "fra_entry_title"
      Tab(6).Control(1).Enabled=   0   'False
      Tab(6).Control(2)=   "Frame6"
      Tab(6).Control(2).Enabled=   0   'False
      Tab(6).ControlCount=   3
      TabCaption(7)   =   "WORKING STATUS"
      TabPicture(7)   =   "frm_mst_company.frx":25B4
      Tab(7).ControlEnabled=   0   'False
      Tab(7).Control(0)=   "TDBGrid_Status"
      Tab(7).Control(0).Enabled=   0   'False
      Tab(7).Control(1)=   "fra_entry_status"
      ...
      Begin VB.Frame Frame8 
         ...
         Begin VB.Timer Timer7 
            ...
            Top             =   360
         End
         Begin prj_tpc.vbButton cmdNew_Status 
            Height          =   705
            Left            =   600
            TabIndex        =   155
            Top             =   360
            ...
            MCOL            =   12632256
            MPTR            =   1
            MICON           =   "frm_mst_company.frx":25D0
            PICN            =   "frm_mst_company.frx":25EC
            UMCOL           =   -1  'True
            SOFT            =   0   'False
            PICPOS          =   2
            NGREY           =   0   'False
            ...
            VALUE           =   0   'False
         End
         Begin prj_tpc.vbButton cmdSave_Status 
            Height          =   705
            Left            =   1620
            TabIndex        =   156
            Top             =   360
            ...
            MCOL            =   12632256
            MPTR            =   1
            MICON           =   "frm_mst_company.frx":367E
            PICN            =   "frm_mst_company.frx":369A
            UMCOL           =   -1  'True
            SOFT            =   0   'False
            PICPOS          =   2
            NGREY           =   0   'False
            ...
            VALUE           =   0   'False
         End
         Begin prj_tpc.vbButton cmdEdit_Status 
            Height          =   705
            Left            =   2640
            TabIndex        =   157
            Top             =   360
            ...
            MCOL            =   12632256
            MPTR            =   1
            MICON           =   "frm_mst_company.frx":472C
            PICN            =   "frm_mst_company.frx":4748
            UMCOL           =   -1  'True
            SOFT            =   0   'False
            PICPOS          =   2
            NGREY           =   0   'False
            ...
            VALUE           =   0   'False
         End
         Begin prj_tpc.vbButton cmdDelete_Status 
            Height          =   705
            Left            =   3660
            TabIndex        =   158
            Top             =   360
            ...
            MCOL            =   12632256
            MPTR            =   1
            MICON           =   "frm_mst_company.frx":57DA
            PICN            =   "frm_mst_company.frx":57F6
            UMCOL           =   -1  'True
            SOFT            =   0   'False
            PICPOS          =   2
            NGREY           =   0   'False
            ...
            VALUE           =   0   'False
         End
         Begin prj_tpc.vbButton cmdCancel_Status 
            Height          =   705
            Left            =   4680
            TabIndex        =   159
            Top             =   360
            ...
            MCOL            =   12632256
            MPTR            =   1
            MICON           =   "frm_mst_company.frx":6888
            PICN            =   "frm_mst_company.frx":68A4
            UMCOL           =   -1  'True
            SOFT            =   0   'False
            PICPOS          =   2
            NGREY           =   0   'False
         ...
         End
      End
      Begin VB.Frame fra_entry_status 
         Height          =   2775
         Left            =   -74820
         TabIndex        =   108
         Top             =   1590
         ...
         Begin VB.ComboBox cboPeriode 
            Height          =   315
            ItemData        =   "frm_mst_company.frx":7936
            Left            =   5280
            List            =   "frm_mst_company.frx":7940
            TabIndex        =   109
            Top             =   1440
            Width           =   2175
         End
      ...
      Begin VB.Frame Frame6 
         ...
         Begin VB.Timer Timer6 
            ...
            Top             =   240
         End
         Begin prj_tpc.vbButton cmdNew_Title 
            Height          =   705
            Left            =   630
            TabIndex        =   150
            Top             =   330
            ...
            MCOL            =   12632256
            MPTR            =   1
            MICON           =   "frm_mst_company.frx":7958
            PICN            =   "frm_mst_company.frx":7974
            UMCOL           =   -1  'True
            SOFT            =   0   'False
            PICPOS          =   2
            NGREY           =   0   'False
            ...
            VALUE           =   0   'False
         End
         Begin prj_tpc.vbButton cmdSave_Title 
            Height          =   705
            Left            =   1650
            TabIndex        =   151
            Top             =   330
            ...
            MCOL            =   12632256
            MPTR            =   1
            MICON           =   "frm_mst_company.frx":8A06
            PICN            =   "frm_mst_company.frx":8A22
            UMCOL           =   -1  'True
            SOFT            =   0   'False
            PICPOS          =   2
            NGREY           =   0   'False
            ...
            VALUE           =   0   'False
         End
         Begin prj_tpc.vbButton cmdEdit_Title 
            Height          =   705
            Left            =   2670
            TabIndex        =   152
            Top             =   330
            ...
            MCOL            =   12632256
            MPTR            =   1
            MICON           =   "frm_mst_company.frx":9AB4
            PICN            =   "frm_mst_company.frx":9AD0
            UMCOL           =   -1  'True
            SOFT            =   0   'False
            PICPOS          =   2
            NGREY           =   0   'False
            ...
            VALUE           =   0   'False
         End
         Begin prj_tpc.vbButton cmdDelete_Title 
            Height          =   705
            Left            =   3690
            TabIndex        =   153
            Top             =   330
            ...
            MCOL            =   12632256
            MPTR            =   1
            MICON           =   "frm_mst_company.frx":AB62
            PICN            =   "frm_mst_company.frx":AB7E
            UMCOL           =   -1  'True
            SOFT            =   0   'False
            PICPOS          =   2
            NGREY           =   0   'False
            ...
            VALUE           =   0   'False
         End
         Begin prj_tpc.vbButton cmdCancel_Title 
            Height          =   705
            Left            =   4710
            TabIndex        =   154
            Top             =   330
            ...
            MCOL            =   12632256
            MPTR            =   1
            MICON           =   "frm_mst_company.frx":BC10
            PICN            =   "frm_mst_company.frx":BC2C
            UMCOL           =   -1  'True
            SOFT            =   0   'False
            PICPOS          =   2
            NGREY           =   0   'False
      ...
      Begin VB.Frame Frame5 
         ...
         Begin prj_tpc.vbButton cmdNew_Perf 
            ...
            MCOL            =   12632256
            MPTR            =   1
            MICON           =   "frm_mst_company.frx":CCBE
            PICN            =   "frm_mst_company.frx":CCDA
            UMCOL           =   -1  'True
            SOFT            =   0   'False
            PICPOS          =   2
            NGREY           =   0   'False
         ...
         Begin prj_tpc.vbButton cmdSave_Perf 
            ...
            MCOL            =   12632256
            MPTR            =   1
            MICON           =   "frm_mst_company.frx":DD6C
            PICN            =   "frm_mst_company.frx":DD88
            UMCOL           =   -1  'True
            SOFT            =   0   'False
            PICPOS          =   2
            NGREY           =   0   'False
         ...
         Begin prj_tpc.vbButton cmdEdit_Perf 
            ...
            MCOL            =   12632256
            MPTR            =   1
            MICON           =   "frm_mst_company.frx":EE1A
            PICN            =   "frm_mst_company.frx":EE36
            UMCOL           =   -1  'True
            SOFT            =   0   'False
            PICPOS          =   2
            NGREY           =   0   'False
         ...
         Begin prj_tpc.vbButton cmdDelete_Perf 
            ...
            MCOL            =   12632256
            MPTR            =   1
            MICON           =   "frm_mst_company.frx":FEC8
            PICN            =   "frm_mst_company.frx":FEE4
            UMCOL           =   -1  'True
            SOFT            =   0   'False
            PICPOS          =   2
            NGREY           =   0   'False
         ...
         Begin prj_tpc.vbButton cmdCancel_Perf 
            ...
            MCOL            =   12632256
            MPTR            =   1
            MICON           =   "frm_mst_company.frx":10F76
            PICN            =   "frm_mst_company.frx":10F92
            UMCOL           =   -1  'True
            SOFT            =   0   'False
            PICPOS          =   2
            NGREY           =   0   'False
      ...
      Begin VB.Frame Frame3 
         ...
         Begin prj_tpc.vbButton cmdNew_Level 
            ...
            MCOL            =   12632256
            MPTR            =   1
            MICON           =   "frm_mst_company.frx":12024
            PICN            =   "frm_mst_company.frx":12040
            UMCOL           =   -1  'True
            SOFT            =   0   'False
            PICPOS          =   2
            NGREY           =   0   'False
         ...
         Begin prj_tpc.vbButton cmdSave_Level 
            ...
            MCOL            =   12632256
            MPTR            =   1
            MICON           =   "frm_mst_company.frx":130D2
            PICN            =   "frm_mst_company.frx":130EE
            UMCOL           =   -1  'True
            SOFT            =   0   'False
            PICPOS          =   2
            NGREY           =   0   'False
         ...
         Begin prj_tpc.vbButton cmdEdit_Level 
            ...
            MCOL            =   12632256
            MPTR            =   1
            MICON           =   "frm_mst_company.frx":14180
            PICN            =   "frm_mst_company.frx":1419C
            UMCOL           =   -1  'True
            SOFT            =   0   'False
            PICPOS          =   2
            NGREY           =   0   'False
         ...
         Begin prj_tpc.vbButton cmdDelete_Level 
            ...
            MCOL            =   12632256
            MPTR            =   1
            MICON           =   "frm_mst_company.frx":1522E
            PICN            =   "frm_mst_company.frx":1524A
            UMCOL           =   -1  'True
            SOFT            =   0   'False
            PICPOS          =   2
            NGREY           =   0   'False
         ...
         Begin prj_tpc.vbButton cmdCancel_Level 
            ...
            MCOL            =   12632256
            MPTR            =   1
            MICON           =   "frm_mst_company.frx":162DC
            PICN            =   "frm_mst_company.frx":162F8
            UMCOL           =   -1  'True
            SOFT            =   0   'False
            PICPOS          =   2
            NGREY           =   0   'False
      ...
      Begin VB.Frame Frame4 
         ...
         Begin prj_tpc.vbButton cmdNew_Grade 
            ...
            MCOL            =   12632256
            MPTR            =   1
            MICON           =   "frm_mst_company.frx":1738A
            PICN            =   "frm_mst_company.frx":173A6
            UMCOL           =   -1  'True
            SOFT            =   0   'False
            PICPOS          =   2
            NGREY           =   0   'False
         ...
         Begin prj_tpc.vbButton cmdSave_Grade 
            ...
            MCOL            =   12632256
            MPTR            =   1
            MICON           =   "frm_mst_company.frx":18438
            PICN            =   "frm_mst_company.frx":18454
            UMCOL           =   -1  'True
            SOFT            =   0   'False
            PICPOS          =   2
            NGREY           =   0   'False
         ...
         Begin prj_tpc.vbButton cmdEdit_Grade 
            ...
            MCOL            =   12632256
            MPTR            =   1
            MICON           =   "frm_mst_company.frx":194E6
            PICN            =   "frm_mst_company.frx":19502
            UMCOL           =   -1  'True
            SOFT            =   0   'False
            PICPOS          =   2
            NGREY           =   0   'False
         ...
         Begin prj_tpc.vbButton cmdDelete_Grade 
            ...
            MCOL            =   12632256
            MPTR            =   1
            MICON           =   "frm_mst_company.frx":1A594
            PICN            =   "frm_mst_company.frx":1A5B0
            UMCOL           =   -1  'True
            SOFT            =   0   'False
            PICPOS          =   2
            NGREY           =   0   'False
         ...
         Begin prj_tpc.vbButton cmdCancel_Grade 
            ...
            MCOL            =   12632256
            MPTR            =   1
            MICON           =   "frm_mst_company.frx":1B642
            PICN            =   "frm_mst_company.frx":1B65E
            UMCOL           =   -1  'True
            SOFT            =   0   'False
            PICPOS          =   2
            NGREY           =   0   'False
      ...
      Begin VB.Frame Frame1 
         ...
         Begin prj_tpc.vbButton cmdNew_Division 
            ...
            MCOL            =   12632256
            MPTR            =   1
            MICON           =   "frm_mst_company.frx":1C6F0
            PICN            =   "frm_mst_company.frx":1C70C
            UMCOL           =   -1  'True
            SOFT            =   0   'False
            PICPOS          =   2
            NGREY           =   0   'False
         ...
         Begin prj_tpc.vbButton cmdSave_Division 
            ...
            MCOL            =   12632256
            MPTR            =   1
            MICON           =   "frm_mst_company.frx":1D79E
            PICN            =   "frm_mst_company.frx":1D7BA
            UMCOL           =   -1  'True
            SOFT            =   0   'False
            PICPOS          =   2
            NGREY           =   0   'False
         ...
         Begin prj_tpc.vbButton cmdEdit_Division 
            ...
            MCOL            =   12632256
            MPTR            =   1
            MICON           =   "frm_mst_company.frx":1E84C
            PICN            =   "frm_mst_company.frx":1E868
            UMCOL           =   -1  'True
            SOFT            =   0   'False
            PICPOS          =   2
            NGREY           =   0   'False
         ...
         Begin prj_tpc.vbButton cmdDelete_Division 
            ...
            MCOL            =   12632256
            MPTR            =   1
            MICON           =   "frm_mst_company.frx":1F8FA
            PICN            =   "frm_mst_company.frx":1F916
            UMCOL           =   -1  'True
            SOFT            =   0   'False
            PICPOS          =   2
            NGREY           =   0   'False
         ...
         Begin prj_tpc.vbButton cmdCancel_Division 
            ...
            MCOL            =   12632256
            MPTR            =   1
            MICON           =   "frm_mst_company.frx":209A8
            PICN            =   "frm_mst_company.frx":209C4
            UMCOL           =   -1  'True
            SOFT            =   0   'False
            PICPOS          =   2
            NGREY           =   0   'False
      ...
      Begin VB.Frame fra_entry_Division 
         ...
         Begin TrueOleDBList60.TDBCombo TDBCombo_department 
            Height          =   375
            Left            =   3600
            OleObjectBlob   =   "frm_mst_company.frx":21A56
            TabIndex        =   79
            Top             =   660
            Width           =   1725
         End
      ...
      Begin VB.Frame Frame2 
         ...
         Begin prj_tpc.vbButton cmdNew_Department 
            ...
            MCOL            =   12632256
            MPTR            =   1
            MICON           =   "frm_mst_company.frx":239BF
            PICN            =   "frm_mst_company.frx":239DB
            UMCOL           =   -1  'True
            SOFT            =   0   'False
            PICPOS          =   2
            NGREY           =   0   'False
         ...
         Begin prj_tpc.vbButton cmdSave_Department 
            ...
            MCOL            =   12632256
            MPTR            =   1
            MICON           =   "frm_mst_company.frx":24A6D
            PICN            =   "frm_mst_company.frx":24A89
            UMCOL           =   -1  'True
            SOFT            =   0   'False
            PICPOS          =   2
            NGREY           =   0   'False
         ...
         Begin prj_tpc.vbButton cmdEdit_Department 
            ...
            MCOL            =   12632256
            MPTR            =   1
            MICON           =   "frm_mst_company.frx":25B1B
            PICN            =   "frm_mst_company.frx":25B37
            UMCOL           =   -1  'True
            SOFT            =   0   'False
            PICPOS          =   2
            NGREY           =   0   'False
         ...
         Begin prj_tpc.vbButton cmdDelete_Department 
            ...
            MCOL            =   12632256
            MPTR            =   1
            MICON           =   "frm_mst_company.frx":26BC9
            PICN            =   "frm_mst_company.frx":26BE5
            UMCOL           =   -1  'True
            SOFT            =   0   'False
            PICPOS          =   2
            NGREY           =   0   'False
         ...
         Begin prj_tpc.vbButton cmdCancel_Department 
            ...
            MCOL            =   12632256
            MPTR            =   1
            MICON           =   "frm_mst_company.frx":27C77
            PICN            =   "frm_mst_company.frx":27C93
            UMCOL           =   -1  'True
            SOFT            =   0   'False
            PICPOS          =   2
            NGREY           =   0   'False
      ...
      Begin VB.Frame frmTombol 
         ...
         Begin prj_tpc.vbButton cmdNew_Company 
            ...
            MCOL            =   12632256
            MPTR            =   1
            MICON           =   "frm_mst_company.frx":28D25
            PICN            =   "frm_mst_company.frx":28D41
            UMCOL           =   -1  'True
            SOFT            =   0   'False
            PICPOS          =   2
            NGREY           =   0   'False
         ...
         Begin prj_tpc.vbButton cmdSave_Company 
            ...
            MCOL            =   12632256
            MPTR            =   1
            MICON           =   "frm_mst_company.frx":29DD3
            PICN            =   "frm_mst_company.frx":29DEF
            UMCOL           =   -1  'True
            SOFT            =   0   'False
            PICPOS          =   2
            NGREY           =   0   'False
         ...
         Begin prj_tpc.vbButton cmdEdit_Company 
            ...
            MCOL            =   12632256
            MPTR            =   1
            MICON           =   "frm_mst_company.frx":2AE81
            PICN            =   "frm_mst_company.frx":2AE9D
            UMCOL           =   -1  'True
            SOFT            =   0   'False
            PICPOS          =   2
            NGREY           =   0   'False
         ...
         Begin prj_tpc.vbButton cmdDelete_Company 
            ...
            MCOL            =   12632256
            MPTR            =   1
            MICON           =   "frm_mst_company.frx":2BF2F
            PICN            =   "frm_mst_company.frx":2BF4B
            UMCOL           =   -1  'True
            SOFT            =   0   'False
            PICPOS          =   2
            NGREY           =   0   'False
         ...
         Begin prj_tpc.vbButton cmdCancel_Company 
            ...
            MCOL            =   12632256
            MPTR            =   1
            MICON           =   "frm_mst_company.frx":2CFDD
            PICN            =   "frm_mst_company.frx":2CFF9
            UMCOL           =   -1  'True
            SOFT            =   0   'False
            PICPOS          =   2
            NGREY           =   0   'False
      ...
      Begin VB.Frame fra_entry_Company 
         ...
         Begin VB.TextBox txt_company_code 
            ...
            Width           =   1875
         End
         Begin VB.PictureBox cmd_brows_pict 
            Height          =   585
            Left            =   9030
            ScaleHeight     =   525
            ScaleWidth      =   1455
         ...
         Begin TrueOleDBList60.TDBCombo TDBCombo_country 
            Height          =   375
            Left            =   1860
            OleObjectBlob   =   "frm_mst_company.frx":2E08B
            TabIndex        =   8
            Top             =   2160
            Width           =   915
         End
      ...
      Begin TrueOleDBGrid70.TDBGrid TDBGrid_Title 
         ...
         _StyleDefs(70)  =   ":id=42,.parent=33"
      End
      Begin TrueOleDBGrid70.TDBGrid TDBGrid_Status 
         Height          =   3855
         Left            =   -74820
         TabIndex        =   119
         Top             =   510
   ...
   Begin prj_tpc.vbButton cmdExit 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "frm_mst_company.frx":2FFF9
      PICN            =   "frm_mst_company.frx":30015
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   2
      NGREY           =   0   'False
   ...
   Begin VB.Image Image1 
      Height          =   585
      Left            =   0
      Picture         =   "frm_mst_company.frx":310A7
      Stretch         =   -1  'True
      Top             =   0
      Width           =   12690
   End
...
Dim str_sql As String
    ...
    ElseIf SSTab1.Tab = 6 Then
        str_sql = "select count(title_code) as rec_count from m_title where title_code = '" & Trim(txt_title_code) & "'"
    ElseIf SSTab1.Tab = 7 Then
        str_sql = "select count(status_code) as rec_count from m_emp_status where status_code = '" & Trim(txt_code) & "'"
    End If
...
Private Function check_validate_exist_edit() As Boolean
    ...
    ElseIf SSTab1.Tab = 5 Then
        ...
        End If
    ElseIf SSTab1.Tab = 6 Then
        If Not txt_title_code = rsTitle.Fields("title_code").Value And _
        check_validate_exist_new Then
            check_validate_exist_edit = True
            Exit Function
        End If
...
Private Sub load_data()
    ...
    ElseIf SSTab1.Tab = 6 Then
        ...
        SQL = "select * from m_title " & oClause
        rsTitle.Open SQL, CnG, adOpenForwardOnly, adLockReadOnly
        
        TDBGrid_Title.DataSource = rsTitle
    ElseIf SSTab1.Tab = 7 Then
        ...
        TDBGrid_Status.DataSource = rsWorkingStatus
    End If
End Sub
...
Dim i As Integer
    ...
    ElseIf SSTab1.Tab = 6 Then
        ...
        CnG.Execute "delete from m_title where title_code = '" _
                        & TDBGrid_Title.Columns("title_code").Value & "'"
    ElseIf SSTab1.Tab = 7 Then
        If Not (TDBGrid_Status.ApproxCount > 0 And TDBGrid_Status.Bookmark > 0) Then
            MsgBox "No Data selected!", vbInformation, headerMSG
            Exit Sub
        End If
        
        i = MsgBox("Are you sure want to delete data '" _
            & TDBGrid_Status.Columns("status_name").Value & "' ?", vbYesNo + vbQuestion, headerMSG)
        If Not i = vbYes Then
            CnG.CommitTrans
            Exit Sub
        End If
        ...
        CnG.Execute "delete from m_emp_status where status_code = '" _
                        & TDBGrid_Status.Columns("status_code").Value & "'"
    End If
...
On Error GoTo Err
    ...
    ElseIf SSTab1.Tab = 5 Then
        ...
        CnG.Execute SQL
    ElseIf SSTab1.Tab = 6 Then
        SQL = "INSERT INTO m_title(title_code,title_name,description) " _
                & "VALUES " _
                & "('" & Trim(txt_title_code.Text) & "'," _
                & "'" & Trim(txt_title_name.Text) & "','" & Trim(txt_description.Text) & "')"
        CnG.Execute SQL
    ElseIf SSTab1.Tab = 7 Then
...
On Error GoTo Err
    ...
    ElseIf SSTab1.Tab = 5 Then
        ...
        CnG.Execute SQL
    ElseIf SSTab1.Tab = 6 Then
        SQL = "UPDATE m_title SET title_code = '" & Trim(txt_title_code.Text) & "'," _
...
ByVal d As Boolean, ByVal e As Boolean, ByVal f As Boolean, ByVal g As Boolean)
    ...
    ElseIf SSTab1.Tab = 6 Then
        cmdNew_Title.Enabled = a And blnUser_Add
        cmdSave_Title.Enabled = b
        cmdEdit_Title.Enabled = c And blnUser_Edit
        cmdDelete_Title.Enabled = d And blnUser_Delete
        cmdCancel_Title.Enabled = e
    ElseIf SSTab1.Tab = 7 Then
...
Private Sub set_data_mode()
    If int_mode = 1 Then        'NEW
        ...
        ElseIf SSTab1.Tab = 6 Then
            ...
            End If
        ElseIf SSTab1.Tab = 7 Then
            fra_entry_status.Visible = True
            txt_code.Enabled = True
            TDBGrid_Status.Enabled = False
            Call set_new_data
    ...
    ElseIf int_mode = 0 Then    'VIEW
        ...
        ElseIf SSTab1.Tab = 7 Then
            fra_entry_status.Visible = False
            TDBGrid_Status.Enabled = True
        End If
...
Private Sub clear_filter()
    ...
    ElseIf SSTab1.Tab = 6 Then
        For Each Col In TDBGrid_Title.Columns
            Col.FilterText = ""
        Next Col
        rsTitle.Filter = adFilterNone
    ElseIf SSTab1.Tab = 7 Then
        For Each Col In TDBGrid_Status.Columns
            Col.FilterText = ""
        Next Col
...
Dim i As Integer
    ...
    ElseIf SSTab1.Tab = 6 Then
        ...
        End If
    ElseIf SSTab1.Tab = 7 Then
        Set Cols = TDBGrid_Status.Columns
        i = TDBGrid_Status.Col
        TDBGrid_Status.HoldFields
        
        rsWorkingStatus.Filter = getFilter()
        TDBGrid_Status.Col = i
        TDBGrid_Status.EditActive = True
        
        TDBGrid_Status.SelStart = Len(TDBGrid_Status.Columns(i).FilterText)
        If TDBGrid_Status.ApproxCount < 1 Then
            Call clear_filter
            TDBGrid_Status.Col = i
        End If
    End If
...
'    End If
    ...
    oClause = ""
    If SSTab1.Tab = 0 Or SSTab1.Tab = 3 Or SSTab1.Tab = 4 Or SSTab1.Tab = 5 Or SSTab1.Tab = 6 Or SSTab1.Tab = 7 Then
...
Private Sub cmdNew_Title_Click()
    Call new_data
End Sub

Private Sub cmdSave_Title_Click()
    Call simpan_data
End Sub

Private Sub cmdEdit_Title_Click()
    Call edit_data
End Sub

Private Sub cmdDelete_Title_Click()
    Call delete_data
End Sub

Private Sub cmdCancel_Title_Click()
    Call cancel_data
End Sub
...
Private Sub TDBGrid_Title_FilterChange()
    Call grid_filter
End Sub
Private Sub TDBGrid_Status_FilterChange()
    Call grid_filter
End Sub
...
Private Sub txt_title_code_KeyPress(KeyAscii As Integer)
    KeyAscii = Asc(UCase(Chr(KeyAscii)))
End Sub

Private Sub txt_title_name_KeyPress(KeyAscii As Integer)
    KeyAscii = Asc(UCase(Chr(KeyAscii)))
End Sub
...
Private Sub TDBGrid_Status_HeadClick(ByVal ColIndex As Integer)
    
    x = x + 1
    
    If x Mod 2 <> 1 And vSubject = TDBGrid_Status.Columns(ColIndex).DataField Then
        oClause = " ORDER BY " + TDBGrid_Status.Columns(ColIndex).DataField + " DESC"
    Else
        oClause = " ORDER BY " + TDBGrid_Status.Columns(ColIndex).DataField + " ASC"
    End If
    
    vSubject = TDBGrid_Status.Columns(ColIndex).DataField
    Call load_data
