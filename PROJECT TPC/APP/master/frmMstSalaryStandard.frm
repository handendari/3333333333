...
Begin VB.Form frm_mst_salary_standard 
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      TabPicture(0)   =   "frmMstSalaryStandard.frx":058A
      Tab(0).ControlEnabled=   0   'False
      Tab(0).Control(0)=   "txt_bulanan"
      Tab(0).Control(1)=   "txt_main_salary_sunday"
      Tab(0).Control(2)=   "Frame3"
      Tab(0).Control(3)=   "txt_main_salary"
      Tab(0).Control(4)=   "txt_pph21_name"
      Tab(0).Control(5)=   "txt_ptkp_name"
      Tab(0).Control(6)=   "txt_jstk_name"
      Tab(0).Control(7)=   "TDBCombo_jstk"
      Tab(0).Control(8)=   "DTPicker_salary"
      Tab(0).Control(9)=   "TDBCombo_ptkp"
      Tab(0).Control(10)=   "TDBCombo_pph"
      Tab(0).Control(11)=   "lbl_ket"
      Tab(0).Control(12)=   "lbl_pengali"
      ...
      TabCaption(1)   =   "ALLOWANCE"
      TabPicture(1)   =   "frmMstSalaryStandard.frx":05A6
      ...
      Tab(1).Control(7)=   "lblPresence"
      Tab(1).Control(7).Enabled=   0   'False
      Tab(1).Control(8)=   "txt_presence_allowance"
      Tab(1).Control(8).Enabled=   0   'False
      Tab(1).Control(9)=   "txt_shift3_allowance"
      Tab(1).Control(9).Enabled=   0   'False
      Tab(1).Control(10)=   "txt_meal_allowance"
      Tab(1).Control(10).Enabled=   0   'False
      Tab(1).Control(11)=   "txt_shift2_allowance"
      Tab(1).Control(11).Enabled=   0   'False
      Tab(1).Control(12)=   "Frame1"
      Tab(1).Control(12).Enabled=   0   'False
      Tab(1).Control(13)=   "Frame2"
      Tab(1).Control(13).Enabled=   0   'False
      Tab(1).Control(14)=   "txt_pph21_allowance"
      Tab(1).Control(14).Enabled=   0   'False
      Tab(1).Control(15)=   "Frame4"
      Tab(1).Control(15).Enabled=   0   'False
      Tab(1).Control(16)=   "txt_transport_allowance"
      Tab(1).Control(16).Enabled=   0   'False
      Tab(1).Control(17)=   "Frame5"
      Tab(1).Control(17).Enabled=   0   'False
      Tab(1).Control(18)=   "txt_position_allowance"
      Tab(1).Control(18).Enabled=   0   'False
      Tab(1).ControlCount=   19
      TabCaption(2)   =   "EXPENSE"
      TabPicture(2)   =   "frmMstSalaryStandard.frx":05C2
      Tab(2).ControlEnabled=   0   'False
      Tab(2).Control(0)=   "Label7"
      Tab(2).Control(1)=   "Label13"
      Tab(2).Control(2)=   "Label15"
      Tab(2).Control(3)=   "Label8"
      Tab(2).Control(4)=   "txt_late_minutes"
      Tab(2).Control(5)=   "txt_late_amount"
      Tab(2).Control(6)=   "chkCoop"
      Tab(2).Control(7)=   "txtCoopValue"
      Tab(2).ControlCount=   8
      Begin VB.TextBox txtCoopValue 
      ...
      Begin VB.Frame Frame5 
         ...
         Top             =   510
         Width           =   2355
         Begin VB.OptionButton opt_daily_position 
            Caption         =   "DAILY"
            Height          =   225
            Left            =   90
            TabIndex        =   69
            ...
            Width           =   1035
         End
         Begin VB.OptionButton opt_monthly_position 
            Caption         =   "MONTHLY"
            Height          =   225
            Left            =   1110
            TabIndex        =   68
      ...
      Begin TrueOleDBList60.TDBCombo TDBCombo_jstk 
         Height          =   375
         Left            =   -69480
         OleObjectBlob   =   "frmMstSalaryStandard.frx":05DE
         TabIndex        =   3
         Top             =   2280
         Width           =   1695
      End
      ...
      Begin TrueOleDBList60.TDBCombo TDBCombo_ptkp 
         Height          =   375
         Left            =   -69480
         OleObjectBlob   =   "frmMstSalaryStandard.frx":2549
         TabIndex        =   2
         Top             =   1860
         Width           =   1695
      End
      Begin TrueOleDBList60.TDBCombo TDBCombo_pph 
         Height          =   375
         Left            =   -69480
         OleObjectBlob   =   "frmMstSalaryStandard.frx":44A4
         TabIndex        =   1
         Top             =   1440
         Width           =   1695
      End
   ...
   Begin VB.Frame frmTombol 
      ...
      Begin prj_tpc.vbButton cmdNew 
         ...
         tx              =   "&New"
         enab            =   -1
         font            =   "frmMstSalaryStandard.frx":63FE
         coltype         =   1
         focusr          =   -1
         bcol            =   15790320
         bcolo           =   15790320
         ...
         mcol            =   12632256
         mptr            =   1
         micon           =   "frmMstSalaryStandard.frx":642A
         picn            =   "frmMstSalaryStandard.frx":6448
         umcol           =   -1
         soft            =   0
         picpos          =   2
         ngrey           =   0
      ...
      Begin prj_tpc.vbButton cmdSave 
         ...
         tx              =   "&Save"
         enab            =   -1
         font            =   "frmMstSalaryStandard.frx":74DC
         coltype         =   1
         focusr          =   -1
         bcol            =   15790320
         bcolo           =   15790320
         ...
         mcol            =   12632256
         mptr            =   1
         micon           =   "frmMstSalaryStandard.frx":7508
         picn            =   "frmMstSalaryStandard.frx":7526
         umcol           =   -1
         soft            =   0
         picpos          =   2
         ngrey           =   0
      ...
      Begin prj_tpc.vbButton cmdEdit 
         ...
         tx              =   "&Edit"
         enab            =   -1
         font            =   "frmMstSalaryStandard.frx":85BA
         coltype         =   1
         focusr          =   -1
         bcol            =   15790320
         bcolo           =   15790320
         ...
         mcol            =   12632256
         mptr            =   1
         micon           =   "frmMstSalaryStandard.frx":85E6
         picn            =   "frmMstSalaryStandard.frx":8604
         umcol           =   -1
         soft            =   0
         picpos          =   2
         ngrey           =   0
      ...
      Begin prj_tpc.vbButton cmdDelete 
         ...
         tx              =   "&Delete"
         enab            =   -1
         font            =   "frmMstSalaryStandard.frx":9698
         coltype         =   1
         focusr          =   -1
         bcol            =   15790320
         bcolo           =   15790320
         ...
         mcol            =   12632256
         mptr            =   1
         micon           =   "frmMstSalaryStandard.frx":96C4
         picn            =   "frmMstSalaryStandard.frx":96E2
         umcol           =   -1
         soft            =   0
         picpos          =   2
         ngrey           =   0
      ...
      Begin prj_tpc.vbButton cmdCancel 
         ...
         tx              =   "&Cancel"
         enab            =   -1
         font            =   "frmMstSalaryStandard.frx":A776
         coltype         =   1
         focusr          =   -1
         bcol            =   15790320
         bcolo           =   15790320
         ...
         mcol            =   12632256
         mptr            =   1
         micon           =   "frmMstSalaryStandard.frx":A7A2
         picn            =   "frmMstSalaryStandard.frx":A7C0
         umcol           =   -1
         soft            =   0
         picpos          =   2
         ngrey           =   0
      ...
      Begin prj_tpc.vbButton cmdExit 
         ...
         tx              =   "&Exit"
         enab            =   -1
         font            =   "frmMstSalaryStandard.frx":B854
         coltype         =   1
         focusr          =   -1
         bcol            =   15790320
         bcolo           =   15790320
         ...
         mcol            =   12632256
         mptr            =   1
         micon           =   "frmMstSalaryStandard.frx":B880
         picn            =   "frmMstSalaryStandard.frx":B89E
         umcol           =   -1
         soft            =   0
         picpos          =   2
         ngrey           =   0
      ...
      Begin prj_tpc.vbButton cmdImport 
         ...
         tx              =   "&Import"
         enab            =   -1
         font            =   "frmMstSalaryStandard.frx":C932
         coltype         =   1
         focusr          =   -1
         bcol            =   15790320
         bcolo           =   15790320
         ...
         mcol            =   12632256
         mptr            =   1
         micon           =   "frmMstSalaryStandard.frx":C95E
         picn            =   "frmMstSalaryStandard.frx":C97C
         umcol           =   -1
         soft            =   0
         picpos          =   2
         ngrey           =   0
   ...
   Begin TrueOleDBGrid70.TDBGrid TDBGrid_Emp 
      ...
      Splits(0)._ColumnProps(29)=   "Column(4).Width=2037"
      Splits(0)._ColumnProps(30)=   "Column(4).DividerColor=0"
      Splits(0)._ColumnProps(31)=   "Column(4)._WidthInPix=1958"
   ...
   Begin TrueOleDBList60.TDBCombo TDBCombo_company 
      Height          =   375
      Left            =   1320
      OleObjectBlob   =   "frmMstSalaryStandard.frx":DA10
      TabIndex        =   20
      Top             =   780
      Width           =   1695
   End
   Begin TrueOleDBList60.TDBCombo TDBCombo_department 
      Height          =   375
      Left            =   1320
      OleObjectBlob   =   "frmMstSalaryStandard.frx":F976
      TabIndex        =   23
      Top             =   1170
      Width           =   1695
   End
   Begin TrueOleDBGrid70.TDBGrid TDBGrid_Salary 
      ...
      Columns(4)._VlistStyle=   0
      Columns(4)._MaxComboItems=   5
      Columns(4).Caption=   "PRESENCE ALLOW. (%)"
      Columns(4).DataField=   "presence_allowance"
      Columns(4).NumberFormat=   "Standard"
      Columns(4)._PropDict=   "_MaxComboItems,516,2;_VlistStyle,514,3"
      Columns(5)._VlistStyle=   0
      Columns(5)._MaxComboItems=   5
      Columns(5).Caption=   "MEAL ALLOW. (DAILY)"
      Columns(5).DataField=   "meal_allowance"
      Columns(5).NumberFormat=   "Standard"
      Columns(5)._PropDict=   "_MaxComboItems,516,2;_VlistStyle,514,3"
      Columns(6)._VlistStyle=   0
      Columns(6)._MaxComboItems=   5
      Columns(6).Caption=   "TRANSPORT ALLOW. (DAILY)"
      Columns(6).DataField=   "transport_allowance"
      Columns(6).NumberFormat=   "Standard"
      Columns(6)._PropDict=   "_MaxComboItems,516,2;_VlistStyle,514,3"
      Columns(7)._VlistStyle=   0
      Columns(7)._MaxComboItems=   5
      Columns(7).Caption=   "POSITION ALLOW."
      Columns(7).DataField=   "position_allowance"
      Columns(7).NumberFormat=   "Standard"
      Columns(7)._PropDict=   "_MaxComboItems,516,2;_VlistStyle,514,3"
      Columns(8)._VlistStyle=   0
      Columns(8)._MaxComboItems=   5
      Columns(8).Caption=   "SHIFT 2 ALLOW."
      Columns(8).DataField=   "shift2_allowance"
      Columns(8).NumberFormat=   "Standard"
      Columns(8)._PropDict=   "_MaxComboItems,516,2;_VlistStyle,514,3"
      Columns(9)._VlistStyle=   0
      Columns(9)._MaxComboItems=   5
      Columns(9).Caption=   "SHIFT 3 ALLOW."
      Columns(9).DataField=   "shift3_allowance"
      Columns(9).NumberFormat=   "Standard"
      Columns(9)._PropDict=   "_MaxComboItems,516,2;_VlistStyle,514,3"
      Columns(10)._VlistStyle=   0
      Columns(10)._MaxComboItems=   5
      Columns(10).Caption=   "COOPERATION"
      Columns(10).DataField=   "coop_value"
      Columns(10).NumberFormat=   "Standard"
      Columns(10)._PropDict=   "_MaxComboItems,516,2;_VlistStyle,514,3"
      Columns(11)._VlistStyle=   0
      Columns(11)._MaxComboItems=   5
      Columns(11).Caption=   "PPh21 TYPE"
      Columns(11).DataField=   "pph21_name"
      Columns(11).NumberFormat=   "Standard"
      Columns(11)._PropDict=   "_MaxComboItems,516,2;_VlistStyle,514,3"
      Columns(12)._VlistStyle=   0
      Columns(12)._MaxComboItems=   5
      Columns(12).Caption=   "PTKP TYPE"
      Columns(12).DataField=   "ptkp_name"
      Columns(12).NumberFormat=   "Standard"
      Columns(12)._PropDict=   "_MaxComboItems,516,2;_VlistStyle,514,3"
      Columns(13)._VlistStyle=   0
      Columns(13)._MaxComboItems=   5
      Columns(13).Caption=   "JAMSOSTEK TYPE"
      Columns(13).DataField=   "jamsostek_name"
      ...
      _StyleDefs(50)  =   "Splits(0).Columns(4).Style:id=86,.parent=13,.alignment=1"
      ...
      _StyleDefs(54)  =   "Splits(0).Columns(5).Style:id=102,.parent=13,.alignment=1"
      ...
      _StyleDefs(58)  =   "Splits(0).Columns(6).Style:id=28,.parent=13,.alignment=1"
      ...
      _StyleDefs(62)  =   "Splits(0).Columns(7).Style:id=32,.parent=13,.alignment=1"
      ...
      _StyleDefs(66)  =   "Splits(0).Columns(8).Style:id=106,.parent=13,.alignment=1"
      _StyleDefs(67)  =   "Splits(0).Columns(8).HeadingStyle:id=103,.parent=14"
      _StyleDefs(68)  =   "Splits(0).Columns(8).FooterStyle:id=104,.parent=15"
      _StyleDefs(69)  =   "Splits(0).Columns(8).EditorStyle:id=105,.parent=17"
      _StyleDefs(70)  =   "Splits(0).Columns(9).Style:id=110,.parent=13,.alignment=1"
      ...
      _StyleDefs(74)  =   "Splits(0).Columns(10).Style:id=46,.parent=13,.alignment=1"
      ...
      _StyleDefs(78)  =   "Splits(0).Columns(11).Style:id=114,.parent=13,.alignment=1"
      ...
      _StyleDefs(82)  =   "Splits(0).Columns(12).Style:id=118,.parent=13,.alignment=1"
      _StyleDefs(83)  =   "Splits(0).Columns(12).HeadingStyle:id=115,.parent=14"
      _StyleDefs(84)  =   "Splits(0).Columns(12).FooterStyle:id=116,.parent=15"
      _StyleDefs(85)  =   "Splits(0).Columns(12).EditorStyle:id=117,.parent=17"
      _StyleDefs(86)  =   "Splits(0).Columns(13).Style:id=122,.parent=13,.alignment=1"
      _StyleDefs(87)  =   "Splits(0).Columns(13).HeadingStyle:id=119,.parent=14"
      _StyleDefs(88)  =   "Splits(0).Columns(13).FooterStyle:id=120,.parent=15"
      _StyleDefs(89)  =   "Splits(0).Columns(13).EditorStyle:id=121,.parent=17"
   ...
   Begin VB.Image Image1 
      Height          =   585
      Left            =   0
      Picture         =   "frmMstSalaryStandard.frx":118DF
      Stretch         =   -1  'True
      Top             =   0
      Width           =   12450
   End
...
Private Function check_validate_new() As Boolean
    ...
    If Trim(TDBCombo_ptkp.Text) = "" Then
        MsgBox "PTKP Type Is Empty...", vbOKOnly + vbInformation, headerMSG
    ...
    If Trim(TDBCombo_jstk.Text) = "" Then
        MsgBox "Jamsostek Type Is Empty...", vbOKOnly + vbInformation, headerMSG
...
Private Sub chkCoop_Click()
    If chkCoop.Value = 0 Then
        txtCoopValue.Visible = False
        txtCoopValue.Text = 0
    Else
        SQL = "SELECT iuran_koperasi FROM m_pref_allow"
        rscari.Open SQL, CnG, adOpenForwardOnly, adLockReadOnly
        
        If rscari.RecordCount > 0 Then
            txtCoopValue.Text = FormatNumber(rscari.Fields(0).Value)
        Else
            txtCoopValue.Text = FormatNumber(0)
        End If
        rscari.Close
        
        txtCoopValue.Visible = True
    End If
End Sub
...
Dim vSalaryDate As String
    ...
    If vSalaryDate = Format(TDBGrid_Salary.Columns("salary_date").Value, "yyyy-MM-dd") Then
        ...
        i = MsgBox("Are You Sure To Delete Data  '" _
        ...
        Call load_mode
    Else
        MsgBox "Data Cannot Be Delete, Because Is Not Last Salary...", vbExclamation, headerMSG
        Exit Sub
    End If
...
Dim v_flag_position As Integer
Dim jhk As Integer
    
    vSetData = 1
    
    If Not (TDBGrid_Salary.ApproxCount > 0 And TDBGrid_Salary.Bookmark > 0) Then
        MsgBox "Data Salary Is Not Selected...", vbInformation, headerMSG
        vSetData = 0
        Exit Sub
    End If
...
'        txt_family_allowance.Text = FormatNumber(IIf(IsNull(.Fields("family_allowance").Value), 0, .Fields("family_allowance").Value))
        ...
        v_flag_position = .Fields("flag_position").Value
        opt_daily_position.Value = IIf(v_flag_position = 0, True, False)
        opt_monthly_position.Value = IIf(v_flag_position = 0, False, True)
        txt_position_allowance.Text = FormatNumber(IIf(IsNull(.Fields("position_allowance").Value), 0, .Fields("position_allowance").Value))
        ...
        chkCoop.Value = IIf(IsNull(.Fields("flag_coop").Value), 0, .Fields("flag_coop").Value)
        txtCoopValue.Text = FormatNumber(IIf(IsNull(.Fields("coop_value").Value), 0, .Fields("coop_value").Value))
...
'    SQL = "SELECT company_code, department_code FROM m_employee WHERE employee_code = '" & TDBGrid_Emp.Columns("employee_code").Value & "'"
'    rs.Open SQL, CnG, adOpenForwardOnly, adLockReadOnly
'
'    If rs.RecordCount > 0 Then
'        vCompany = rs!COMPANY_CODE
'        vDepartment = rs!DEPARTMENT_CODE
'    End If
'    rs.Close
'
'    SQL = "SELECT jhk_value FROM m_pref_presence WHERE company_code = '" & vCompany & "' AND department_code = '" & vDepartment & "'"
'    rs.Open SQL, CnG, adOpenForwardOnly, adLockReadOnly
'
'    If rs.RecordCount > 0 Then
'        jhk = rs!jhk_value
...
'        lbl_ket.Caption = "Salary Per Month Asumption"
'    Else
'        lbl_pengali.Caption = "/ " & jhk
'        lbl_ket.Caption = "Salary Per Days"
'    End If
End Sub
...
Dim vSalaryDate As String
    ...
    If vSalaryDate = Format(TDBGrid_Salary.Columns("salary_date").Value, "yyyy-MM-dd") Then
        ...
        SSTab1.Tab = 0
    Else
        MsgBox "Data Cannot Be Edited, Because Is Not Last Salary...", vbExclamation, headerMSG
        Exit Sub
    End If
End Sub
...
On Error GoTo Err
    ...
    SQL = "INSERT INTO m_salary_standard (employee_code, salary_date," & _
            ...
            "late_time_tolerance,late_amount,pph21_type,ptkp_type,jstk_type,entry_date,entry_user,flag_coop,coop_value) " & _
            "VALUES " & _
            "('" & TDBGrid_Emp.Columns("employee_code").Value & "','" & Format(DTPicker_salary.Value, "yyyy-MM-dd") & "'," & _
            "'" & IIf(opt_daily_basic.Value, 0, 1) & "'," & Val(DropAllComma(txt_main_salary.Text)) & "," & Val(DropAllComma(txt_main_salary_sunday.Text)) & ",'" & IIf(opt_daily_presence.Value, 0, 1) & "'," & Val(DropAllComma(txt_presence_allowance.Text)) & "," & _
            "'" & IIf(opt_daily_transport.Value, 0, 1) & "'," & Val(DropAllComma(txt_transport_allowance.Text)) & "," & _
            "'" & IIf(opt_daily_meal.Value, 0, 1) & "'," & Val(DropAllComma(txt_meal_allowance.Text)) & ",'" & IIf(opt_daily_position.Value, 0, 1) & "'," & Val(DropAllComma(txt_position_allowance.Text)) & "," & _
            ...
            "now(),'" & LOGIN_NAME & "','" & chkCoop.Value & "','" & Val(DropAllComma(txtCoopValue.Text)) & "')"
    CnG.Execute SQL
...
On Error GoTo Err
    ...
    SQL = "UPDATE m_salary_standard SET " & _
            ...
            "flag_position = '" & IIf(opt_daily_position.Value, 0, 1) & "'," & _
            "position_allowance = '" & Val(DropAllComma(txt_position_allowance.Text)) & "'," & _
            ...
            "flag_coop = '" & chkCoop.Value & "'," & _
            "coop_value = '" & DropAllComma(txtCoopValue.Text) & "' " & _
            "WHERE employee_code = '" & TDBGrid_Emp.Columns("employee_code").Value & "' " & _
...
Dim Ctr As CONTROL
    For Each Ctr In Me
        If TypeOf Ctr Is TextBox Or TypeOf Ctr Is TDBText Then
            If Not LCase(Ctr.name) = "txt_company_name" And Not LCase(Ctr.name) = "txt_department_name" Then Ctr.Text = ""
        ElseIf TypeOf Ctr Is TDBCombo Then
            If Not LCase(Ctr.name) = "tdbcombo_company" And Not LCase(Ctr.name) = "tdbcombo_department" Then Ctr.Text = ""
...
Dim v_flag_transport As Integer
    ...
    SQL = "SELECT npwp_method, flag_transport FROM m_employee WHERE employee_code = '" & TDBGrid_Emp.Columns("employee_code").Value & "'"
    ...
    If rs.RecordCount > 0 Then
        ...
        vFlagTransport = IIf(IsNull(rs!flag_transport), 0, rs!flag_transport)
    Else
        txt_pph21_allowance.Enabled = False
        txt_pph21_allowance.Text = 0
    End If
    ...
    If rs.RecordCount > 0 Then
        txt_late_minutes.Text = rs!late_tolerance
        
        TDBCombo_pph.Text = rs!pph21_code
        txt_pph21_name.Text = rs!pph21_name
        TDBCombo_ptkp.Text = rs!ptkp_code
        txt_ptkp_name.Text = rs!ptkp_name
        TDBCombo_jstk.Text = rs!jamsostek_code
        txt_jstk_name.Text = rs!jamsostek_name
    Else
        txt_late_minutes.Text = 0
        
        TDBCombo_pph.Text = "STD"
        txt_pph21_name.Text = "STANDARD"
        TDBCombo_ptkp.Text = "STD"
        txt_ptkp_name.Text = "STANDARD"
        TDBCombo_jstk.Text = "STD"
        txt_jstk_name.Text = "STANDARD"
    End If
    rs.Close
    ...
    If rs.RecordCount > 0 Then
        v_flag_presence = rs.Fields("flag_presence").Value
        opt_daily_presence.Value = IIf(v_flag_presence = 0, True, False)
        opt_monthly_presence.Value = IIf(v_flag_presence = 0, False, True)
        txt_presence_allowance.Text = FormatNumber(IIf(IsNull(rs.Fields("presence_allowance").Value), 0, rs.Fields("presence_allowance").Value))
        
        v_flag_meal = rs.Fields("flag_meal").Value
        opt_daily_meal.Value = IIf(v_flag_meal = 0, 1, 0)
        opt_monthly_meal.Value = IIf(v_flag_meal = 0, 0, 1)
        txt_meal_allowance.Text = FormatNumber(IIf(IsNull(rs.Fields("meal_allowance").Value), 0, rs.Fields("meal_allowance").Value))
        
        v_flag_transport = rs.Fields("flag_transport").Value
        opt_daily_transport.Value = IIf(v_flag_transport = 0, True, False)
        opt_monthly_transport.Value = IIf(v_flag_transport = 0, False, True)
        If vFlagTransport = 0 Then
            txt_transport_allowance.Text = 0
        Else
            txt_transport_allowance.Text = FormatNumber(IIf(IsNull(rs.Fields("transport_allowance").Value), 0, rs.Fields("transport_allowance").Value))
        End If
        
        txt_shift2_allowance.Text = FormatNumber(IIf(IsNull(rs.Fields("shift2_allowance").Value), 0, rs.Fields("shift2_allowance").Value))
        txt_shift3_allowance.Text = FormatNumber(IIf(IsNull(rs.Fields("shift3_allowance").Value), 0, rs.Fields("shift3_allowance").Value))
    Else
        opt_daily_presence.Value = False
        opt_monthly_presence.Value = True
        txt_presence_allowance.Text = 0
        
        opt_daily_meal.Value = True
        opt_monthly_meal.Value = False
        txt_meal_allowance.Text = 0
        
        opt_daily_transport.Value = True
        opt_monthly_transport.Value = False
        txt_transport_allowance.Text = 0
        
        txt_shift2_allowance.Text = 0
        txt_shift3_allowance.Text = 0
    End If
    rs.Close
End Sub
...
Public Sub load_data_employee()
    ...
    If LOGIN_LEVEL = 100 Then
        SQL = "SELECT a.*,c.department_name,d.title_name " & _
              ...
              "WHERE " & IIf(TDBCombo_department.Text <> "", "a.company_code = '" & TDBCombo_company.Columns("company_code").Value & "' AND a.department_code = '" & TDBCombo_department.Text & "'", "a.company_code = '" & TDBCombo_company.Columns("company_code").Value & "'") & " " & _
                "AND flag_active <> 0 " & oClause
    Else
        SQL = "SELECT a.*,c.department_name,d.title_name " & _
              "FROM m_employee a JOIN m_department c ON a.department_code = c.department_code " & _
                "JOIN m_title d ON a.title_code = d.title_code " & _
              "WHERE " & IIf(TDBCombo_department.Text <> "", "a.company_code = '" & TDBCombo_company.Columns("company_code").Value & "' AND a.department_code = '" & TDBCombo_department.Text & "'", "a.company_code = '" & TDBCombo_company.Columns("company_code").Value & "'") & " " & _
                "AND (level_code = ANY (SELECT access_level_code FROM t_user_access_level WHERE level_code = '" & LOGIN_CODE & "' AND allow_access <> 0)) AND flag_active <> 0 " & oClause
    End If
...
Dim vJHK As Double
    If TDBCombo_department = "" Then
        SQL = "SELECT jhk_value FROM m_pref_presence WHERE company_code = '" & TDBCombo_company.Text & "'"
    Else
        SQL = "SELECT jhk_value FROM m_pref_presence WHERE company_code = '" & TDBCombo_company.Text & "' AND department_code = '" & TDBCombo_department.Text & "'"
    End If
    rs.Open SQL, CnG, adOpenForwardOnly, adLockReadOnly
...
Private Sub txt_presence_allowance_Validate(Cancel As Boolean)
    If Not Trim(txt_presence_allowance) = "" Then
        ...
        lblPresence.Caption = FormatNumber(DropAllComma(txt_main_salary.Text) * (txt_presence_allowance.Text / 100))
    End If
End Sub
...
Private Sub txt_position_allowance_Validate(Cancel As Boolean)
    If Not Trim(txt_position_allowance) = "" Then
        txt_position_allowance = FormatNumber(DropAllComma(txt_position_allowance))
    End If
End Sub
...
Private Sub txtCoopValue_Validate(Cancel As Boolean)
    If Not Trim(txtCoopValue) = "" Then
        txtCoopValue = FormatNumber(DropAllComma(txtCoopValue))
    End If
End Sub
...
Private Sub txt_late_amount_allowance_Validate(Cancel As Boolean)
