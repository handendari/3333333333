...
Begin VB.Form frm_mst_reminder 
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "MASTER REMINDER"
   ClientHeight    =   6690
   ClientLeft      =   -15
   ClientTop       =   300
   ClientWidth     =   8175
   ...
   EndProperty
   Icon            =   "frm_mst_reminder.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   6690
   ...
   Begin VB.Frame fra_entry 
      ...
      Begin VB.TextBox txt_email 
         ...
         Width           =   3495
      End
      Begin VB.TextBox txt_person_name 
         Appearance      =   0  'Flat
         Height          =   315
         Left            =   3000
         MaxLength       =   50
   ...
   Begin VB.Frame frmTombol 
      ...
      Begin prj_tpc.vbButton cmdNew 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frm_mst_reminder.frx":058A
         PICN            =   "frm_mst_reminder.frx":05A6
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   2
         NGREY           =   0   'False
      ...
      Begin prj_tpc.vbButton cmdSave 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frm_mst_reminder.frx":1638
         PICN            =   "frm_mst_reminder.frx":1654
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   2
         NGREY           =   0   'False
      ...
      Begin prj_tpc.vbButton cmdEdit 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frm_mst_reminder.frx":26E6
         PICN            =   "frm_mst_reminder.frx":2702
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   2
         NGREY           =   0   'False
      ...
      Begin prj_tpc.vbButton cmdDelete 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frm_mst_reminder.frx":3794
         PICN            =   "frm_mst_reminder.frx":37B0
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   2
         NGREY           =   0   'False
      ...
      Begin prj_tpc.vbButton cmdCancel 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frm_mst_reminder.frx":4842
         PICN            =   "frm_mst_reminder.frx":485E
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   2
         NGREY           =   0   'False
      ...
      Begin prj_tpc.vbButton cmdExit 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frm_mst_reminder.frx":58F0
         PICN            =   "frm_mst_reminder.frx":590C
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   2
         NGREY           =   0   'False
   ...
   Begin TrueOleDBGrid70.TDBGrid TDBGrid1 
      ...
      Columns(0).DataField=   "person_name"
      Columns(0)._PropDict=   "_MaxComboItems,516,2;_VlistStyle,514,3"
      Columns(1)._VlistStyle=   0
      Columns(1)._MaxComboItems=   5
      Columns(1).Caption=   "EMAIL"
      Columns(1).DataField=   "email"
      ...
      Splits(0)._ColumnProps(6)=   "Column(1).Width=6694"
      Splits(0)._ColumnProps(7)=   "Column(1).DividerColor=0"
      Splits(0)._ColumnProps(8)=   "Column(1)._WidthInPix=6615"
   ...
   Begin VB.Image Image2 
      Height          =   585
      Left            =   -60
      Picture         =   "frm_mst_reminder.frx":699E
      Stretch         =   -1  'True
      Top             =   0
      Width           =   11790
   End
End
Attribute VB_Name = "frm_mst_reminder"
...
Dim vPersonName As String

Private Function check_validate_exist_new() As Boolean
Dim str_sql As String
    check_validate_exist_new = False
    
'    If rsReminder.State Then rsReminder.Close
'    str_sql = "select count(title_code) as rec_count from m_reminder where title_code = '" _
'    & Replace$(Trim$(txt_title_code), Chr$(39), Chr$(96)) & "'"
'    rsReminder.Open str_sql, CnG, adOpenStatic, adLockReadOnly
'
'    If rsReminder.Fields("rec_count").Value > 0 Then
...
'    If Not txt_title_code = rsReminder.Fields("title_code").Value And _
...
Private Function check_validate_new() As Boolean
    ...
    If Trim(txt_person_name) = "" Then
        MsgBox "Name is empty!", vbOKOnly + vbInformation, headerMSG
        txt_person_name.SetFocus
        check_validate_new = False
        Exit Function
    End If
    
    If Trim(txt_email) = "" Then
        MsgBox "Email is empty!", vbOKOnly + vbInformation, headerMSG
        txt_email.SetFocus
        check_validate_new = False
        Exit Function
    End If
...
Private Sub cmdDelete_Click()
    ...
    i = MsgBox("Are you sure want to delete data '" _
        & TDBGrid1.Columns("person_name").Value & "' ?", vbYesNo + vbQuestion, headerMSG)
    If Not i = vbYes Then Exit Sub
    
    CnG.BeginTrans
    CnG.Execute "delete from m_reminder where title_code = '" _
        & TDBGrid1.Columns("person_name").Value & "'"
    CnG.CommitTrans
    
    Call load_data_person
    int_mode = 0
    Call load_mode
End Sub
...
On Error GoTo Err
    ...
    With rsReminder
        txt_person_name.Text = .Fields("person_name").Value
        txt_email.Text = .Fields("email").Value
        
        vPersonName = .Fields("person_name").Value
    End With
    Exit Sub
...
On Error GoTo Err
    ...
    SQL = "INSERT INTO m_reminder(person_name,email) " _
            & "VALUES " _
            & "('" & Trim(txt_person_name.Text) & "','" & Trim(txt_email.Text) & "')"
    CnG.Execute SQL
...
On Error GoTo Err
    ...
    SQL = "UPDATE m_reminder SET person_name = '" & Trim(txt_person_name.Text) & "'," _
            & "email = '" & Trim(txt_email.Text) & "' " _
            & "WHERE person_name = '" & vPersonName & "'"
    CnG.Execute SQL
...
Private Sub set_data_mode()
    If int_mode = 1 Then        'NEW
        ...
        txt_person_name.Enabled = True
        TDBGrid1.Enabled = False
        Call set_new_data
        
        If txt_person_name.Enabled = True Then
            txt_person_name.SetFocus
        End If
...
Private Sub clear_filter()
    For Each Col In TDBGrid1.Columns
        Col.FilterText = ""
    Next Col
    rsReminder.Filter = adFilterNone
End Sub
...
Public Sub load_data_person()
    If rsReminder.State Then rsReminder.Close
'    SQL = "select title_code,title_name,description " _
'        & "from m_reminder "
    SQL = "select * from m_reminder " & oClause
    rsReminder.Open SQL, CnG, adOpenForwardOnly, adLockReadOnly
    
    TDBGrid1.DataSource = rsReminder
End Sub
...
Private Sub txt_person_name_KeyPress(KeyAscii As Integer)
