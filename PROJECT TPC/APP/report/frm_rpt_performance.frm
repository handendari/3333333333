...
Begin VB.Form frm_rpt_performance 
   ...
   Caption         =   "REPORT - EMPLOYEE PERFORMANCE"
   ClientHeight    =   7545
   ClientLeft      =   -15
   ClientTop       =   300
   ClientWidth     =   10560
   ...
   Begin TrueOleDBList60.TDBCombo TDBCombo_company 
      Height          =   375
      Left            =   1530
      OleObjectBlob   =   "frm_rpt_performance.frx":058A
      TabIndex        =   3
      Top             =   1110
      Width           =   1695
   End
   ...
   Begin VB.Frame Frame3 
      ...
      Begin prj_tpc.vbButton cmdExit 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frm_rpt_performance.frx":24F0
         PICN            =   "frm_rpt_performance.frx":250C
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   2
         NGREY           =   0   'False
      ...
      Begin prj_tpc.vbButton cmdSummary 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frm_rpt_performance.frx":359E
         PICN            =   "frm_rpt_performance.frx":35BA
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   2
         NGREY           =   0   'False
      ...
      Begin prj_tpc.vbButton cmdPrint 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frm_rpt_performance.frx":464C
         PICN            =   "frm_rpt_performance.frx":4668
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   2
         NGREY           =   0   'False
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      TabHeight       =   520
      TabCaption(0)   =   "YEARLY"
      TabPicture(0)   =   "frm_rpt_performance.frx":56FA
      ...
      Begin VB.Frame Frame2 
         ...
         Begin VB.Frame fra_yearly_department 
            ...
            Begin TrueOleDBList60.TDBCombo TDBCombo_yearly_department 
               Height          =   375
               Left            =   30
               OleObjectBlob   =   "frm_rpt_performance.frx":5716
               TabIndex        =   11
               Top             =   90
               Width           =   1815
            End
         ...
         Begin VB.ComboBox cbo_yearly_department 
            Height          =   315
            ItemData        =   "frm_rpt_performance.frx":7686
            Left            =   1800
            List            =   "frm_rpt_performance.frx":7690
            TabIndex        =   8
            Text            =   "..."
            Top             =   840
            Width           =   1695
         ...
         Begin VB.ComboBox cbo_yearly_employee 
            Height          =   315
            ItemData        =   "frm_rpt_performance.frx":76A3
            Left            =   1800
            List            =   "frm_rpt_performance.frx":76AD
            TabIndex        =   7
            Text            =   "..."
            Top             =   1200
            Width           =   1695
         ...
         Begin VB.ComboBox cbo_monthly_company 
            Height          =   315
            ItemData        =   "frm_rpt_performance.frx":76BE
            Left            =   3600
            List            =   "frm_rpt_performance.frx":76C8
            TabIndex        =   6
            Text            =   "..."
            Top             =   1590
            Visible         =   0   'False
         ...
         Begin VB.Frame fra_yearly_employee 
            ...
            Begin prj_tpc.vbButton cmd_monthly_browse_employee 
               ...
               MCOL            =   12632256
               MPTR            =   1
               MICON           =   "frm_rpt_performance.frx":76DB
               UMCOL           =   -1  'True
               SOFT            =   0   'False
               PICPOS          =   0
               NGREY           =   0   'False
   ...
   Begin VB.Image Image1 
      Height          =   585
      Left            =   0
      Picture         =   "frm_rpt_performance.frx":76F7
      Stretch         =   -1  'True
      Top             =   0
      Width           =   12690
   End
...
'    d2 = Format(DTPicker_monthly.Value, "yyyy-MM") & getEndDay(Format(DTPicker_monthly.Value, "MM"), Format(DTPicker_monthly.Value, "yyyy"))
    ...
    str_sql = "SELECT a.company_code, e.company_name, a.department_code, f.department_name, " & _
              ...
              "FROM m_employee a join t_employee_perf_result b on a.employee_code = b.employee_code " & _
                ...
                "JOIN m_department f on a.company_code = f.company_code AND a.department_code = f.department_code " & _
              "WHERE " & IIf(cbo_yearly_department.ListIndex = 0, "a.company_code = '" & TDBCombo_company.Text & "' ", "a.company_code = '" & TDBCombo_company.Text & "' AND a.department_code = '" & TDBCombo_yearly_department.Text & "' ") & " " & _
...
'            & cbo_yearly_department.ListIndex & ",'" & LOGIN_LEVEL & "');"
    str_sql = "SELECT a.company_code, e.company_name, a.department_code, f.department_name, " & _
...
Private Sub createGridKar()
   With LynxGrid2
      ...
      .AddColumn "DEPARTMENT", 1300, , , , , , , , , True
    ...
    If pilihan = 1 Then
        ...
        If LOGIN_LEVEL = 100 Then
            SQL = "SELECT a.nik,a.employee_name," _
                    ...
                    & "JOIN m_company e ON a.company_code = e.company_code " _
                    & "WHERE " & IIf(cbo_yearly_department.ListIndex = 0, "b.company_code = '" & TDBCombo_company.Text & "'", _
                            "b.company_code = '" & TDBCombo_company.Text & "' AND b.department_code = '" & TDBCombo_yearly_department.Text & "'") & " " _
