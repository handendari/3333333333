...
Begin VB.Form frm_rpt_loan 
   ...
   Begin VB.Frame Frame3 
      ...
      Begin prj_tpc.vbButton cmdSummary 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frm_rpt_loan.frx":2544
         PICN            =   "frm_rpt_loan.frx":2560
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   2
         NGREY           =   0   'False
      ...
      Begin prj_tpc.vbButton cmdPrint 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frm_rpt_loan.frx":35F2
         PICN            =   "frm_rpt_loan.frx":360E
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   2
         NGREY           =   0   'False
      ...
      Begin prj_tpc.vbButton cmdExit 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frm_rpt_loan.frx":46A0
         PICN            =   "frm_rpt_loan.frx":46BC
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   2
         NGREY           =   0   'False
   ...
   Begin TrueOleDBList60.TDBCombo TDBCombo_company 
      Height          =   375
      Left            =   1200
      OleObjectBlob   =   "frm_rpt_loan.frx":574E
      TabIndex        =   3
      Top             =   930
      Width           =   1695
   End
