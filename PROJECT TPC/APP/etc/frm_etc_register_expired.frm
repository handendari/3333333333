...
Begin VB.Form frm_etc_register_expired 
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      Tab(0).Control(1)=   "cmd_request_key"
      ...
      Begin VB.Frame Frame1 
         ...
         Begin TrueOleDBList60.TDBCombo TDBCombo_company 
            Height          =   375
            Left            =   1920
            OleObjectBlob   =   "frm_etc_register_expired.frx":05C2
            TabIndex        =   10
            Top             =   810
            Width           =   1695
         End
         Begin prj_tpc.vbButton cmd_req_browse 
            ...
            MCOL            =   12632256
            MPTR            =   1
            MICON           =   "frm_etc_register_expired.frx":2528
            UMCOL           =   -1  'True
            SOFT            =   0   'False
            PICPOS          =   0
            NGREY           =   0   'False
      ...
      Begin VB.Frame Frame2 
         ...
         Begin prj_tpc.vbButton cmd_reg_browse 
            ...
            MCOL            =   12632256
            MPTR            =   1
            MICON           =   "frm_etc_register_expired.frx":2544
            UMCOL           =   -1  'True
            SOFT            =   0   'False
            PICPOS          =   0
            NGREY           =   0   'False
...
On Error GoTo Err
    ...
    If txt_registration_name.Text = "" Then
        MsgBox "Register Name Is Empty...", vbExclamation, headerMSG
