...
Public Function GetInitEntry(ByVal index As Integer, ByVal sSection As String, ByVal sKeyName As String, Optional ByVal sDefault As String = "", Optional ByVal sInitFileName As String = "") As String
...
Dim sInitFile As String
    ...
    If index = 0 Then
        ...
        If Len(sInitFileName) = 0 Then
            ...
            If Left(sDefInitFileName, 11) <> "config1.ssd" Then
                ...
                sDefInitFileName = sDefInitFileName & "config1.ssd"
            End If
    ...
    ElseIf index = 1 Then
        ...
        If Len(sInitFileName) = 0 Then
            'If Static Init FileName NOT Already Created
            If Left(sDefInitFileName, 11) <> "config2.ssd" Then
                'Create Static Init FileName
                sDefInitFileName = App.Path
                If Right$(sDefInitFileName, 1) <> "\config\" Then
                    sDefInitFileName = sDefInitFileName & "\config\"
                ...
                sDefInitFileName = sDefInitFileName & "config2.ssd"
            End If
            sInitFile = sDefInitFileName
        Else    'If Init Filename Passed In
            sInitFile = sInitFileName
    ...
    Else
        ...
        If Len(sInitFileName) = 0 Then
            'If Static Init FileName NOT Already Created
            If Left(sDefInitFileName, 11) <> "config3.ssd" Then
                'Create Static Init FileName
                sDefInitFileName = App.Path
                If Right$(sDefInitFileName, 1) <> "\config\" Then
                    sDefInitFileName = sDefInitFileName & "\config\"
                ...
                sDefInitFileName = sDefInitFileName & "config3.ssd"
            End If
            sInitFile = sDefInitFileName
        Else    'If Init Filename Passed In
            sInitFile = sInitFileName
...
Public Function SetInitEntry(ByVal index As Integer, ByVal sSection As String, Optional ByVal sKeyName As String, Optional ByVal sValue As String, Optional ByVal sInitFileName As String = "") As Long
Dim sInitFile As String
